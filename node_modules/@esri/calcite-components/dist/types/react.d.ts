...
interface ReactCalciteAccordion extends Partial<Pick<Accordion, "appearance" | "iconPosition" | "iconType" | "scale" | "selectionMode">>, HTMLProps<Accordion> {
}

interface ReactCalciteAccordionItem extends Partial<Pick<AccordionItem, "description" | "expanded" | "heading" | "headingLevel" | "iconEnd" | "iconFlipRtl" | "iconStart" | "messageOverrides">>, HTMLProps<AccordionItem> {
...
interface ReactCalciteAction extends Required<Pick<Action, "text">>, Partial<Pick<Action, "active" | "alignment" | "appearance" | "aria" | "compact" | "disabled" | "form" | "icon" | "iconFlipRtl" | "indicator" | "label" | "loading" | "messageOverrides" | "overflowDisabled" | "scale" | "textEnabled" | "type">>, HTMLProps<Action> {
}

interface ReactCalciteActionBar extends Partial<Pick<ActionBar, "actionsEndGroupLabel" | "actionsStartGroupLabel" | "expandDisabled" | "expanded" | "expandPosition" | "floating" | "layout" | "messageOverrides" | "overflowActionsDisabled" | "overlayPositioning" | "position" | "scale" | "selectionAppearance">>, HTMLProps<ActionBar> {
...
interface ReactCalciteActionGroup extends Partial<Pick<ActionGroup, "columns" | "expanded" | "label" | "layout" | "menuFlipPlacements" | "menuOpen" | "menuPlacement" | "messageOverrides" | "overflowActionsDisabled" | "overlayPositioning" | "scale" | "selectionMode" | "topLayerDisabled">>, HTMLProps<ActionGroup> {
...
interface ReactCalciteActionMenu extends Required<Pick<ActionMenu, "label">>, Partial<Pick<ActionMenu, "appearance" | "expanded" | "flipPlacements" | "open" | "overlayPositioning" | "placement" | "scale" | "topLayerDisabled">>, HTMLProps<ActionMenu> {
...
interface ReactCalciteActionPad extends Partial<Pick<ActionPad, "actionsEndGroupLabel" | "expandDisabled" | "expanded" | "layout" | "messageOverrides" | "overlayPositioning" | "position" | "scale" | "selectionAppearance">>, HTMLProps<ActionPad> {
...
interface ReactCalciteAlert extends Required<Pick<Alert, "label">>, Partial<Pick<Alert, "autoClose" | "autoCloseDuration" | "icon" | "iconFlipRtl" | "kind" | "messageOverrides" | "numberingSystem" | "open" | "placement" | "queue" | "scale" | "topLayerDisabled">>, HTMLProps<Alert> {
...
interface ReactCalciteAutocomplete extends Partial<Pick<Autocomplete, "alignment" | "autocomplete" | "disabled" | "flipPlacements" | "form" | "icon" | "iconFlipRtl" | "inputValue" | "label" | "labelText" | "loading" | "maxLength" | "messageOverrides" | "minLength" | "name" | "open" | "overlayPositioning" | "pattern" | "placeholder" | "placement" | "prefixText" | "readOnly" | "required" | "scale" | "status" | "suffixText" | "topLayerDisabled" | "validationIcon" | "validationMessage" | "value">>, HTMLProps<Autocomplete> {
...
interface ReactCalciteAutocompleteItem extends Required<Pick<AutocompleteItem, "heading">>, Partial<Pick<AutocompleteItem, "description" | "disabled" | "iconEnd" | "iconFlipRtl" | "iconStart" | "label" | "selected" | "value">>, HTMLProps<AutocompleteItem> {
  oncalciteAutocompleteItemSelect?: EventHandler<AutocompleteItem["calciteAutocompleteItemSelect"]>;
}

interface ReactCalciteAutocompleteItemGroup extends Required<Pick<AutocompleteItemGroup, "heading">>, Partial<Pick<AutocompleteItemGroup, "label" | "position">>, HTMLProps<AutocompleteItemGroup> {
}

interface ReactCalciteAvatar extends Partial<Pick<Avatar, "fullName" | "label" | "scale" | "thumbnail" | "userId" | "username">>, HTMLProps<Avatar> {
}

interface ReactCalciteBlock extends Partial<Pick<Block, "collapsible" | "description" | "disabled" | "dragDisabled" | "dragHandle" | "expanded" | "heading" | "headingLevel" | "iconEnd" | "iconFlipRtl" | "iconStart" | "label" | "loading" | "menuFlipPlacements" | "menuPlacement" | "messageOverrides" | "open" | "overlayPositioning" | "scale" | "sortHandleOpen" | "status" | "topLayerDisabled">>, HTMLProps<Block> {
...
interface ReactCalciteBlockGroup extends Required<Pick<BlockGroup, "label">>, Partial<Pick<BlockGroup, "canPull" | "canPut" | "disabled" | "dragEnabled" | "group" | "loading" | "scale" | "sortDisabled">>, HTMLProps<BlockGroup> {
...
interface ReactCalciteBlockSection extends Partial<Pick<BlockSection, "expanded" | "iconEnd" | "iconFlipRtl" | "iconStart" | "messageOverrides" | "open" | "scale" | "status" | "text" | "toggleDisplay">>, HTMLProps<BlockSection> {
...
interface ReactCalciteButton extends Partial<Pick<Button, "alignment" | "appearance" | "disabled" | "download" | "form" | "href" | "iconEnd" | "iconFlipRtl" | "iconStart" | "kind" | "label" | "loading" | "messageOverrides" | "name" | "rel" | "round" | "scale" | "splitChild" | "target" | "type" | "width">>, HTMLProps<Button> {
}

interface ReactCalciteCard extends Partial<Pick<Card, "disabled" | "label" | "loading" | "messageOverrides" | "scale" | "selectable" | "selected" | "thumbnailPosition">>, HTMLProps<Card> {
  oncalciteCardSelect?: EventHandler<Card["calciteCardSelect"]>;
}

interface ReactCalciteCardGroup extends Required<Pick<CardGroup, "label">>, Partial<Pick<CardGroup, "disabled" | "scale" | "selectionMode">>, HTMLProps<CardGroup> {
  oncalciteCardGroupSelect?: EventHandler<CardGroup["calciteCardGroupSelect"]>;
}

interface ReactCalciteCarousel extends Required<Pick<Carousel, "label">>, Partial<Pick<Carousel, "arrowType" | "autoplay" | "autoplayDuration" | "controlOverlay" | "disabled" | "messageOverrides" | "paginationDisabled" | "paginationPosition">>, HTMLProps<Carousel> {
...
interface ReactCalciteCarouselItem extends Required<Pick<CarouselItem, "label">>, Partial<Pick<CarouselItem, "selected">>, HTMLProps<CarouselItem> {
}

interface ReactCalciteCheckbox extends Partial<Pick<Checkbox, "checked" | "disabled" | "form" | "indeterminate" | "label" | "labelText" | "messageOverrides" | "name" | "required" | "scale" | "status" | "value">>, HTMLProps<Checkbox> {
  oncalciteCheckboxChange?: EventHandler<Checkbox["calciteCheckboxChange"]>;
}

interface ReactCalciteChip extends Required<Pick<Chip, "label">>, Partial<Pick<Chip, "appearance" | "closable" | "closed" | "closeOnDelete" | "disabled" | "icon" | "iconFlipRtl" | "kind" | "messageOverrides" | "scale" | "selected" | "value">>, HTMLProps<Chip> {
  oncalciteChipClose?: EventHandler<Chip["calciteChipClose"]>;
  oncalciteChipSelect?: EventHandler<Chip["calciteChipSelect"]>;
}

interface ReactCalciteChipGroup extends Required<Pick<ChipGroup, "label">>, Partial<Pick<ChipGroup, "disabled" | "scale" | "selectionMode">>, HTMLProps<ChipGroup> {
  oncalciteChipGroupSelect?: EventHandler<ChipGroup["calciteChipGroupSelect"]>;
}

interface ReactCalciteColorPicker extends Partial<Pick<ColorPicker, "alphaChannel" | "channelsDisabled" | "clearable" | "disabled" | "fieldDisabled" | "format" | "hexDisabled" | "messageOverrides" | "numberingSystem" | "savedDisabled" | "scale" | "storageId" | "value">>, HTMLProps<ColorPicker> {
...
interface ReactCalciteColorPickerHexInput extends Partial<Pick<ColorPickerHexInput, "allowEmpty" | "alphaChannel" | "hexLabel" | "numberingSystem" | "scale" | "value">>, HTMLProps<ColorPickerHexInput> {
  oncalciteColorPickerHexInputChange?: EventHandler<ColorPickerHexInput["calciteColorPickerHexInputChange"]>;
}

interface ReactCalciteColorPickerSwatch extends Partial<Pick<ColorPickerSwatch, "active" | "color" | "scale">>, HTMLProps<ColorPickerSwatch> {
}

interface ReactCalciteCombobox extends Required<Pick<Combobox, "label">>, Partial<Pick<Combobox, "allowCustomValues" | "clearDisabled" | "disabled" | "filterProps" | "filterText" | "flipPlacements" | "form" | "labelText" | "maxItems" | "messageOverrides" | "name" | "open" | "overlayPositioning" | "placeholder" | "placeholderIcon" | "placeholderIconFlipRtl" | "placement" | "readOnly" | "required" | "scale" | "selectAllEnabled" | "selectionAppearance" | "selectionDisplay" | "selectionMode" | "status" | "topLayerDisabled" | "validationIcon" | "validationMessage" | "value">>, HTMLProps<Combobox> {
...
interface ReactCalciteComboboxItem extends Required<Pick<ComboboxItem, "heading">>, Partial<Pick<ComboboxItem, "active" | "ancestors" | "description" | "disabled" | "filterDisabled" | "guid" | "icon" | "iconFlipRtl" | "label" | "metadata" | "selected" | "shortHeading" | "value">>, HTMLProps<ComboboxItem> {
  oncalciteComboboxItemChange?: EventHandler<ComboboxItem["calciteComboboxItemChange"]>;
}

interface ReactCalciteComboboxItemGroup extends Required<Pick<ComboboxItemGroup, "label">>, Partial<Pick<ComboboxItemGroup, "ancestors" | "position">>, HTMLProps<ComboboxItemGroup> {
}

interface ReactCalciteDatePicker extends Partial<Pick<DatePicker, "activeDate" | "activeRange" | "calendars" | "headingLevel" | "layout" | "max" | "maxAsDate" | "messageOverrides" | "min" | "minAsDate" | "monthStyle" | "numberingSystem" | "proximitySelectionDisabled" | "range" | "scale" | "value" | "valueAsDate">>, HTMLProps<DatePicker> {
...
interface ReactCalciteDatePickerDay extends Required<Pick<DatePickerDay, "day">>, Partial<Pick<DatePickerDay, "active" | "currentMonth" | "disabled" | "endOfRange" | "highlighted" | "range" | "rangeHover" | "scale" | "selected" | "startOfRange" | "value">>, HTMLProps<DatePickerDay> {
}

interface ReactCalciteDatePickerMonth extends Partial<Pick<DatePickerMonth, "activeDate" | "calendars" | "endDate" | "headingLevel" | "hoverRange" | "max" | "min" | "monthStyle" | "range" | "scale" | "selectedDate" | "startDate">>, HTMLProps<DatePickerMonth> {
}
...
interface ReactCalciteDropdown extends Partial<Pick<Dropdown, "closeOnSelectDisabled" | "disabled" | "flipPlacements" | "maxItems" | "offsetDistance" | "offsetSkidding" | "open" | "overlayPositioning" | "placement" | "referenceElement" | "scale" | "topLayerDisabled" | "type" | "width" | "widthScale">>, HTMLProps<Dropdown> {
...
interface ReactCalciteDropdownGroup extends Partial<Pick<DropdownGroup, "groupTitle" | "position" | "selectionMode">>, HTMLProps<DropdownGroup> {
}

interface ReactCalciteDropdownItem extends Partial<Pick<DropdownItem, "disabled" | "href" | "iconEnd" | "iconFlipRtl" | "iconStart" | "label" | "rel" | "selected" | "target">>, HTMLProps<DropdownItem> {
  oncalciteDropdownItemSelect?: EventHandler<DropdownItem["calciteDropdownItemSelect"]>;
}

interface ReactCalciteFab extends Partial<Pick<Fab, "appearance" | "disabled" | "icon" | "iconFlipRtl" | "kind" | "label" | "loading" | "scale" | "text" | "textEnabled">>, HTMLProps<Fab> {
}

interface ReactCalciteFilter extends Partial<Pick<Filter, "disabled" | "filterProps" | "items" | "label" | "messageOverrides" | "placeholder" | "scale" | "value">>, HTMLProps<Filter> {
  oncalciteFilterChange?: EventHandler<Filter["calciteFilterChange"]>;
}

interface ReactCalciteFlow extends HTMLProps<Flow> {
}

interface ReactCalciteFlowItem extends Partial<Pick<FlowItem, "beforeBack" | "beforeClose" | "closable" | "closed" | "collapsed" | "collapsible" | "description" | "disabled" | "heading" | "headingLevel" | "icon" | "iconFlipRtl" | "loading" | "menuOpen" | "messageOverrides" | "overlayPositioning" | "scale" | "selected" | "showBackButton" | "topLayerDisabled">>, HTMLProps<FlowItem> {
...
interface ReactCalciteFocusTrap extends Partial<Pick<FocusTrap, "focusTrapDisabled" | "focusTrapDisabledOverride" | "focusTrapOptions">>, HTMLProps<FocusTrap> {
  oncalciteFocusTrapActiveChange?: EventHandler<FocusTrap["calciteFocusTrapActiveChange"]>;
}

interface ReactCalciteGraph extends Required<Pick<Graph, "max" | "min">>, Partial<Pick<Graph, "colorStops" | "data" | "highlightMax" | "highlightMin">>, HTMLProps<Graph> {
}

interface ReactCalciteHandle extends Partial<Pick<Handle, "disabled" | "dragHandle" | "messageOverrides" | "selected">>, HTMLProps<Handle> {
  oncalciteHandleChange?: EventHandler<Handle["calciteHandleChange"]>;
  oncalciteHandleNudge?: EventHandler<Handle["calciteHandleNudge"]>;
}

interface ReactCalciteIcon extends Partial<Pick<Icon, "flipRtl" | "icon" | "preload" | "scale" | "textLabel">>, HTMLProps<Icon> {
}

interface ReactCalciteInlineEditable extends Partial<Pick<InlineEditable, "afterConfirm" | "controls" | "disabled" | "editingEnabled" | "loading" | "messageOverrides" | "scale">>, HTMLProps<InlineEditable> {
...
interface ReactCalciteInput extends Partial<Pick<Input, "accept" | "alignment" | "autocomplete" | "clearable" | "disabled" | "files" | "form" | "groupSeparator" | "icon" | "iconFlipRtl" | "label" | "labelText" | "loading" | "max" | "maxLength" | "messageOverrides" | "min" | "minLength" | "multiple" | "name" | "numberButtonType" | "numberingSystem" | "pattern" | "placeholder" | "prefixText" | "readOnly" | "required" | "scale" | "status" | "step" | "suffixText" | "type" | "validationIcon" | "validationMessage" | "value">>, HTMLProps<Input> {
  oncalciteInputChange?: EventHandler<Input["calciteInputChange"]>;
  oncalciteInputInput?: EventHandler<Input["calciteInputInput"]>;
}

interface ReactCalciteInputDatePicker extends Partial<Pick<InputDatePicker, "calendars" | "disabled" | "flipPlacements" | "focusTrapDisabled" | "form" | "headingLevel" | "label" | "labelText" | "layout" | "max" | "maxAsDate" | "messageOverrides" | "min" | "minAsDate" | "monthStyle" | "name" | "numberingSystem" | "open" | "overlayPositioning" | "placement" | "proximitySelectionDisabled" | "range" | "readOnly" | "required" | "scale" | "status" | "topLayerDisabled" | "validationIcon" | "validationMessage" | "value" | "valueAsDate">>, HTMLProps<InputDatePicker> {
...
interface ReactCalciteInputMessage extends Partial<Pick<InputMessage, "icon" | "iconFlipRtl" | "scale" | "status">>, HTMLProps<InputMessage> {
}

interface ReactCalciteInputNumber extends Partial<Pick<InputNumber, "alignment" | "autocomplete" | "clearable" | "disabled" | "form" | "groupSeparator" | "icon" | "iconFlipRtl" | "integer" | "label" | "labelText" | "loading" | "max" | "maxLength" | "messageOverrides" | "min" | "minLength" | "name" | "numberButtonType" | "numberingSystem" | "placeholder" | "prefixText" | "readOnly" | "required" | "scale" | "status" | "step" | "suffixText" | "validationIcon" | "validationMessage" | "value">>, HTMLProps<InputNumber> {
...
interface ReactCalciteInputText extends Partial<Pick<InputText, "alignment" | "autocomplete" | "clearable" | "disabled" | "form" | "icon" | "iconFlipRtl" | "label" | "labelText" | "loading" | "maxLength" | "messageOverrides" | "minLength" | "name" | "pattern" | "placeholder" | "prefixText" | "readOnly" | "required" | "scale" | "status" | "suffixText" | "validationIcon" | "validationMessage" | "value">>, HTMLProps<InputText> {
...
interface ReactCalciteInputTimePicker extends Partial<Pick<InputTimePicker, "disabled" | "focusTrapDisabled" | "form" | "hourFormat" | "label" | "labelText" | "max" | "messageOverrides" | "min" | "name" | "numberingSystem" | "open" | "overlayPositioning" | "placement" | "readOnly" | "required" | "scale" | "status" | "step" | "validationIcon" | "validationMessage" | "value">>, HTMLProps<InputTimePicker> {
...
interface ReactCalciteInputTimeZone extends Partial<Pick<InputTimeZone, "clearable" | "disabled" | "form" | "labelText" | "maxItems" | "messageOverrides" | "mode" | "name" | "offsetStyle" | "open" | "overlayPositioning" | "readOnly" | "referenceDate" | "scale" | "status" | "topLayerDisabled" | "validationIcon" | "validationMessage" | "value">>, HTMLProps<InputTimeZone> {
...
interface ReactCalciteLabel extends Partial<Pick<Label, "alignment" | "for" | "layout" | "scale">>, HTMLProps<Label> {
}

interface ReactCalciteLink extends Partial<Pick<Link, "disabled" | "download" | "href" | "iconEnd" | "iconFlipRtl" | "iconStart" | "rel" | "target">>, HTMLProps<Link> {
}

interface ReactCalciteList extends Required<Pick<List, "label">>, Partial<Pick<List, "canPull" | "canPut" | "disabled" | "displayMode" | "dragEnabled" | "filterEnabled" | "filterLabel" | "filterPlaceholder" | "filterPredicate" | "filterProps" | "filterText" | "group" | "interactionMode" | "loading" | "messageOverrides" | "numberingSystem" | "scale" | "selectionAppearance" | "selectionMode" | "sortDisabled">>, HTMLProps<List> {
...
interface ReactCalciteListItem extends Partial<Pick<ListItem, "closable" | "closed" | "description" | "disabled" | "dragDisabled" | "expanded" | "iconEnd" | "iconFlipRtl" | "iconStart" | "label" | "messageOverrides" | "metadata" | "open" | "scale" | "selected" | "sortHandleOpen" | "topLayerDisabled" | "unavailable" | "value">>, HTMLProps<ListItem> {
...
interface ReactCalciteListItemGroup extends Partial<Pick<ListItemGroup, "disabled" | "heading" | "scale">>, HTMLProps<ListItemGroup> {
}

interface ReactCalciteLoader extends Required<Pick<Loader, "label">>, Partial<Pick<Loader, "inline" | "scale" | "text" | "type" | "value">>, HTMLProps<Loader> {
}

interface ReactCalciteMenu extends Required<Pick<Menu, "label">>, Partial<Pick<Menu, "layout" | "messageOverrides">>, HTMLProps<Menu> {
}

interface ReactCalciteMenuItem extends Required<Pick<MenuItem, "label">>, Partial<Pick<MenuItem, "active" | "breadcrumb" | "href" | "iconEnd" | "iconFlipRtl" | "iconStart" | "messageOverrides" | "open" | "rel" | "target" | "text">>, HTMLProps<MenuItem> {
  oncalciteMenuItemSelect?: EventHandler<MenuItem["calciteMenuItemSelect"]>;
}

interface ReactCalciteMeter extends Required<Pick<Meter, "label">>, Partial<Pick<Meter, "appearance" | "disabled" | "fillType" | "form" | "groupSeparator" | "high" | "low" | "max" | "min" | "name" | "numberingSystem" | "rangeLabels" | "rangeLabelType" | "scale" | "unitLabel" | "value" | "valueLabel" | "valueLabelType">>, HTMLProps<Meter> {
}

interface ReactCalciteNavigation extends Partial<Pick<Navigation, "label" | "navigationAction" | "scale">>, HTMLProps<Navigation> {
  oncalciteNavigationActionSelect?: EventHandler<Navigation["calciteNavigationActionSelect"]>;
}

interface ReactCalciteNavigationLogo extends Partial<Pick<NavigationLogo, "active" | "description" | "heading" | "headingLevel" | "href" | "icon" | "iconFlipRtl" | "label" | "rel" | "target" | "thumbnail">>, HTMLProps<NavigationLogo> {
}

interface ReactCalciteNavigationUser extends Partial<Pick<NavigationUser, "active" | "fullName" | "label" | "textDisabled" | "thumbnail" | "userId" | "username">>, HTMLProps<NavigationUser> {
}

interface ReactCalciteNotice extends Partial<Pick<Notice, "appearance" | "closable" | "icon" | "iconFlipRtl" | "kind" | "messageOverrides" | "open" | "scale" | "width">>, HTMLProps<Notice> {
...
interface ReactCalciteOption extends Partial<Pick<Option, "disabled" | "label" | "selected" | "value">>, HTMLProps<Option> {
}

interface ReactCalciteOptionGroup extends Required<Pick<OptionGroup, "label">>, Partial<Pick<OptionGroup, "disabled">>, HTMLProps<OptionGroup> {
}

interface ReactCalcitePagination extends Partial<Pick<Pagination, "groupSeparator" | "messageOverrides" | "numberingSystem" | "pageSize" | "scale" | "startItem" | "totalItems">>, HTMLProps<Pagination> {
  oncalcitePaginationChange?: EventHandler<Pagination["calcitePaginationChange"]>;
}

interface ReactCalcitePanel extends Partial<Pick<Panel, "beforeClose" | "closable" | "closed" | "collapsed" | "collapseDirection" | "collapsible" | "description" | "disabled" | "heading" | "headingLevel" | "icon" | "iconFlipRtl" | "loading" | "menuFlipPlacements" | "menuOpen" | "menuPlacement" | "messageOverrides" | "overlayPositioning" | "scale" | "topLayerDisabled">>, HTMLProps<Panel> {
...
interface ReactCalciteProgress extends Partial<Pick<Progress, "label" | "reversed" | "text" | "type" | "value">>, HTMLProps<Progress> {
}

interface ReactCalciteRadioButton extends Required<Pick<RadioButton, "value">>, Partial<Pick<RadioButton, "checked" | "disabled" | "form" | "labelText" | "name" | "required" | "scale" | "status" | "validationMessage">>, HTMLProps<RadioButton> {
  oncalciteRadioButtonChange?: EventHandler<RadioButton["calciteRadioButtonChange"]>;
}

interface ReactCalciteRadioButtonGroup extends Required<Pick<RadioButtonGroup, "name">>, Partial<Pick<RadioButtonGroup, "disabled" | "labelText" | "layout" | "messageOverrides" | "required" | "scale" | "status" | "validationIcon" | "validationMessage">>, HTMLProps<RadioButtonGroup> {
  oncalciteRadioButtonGroupChange?: EventHandler<RadioButtonGroup["calciteRadioButtonGroupChange"]>;
}

interface ReactCalciteRating extends Partial<Pick<Rating, "average" | "count" | "disabled" | "form" | "labelText" | "messageOverrides" | "name" | "readOnly" | "scale" | "showChip" | "status" | "validationIcon" | "validationMessage" | "value">>, HTMLProps<Rating> {
  oncalciteRatingChange?: EventHandler<Rating["calciteRatingChange"]>;
}

interface ReactCalciteScrim extends Partial<Pick<Scrim, "loading" | "messageOverrides">>, HTMLProps<Scrim> {
}

interface ReactCalciteSegmentedControl extends Partial<Pick<SegmentedControl, "appearance" | "disabled" | "form" | "labelText" | "layout" | "messageOverrides" | "name" | "required" | "scale" | "status" | "validationIcon" | "validationMessage" | "value" | "width">>, HTMLProps<SegmentedControl> {
  oncalciteSegmentedControlChange?: EventHandler<SegmentedControl["calciteSegmentedControlChange"]>;
}

interface ReactCalciteSegmentedControlItem extends Partial<Pick<SegmentedControlItem, "checked" | "iconEnd" | "iconFlipRtl" | "iconStart" | "value">>, HTMLProps<SegmentedControlItem> {
}

interface ReactCalciteSelect extends Required<Pick<Select, "label">>, Partial<Pick<Select, "disabled" | "form" | "labelText" | "messageOverrides" | "name" | "required" | "scale" | "status" | "validationIcon" | "validationMessage" | "value" | "width">>, HTMLProps<Select> {
  oncalciteSelectChange?: EventHandler<Select["calciteSelectChange"]>;
}

interface ReactCalciteSheet extends Required<Pick<Sheet, "label">>, Partial<Pick<Sheet, "beforeClose" | "displayMode" | "escapeDisabled" | "focusTrapDisabled" | "focusTrapOptions" | "height" | "heightScale" | "messageOverrides" | "open" | "outsideCloseDisabled" | "position" | "resizable" | "topLayerDisabled" | "width" | "widthScale">>, HTMLProps<Sheet> {
...
interface ReactCalciteShell extends Partial<Pick<Shell, "contentBehind">>, HTMLProps<Shell> {
}

interface ReactCalciteShellPanel extends Partial<Pick<ShellPanel, "collapsed" | "displayMode" | "height" | "heightScale" | "layout" | "messageOverrides" | "position" | "resizable" | "width" | "widthScale">>, HTMLProps<ShellPanel> {
...
interface ReactCalciteSlider extends Partial<Pick<Slider, "disabled" | "fillPlacement" | "form" | "groupSeparator" | "hasHistogram" | "histogram" | "histogramStops" | "labelFormatter" | "labelHandles" | "labelText" | "labelTicks" | "max" | "maxLabel" | "maxValue" | "messageOverrides" | "min" | "minLabel" | "minValue" | "mirrored" | "name" | "numberingSystem" | "pageStep" | "precise" | "required" | "scale" | "snap" | "status" | "step" | "ticks" | "validationIcon" | "validationMessage" | "value">>, HTMLProps<Slider> {
  oncalciteSliderChange?: EventHandler<Slider["calciteSliderChange"]>;
  oncalciteSliderInput?: EventHandler<Slider["calciteSliderInput"]>;
}

interface ReactCalciteSortHandle extends Partial<Pick<SortHandle, "addToItems" | "disabled" | "flipPlacements" | "label" | "messageOverrides" | "moveToItems" | "open" | "overlayPositioning" | "placement" | "scale" | "setPosition" | "setSize" | "sortDisabled" | "topLayerDisabled" | "widthScale">>, HTMLProps<SortHandle> {
...
interface ReactCalciteStack extends Partial<Pick<Stack, "disabled">>, HTMLProps<Stack> {
}

interface ReactCalciteStepper extends Partial<Pick<Stepper, "icon" | "layout" | "messageOverrides" | "numbered" | "numberingSystem" | "scale">>, HTMLProps<Stepper> {
  oncalciteStepperChange?: EventHandler<Stepper["calciteStepperChange"]>;
}

interface ReactCalciteStepperItem extends Partial<Pick<StepperItem, "complete" | "description" | "disabled" | "error" | "heading" | "iconFlipRtl" | "messageOverrides" | "selected">>, HTMLProps<StepperItem> {
  oncalciteStepperItemSelect?: EventHandler<StepperItem["calciteStepperItemSelect"]>;
}

interface ReactCalciteSwatch extends Required<Pick<Swatch, "label">>, Partial<Pick<Swatch, "color" | "disabled" | "scale" | "selected" | "value">>, HTMLProps<Swatch> {
  oncalciteSwatchSelect?: EventHandler<Swatch["calciteSwatchSelect"]>;
}

interface ReactCalciteSwatchGroup extends Required<Pick<SwatchGroup, "label">>, Partial<Pick<SwatchGroup, "disabled" | "scale" | "selectionMode">>, HTMLProps<SwatchGroup> {
  oncalciteSwatchGroupSelect?: EventHandler<SwatchGroup["calciteSwatchGroupSelect"]>;
}

interface ReactCalciteSwitch extends Partial<Pick<Switch, "checked" | "disabled" | "form" | "label" | "labelTextEnd" | "labelTextStart" | "name" | "scale" | "value">>, HTMLProps<Switch> {
  oncalciteSwitchChange?: EventHandler<Switch["calciteSwitchChange"]>;
}

interface ReactCalciteTab extends Partial<Pick<Tab, "selected" | "tab">>, HTMLProps<Tab> {
}

interface ReactCalciteTabNav extends Partial<Pick<TabNav, "messageOverrides" | "position" | "storageId" | "syncId">>, HTMLProps<TabNav> {
  oncalciteTabChange?: EventHandler<TabNav["calciteTabChange"]>;
}

interface ReactCalciteTabTitle extends Partial<Pick<TabTitle, "closable" | "closed" | "disabled" | "iconEnd" | "iconFlipRtl" | "iconStart" | "messageOverrides" | "position" | "selected" | "tab">>, HTMLProps<TabTitle> {
  oncalciteTabsActivate?: EventHandler<TabTitle["calciteTabsActivate"]>;
  oncalciteTabsClose?: EventHandler<TabTitle["calciteTabsClose"]>;
}

interface ReactCalciteTable extends Required<Pick<Table, "caption">>, Partial<Pick<Table, "bordered" | "currentPage" | "groupSeparator" | "interactionMode" | "layout" | "messageOverrides" | "numbered" | "numberingSystem" | "pageSize" | "scale" | "selectionDisplay" | "selectionMode" | "striped">>, HTMLProps<Table> {
...
interface ReactCalciteTableCell extends Partial<Pick<TableCell, "alignment" | "colSpan" | "messageOverrides" | "rowSpan">>, HTMLProps<TableCell> {
}

interface ReactCalciteTableHeader extends Partial<Pick<TableHeader, "alignment" | "colSpan" | "description" | "heading" | "messageOverrides" | "rowSpan">>, HTMLProps<TableHeader> {
}

interface ReactCalciteTableRow extends Partial<Pick<TableRow, "alignment" | "disabled" | "selected">>, HTMLProps<TableRow> {
  oncalciteTableRowSelect?: EventHandler<TableRow["calciteTableRowSelect"]>;
}

interface ReactCalciteTabs extends Partial<Pick<Tabs, "bordered" | "layout" | "position" | "scale">>, HTMLProps<Tabs> {
}

interface ReactCalciteTextArea extends Partial<Pick<TextArea, "columns" | "disabled" | "form" | "groupSeparator" | "label" | "labelText" | "limitText" | "loading" | "maxLength" | "messageOverrides" | "minLength" | "name" | "numberingSystem" | "placeholder" | "readOnly" | "required" | "resize" | "rows" | "scale" | "status" | "validationIcon" | "validationMessage" | "value" | "wrap">>, HTMLProps<TextArea> {
...
interface ReactCalciteTile extends Partial<Pick<Tile, "active" | "alignment" | "description" | "disabled" | "embed" | "heading" | "headingLevel" | "href" | "icon" | "iconFlipRtl" | "label" | "scale" | "selected">>, HTMLProps<Tile> {
  oncalciteTileSelect?: EventHandler<Tile["calciteTileSelect"]>;
}

interface ReactCalciteTileGroup extends Required<Pick<TileGroup, "label">>, Partial<Pick<TileGroup, "alignment" | "disabled" | "layout" | "scale" | "selectionAppearance" | "selectionMode">>, HTMLProps<TileGroup> {
  oncalciteTileGroupSelect?: EventHandler<TileGroup["calciteTileGroupSelect"]>;
}

interface ReactCalciteTimePicker extends Partial<Pick<TimePicker, "hourFormat" | "messageOverrides" | "numberingSystem" | "scale" | "step" | "time" | "value">>, HTMLProps<TimePicker> {
  oncalciteTimePickerChange?: EventHandler<TimePicker["calciteTimePickerChange"]>;
}

interface ReactCalciteTooltip extends Partial<Pick<Tooltip, "closeOnClick" | "label" | "offsetDistance" | "offsetSkidding" | "open" | "overlayPositioning" | "placement" | "pointerDisabled" | "referenceElement" | "scale" | "topLayerDisabled">>, HTMLProps<Tooltip> {
...
interface ReactCalciteTree extends Partial<Pick<Tree, "lines" | "scale" | "selectionMode">>, HTMLProps<Tree> {
  oncalciteTreeSelect?: EventHandler<Tree["calciteTreeSelect"]>;
}

interface ReactCalciteTreeItem extends Partial<Pick<TreeItem, "disabled" | "expanded" | "iconFlipRtl" | "iconStart" | "label" | "selected">>, HTMLProps<TreeItem> {
...
declare module "react" {
  namespace JSX {
    interface IntrinsicElements {
      ...
      "calcite-focus-trap": ReactCalciteFocusTrap;
      ...
      "calcite-swatch": ReactCalciteSwatch;
      "calcite-swatch-group": ReactCalciteSwatchGroup;
