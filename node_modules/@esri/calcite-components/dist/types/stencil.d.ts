...
interface StencilCalciteAction extends Required<Pick<Action, "text">>, Partial<Pick<Action, "active" | "alignment" | "appearance" | "aria" | "compact" | "disabled" | "form" | "icon" | "iconFlipRtl" | "indicator" | "label" | "loading" | "messageOverrides" | "overflowDisabled" | "scale" | "textEnabled" | "type">>, StencilJsx.HTMLAttributes<Action> {
}
...
interface StencilCalciteActionGroup extends Partial<Pick<ActionGroup, "columns" | "expanded" | "label" | "layout" | "menuFlipPlacements" | "menuOpen" | "menuPlacement" | "messageOverrides" | "overflowActionsDisabled" | "overlayPositioning" | "scale" | "selectionMode" | "topLayerDisabled">>, StencilJsx.HTMLAttributes<ActionGroup> {
...
interface StencilCalciteCard extends Partial<Pick<Card, "disabled" | "label" | "loading" | "messageOverrides" | "scale" | "selectable" | "selected" | "thumbnailPosition">>, StencilJsx.HTMLAttributes<Card> {
  onCalciteCardSelect?: EventHandler<Card["calciteCardSelect"]>;
}

interface StencilCalciteCardGroup extends Required<Pick<CardGroup, "label">>, Partial<Pick<CardGroup, "disabled" | "scale" | "selectionMode">>, StencilJsx.HTMLAttributes<CardGroup> {
  onCalciteCardGroupSelect?: EventHandler<CardGroup["calciteCardGroupSelect"]>;
}

interface StencilCalciteCarousel extends Required<Pick<Carousel, "label">>, Partial<Pick<Carousel, "arrowType" | "autoplay" | "autoplayDuration" | "controlOverlay" | "disabled" | "messageOverrides" | "paginationDisabled" | "paginationPosition">>, StencilJsx.HTMLAttributes<Carousel> {
...
interface StencilCalciteFocusTrap extends Partial<Pick<FocusTrap, "focusTrapDisabled" | "focusTrapDisabledOverride" | "focusTrapOptions">>, StencilJsx.HTMLAttributes<FocusTrap> {
...
interface StencilCalciteNavigation extends Partial<Pick<Navigation, "label" | "navigationAction" | "scale">>, StencilJsx.HTMLAttributes<Navigation> {
...
interface StencilCalciteRadioButton extends Required<Pick<RadioButton, "value">>, Partial<Pick<RadioButton, "checked" | "disabled" | "form" | "labelText" | "name" | "required" | "scale" | "status" | "validationMessage">>, StencilJsx.HTMLAttributes<RadioButton> {
...
interface ExposedElements {
  ...
  "calcite-focus-trap": StencilCalciteFocusTrap;
