...
interface LuminaCalciteAction extends Required<Pick<Action, "text">>, Partial<Pick<Action, "active" | "alignment" | "appearance" | "aria" | "compact" | "disabled" | "form" | "icon" | "iconFlipRtl" | "indicator" | "label" | "loading" | "messageOverrides" | "overflowDisabled" | "scale" | "textEnabled" | "type">>, h.JSX.HTMLAttributes<Action> {
}

interface LuminaCalciteActionBar extends Partial<Pick<ActionBar, "actionsEndGroupLabel" | "actionsStartGroupLabel" | "expandDisabled" | "expanded" | "expandPosition" | "floating" | "layout" | "messageOverrides" | "overflowActionsDisabled" | "overlayPositioning" | "position" | "scale" | "selectionAppearance">>, h.JSX.HTMLAttributes<ActionBar> {
...
interface LuminaCalciteActionGroup extends Partial<Pick<ActionGroup, "columns" | "expanded" | "label" | "layout" | "menuFlipPlacements" | "menuOpen" | "menuPlacement" | "messageOverrides" | "overflowActionsDisabled" | "overlayPositioning" | "scale" | "selectionMode" | "topLayerDisabled">>, h.JSX.HTMLAttributes<ActionGroup> {
...
interface LuminaCalciteAutocompleteItem extends Required<Pick<AutocompleteItem, "heading">>, Partial<Pick<AutocompleteItem, "description" | "disabled" | "iconEnd" | "iconFlipRtl" | "iconStart" | "label" | "selected" | "value">>, h.JSX.HTMLAttributes<AutocompleteItem> {
...
interface LuminaCalciteCard extends Partial<Pick<Card, "disabled" | "label" | "loading" | "messageOverrides" | "scale" | "selectable" | "selected" | "thumbnailPosition">>, h.JSX.HTMLAttributes<Card> {
  oncalciteCardSelect?: EventHandler<Card["calciteCardSelect"]>;
}

interface LuminaCalciteCardGroup extends Required<Pick<CardGroup, "label">>, Partial<Pick<CardGroup, "disabled" | "scale" | "selectionMode">>, h.JSX.HTMLAttributes<CardGroup> {
  oncalciteCardGroupSelect?: EventHandler<CardGroup["calciteCardGroupSelect"]>;
}

interface LuminaCalciteCarousel extends Required<Pick<Carousel, "label">>, Partial<Pick<Carousel, "arrowType" | "autoplay" | "autoplayDuration" | "controlOverlay" | "disabled" | "messageOverrides" | "paginationDisabled" | "paginationPosition">>, h.JSX.HTMLAttributes<Carousel> {
...
interface LuminaCalciteCombobox extends Required<Pick<Combobox, "label">>, Partial<Pick<Combobox, "allowCustomValues" | "clearDisabled" | "disabled" | "filterProps" | "filterText" | "flipPlacements" | "form" | "labelText" | "maxItems" | "messageOverrides" | "name" | "open" | "overlayPositioning" | "placeholder" | "placeholderIcon" | "placeholderIconFlipRtl" | "placement" | "readOnly" | "required" | "scale" | "selectAllEnabled" | "selectionAppearance" | "selectionDisplay" | "selectionMode" | "status" | "topLayerDisabled" | "validationIcon" | "validationMessage" | "value">>, h.JSX.HTMLAttributes<Combobox> {
...
interface LuminaCalciteDropdown extends Partial<Pick<Dropdown, "closeOnSelectDisabled" | "disabled" | "flipPlacements" | "maxItems" | "offsetDistance" | "offsetSkidding" | "open" | "overlayPositioning" | "placement" | "referenceElement" | "scale" | "topLayerDisabled" | "type" | "width" | "widthScale">>, h.JSX.HTMLAttributes<Dropdown> {
...
interface LuminaCalciteFocusTrap extends Partial<Pick<FocusTrap, "focusTrapDisabled" | "focusTrapDisabledOverride" | "focusTrapOptions">>, h.JSX.HTMLAttributes<FocusTrap> {
...
interface LuminaCalciteNavigation extends Partial<Pick<Navigation, "label" | "navigationAction" | "scale">>, h.JSX.HTMLAttributes<Navigation> {
...
interface LuminaCalciteRadioButton extends Required<Pick<RadioButton, "value">>, Partial<Pick<RadioButton, "checked" | "disabled" | "form" | "labelText" | "name" | "required" | "scale" | "status" | "validationMessage">>, h.JSX.HTMLAttributes<RadioButton> {
...
interface LuminaCalciteTooltip extends Partial<Pick<Tooltip, "closeOnClick" | "label" | "offsetDistance" | "offsetSkidding" | "open" | "overlayPositioning" | "placement" | "pointerDisabled" | "referenceElement" | "scale" | "topLayerDisabled">>, h.JSX.HTMLAttributes<Tooltip> {
...
declare module "@arcgis/lumina" {
  export namespace h.JSX {
    interface IntrinsicElements {
      ...
      "calcite-focus-trap": LuminaCalciteFocusTrap;
