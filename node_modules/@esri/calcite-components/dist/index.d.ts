 ...
 * @internal
 */
export const assetPathChanged: boolean;
...
export interface CalciteAutocompleteItemCustomEvent<T> extends CustomEvent<T> {
  ...
  currentTarget: AutocompleteItem;
}
...
export interface CalciteFlowItemCustomEvent<T> extends CustomEvent<T> {
  detail: T;
  target: FlowItem;
  currentTarget: FlowItem;
}
export interface CalciteFocusTrapCustomEvent<T> extends CustomEvent<T> {
  detail: T;
  target: FocusTrap;
  currentTarget: FocusTrap;
}
...
export interface CalciteInlineEditableCustomEvent<T> extends CustomEvent<T> {
  detail: T;
  target: InlineEditable;
  currentTarget: InlineEditable;
}
...
export interface CalciteInputDatePickerCustomEvent<T> extends CustomEvent<T> {
  detail: T;
  target: InputDatePicker;
  currentTarget: InputDatePicker;
}
export interface CalciteInputNumberCustomEvent<T> extends CustomEvent<T> {
  detail: T;
  target: InputNumber;
  currentTarget: InputNumber;
}
...
export interface CalciteInputTimePickerCustomEvent<T> extends CustomEvent<T> {
  detail: T;
  target: InputTimePicker;
  currentTarget: InputTimePicker;
}
export interface CalciteInputTimeZoneCustomEvent<T> extends CustomEvent<T> {
  detail: T;
  target: InputTimeZone;
  currentTarget: InputTimeZone;
}
...
export interface CalciteRadioButtonGroupCustomEvent<T> extends CustomEvent<T> {
  ...
  currentTarget: RadioButtonGroup;
}
...
export interface CalciteSegmentedControlCustomEvent<T> extends CustomEvent<T> {
  ...
  currentTarget: SegmentedControl;
}
...
export interface CalciteStepperCustomEvent<T> extends CustomEvent<T> {
  detail: T;
  target: Stepper;
  currentTarget: Stepper;
}
export interface CalciteStepperItemCustomEvent<T> extends CustomEvent<T> {
  detail: T;
  target: StepperItem;
  currentTarget: StepperItem;
}
export interface CalciteSwatchCustomEvent<T> extends CustomEvent<T> {
  detail: T;
  target: Swatch;
  currentTarget: Swatch;
}
export interface CalciteSwatchGroupCustomEvent<T> extends CustomEvent<T> {
  detail: T;
  target: SwatchGroup;
  currentTarget: SwatchGroup;
}
...
declare global {
  ...
  type HTMLCalciteAccordionElement = Accordion;

  type HTMLCalciteAccordionItemElementEventMap = AccordionItem["@eventTypes"];
  type HTMLCalciteAccordionItemElement = AccordionItem;

  type HTMLCalciteActionElement = Action;

  type HTMLCalciteActionBarElementEventMap = ActionBar["@eventTypes"];
  type HTMLCalciteActionBarElement = ActionBar;

  type HTMLCalciteActionGroupElementEventMap = ActionGroup["@eventTypes"];
  type HTMLCalciteActionGroupElement = ActionGroup;

  type HTMLCalciteActionMenuElementEventMap = ActionMenu["@eventTypes"];
  type HTMLCalciteActionMenuElement = ActionMenu;

  type HTMLCalciteActionPadElementEventMap = ActionPad["@eventTypes"];
  type HTMLCalciteActionPadElement = ActionPad;

  type HTMLCalciteAlertElementEventMap = Alert["@eventTypes"];
  type HTMLCalciteAlertElement = Alert;

  type HTMLCalciteAutocompleteElementEventMap = Autocomplete["@eventTypes"];
  type HTMLCalciteAutocompleteElement = Autocomplete;

  type HTMLCalciteAutocompleteItemElementEventMap = AutocompleteItem["@eventTypes"];
  type HTMLCalciteAutocompleteItemElement = AutocompleteItem;

  type HTMLCalciteAutocompleteItemGroupElement = AutocompleteItemGroup;

  type HTMLCalciteAvatarElement = Avatar;

  type HTMLCalciteBlockElementEventMap = Block["@eventTypes"];
  type HTMLCalciteBlockElement = Block;

  type HTMLCalciteBlockGroupElementEventMap = BlockGroup["@eventTypes"];
  type HTMLCalciteBlockGroupElement = BlockGroup;

  type HTMLCalciteBlockSectionElementEventMap = BlockSection["@eventTypes"];
  type HTMLCalciteBlockSectionElement = BlockSection;

  type HTMLCalciteButtonElement = Button;

  type HTMLCalciteCardElementEventMap = Card["@eventTypes"];
  type HTMLCalciteCardElement = Card;

  type HTMLCalciteCardGroupElementEventMap = CardGroup["@eventTypes"];
  type HTMLCalciteCardGroupElement = CardGroup;

  type HTMLCalciteCarouselElementEventMap = Carousel["@eventTypes"];
  type HTMLCalciteCarouselElement = Carousel;

  type HTMLCalciteCarouselItemElement = CarouselItem;

  type HTMLCalciteCheckboxElementEventMap = Checkbox["@eventTypes"];
  type HTMLCalciteCheckboxElement = Checkbox;

  type HTMLCalciteChipElementEventMap = Chip["@eventTypes"];
  type HTMLCalciteChipElement = Chip;

  type HTMLCalciteChipGroupElementEventMap = ChipGroup["@eventTypes"];
  type HTMLCalciteChipGroupElement = ChipGroup;

  type HTMLCalciteColorPickerElementEventMap = ColorPicker["@eventTypes"];
  type HTMLCalciteColorPickerElement = ColorPicker;

  type HTMLCalciteColorPickerHexInputElementEventMap = ColorPickerHexInput["@eventTypes"];
  type HTMLCalciteColorPickerHexInputElement = ColorPickerHexInput;

  type HTMLCalciteColorPickerSwatchElement = ColorPickerSwatch;

  type HTMLCalciteComboboxElementEventMap = Combobox["@eventTypes"];
  type HTMLCalciteComboboxElement = Combobox;

  type HTMLCalciteComboboxItemElementEventMap = ComboboxItem["@eventTypes"];
  type HTMLCalciteComboboxItemElement = ComboboxItem;

  type HTMLCalciteComboboxItemGroupElement = ComboboxItemGroup;

  type HTMLCalciteDatePickerElementEventMap = DatePicker["@eventTypes"];
  type HTMLCalciteDatePickerElement = DatePicker;

  type HTMLCalciteDatePickerDayElement = DatePickerDay;

  type HTMLCalciteDatePickerMonthElement = DatePickerMonth;

  type HTMLCalciteDialogElementEventMap = Dialog["@eventTypes"];
  type HTMLCalciteDialogElement = Dialog;

  type HTMLCalciteDropdownElementEventMap = Dropdown["@eventTypes"];
  type HTMLCalciteDropdownElement = Dropdown;

  type HTMLCalciteDropdownGroupElement = DropdownGroup;

  type HTMLCalciteDropdownItemElementEventMap = DropdownItem["@eventTypes"];
  type HTMLCalciteDropdownItemElement = DropdownItem;

  type HTMLCalciteFabElement = Fab;

  type HTMLCalciteFilterElementEventMap = Filter["@eventTypes"];
  type HTMLCalciteFilterElement = Filter;

  type HTMLCalciteFlowElement = Flow;

  type HTMLCalciteFlowItemElementEventMap = FlowItem["@eventTypes"];
  type HTMLCalciteFlowItemElement = FlowItem;

  type HTMLCalciteFocusTrapElementEventMap = FocusTrap["@eventTypes"];
  type HTMLCalciteFocusTrapElement = FocusTrap;

  type HTMLCalciteGraphElement = Graph;

  type HTMLCalciteHandleElementEventMap = Handle["@eventTypes"];
  type HTMLCalciteHandleElement = Handle;

  type HTMLCalciteIconElement = Icon;

  type HTMLCalciteInlineEditableElementEventMap = InlineEditable["@eventTypes"];
  type HTMLCalciteInlineEditableElement = InlineEditable;

  type HTMLCalciteInputElementEventMap = Input["@eventTypes"];
  type HTMLCalciteInputElement = Input;

  type HTMLCalciteInputDatePickerElementEventMap = InputDatePicker["@eventTypes"];
  type HTMLCalciteInputDatePickerElement = InputDatePicker;

  type HTMLCalciteInputMessageElement = InputMessage;

  type HTMLCalciteInputNumberElementEventMap = InputNumber["@eventTypes"];
  type HTMLCalciteInputNumberElement = InputNumber;

  type HTMLCalciteInputTextElementEventMap = InputText["@eventTypes"];
  type HTMLCalciteInputTextElement = InputText;

  type HTMLCalciteInputTimePickerElementEventMap = InputTimePicker["@eventTypes"];
  type HTMLCalciteInputTimePickerElement = InputTimePicker;

  type HTMLCalciteInputTimeZoneElementEventMap = InputTimeZone["@eventTypes"];
  type HTMLCalciteInputTimeZoneElement = InputTimeZone;

  type HTMLCalciteLabelElement = Label;

  type HTMLCalciteLinkElement = Link;

  type HTMLCalciteListElementEventMap = List["@eventTypes"];
  type HTMLCalciteListElement = List;

  type HTMLCalciteListItemElementEventMap = ListItem["@eventTypes"];
  type HTMLCalciteListItemElement = ListItem;

  type HTMLCalciteListItemGroupElement = ListItemGroup;

  type HTMLCalciteLoaderElement = Loader;

  type HTMLCalciteMenuElement = Menu;

  type HTMLCalciteMenuItemElementEventMap = MenuItem["@eventTypes"];
  type HTMLCalciteMenuItemElement = MenuItem;

  type HTMLCalciteMeterElement = Meter;

  type HTMLCalciteNavigationElementEventMap = Navigation["@eventTypes"];
  type HTMLCalciteNavigationElement = Navigation;

  type HTMLCalciteNavigationLogoElement = NavigationLogo;

  type HTMLCalciteNavigationUserElement = NavigationUser;

  type HTMLCalciteNoticeElementEventMap = Notice["@eventTypes"];
  type HTMLCalciteNoticeElement = Notice;

  type HTMLCalciteOptionElement = Option;

  type HTMLCalciteOptionGroupElement = OptionGroup;

  type HTMLCalcitePaginationElementEventMap = Pagination["@eventTypes"];
  type HTMLCalcitePaginationElement = Pagination;

  type HTMLCalcitePanelElementEventMap = Panel["@eventTypes"];
  type HTMLCalcitePanelElement = Panel;

  type HTMLCalcitePopoverElementEventMap = Popover["@eventTypes"];
  type HTMLCalcitePopoverElement = Popover;

  type HTMLCalciteProgressElement = Progress;

  type HTMLCalciteRadioButtonElementEventMap = RadioButton["@eventTypes"];
  type HTMLCalciteRadioButtonElement = RadioButton;

  type HTMLCalciteRadioButtonGroupElementEventMap = RadioButtonGroup["@eventTypes"];
  type HTMLCalciteRadioButtonGroupElement = RadioButtonGroup;

  type HTMLCalciteRatingElementEventMap = Rating["@eventTypes"];
  type HTMLCalciteRatingElement = Rating;

  type HTMLCalciteScrimElement = Scrim;

  type HTMLCalciteSegmentedControlElementEventMap = SegmentedControl["@eventTypes"];
  type HTMLCalciteSegmentedControlElement = SegmentedControl;

  type HTMLCalciteSegmentedControlItemElement = SegmentedControlItem;

  type HTMLCalciteSelectElementEventMap = Select["@eventTypes"];
  type HTMLCalciteSelectElement = Select;

  type HTMLCalciteSheetElementEventMap = Sheet["@eventTypes"];
  type HTMLCalciteSheetElement = Sheet;

  type HTMLCalciteShellElement = Shell;

  type HTMLCalciteShellPanelElementEventMap = ShellPanel["@eventTypes"];
  type HTMLCalciteShellPanelElement = ShellPanel;

  type HTMLCalciteSliderElementEventMap = Slider["@eventTypes"];
  type HTMLCalciteSliderElement = Slider;

  type HTMLCalciteSortHandleElementEventMap = SortHandle["@eventTypes"];
  type HTMLCalciteSortHandleElement = SortHandle;

  type HTMLCalciteSortableListElementEventMap = SortableList["@eventTypes"];
  type HTMLCalciteSortableListElement = SortableList;

  type HTMLCalciteSplitButtonElementEventMap = SplitButton["@eventTypes"];
  type HTMLCalciteSplitButtonElement = SplitButton;

  type HTMLCalciteStackElement = Stack;

  type HTMLCalciteStepperElementEventMap = Stepper["@eventTypes"];
  type HTMLCalciteStepperElement = Stepper;

  type HTMLCalciteStepperItemElementEventMap = StepperItem["@eventTypes"];
  type HTMLCalciteStepperItemElement = StepperItem;

  type HTMLCalciteSwatchElementEventMap = Swatch["@eventTypes"];
  type HTMLCalciteSwatchElement = Swatch;

  type HTMLCalciteSwatchGroupElementEventMap = SwatchGroup["@eventTypes"];
  type HTMLCalciteSwatchGroupElement = SwatchGroup;

  type HTMLCalciteSwitchElementEventMap = Switch["@eventTypes"];
  type HTMLCalciteSwitchElement = Switch;

  type HTMLCalciteTabElement = Tab;

  type HTMLCalciteTabNavElementEventMap = TabNav["@eventTypes"];
  type HTMLCalciteTabNavElement = TabNav;

  type HTMLCalciteTabTitleElementEventMap = TabTitle["@eventTypes"];
  type HTMLCalciteTabTitleElement = TabTitle;

  type HTMLCalciteTableElementEventMap = Table["@eventTypes"];
  type HTMLCalciteTableElement = Table;

  type HTMLCalciteTableCellElement = TableCell;

  type HTMLCalciteTableHeaderElement = TableHeader;

  type HTMLCalciteTableRowElementEventMap = TableRow["@eventTypes"];
  type HTMLCalciteTableRowElement = TableRow;

  type HTMLCalciteTabsElement = Tabs;

  type HTMLCalciteTextAreaElementEventMap = TextArea["@eventTypes"];
  type HTMLCalciteTextAreaElement = TextArea;

  type HTMLCalciteTileElementEventMap = Tile["@eventTypes"];
  type HTMLCalciteTileElement = Tile;

  type HTMLCalciteTileGroupElementEventMap = TileGroup["@eventTypes"];
  type HTMLCalciteTileGroupElement = TileGroup;

  type HTMLCalciteTimePickerElementEventMap = TimePicker["@eventTypes"];
  type HTMLCalciteTimePickerElement = TimePicker;

  type HTMLCalciteTooltipElementEventMap = Tooltip["@eventTypes"];
  type HTMLCalciteTooltipElement = Tooltip;

  type HTMLCalciteTreeElementEventMap = Tree["@eventTypes"];
  type HTMLCalciteTreeElement = Tree;

  type HTMLCalciteTreeItemElementEventMap = TreeItem["@eventTypes"];
  type HTMLCalciteTreeItemElement = TreeItem;
