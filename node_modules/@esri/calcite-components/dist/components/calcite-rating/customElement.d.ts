 ...
 * @cssproperty [--calcite-rating-color-hover] - Specifies the component's item color when hovered.
 * @cssproperty [--calcite-rating-color-press] - Specifies the component's item color when active.
 * @cssproperty [--calcite-rating-color] - Specifies the component's item color.
 * @cssproperty [--calcite-rating-average-color] - When `average` is set, specifies the component's item color.
 * @cssproperty [--calcite-rating-average-text-color] - When `average` is set, specifies the component's `average` text color.
 * @cssproperty [--calcite-rating-count-text-color] - Specifies the component's text color for `count`.
...
export abstract class Rating extends LitElement {
  ...
  readonly calciteRatingChange: import("@arcgis/lumina").TargetedEvent<this, void>;
  readonly "@eventTypes": {
