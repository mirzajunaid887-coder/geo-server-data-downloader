...
/**
 * @cssproperty [--calcite-swatch-corner-radius] - Specifies the component's corner radius.
 * @slot [image] - A slot for adding an image or pattern.
 */
export abstract class Swatch extends LitElement {
  /**
  ...
  readonly calciteSwatchSelect: import("@arcgis/lumina").TargetedEvent<this, void>;
  readonly "@eventTypes": {
    calciteSwatchSelect: Swatch["calciteSwatchSelect"]["detail"];
  };
}