 ...
 * @cssproperty [--calcite-accordion-item-header-background-color] - Specifies the component's `heading` background color.
...
export abstract class AccordionItem extends LitElement {
  ...
  readonly calciteAccordionItemCollapse: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the component's content area is expanded. */
  readonly calciteAccordionItemExpand: import("@arcgis/lumina").TargetedEvent<this, void>;
  readonly "@eventTypes": {
    calciteAccordionItemCollapse: AccordionItem["calciteAccordionItemCollapse"]["detail"];
    calciteAccordionItemExpand: AccordionItem["calciteAccordionItemExpand"]["detail"];
  };
}