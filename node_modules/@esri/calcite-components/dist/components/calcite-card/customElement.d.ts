...
import type { LogicalFlowPosition, Scale } from "../interfaces.js";
 ...
 * @cssproperty [--calcite-card-selection-background-color] - [Deprecated] in v2.13.0, removal target v6.0.0 - Use `--calcite-card-background-color` instead. Specifies the component's selection element background color.
 ...
 * @cssproperty [--calcite-card-selection-icon-color-hover] - [Deprecated] in v2.13.0, removal target v6.0.0 - Use `--calcite-card-selection-color-hover` instead. Specifies the component's selection element icon color when hovered.
 * @cssproperty [--calcite-card-selection-icon-color-selected] - [Deprecated] in v2.13.0, removal target v6.0.0 - Use `--calcite-card-accent-color-selected` instead. Specifies the component's selection element icon color when `selected`.
