...
class Sheet extends LitElement {
  ...
  willUpdate(changes) {
    ...
    if (changes.has("open") && (this.hasUpdated || this.open !== false) || changes.has("position") && (this.hasUpdated || this.position !== "inline-start") || changes.has("resizable") && (this.hasUpdated || this.resizable !== false) || changes.has("direction")) {
      this.setupInteractions();
    }
  ...
  handleKeyDown(event) {
    ...
    const { contentRef, position, resizable, resizeValues: { maxBlockSize, maxInlineSize, minBlockSize, minInlineSize } } = this;
  ...
  async setupInteractions() {
    ...
    const { inlineSize, minInlineSize, blockSize, minBlockSize, maxInlineSize, maxBlockSize } = computedStyle;
    const values = {
