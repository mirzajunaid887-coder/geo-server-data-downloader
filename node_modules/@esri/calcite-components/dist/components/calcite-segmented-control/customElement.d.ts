 ...
 */
export abstract class SegmentedControl extends LitElement {
  /**
  ...
  get selectedItem(): SegmentedControlItem;
  /**
   ...
   * @default "auto"
   */
  accessor width: Extract<"auto" | "full", Width>;
  /**
  ...
  readonly calciteSegmentedControlChange: import("@arcgis/lumina").TargetedEvent<this, void>;
  readonly "@eventTypes": {
