 ...
 * @cssproperty [--calcite-notice-close-background-color-focus] - [Deprecated] in v5.0.0, removal target v6.0.0 - Use `--calcite-notice-close-background-color-hover` instead. Specifies the background color of the component's close element when hovered.
 ...
 * @cssproperty [--calcite-notice-width] - [Deprecated] in v3.0.0, removal target v6.0.0 - Specifies the component's width.
