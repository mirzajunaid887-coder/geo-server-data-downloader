 ...
 * @cssproperty [--calcite-stepper-bar-inactive-fill-color] - [Deprecated] in 5.1.0, removal target v6.0.0 - Use `--calcite-stepper-bar-fill-color` instead. Specifies the `calcite-stepper-item`s' bar fill color of the component's `calcite-stepper-item`s.
 * @cssproperty [--calcite-stepper-bar-active-fill-color] - [Deprecated] in 5.1.0, removal target v6.0.0 - Use `--calcite-stepper-bar-selected-fill-color` instead. Specifies the `calcite-stepper-item`s' bar fill color of the component's active `calcite-stepper-item`s.
