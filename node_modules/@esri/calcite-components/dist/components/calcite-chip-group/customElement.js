...
class ChipGroup extends LitElement {
  ...
  render() {
    ...
    const { disabled } = this;
    return this.interactiveContainer({ disabled, children: html`<div .ariaLabel=${this.label} class="container" .role=${role}><slot @slotchange=${this.updateItems} ${ref(this.slotRef)}></slot></div>` });
  }
}
