...
/**
 * @cssproperty [--calcite-combobox-divider-color] - Specifies the component's divider color.
 * @cssproperty [--calcite-combobox-icon-color] - Specifies the component's icon color.
 * @cssproperty [--calcite-combobox-icon-color-hover] - Specifies the component's icon color when hovered.
 * @cssproperty [--calcite-combobox-background-color] - Specifies the background color of the component's listbox.
 * @cssproperty [--calcite-combobox-input-border-color] - Specifies the border color of the component's input.
 * @cssproperty [--calcite-combobox-input-background-color] - Specifies the background color of the component's input.
 * @cssproperty [--calcite-combobox-input-height] - Specifies the height of the component's input.
 * @cssproperty [--calcite-combobox-input-text-color] - When `selectionDisplay` is `"single"`, specifies the text color of the component's input.
 * @slot  - A slot for adding `calcite-combobox-item`s.
 * @slot [label-content] - A slot for rendering content next to the component's `labelText`.
 */
export abstract class Combobox extends LitElement {
  /**
   * When `true`, allows entry of custom values, which are not in the original set of items.
   *
   * @default false
   */
  accessor allowCustomValues: boolean;
  /**
  ...
  get filteredItems(): HTMLCalciteComboboxItemElement[];
   ...
   * @default "multiple"
   */
  accessor selectionMode: Extract<"single" | "single-persist" | "ancestors" | "multiple", SelectionMode>;
  /**
  ...
  readonly calciteComboboxBeforeClose: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the component is added to the DOM but not rendered, and before the opening transition begins. */
  readonly calciteComboboxBeforeOpen: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the selected item(s) changes. */
  readonly calciteComboboxChange: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when a selected item in the component is closed via its `calcite-chip`. */
  readonly calciteComboboxChipClose: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the component is closed and animation is complete. */
  readonly calciteComboboxClose: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when text is added to filter the options list. */
  readonly calciteComboboxFilterChange: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the component is open and animation is complete. */
  readonly calciteComboboxOpen: import("@arcgis/lumina").TargetedEvent<this, void>;
  readonly "@eventTypes": {
