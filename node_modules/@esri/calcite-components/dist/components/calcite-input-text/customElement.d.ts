...
/**
 * @cssproperty [--calcite-input-action-background-color] - Specifies the background color of the component's `clearable` element.
 * @cssproperty [--calcite-input-action-background-color-hover] - Specifies the background color of the component's `clearable` element when hovered.
 * @cssproperty [--calcite-input-action-background-color-press] - Specifies the background color of the component's `clearable` element when pressed.
 * @cssproperty [--calcite-input-action-icon-color] - Specifies the icon color of the component's `clearable` element.
 * @cssproperty [--calcite-input-action-icon-color-hover] - Specifies the icon color of the component's `clearable` element when hovered.
 * @cssproperty [--calcite-input-action-icon-color-press] - Specifies the icon color of the component's `clearable` element when pressed.
 ...
 * @cssproperty [--calcite-input-prefix-size-x] - When `prefixText` is provided, specifies the width of the component's prefix element.
 ...
 * @cssproperty [--calcite-input-suffix-size-x] - When `suffixText` is provided, specifies the width of the component's suffix element.
 * @cssproperty [--calcite-input-suffix-text-color] - When `suffixText` is provided, specifies the color of the component's suffix element.
 * @cssproperty [--calcite-input-text-background-color] - Specifies the component's background color.
 * @cssproperty [--calcite-input-text-border-color] - Specifies the component's border color.
 * @cssproperty [--calcite-input-text-corner-radius] - Specifies the component's border radius.
 * @cssproperty [--calcite-input-text-icon-color] - Specifies the component's `icon` color.
 * @cssproperty [--calcite-input-text-placeholder-text-color] - Specifies the component's `placeholder` text color.
 * @cssproperty [--calcite-input-text-text-color] - Specifies the component's text color.
 * @cssproperty [--calcite-input-text-text-color-focus] - Specifies the component's text color when focused.
 ...
 */
export abstract class InputText extends LitElement {
  /**
  ...
  readonly calciteInputTextChange: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires each time a new `value` is typed. */
  readonly calciteInputTextInput: import("@arcgis/lumina").TargetedEvent<this, void>;
  readonly "@eventTypes": {
