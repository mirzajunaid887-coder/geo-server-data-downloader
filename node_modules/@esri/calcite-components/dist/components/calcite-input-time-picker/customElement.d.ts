 ...
 * @cssproperty [--calcite-input-time-picker-border-color] - Specifies the component's border color.
 * @cssproperty [--calcite-input-time-picker-icon-color] - Specifies the component's icon color.
 * @cssproperty [--calcite-input-time-picker-icon-color-hover] - Specifies the component's icon color when hovered.
 * @cssproperty [--calcite-input-time-picker-shadow] - Specifies the component's shadow.
 * @cssproperty [--calcite-input-time-picker-corner-radius] - Specifies the component's border radius.
 * @cssproperty [--calcite-input-time-picker-input-background-color] - Specifies the component's input background color.
 * @cssproperty [--calcite-input-time-picker-input-text-color] - Specifies the component's input text color.
 * @cssproperty [--calcite-input-time-picker-input-shadow] - Specifies the component's input shadow.
 * @cssproperty [--calcite-input-time-picker-input-corner-radius] - Specifies the component's input border radius.
 * @cssproperty [--calcite-input-time-picker-input-border-color] - Specifies the component's input border color.
 * @cssproperty [--calcite-input-time-picker-digit-text-color] - Specifies the component's digit text color.
 * @cssproperty [--calcite-input-time-picker-digit-icon-color] - Specifies the component's digit icon color.
 * @cssproperty [--calcite-input-time-picker-digit-border-color-press] - Specifies the component's digit border color when pressed.
 * @cssproperty [--calcite-input-time-picker-digit-border-color-hover] - Specifies the component's digit border color when hovered.
 * @cssproperty [--calcite-input-time-picker-action-background-color-hover] - Specifies the background color of the component's actions when hovered.
 * @cssproperty [--calcite-input-time-picker-action-background-color-press] - Specifies the background color of the component's actions when active.
 * @slot [label-content] - A slot for rendering content next to the component's `labelText`.
 */
export abstract class InputTimePicker extends LitElement {
  /**
  ...
  readonly calciteInputTimePickerBeforeClose: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the component is added to the DOM but not rendered, and before the opening transition begins. */
  readonly calciteInputTimePickerBeforeOpen: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the component's `value` is modified by the user. */
  readonly calciteInputTimePickerChange: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the component is closed and animation is complete. */
  readonly calciteInputTimePickerClose: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the component is opened and animation is complete. */
  readonly calciteInputTimePickerOpen: import("@arcgis/lumina").TargetedEvent<this, void>;
  readonly "@eventTypes": {
