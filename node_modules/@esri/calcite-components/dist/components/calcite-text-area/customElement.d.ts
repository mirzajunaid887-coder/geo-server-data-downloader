...
/**
 * @cssproperty [--calcite-text-area-background-color] - Specifies the component's background color.
 * @cssproperty [--calcite-text-area-border-color] - Specifies the component's text area border color.
 * @cssproperty [--calcite-text-area-character-limit-text-color] - Specifies the color of the character limit text displayed in the footer of the component.
 * @cssproperty [--calcite-text-area-divider-color] - Specifies the color of the divider between the text area and footer.
 * @cssproperty [--calcite-text-area-font-size] - Specifies the font size of the text area and footer.
 * @cssproperty [--calcite-text-area-max-height] - Specifies the component's text area maximum height.
 * @cssproperty [--calcite-text-area-min-height] - Specifies the component's text area minimum height.
 * @cssproperty [--calcite-text-area-max-width] - Specifies the component's text area maximum width.
 * @cssproperty [--calcite-text-area-min-width] - Specifies the component's text area minimum width.
 * @cssproperty [--calcite-text-area-text-color] - Specifies the component's text color.
 * @cssproperty [--calcite-text-area-footer-border-color] - Specifies the footer's border color.
 * @cssproperty [--calcite-text-area-corner-radius] - Specifies component's corner radius.
 * @cssproperty [--calcite-text-area-shadow] - Specifies the component's shadow.
 * @cssproperty [--calcite-text-area-footer-background-color] - Specifies the footer's background color.
 ...
 */
export abstract class TextArea extends LitElement {
  /**
   ...
   * @default "both"
   */
  accessor resize: "both" | "horizontal" | "vertical" | "none";
  /**
  ...
  readonly calciteTextAreaChange: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires each time a new `value` is typed. */
  readonly calciteTextAreaInput: import("@arcgis/lumina").TargetedEvent<this, void>;
  readonly "@eventTypes": {
