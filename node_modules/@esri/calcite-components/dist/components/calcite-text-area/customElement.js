...
class TextArea extends LitElement {
  ...
  willUpdate(changes) {
    ...
    if (changes.has("messages") || changes.has("numberingSystem") || changes.has("groupSeparator")) {
    ...
    if (changes.has("value") || changes.has("maxLength") || numberFormatOptionsChanged) {
      ...
      this.formSupport.setCustomValidity(this.isCharacterLimitExceeded() ? this.replacePlaceholdersInMessages() : "");
    }
  }
  updated() {
