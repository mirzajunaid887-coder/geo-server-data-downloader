...
import type { Scale, FlipContext } from "../interfaces.js";
import type { IconName } from "../calcite-icon/interfaces.js";

/**
 * @cssproperty [--calcite-list-background-color-hover] - Specifies the component's background color when hovered.
 * @cssproperty [--calcite-list-background-color-press] - Specifies the component's background color when pressed.
 * @cssproperty [--calcite-list-background-color] - Specifies the component's background color.
 * @cssproperty [--calcite-list-border-color] - Specifies the component's border color.
 * @cssproperty [--calcite-list-content-text-color] - Specifies the content color.
 * @cssproperty [--calcite-list-description-text-color] - Specifies the `description` color.
 * @cssproperty [--calcite-list-icon-color] - Specifies the component's icon color.
 * @cssproperty [--calcite-list-label-text-color] - Specifies the `label` color.
 * @cssproperty [--calcite-list-selection-border-color] - Specifies the component's selection border color.
 ...
 */
export abstract class ListItem extends LitElement {
  /**
  ...
  readonly calciteListItemClose: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the component's content area is collapsed. */
  readonly calciteListItemCollapse: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the component's content area is expanded. */
  readonly calciteListItemExpand: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the component is selected. */
  readonly calciteListItemSelect: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the sort handle is requested to be closed and before the closing transition begins. */
  readonly calciteListItemSortHandleBeforeClose: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the sort handle is added to the DOM but not rendered, and before the opening transition begins. */
  readonly calciteListItemSortHandleBeforeOpen: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the sort handle is closed and animation is complete. */
  readonly calciteListItemSortHandleClose: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the sort handle is open and animation is complete. */
  readonly calciteListItemSortHandleOpen: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the open button is clicked. */
  readonly calciteListItemToggle: import("@arcgis/lumina").TargetedEvent<this, void>;
  readonly "@eventTypes": {
    calciteListItemClose: ListItem["calciteListItemClose"]["detail"];
    calciteListItemCollapse: ListItem["calciteListItemCollapse"]["detail"];
    calciteListItemExpand: ListItem["calciteListItemExpand"]["detail"];
