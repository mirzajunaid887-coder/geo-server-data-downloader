 ...
 * @cssproperty [--calcite-tooltip-border-color] - Specifies the component's border color.
 * @cssproperty [--calcite-tooltip-corner-radius] - Specifies the component's corner radius.
 * @cssproperty [--calcite-tooltip-max-size-x] - Specifies the component's maximum width.
 * @cssproperty [--calcite-tooltip-text-color] - Specifies the component's text color.
 * @slot  - A slot for adding text.
 */
export abstract class Tooltip extends LitElement {
  /**
  ...
  readonly calciteTooltipBeforeClose: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the component is added to the DOM but not rendered, and before the opening transition begins. */
  readonly calciteTooltipBeforeOpen: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the component is closed and animation is complete. */
  readonly calciteTooltipClose: import("@arcgis/lumina").TargetedEvent<this, void>;
  /** Fires when the component is open and animation is complete. */
  readonly calciteTooltipOpen: import("@arcgis/lumina").TargetedEvent<this, void>;
  readonly "@eventTypes": {
