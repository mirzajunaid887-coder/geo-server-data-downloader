...
/**
 * @cssproperty [--calcite-radio-button-background-color] - Specifies the component's background color.
 * @cssproperty [--calcite-radio-button-border-color] - Specifies the component's border color.
 * @cssproperty [--calcite-radio-button-corner-radius] - Specifies the component's corner radius.
 * @cssproperty [--calcite-radio-button-size] - Specifies the component's size.
 */
export abstract class RadioButton extends LitElement {
  /**
   ...
   */
  readonly calciteRadioButtonChange: import("@arcgis/lumina").TargetedEvent<this, void>;
  readonly "@eventTypes": {
