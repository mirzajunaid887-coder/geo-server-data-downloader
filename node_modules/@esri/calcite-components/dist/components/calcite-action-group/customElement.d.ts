...
import type { Layout, Scale, SelectionMode } from "../interfaces.js";
import type { FlipPlacement, LogicalPlacement, OverlayPositioning } from "../../utils/floating-ui.js";
import type { Action } from "../calcite-action/customElement.js";
import type { Columns } from "./interfaces.js";

/**
 * @cssproperty [--calcite-action-background-color] - Specifies the component's background color.
 * @cssproperty [--calcite-action-group-border-color] - Specifies the component's border color when used in a `calcite-action-bar` or `calcite-action-menu`.
 * @cssproperty [--calcite-action-group-columns] - When `layout` is `"grid"`, specifies the component's `grid-template-columns`.
 * @cssproperty [--calcite-action-group-gap] - When `layout` is `"grid"`, specifies the component's gap.
...
export abstract class ActionGroup extends LitElement {
   ...
   * @default "none"
   */
  accessor selectionMode: Extract<"single" | "single-persist" | "multiple" | "none", SelectionMode>;
  /**
  ...
  readonly calciteActionGroupChange: import("@arcgis/lumina").TargetedEvent<this, void>;
