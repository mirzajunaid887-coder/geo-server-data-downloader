...
export class CurveChart extends XYChart {
    constructor() {
         ...
         */
        this.curveContainer = this.plotContainer.children.push(Container.new(this._root, { x: p50, y: p50 }));
    }
    _afterNew() {
...
CurveChart.classNames = XYChart.classNames.concat([CurveChart.className]);
