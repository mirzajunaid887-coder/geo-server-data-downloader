...
export class ArcDiagram extends Flow {
    constructor() {
         ...
         */
        this.links = this.addDisposer(new ListTemplate(Template.new({}), () => ArcDiagramLink._new(this._root, { themeTags: ["link", "shape"] }, [this.links.template])));
        /**
         * A series for all ArcDiagram nodes.
         *
         * @default ArcDiagramNodes.new()
         */
        this.nodes = this.children.push(ArcDiagramNodes.new(this._root, {}));
    }
    _afterNew() {
...
ArcDiagram.className = "ArcDiagram";
ArcDiagram.classNames = Flow.classNames.concat([ArcDiagram.className]);
