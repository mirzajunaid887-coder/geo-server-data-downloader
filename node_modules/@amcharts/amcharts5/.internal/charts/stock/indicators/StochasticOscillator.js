...
StochasticOscillator.className = "StochasticOscillator";
StochasticOscillator.classNames = OverboughtOversold.classNames.concat([StochasticOscillator.className]);
