...
export interface VisualVariableParameters extends AbortOptions {
  ...
  /**
   * The name of a data series configuration from which to derive information for authoring an
   * expression used to drive opacity. This allows client applications to link opacity
   * to a specific data series configuration.
   *
   * @since 5.1
   */
