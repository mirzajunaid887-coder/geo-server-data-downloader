 ...
 *
 * [![predominance-size](https://developers.arcgis.com/javascript/latest/assets/references/core/renderers/smartmapping/predominance-default.avif)](https://developers.arcgis.com/javascript/latest/sample-code/visualization-sm-predominance/)
 *
 * > [!WARNING]
 * >
 * > **Known Limitations**
...
export interface RendererParameters extends AbortOptions {
   ...
   *
   *   ![predominance-opacity](https://developers.arcgis.com/javascript/latest/assets/references/core/renderers/smartmapping/predominance-opacity.avif)
   */
   ...
   *
   *   ![predominance-size](https://developers.arcgis.com/javascript/latest/assets/references/core/renderers/smartmapping/predominance-size.avif)
   */
