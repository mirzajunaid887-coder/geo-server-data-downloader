...
export interface RegenerateRendererParameters extends AbortOptions {
   ...
   *  - `opacity-variable`: Only regenerate the opacity visual variable.
   *  - `rotation-variable`: Only regenerate the rotation visual variable.
   *  - `class-breaks`: Regenerate the class breaks for the renderer.
   *
   * @since 4.33
   */
  includedParts?: ("color-variable" | "size-variable" | "opacity-variable" | "rotation-variable" | "class-breaks")[];
}