...
/**
 * The return object of the [getSchemes()](https://developers.arcgis.com/javascript/latest/references/core/smartMapping/symbology/color/#getSchemes) method.
 *
 * @since 5.0
 */
...
/**
 * The return object of the [getSchemes()](https://developers.arcgis.com/javascript/latest/references/core/smartMapping/symbology/size/#getSchemes) method.
 *
 * @since 5.0
 */
...
/**
 * The return object of the [getSchemes()](https://developers.arcgis.com/javascript/latest/references/core/smartMapping/symbology/location/#getSchemes) method.
 *
 * @since 5.0
 */
...
/**
 * The return object of the [getSchemes()](https://developers.arcgis.com/javascript/latest/references/core/smartMapping/symbology/type/#getSchemes) method.
 *
 * @since 5.0
 */
...
/**
 * The return object of the [getSchemes()](https://developers.arcgis.com/javascript/latest/references/core/smartMapping/symbology/heatmap/#getSchemes) method.
 *
 * @since 5.0
 */
...
/**
 * The return object of the [getSchemes()](https://developers.arcgis.com/javascript/latest/references/core/smartMapping/symbology/predominance/#getSchemes) method.
 *
 * @since 5.0
 */
...
/**
 * The return object of the [getSchemes()](https://developers.arcgis.com/javascript/latest/references/core/smartMapping/symbology/relationship/#getSchemes) method.
 *
 * @since 5.0
 */
...
/**
 * The return object of the [getSchemes()](https://developers.arcgis.com/javascript/latest/references/core/smartMapping/symbology/dotDensity/#getSchemes) method.
 *
 * @since 5.0
 */
...
/**
 * The return object of the [getSchemes()](https://developers.arcgis.com/javascript/latest/references/core/smartMapping/symbology/pieChart/#getSchemes) method.
 *
 * @since 5.0
 */
...
export interface FlowScheme {
   ...
   * | Value | Description | Example |
   * | ----- | ----------- | ------- |
   * | flow-line | Renders the uv and magnitude data as animated flow lines. This is ideal for representing wind and other atmospheric data. | <video src="https://developers.arcgis.com/javascript/latest/assets/references/core/renderers/animated-flow/sm-flow-line-2.webm" aria-label="flow-line" autoplay muted playsinline loop></video> |
   * | wave-front | Renders UV and magnitude data in a wave-like animation. This theme works well for ocean data. | <video src="https://developers.arcgis.com/javascript/latest/assets/references/core/renderers/animated-flow/sm-wave-front-2.webm" aria-label="wave-front" autoplay muted playsinline loop></video> |
   *
   * > [!WARNING]
   * >
   * > **Known Limitations**
   ...
   *   [ColorVariable](https://developers.arcgis.com/javascript/latest/references/core/renderers/visualVariables/ColorVariable/) is set on the flow renderer.
   *
   * @since 5.0
   */
  colors: Color[];
  /**
   * The suggested [FlowRenderer.density](https://developers.arcgis.com/javascript/latest/references/core/renderers/FlowRenderer/#density) of the streamlines.
   *
   * @since 5.0
   */
  density: number;
  /**
   * The suggested [FlowRenderer.flowSpeed](https://developers.arcgis.com/javascript/latest/references/core/renderers/FlowRenderer/#flowSpeed) of the streamlines.
   *
   * @since 5.0
   */
  flowSpeed: number;
  /**
   * The suggested [length](https://developers.arcgis.com/javascript/latest/references/core/renderers/FlowRenderer/#trailLength) of the streamlines.
   *
   * @since 5.0
   */
  trailLength: number;
  /**
   * The suggested [width](https://developers.arcgis.com/javascript/latest/references/core/renderers/FlowRenderer/#trailWidth) of the streamlines.
   *
   * @since 5.0
   */
  trailWidth: number;
  /**
   * The suggested [cap style](https://developers.arcgis.com/javascript/latest/references/core/renderers/FlowRenderer/#trailCap) of the streamlines.
   *
   * > [!WARNING]
   * >
   * > **Known Limitations**
  ...
  trailCap: "butt" | "round";
  /**
   * The suggested [ImageryTileLayer.effect](https://developers.arcgis.com/javascript/latest/references/core/layers/ImageryTileLayer/#effect) to apply to the input layer.
   *
   * > [!WARNING]
   * >
   * > **Known Limitations**
   * >
   * > The layer effects are not supported in 3D [SceneView](https://developers.arcgis.com/javascript/latest/references/core/views/SceneView/).
   *
   * @since 5.0
   */
  layerEffect: string;
   ...
   *   [SizeVariable](https://developers.arcgis.com/javascript/latest/references/core/renderers/visualVariables/SizeVariable/) is set on the flow renderer.
   *
   * @since 5.0
   */
  minSize: number;
   ...
   *   [OpacityVariable](https://developers.arcgis.com/javascript/latest/references/core/renderers/visualVariables/OpacityVariable/) is set on the flow renderer.
   *
   * @since 5.0
   */
  minOpacity: number;
...
/**
 * The return object of the [getSchemes()](https://developers.arcgis.com/javascript/latest/references/core/smartMapping/symbology/flow/#getSchemes) method.
 *
 * @since 5.0
 */
...
/**
 * Defines a ramp of colors to use for visualizing data in a chart, [Renderer](https://developers.arcgis.com/javascript/latest/references/core/renderers/Renderer/), or [ColorVariable](https://developers.arcgis.com/javascript/latest/references/core/renderers/visualVariables/ColorVariable/).
 *
 * @since 5.0
 */
