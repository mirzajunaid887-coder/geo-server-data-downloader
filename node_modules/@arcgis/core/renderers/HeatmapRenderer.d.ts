...
export default class HeatmapRenderer extends Renderer {
   ...
   * ------------------------------|----------|--------------
   * +1 LOD | ![static-in1](https://developers.arcgis.com/javascript/latest/assets/references/core/renderers/heatmap/static-in1-small.avif) | ![dynamic-in1](https://developers.arcgis.com/javascript/latest/assets/references/core/renderers/heatmap/dynamic-in1-small.avif)
   * reference scale | ![static-out1](https://developers.arcgis.com/javascript/latest/assets/references/core/renderers/heatmap/static-reference-small.avif) | ![dynamic-out1](https://developers.arcgis.com/javascript/latest/assets/references/core/renderers/heatmap/static-reference-small.avif)
   * -1 LOD | ![static-out1](https://developers.arcgis.com/javascript/latest/assets/references/core/renderers/heatmap/static-out1-small.avif) | ![dynamic-out1](https://developers.arcgis.com/javascript/latest/assets/references/core/renderers/heatmap/dynamic-out1-small.avif)
   *
   * @default 0
   * @since 4.24
   * @see [Sample - Create a static heatmap](https://developers.arcgis.com/javascript/latest/sample-code/visualization-heatmap-static/)
