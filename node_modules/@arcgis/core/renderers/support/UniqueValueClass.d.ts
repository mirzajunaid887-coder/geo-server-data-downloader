...
export interface UniqueValueClassProperties extends Partial<Pick<UniqueValueClass, "label">> {
   ...
   * > To properly support scale-based symbology, the [symbol](https://developers.arcgis.com/javascript/latest/references/core/renderers/support/UniqueValueClass/#symbol) property should also be a [CIMSymbol](https://developers.arcgis.com/javascript/latest/references/core/symbols/CIMSymbol/) with a `minScale` or `maxScale` defined.
   *
   * @since 5.1
   */
