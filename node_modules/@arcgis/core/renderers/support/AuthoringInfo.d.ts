...
export interface AuthoringInfoProperties extends Partial<Pick<AuthoringInfo, "classificationMethod" | "dataSeriesName" | "fadeRatio" | "fields" | "flowTheme" | "focus" | "isAutoGenerated" | "lengthUnit" | "maxSliderValue" | "minSliderValue" | "numClasses" | "standardDeviationInterval" | "type" | "univariateSymbolStyle" | "univariateTheme">> {
...
export default class AuthoringInfo extends JSONSupport {
  ...
  /**
   * The name of the data series configuration
   * from which to derive information for authoring the renderer. This allows client applications to
   * link a renderer to a specific data series configuration. The data series info can then be
   * used to generate expressions for renderers, labels, popups, charts, or other representations
   * of the data for display in the web map based
   * on a sequence of related data points over time or other dimensions.
   *
   * Only applicable when at least one [TimeSeriesInfo](https://developers.arcgis.com/javascript/latest/references/core/layers/support/TimeSeriesInfo/) has been defined in [DataSeriesLayer.dataSeriesInfos](https://developers.arcgis.com/javascript/latest/references/core/layers/mixins/DataSeriesLayer/#dataSeriesInfos).
   *
   * @since 5.1
   */
