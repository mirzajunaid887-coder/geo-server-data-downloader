 ...
 * > and imported into to [ArcGIS Knowledge Studio](https://doc.esri.com/en/arcgis-knowledge/latest/knowledge-studio/add-link-charts-to-your-project.html), or you can set time in the link chart layer definition using ArcGIS Pro or the ArcGIS REST API.
 *
 * @since 4.32
 */
