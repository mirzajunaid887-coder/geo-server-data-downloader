...
export interface MeshTextureProperties extends Partial<Pick<MeshTexture, "transparent" | "url" | "wrap">> {
   ...
   * [image element](https://developer.mozilla.org/docs/Web/API/HTMLImageElement),
   * [canvas element](https://developer.mozilla.org/docs/Web/API/HTMLCanvasElement),
   * [video element](https://developer.mozilla.org/docs/Web/API/HTMLVideoElement)
   * or [ImageData](https://developer.mozilla.org/docs/Web/API/ImageData).
   * If the data is set to a [video element](https://developer.mozilla.org/docs/Web/API/HTMLVideoElement),
 ...
 * });
 *
 * const meshWithCanvasMaterial = createBox(location, {
 *   material: {
 ...
 * const meshWithAutocastMaterial = createSphere(location, {
 *   material: {
 *     colorTexture: {
 *       url: "./image.png"
 *     }
 ...
 * const meshWithCanvasAutocastMaterial = createSphere(location, {
 *   material: {
 ...
 *
 * const meshWithVideoMaterial = createPlane(location, {
 *   material: {
