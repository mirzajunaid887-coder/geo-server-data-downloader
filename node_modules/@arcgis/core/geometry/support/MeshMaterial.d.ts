 ...
 * [HTMLImageElements](https://developer.mozilla.org/docs/Web/API/HTMLImageElement),
 * [HTMLCanvasElements](https://developer.mozilla.org/docs/Web/API/HTMLCanvasElement),
 ...
 * });
 *
 * const boxMesh = createBox(location, {
 *   material: {
