...
export default class SpatialReference extends JSONSupport {
  ...
  /** Indicates if the [wkid](https://developers.arcgis.com/javascript/latest/references/core/geometry/SpatialReference/#wkid) of the spatial reference object is `4326`. */
  get isWGS84(): boolean;
  /**
