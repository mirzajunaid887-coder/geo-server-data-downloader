...
export interface Attachment {
   ...
   * [Data Preparation](https://doc.esri.com/en/arcgis-enterprise/latest/administer/prepare-data-for-offline-use.html#ESRI_SECTION1_CDC34577197B43A980E4B5021DB1C32A) documentation.
   *
   * @since 5.0
   */
  globalId: string;
  ...
  contentType?: string;
  /**
   * The id of pre-loaded attachment. Either 'uploadId' or 'data' must be provided.
   *
   * @since 5.0
   */
  uploadId?: string;
  /**
   * The attachment data to upload. Either 'uploadId' or 'data' must be provided.
   *
   * @since 5.0
   */
...
export interface AddAttachmentOptions extends AttachmentEditOptions {
  /**
   * A text value to be associated with the attachment. Requires that the layer
   * has the `supportsKeywords` capability.
   *
   * @since 5.1
   */
  keywords?: string;
...
export interface Edits {
   ...
   * [numeric](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date/getTime) values
