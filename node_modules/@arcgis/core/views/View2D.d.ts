...
export default abstract class View2D extends View2DSuperclass {
   ...
   * [MapView.animation](https://developers.arcgis.com/javascript/latest/references/core/views/View2D/#animation).
   ...
   * ```
   *
   * If a tiled map service is used as the basemap and `snapToZoom` property is set to `true` in [constraints](https://developers.arcgis.com/javascript/latest/references/core/views/View2D/#constraints),
   ...
   *   in [GoToTarget2D](https://developers.arcgis.com/javascript/latest/references/core/views/types/#GoToTarget2D).
   * @param options - Animation options for controlling the duration and easing of the animation.
   *   See the properties defined in [GoToOptions2D](https://developers.arcgis.com/javascript/latest/references/core/views/types/#GoToOptions2D) for object specifications.
   ...
   * @param options - Options for controlling the [toScreen()](https://developers.arcgis.com/javascript/latest/references/core/views/View2D/#toScreen) calculation.
   *   See the properties defined in [ToScreenOptions2D](https://developers.arcgis.com/javascript/latest/references/core/views/types/#ToScreenOptions2D) for object specifications.
   ...
   * if the analysis does not belong in [MapView.analyses](https://developers.arcgis.com/javascript/latest/references/core/views/MapView/#analyses).
   *
