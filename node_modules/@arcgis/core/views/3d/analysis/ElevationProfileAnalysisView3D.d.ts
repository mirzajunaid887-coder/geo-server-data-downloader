 ...
 *
 * The ElevationProfileAnalysisView3D is responsible for rendering an
 ...
 * The [results](https://developers.arcgis.com/javascript/latest/references/core/views/3d/analysis/ElevationProfileAnalysisView3D/#results) property contains the computed elevation profile results.
 *
 ...
 */
export default abstract class ElevationProfileAnalysisView3D extends AnalysisView3D {
  /** The elevation profile analysis associated with the analysis view. */
  get analysis(): ElevationProfileAnalysis;
  /**
   * Units used for all the [results](https://developers.arcgis.com/javascript/latest/references/core/views/3d/analysis/ElevationProfileAnalysisView3D/#results) and [statistics](https://developers.arcgis.com/javascript/latest/references/core/views/3d/analysis/ElevationProfileAnalysisView3D/#statistics) of the elevation profile analysis.
   *
  ...
  /**
   * Points in the view that are computed from the [indicatorRelativePosition](https://developers.arcgis.com/javascript/latest/references/core/views/3d/analysis/ElevationProfileAnalysisView3D/#indicatorRelativePosition)
   * property (in the view's spatial reference).
   * There is one point for each computed profile line.
   ...
   *
   * Whenever the [indicatorRelativePosition](https://developers.arcgis.com/javascript/latest/references/core/views/3d/analysis/ElevationProfileAnalysisView3D/#indicatorRelativePosition) property has a
   ...
   * them via [indicatorPoints](https://developers.arcgis.com/javascript/latest/references/core/views/3d/analysis/ElevationProfileAnalysisView3D/#indicatorPoints). The view shows points at these
  ...
  /**
   * Enables interactivity for the [analysis](https://developers.arcgis.com/javascript/latest/references/core/views/3d/analysis/ElevationProfileAnalysisView3D/#analysis). When set to `true` the input geometry can be edited
   * interactively.
   *
   * @default false
   */
   ...
   *
   * Each result references the computed profile line via [ElevationProfileResult.profile](https://developers.arcgis.com/javascript/latest/references/core/views/analysis/ElevationProfile/ElevationProfileResult/#profile).
   * The results array may contain more entries than the top-level [ElevationProfileAnalysis.profiles](https://developers.arcgis.com/javascript/latest/references/core/analysis/ElevationProfileAnalysis/#profiles)
   * collection.
   *
   * Watch [progress](https://developers.arcgis.com/javascript/latest/references/core/views/3d/analysis/ElevationProfileAnalysisView3D/#progress) to see the state of the calculation.
   */
  ...
  get type(): "elevation-profile-view-3d";
  /** Whether the analysis is currently being updated. */
  get updating(): boolean;
  /** When `true`, the [analysis](https://developers.arcgis.com/javascript/latest/references/core/views/3d/analysis/ElevationProfileAnalysisView3D/#analysis) is visualized in the view. */
   ...
   *
   * Calling this method sets [interactive](https://developers.arcgis.com/javascript/latest/references/core/views/3d/analysis/ElevationProfileAnalysisView3D/#interactive) to `true`.
   *
   * @param options - An object specifying additional options.
   * @returns A promise which resolves when the operation is completed successfully or rejected if it is canceled.
   * @since 4.34
