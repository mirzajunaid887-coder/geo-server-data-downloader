...
export interface EnvironmentProperties extends WebSceneEnvironmentProperties {
   ...
   *   Known Value | Example
   *   ------------|---------
   *   [SunLighting](https://developers.arcgis.com/javascript/latest/references/core/views/3d/environment/SunLighting/) | ![scene-sun-lighting](https://developers.arcgis.com/javascript/latest/assets/references/core/views/SunLighting.avif)
   *   [VirtualLighting](https://developers.arcgis.com/javascript/latest/references/core/views/3d/environment/VirtualLighting/) | ![scene-virtual-lighting](https://developers.arcgis.com/javascript/latest/assets/references/core/views/VirtualLighting.avif)
   *
   * @since 5.0
   */
