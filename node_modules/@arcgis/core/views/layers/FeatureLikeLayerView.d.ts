...
export default abstract class FeatureLikeLayerView extends LayerView {
  ...
  /**
   * Indicates whether the layer view contains geometries at full resolution.
   * After the layer finishes loading and [fetching](https://developers.arcgis.com/javascript/latest/references/core/views/layers/FeatureLayerView/#dataUpdating) its data,
  ...
  /**
   * Indicates whether the layer view has m aware geometries. The presence of m-values in the geometries of a layer view is determined by the
   * layer's [returnM](https://developers.arcgis.com/javascript/latest/references/core/layers/mixins/FeatureLayerBase/#returnM) property.
   *
   * - When `true`: The layer view has m aware features. M-values are part of the geometry.
   * - When `false`: The layer view does not have m aware features. M-values are not part of the geometry.
   *
   * @default false
   * @see [FeatureLayerBase.returnM](https://developers.arcgis.com/javascript/latest/references/core/layers/mixins/FeatureLayerBase/#returnM) for details regarding fetching m-values with features from a layer
  ...
  get hasM(): boolean;
  /**
   * Indicates whether the layer view has z aware geometries. The presence of z-values in the geometries of a layer view is determined by the
   * layer's [returnZ](https://developers.arcgis.com/javascript/latest/references/core/layers/mixins/FeatureLayerBase/#returnZ) property.
   *
   * - When `true`: The layer view has z aware features. Z-values are part of the geometry.
   * - When `false`: The layer view does not have z aware features. Z-values are not part of the geometry.
   *
   * @default false
   * @since 5.1
   * @see [FeatureLayerBase.returnZ](https://developers.arcgis.com/javascript/latest/references/core/layers/mixins/FeatureLayerBase/#returnZ) for details regarding fetching z-values with features from a layer
   */
  get hasZ(): boolean;
  /**
   ...
   * @param options - An additional set of options to customize the highlight behavior.
  ...
  /**
   * Executes a [AttributeBinsQuery](https://developers.arcgis.com/javascript/latest/references/core/rest/support/AttributeBinsQuery/) against a [FeatureLikeLayerView](https://developers.arcgis.com/javascript/latest/references/core/views/layers/FeatureLikeLayerView/), which groups features into bins based on ranges in numeric or date fields, and returns a
