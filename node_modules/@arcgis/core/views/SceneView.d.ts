 ...
 * > [non-secure context](https://developer.mozilla.org/docs/Web/Security/Secure_Contexts) (e.g. http rather than https).
...
export default class SceneView extends SceneViewSuperclass {
   ...
   * The [GaussianSplatLayer](https://developers.arcgis.com/javascript/latest/references/core/layers/GaussianSplatLayer/) hit test [result](https://developers.arcgis.com/javascript/latest/references/core/views/types/#SceneViewLayerHit) returns the intersected layer,
   * hit location, and hit distance.
   ...
   * Please see [Key Values](https://developer.mozilla.org/docs/Web/API/KeyboardEvent/key/Key_Values)
