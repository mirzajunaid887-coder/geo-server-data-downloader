 ...
 *
 * ![tessellation-helpers-uv](https://developers.arcgis.com/javascript/latest/assets/references/core/layers/tessellation-helpers-rect.avif)
 */
 ...
 *
 * Rendering output is saved into a [framebuffer](https://developer.mozilla.org/docs/Web/API/WebGLFramebuffer),
 * possibly but not necessarily the default one, at a location
 * defined by the [viewport](https://developer.mozilla.org/docs/Web/API/WebGLRenderingContext/viewport).
 *
 ...
 * related class [BaseLayerView2D](https://developers.arcgis.com/javascript/latest/references/core/views/2d/layers/BaseLayerView2D/), this one exposes [WebGL](https://developer.mozilla.org/docs/Web/API/WebGLRenderingContext)
...
export default abstract class BaseLayerViewGL2D extends LayerView {
   ...
   * @param hitTarget - The point in screen coordinates.
   * @returns A Promise that resolves to an array of graphics.
   */
  hitTest(mapPoint: Point, hitTarget: ScreenPoint | ScreenRect): Promise<ViewHit[] | null | undefined>;
  /**
