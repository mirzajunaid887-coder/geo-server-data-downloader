...
export default class Navigation extends Accessor {
   ...
   * > is `true` and the user has requested reduced motion. See [prefers-reduced-motion](https://developer.mozilla.org/docs/Web/CSS/Reference/At-rules/@media/prefers-reduced-motion) for more information.
   *
   * @default true
   * @since 4.14
   * @example
