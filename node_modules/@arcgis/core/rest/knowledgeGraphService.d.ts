 ...
 * @see [Get started with ArcGIS Knowledge Server](https://doc.esri.com/en/arcgis-knowledge/latest/introduction/get-started-with-arcgis-knowledge.html) for overview of ArcGIS Knowledge for ArcGIS Enterprise
 ...
 * > **Note**
 * >
 * > The user must have [sufficient privileges](https://doc.esri.com/en/arcgis-enterprise/latest/administer/roles.html#TABLE_1ECAC6C4F7F549AF98045224603F0AD2)
 ...
 * > See [Enterprise User types, roles, and privileges](https://doc.esri.com/en/arcgis-enterprise/latest/administer/roles.html).
 *
