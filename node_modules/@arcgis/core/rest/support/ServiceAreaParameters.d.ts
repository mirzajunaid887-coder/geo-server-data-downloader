...
export interface ServiceAreaParametersProperties extends Partial<Pick<ServiceAreaParameters, "accumulateAttributes" | "apiKey" | "attributeParameterValues" | "defaultBreaks" | "excludeSourcesFromPolygons" | "facilities" | "geometryPrecision" | "geometryPrecisionM" | "geometryPrecisionZ" | "ignoreInvalidLocations" | "impedanceAttribute" | "mergeSimilarPolygonRanges" | "outputGeometryPrecision" | "outputGeometryPrecisionUnits" | "outputLines" | "outputPolygons" | "overlapLines" | "overlapPolygons" | "overrides" | "pointBarriers" | "polygonBarriers" | "polylineBarriers" | "preserveObjectID" | "restrictionAttributes" | "restrictUTurns" | "returnFacilities" | "returnPointBarriers" | "returnPolygonBarriers" | "returnPolylineBarriers" | "splitLinesAtBreaks" | "splitPolygonsAtBreaks" | "timeOfDay" | "timeOfDayIsUTC" | "travelDirection" | "trimOuterPolygon" | "trimPolygonDistance" | "trimPolygonDistanceUnits" | "useHierarchy">> {
   ...
   * routing reqest.
   *
   * @see [Introduction to travel modes](https://doc.esri.com/en/arcgis-enterprise/latest/administer/travel-modes.html)
   * @see [Default travel modes](https://doc.esri.com/en/arcgis-enterprise/latest/administer/travel-modes.html#107)
   * @see [travelMode](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#travelmode)
   */
  travelMode?: TravelModeProperties | null;
}

/**
 * ServiceAreaParameters provides the input parameters for a [serviceArea](https://developers.arcgis.com/javascript/latest/references/core/rest/serviceArea/) request.
 *
 * @since 4.20
 ...
 * @see [Service area service with synchronous execution](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync.htm)
 */
export default class ServiceAreaParameters extends ServiceAreaParametersSuperclass {
  constructor(properties?: ServiceAreaParametersProperties);
  /**
   * Use this property to specify whether the operation should accumulate values other than the value specified for
   * [impedanceAttribute](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#impedanceAttribute). For example, if your impedanceAttribute is set to `travel-time`, the total
   ...
   * walk-time |
   *
   * @see [Network attributes](https://doc.esri.com/en/arcgis-pro/latest/help/analysis/networks/what-are-network-attributes-.html).
   * @see [accumulateAttributeNames](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#accumulateattributenames)
   */
   ...
   * @see [token](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#token)
   * @example
   ...
   *
   * @see [attributeParameterValues](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#attributeparametervalues)
   */
  accessor attributeParameterValues: AttributeParameterValue[] | null | undefined;
  /**
   * Use this parameter to specify the size and number of service areas to generate for each facility. The service
   * generates travel time- or travel distance-based service areas depending on the units for this parameter. If units
   * are time based, the service areas are generated based on travel time along underlying streets. If units are
   * distance based, the service areas are generated based on travel distances.
   *
   ...
   *
   * @see [defaultBreaks](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#defaultbreaks)
   */
  accessor defaultBreaks: number[] | null | undefined;
  /**
   * An array of network source names to not use when generating polygons.
   *
   * This property specifies if certain network sources should be excluded from the service area polygon generation. A
   * service area on a multi-modal network where only one mode is being used to compute the service area would get a
   * more appropriate shape if other modes are excluded from the polygons.
   */
  accessor excludeSourcesFromPolygons: string[] | null | undefined;
  /**
   * The input locations around which service areas are generated.
   *
   * @see [facilities](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#facilities)
   */
   ...
   *
   * @since 4.25
   * @see [geometryPrecision](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#geometryprecision)
   */
   ...
   *
   * @since 4.25
   * @see [geometryPrecisionM](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#geometryprecisionm)
   */
   ...
   *
   * @since 4.25
   * @see [geometryPrecisionZ](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#geometryprecisionz)
   */
   ...
   *
   * @since 4.25
   * @see [ignoreInvalidLocations](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#ignoreinvalidlocations)
   */
   ...
   * [travelMode](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#travelMode) is set.
   *
   * Known Value |
   * ------------|
   * kilometers |
   ...
   *
   * @see [Network attributes](https://doc.esri.com/en/arcgis-pro/latest/help/analysis/networks/what-are-network-attributes-.html)
   * @see [impedanceAttributeName](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#impedanceattributename)
   */
   ...
   * should be joined together or split at break values.
   *
   ...
   *
   * @default false
   * @see [mergeSimilarPolygonRanges](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#mergesimilarpolygonranges)
   */
  accessor mergeSimilarPolygonRanges: boolean;
  /**
   ...
   * or explicitly set a value, is overridden when you pass in [travelMode](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#travelMode).
   *
   * The units are specified with the [outputGeometryPrecisionUnits](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#outputGeometryPrecisionUnits) parameter.
   *
   * @see [outputGeometryPrecision](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#outputgeometryprecision)
   */
   ...
   * [outputGeometryPrecision](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#outputGeometryPrecision) parameter. The value of this parameter, regardless of whether
   * you rely on the default or explicitly set a value, is overridden when you pass in [travelMode](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#travelMode).
   *
   * @see [outputGeometryPrecisionUnits](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#outputgeometryprecisionunits)
   */
   ...
   * applicable only when route features are included in the result.
   *
   ...
   *
   * @see [outputLines](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#outputlines)
   */
   ...
   *
   * @see [outputPolygons](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#outputpolygons)
   */
  outputPolygons?: OutputPolygon | null;
  /**
   * Use this property to specify the spatial reference of the geometries, such as line or point features, returned by
   * a solve operation.
   *
   ...
   *
   * If `true`, services area lines can overlap one another.
   * If `false`, service area lines from one facility cannot overlap those from another facility.
   *
   * @default false
   * @see [overlapLines](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#overlaplines)
   */
  accessor overlapLines: boolean | null | undefined;
  /**
   * Specifies whether the service areas from different facilities can overlap each other.
   *
   * If `true`, services areas can overlap one another.
   * If `false`, service areas from one facility cannot overlap those from another facility.
   *
   * @default false
   * @see [overlapPolygons](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#overlappolygons)
   */
  accessor overlapPolygons: boolean | null | undefined;
  /**
   * Specify additional settings that can influence the behavior of the solver when finding solutions for the network
   * analysis problems.
   *
   * @since 4.25
   * @see [overrides](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#overrides)
   */
   ...
   *
   * @see [barriers](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#barriers)
   */
   ...
   *
   * @see [polygonBarriers](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#polygonbarriers)
   */
   ...
   * barrier.
   *
   * @see [polylineBarriers](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#polylinebarriers)
   */
   ...
   *
   * @since 4.25
   * @see [preserveObjectID](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#preserveobjectid)
   */
   ...
   * driving preference or requirement. This value is ignored if [travelMode](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#travelMode) is specified.
   *
   * Known Value |
   * ------------|
   ...
   * weight-restriction |
   *
   * @see [restrictionAttributeNames](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#restrictionattributenames)
   */
   ...
   *
   * @see [restrictUTurns](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#restrictuturns)
   */
   ...
   *
   * @default false
   * @see [returnFacilities](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#returnfacilities)
   */
  accessor returnFacilities: boolean | null | undefined;
  /**
   * Specify whether [point barriers](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#pointBarriers) will be returned by the routing operation.
   *
   * @default false
   * @see [returnBarriers](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#returnbarriers)
   */
  accessor returnPointBarriers: boolean | null | undefined;
  /**
   * Specify whether [polygon barriers](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#polygonBarriers) will be returned by the routing operation.
   *
   * @default false
   * @see [returnPolygonBarriers](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#returnpolygonbarriers)
   */
  accessor returnPolygonBarriers: boolean | null | undefined;
  /**
   * Specify whether [polyline barriers](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#polylineBarriers) will be returned by the routing operation.
   *
   * @default false
   * @see [returnPolylineBarriers](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#returnpolylinebarriers)
   */
   ...
   *
   * If `true`, a service area line that intersects a break is split into two lines. This is useful if you want to
   * visualize service area lines by break value.
   *
   * @default false
   * @see [splitLinesAtBreaks](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#splitlinesatbreaks)
   */
  accessor splitLinesAtBreaks: boolean | null | undefined;
  /**
   * Specifies whether multiple service areas around a facility are created as disks or rings.
   *
   * If `true`, larger service areas do not include smaller service areas.
   * If `false`, service areas are independant and may overlap each other.
   *
   * @default false
   * @see [splitPolygonsAtBreaks](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#splitpolygonsatbreaks)
   */
  accessor splitPolygonsAtBreaks: boolean | null | undefined;
  /**
   ...
   *
   * @see [timeOfDay](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#timeofday)
   */
  accessor timeOfDay: NetworkDate | null | undefined;
  /**
   * Specify the time zone or zones of the [timeOfDay](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#timeOfDay) property.
   *
   * @since 4.25
   * @see [timeOfDayIsUTC](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#timeofdayisutc)
   */
  accessor timeOfDayIsUTC: boolean | null | undefined;
  /**
   * Specifies whether the direction of travel used to generate the service area polygons is toward or away from the
   * facilities. The direction of travel may change the shape of the polygons because impedances on opposite sides of
   * streets may differ or one-way restrictions may exist, such as one-way streets.
   *
   * Possible Value | Description
   * ---------------|------------
   ...
   *
   * @see [travelDirection](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#traveldirection)
   */
   ...
   *
   * The parameter value is ignored when the [useHierarchy](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#useHierarchy) parameter is set to `true`.
   *
   * @default false
   * @see [trimOuterPolygon](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#trimouterpolygons)
   */
  accessor trimOuterPolygon: boolean | null | undefined;
  /**
   * The property defines the distance that can be reached from the network.
   *
   * This property is ignored if [trimOuterPolygon](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#trimOuterPolygon) is `false` or [useHierarchy](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#useHierarchy) is
   * `true`.
   *
   * @see [trimPolygonDistance](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#trimpolygondistance)
   */
  accessor trimPolygonDistance: number | null | undefined;
  /**
   * Specifies the units of the value specified [trimPolygonDistance](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#trimPolygonDistance).
   *
   * This property is ignored if [trimOuterPolygon](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#trimOuterPolygon) is `false` or [useHierarchy](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#useHierarchy) is
   * `true`.
   *
   * @see [trimPolygonDistanceUnits](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#trimpolygondistanceunits)
   */
  trimPolygonDistanceUnits?: LengthUnit | null;
  /**
   * Specify whether hierarchy should be used when finding the shortest paths. This value is ignored if a
   * [travelMode](https://developers.arcgis.com/javascript/latest/references/core/rest/support/ServiceAreaParameters/#travelMode) is specified.
   *
   * @see [useHierarchy](https://developers.arcgis.com/rest/services-reference/enterprise/service-area-sync/#usehierarchy)
   */
  accessor useHierarchy: boolean | null | undefined;
}
declare const ServiceAreaParametersSuperclass: typeof JSONSupport & typeof ClonableMixin