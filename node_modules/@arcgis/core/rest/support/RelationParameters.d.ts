...
export interface RelationParametersProperties extends Partial<Pick<RelationParameters, "geometries1" | "geometries2" | "relation" | "relationParameter">> {}

/**
 * Sets the relation and other parameters for the [relation()](https://developers.arcgis.com/javascript/latest/references/core/rest/geometryService/#relation) operation.
 *
 * @since 4.0
 * @see [relation()](https://developers.arcgis.com/javascript/latest/references/core/rest/geometryService/#relation)
 * @see [ArcGIS REST API - Relation](https://developers.arcgis.com/rest/services-reference/relation.htm)
 */
export default class RelationParameters extends JSONSupport {
  constructor(properties?: RelationParametersProperties);
  /**
   ...
   */
  accessor geometries1: GeometryUnion[] | null | undefined;
  /**
   ...
   * of the json geometry objects returned by the ArcGIS REST API.
   */
  accessor geometries2: GeometryUnion[] | null | undefined;
  /**
   ...
   * If the relation is specified as `relation`, the `relationParameter` parameter describes the spatial
   ...
   */
  accessor relation: "cross" | "disjoint" | "in" | "interior-intersection" | "intersection" | "line-coincidence" | "line-touch" | "overlap" | "point-touch" | "relation" | "touch" | "within" | null | undefined;
  /**
   ...
   * Also see the description of [relateOperator](https://developers.arcgis.com/javascript/latest/references/core/geometry/operators/relateOperator/) for
