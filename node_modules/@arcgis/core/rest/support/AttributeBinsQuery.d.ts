...
import type AutoIntervalBinParameters from "./AutoIntervalBinParameters.js";
import type DateBinParameters from "./DateBinParameters.js";
import type FixedBoundariesBinParameters from "./FixedBoundariesBinParameters.js";
import type FixedIntervalBinParameters from "./FixedIntervalBinParameters.js";
...
import type { GeometryWithoutMeshUnion } from "../../geometry/types.js";
import type { DatumTransformation } from "../../portal/jsonTypes.js";
import type { IANATimeZone } from "../../time/types.js";
import type { FixedIntervalBinParametersProperties } from "./FixedIntervalBinParameters.js";
import type { FixedBoundariesBinParametersProperties } from "./FixedBoundariesBinParameters.js";
import type { DateBinParametersProperties } from "./DateBinParameters.js";
...
export interface AttributeBinsQueryProperties extends Partial<Pick<AttributeBinsQuery, "binOrder" | "cacheHint" | "datumTransformation" | "distance" | "lowerBoundaryAlias" | "outTimeZone" | "returnDistinctValues" | "spatialRelationship" | "units" | "upperBoundaryAlias" | "where">> {
  /**
   ...
   */
  binParameters?: ((AutoIntervalBinParametersProperties & { type: "auto-interval" }) | (DateBinParametersProperties & { type: "date" }) | (FixedBoundariesBinParametersProperties & { type: "fixed-boundaries" }) | (FixedIntervalBinParametersProperties & { type: "fixed-interval" }));
  /**
  ...
  /**
   * The definitions for one or more field-based statistics to be calculated. For service-based queries, check the layer's
   * [query.queryAttributeBins.supportedStatistics](https://developers.arcgis.com/javascript/latest/references/core/layers/types/#FeatureLayerCapabilities) capabilities to ensure that
   * the layer supports statistics queries.
   *
   * @example
 ...
 * or calculated dynamically. Additionally, bins can be based on either date or numeric values.
 *
 * @see [binParameters](https://developers.arcgis.com/javascript/latest/references/core/rest/support/AttributeBinsQuery/#binParameters)
 */
...
/**
 * This class configures parameters for the [queryAttributeBins](https://developers.arcgis.com/javascript/latest/references/core/layers/FeatureLayer/#queryAttributeBins) method, which groups features in a layer or layer view into bins
 ...
 *
 * The [binParameters](https://developers.arcgis.com/javascript/latest/references/core/rest/support/AttributeBinsQuery/#binParameters) property defines bin characteristics like size and start value, while the [outStatistics](https://developers.arcgis.com/javascript/latest/references/core/rest/support/AttributeBinsQuery/#outStatistics) parameter specifies the information each bin provides.
 * Features can be filtered using a [where](https://developers.arcgis.com/javascript/latest/references/core/rest/support/AttributeBinsQuery/#where) condition and a [spatial filter](https://developers.arcgis.com/javascript/latest/references/core/rest/support/AttributeBinsQuery/#geometry). Bins are arranged consecutively with no gaps:
 * they are left-inclusive and right-exclusive, except for the last bin, which is right-inclusive. The method supports multiple statistical aggregations per bin and defaults to
 * a histogram of value frequencies/counts if no specific aggregations are provided in `outStatistics`.
 *
 * Bins are defined using one of the bin parameters, each supporting distinct parameters for handling boundaries between bins. Understanding the purpose of each bin parameter is
 ...
 * | ------------------- | ----------- |
 * | [AutoIntervalBinParameters](https://developers.arcgis.com/javascript/latest/references/core/rest/support/AutoIntervalBinParameters/) | You specify the number of [numBins](https://developers.arcgis.com/javascript/latest/references/core/rest/support/AutoIntervalBinParameters/#numBins), [start](https://developers.arcgis.com/javascript/latest/references/core/rest/support/AutoIntervalBinParameters/#start) and [end](https://developers.arcgis.com/javascript/latest/references/core/rest/support/AutoIntervalBinParameters/#end) values of the binning. The bin size is calculated by dividing the dataset's range by this number of bins.|
 * | [FixedBoundariesBinParameters](https://developers.arcgis.com/javascript/latest/references/core/rest/support/FixedBoundariesBinParameters/) | The bins strictly follow the specified [input values](https://developers.arcgis.com/javascript/latest/references/core/rest/support/FixedBoundariesBinParameters/#boundaries). The first item in the array specifies the lower boundary of the first bin, while the last item specifies the upper boundary of the last bin. Intermediate values represent the lower boundaries of each bin. |
 * | [FixedIntervalBinParameters](https://developers.arcgis.com/javascript/latest/references/core/rest/support/FixedIntervalBinParameters/) | The number of bins is not important, but the [interval](https://developers.arcgis.com/javascript/latest/references/core/rest/support/FixedIntervalBinParameters/#interval) size must match the input data. Each bin will cover a range that exactly fits the specified interval. |
 * | [DateBinParameters](https://developers.arcgis.com/javascript/latest/references/core/rest/support/DateBinParameters/) | The [intervals](https://developers.arcgis.com/javascript/latest/references/core/rest/support/DateBinParameters/#interval) are based on calendar units. For example, with monthly intervals, each bin represents an entire month. |
 *
 * @since 4.32
 * @see [FeatureLayer.queryAttributeBins()](https://developers.arcgis.com/javascript/latest/references/core/layers/FeatureLayer/#queryAttributeBins)
 * @see [Sample - Attribute Bins Query](https://developers.arcgis.com/javascript/latest/sample-code/query-attribute-bins/)
 */
export default class AttributeBinsQuery extends AttributeBinsQuerySuperclass {
   ...
   * @default "ascending"
   */
  binOrder?: "ascending" | "descending" | null;
  /**
   * Bin parameters describe the characteristics of the bins, including their size and starting value. Each bin's size can either be specified by a parameter
   * or calculated dynamically. Additionally, bins can be based on either date or numeric values.
   */
  get binParameters(): BinParameters;
  set binParameters(value: ((AutoIntervalBinParametersProperties & { type: "auto-interval" }) | (DateBinParametersProperties & { type: "date" }) | (FixedBoundariesBinParametersProperties & { type: "fixed-boundaries" }) | (FixedIntervalBinParametersProperties & { type: "fixed-interval" })));
  /**
   ...
   * [outSpatialReference](https://developers.arcgis.com/javascript/latest/references/core/rest/support/AttributeBinsQuery/#outSpatialReference) is different than the layer's spatial reference.
   * Requires ArcGIS Server service 10.5 or greater.
   */
  accessor datumTransformation: DatumTransformation | null | undefined;
  /**
   ...
   *
   *   If querying a feature service, the [supportsQueryWithDistance](https://developers.arcgis.com/rest/services-reference/enterprise/query-feature-service-layer/)
   ...
   * > [Mesh](https://developers.arcgis.com/javascript/latest/references/core/geometry/Mesh/) geometry types are currently not supported.
   */
  get geometry(): GeometryWithoutMeshUnion | null | undefined;
  ...
  accessor lowerBoundaryAlias: string | null | undefined;
  /**
   * The spatial reference for the returned geometry. If not specified, the geometry is returned in the spatial
   * reference of the queried layer.
   */
   ...
   * If not specified, the UTC time zone is used for binning calculations.
   * When a time zone is specified, dates and times will be adjusted according to that IANA time zone.
   *
   ...
   *
   * ![intersects](https://developers.arcgis.com/javascript/latest/assets/img/apiref/layers/spatialRelationships/intersects.avif)
   *
   ...
   *
   * ![contains](https://developers.arcgis.com/javascript/latest/assets/img/apiref/layers/spatialRelationships/contains.avif)
   *
   ...
   *
   * ![crosses](https://developers.arcgis.com/javascript/latest/assets/img/apiref/layers/spatialRelationships/crosses.avif)
   *
   ...
   *
   * ![envelope-intersects](https://developers.arcgis.com/javascript/latest/assets/img/apiref/layers/spatialRelationships/envelope-intersects.avif)
   *
   ...
   *
   * ![overlaps](https://developers.arcgis.com/javascript/latest/assets/img/apiref/layers/spatialRelationships/overlap.avif)
   *
   ...
   *
   * ![touches](https://developers.arcgis.com/javascript/latest/assets/img/apiref/layers/spatialRelationships/touches.avif)
   *
   ...
   * `contains`.
   *
   * ![within](https://developers.arcgis.com/javascript/latest/assets/img/apiref/layers/spatialRelationships/within.avif)
   *
   ...
   *
   * ![disjoint](https://developers.arcgis.com/javascript/latest/assets/img/apiref/layers/spatialRelationships/disjoint.avif)
   *
   * > [!WARNING]
   * >
   * > **Known Limitations**
...
declare const AttributeBinsQuerySuperclass: typeof JSONSupport & typeof ClonableMixin