...
import type OutDistance from "./OutDistance.js";
...
import type { OutDistanceProperties } from "./OutDistance.js";
...
export default class Query extends JSONSupport {
   ...
   * [MapImageLayer](https://developers.arcgis.com/javascript/latest/references/core/layers/MapImageLayer/) pointing to a [map service](https://doc.esri.com/en/arcgis-enterprise/latest/administer/what-is-a-map-service.html).
   *
   ...
   * The [Relational functions for ST_Geometry](https://doc.esri.com/en/arcgis-pro/latest/help/data/databases/pdf/stgeometry_reference_pro.pdf) topic has additional details
