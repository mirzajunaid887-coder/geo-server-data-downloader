...
export interface QueryAssociationsParametersProperties extends Partial<Pick<QueryAssociationsParameters, "gdbVersion" | "returnDeletes" | "types">> {
   ...
   *
   * @see [Learn more about branch versioning](https://doc.esri.com/en/arcgis-pro/latest/help/data/geodatabases/overview/data-management-strategies.html#ESRI_SECTION1_6FA2CFB5F9484FF096740D653C674B5D).
   */
