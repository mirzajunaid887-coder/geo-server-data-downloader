...
export default class Symbol3DVerticalOffset extends JSONSupport {
   ...
   *
   * <video src="https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols3D-line-callout-maxWorldLength.webm" aria-label="maxWorldLength" autoplay muted playsinline loop></video>
   */
   ...
   *
   * <video src="https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols3D-line-callout-minWorldLength.webm" aria-label="minWorldLength-on" autoplay muted playsinline loop></video>
   *
   * @default 0
   */
