 ...
 *
 * [![sms-sample](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-sms-sample.avif)](https://developers.arcgis.com/javascript/latest/sample-code/visualization-vv-size/)
 *
 * @since 4.0
...
export default class SimpleMarkerSymbol extends MarkerSymbol {
   ...
   * Value | Description
   * ------|------------
   * circle | ![sms_circle](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-sms-circle.avif)
   * cross | ![sms_cross](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-sms-cross.avif)
   * diamond | ![sms_diamond](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-sms-diamond.avif)
   * square | ![sms_square](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-sms-square.avif)
   * triangle | ![sms_triangle](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-sms-triangle.avif)
   * x | ![sms_x](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-sms-x.avif)
   *
   * @default "circle"
   */
