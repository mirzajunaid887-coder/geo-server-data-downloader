 ...
 *
 * ![3d-path-profiles](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/3d-path-profiles.avif)
 *
 ...
 *
 * ![symbols-3d-path](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-3d-path.avif)
 *
...
export default class PathSymbol3DLayer extends Symbol3DLayer {
   ...
   * ---------------|---------
   * center | ![anchor-center](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/anchor-center.avif)
   * bottom | ![anchor-bottom](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/anchor-bottom.avif)
   * top | ![anchor-top](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/anchor-top.avif)
   *
   * @default "center"
   * @since 4.12
   */
   ...
   * Possible Value | Example
   * ---------------|---------
   * butt | ![line3d-cap-butt](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/line3d-cap-butt.avif)
   * round | ![line3d-cap-round](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/line3d-cap-round.avif)
   * square | ![line3d-cap-square](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/line3d-cap-square.avif)
   * none | ![line3d-cap-square](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/line3d-cap-none.avif)
   *
   * @default "butt"
   * @since 4.12
   */
   ...
   * Possible Value | Example
   * ---------------|---------
   * bevel | ![line3d-join-bevel](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/line3d-join-bevel.avif)
   * miter | ![line3d-join-miter](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/line3d-join-miter.avif)
   * round | ![line3d-join-round](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/line3d-join-round.avif)
   *
   * @default "miter"
   * @since 4.12
   */
   ...
   *
   * ![profileRotation-heading](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/profileRotation-heading.avif)
   *
   * The same path with `profileRotation` set to `all` will rotate in all three degrees of freedom:
   *
   * ![profileRotation-all](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/profileRotation-all.avif)
   *
   * @default "all"
   * @since 4.12
   */
