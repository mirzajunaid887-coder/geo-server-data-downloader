 ...
 *
 * ![text-sample](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-text-sample.avif)
 *
 * @since 4.0
 ...
 * @see [Using icon fonts with map graphics](https://developers.arcgis.com/javascript/latest/sample-code/styling-icon-fonts/)
