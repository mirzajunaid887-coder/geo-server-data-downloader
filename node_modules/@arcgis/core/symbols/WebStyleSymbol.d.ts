 ...
 *
 * [![web-style](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-web-style.avif)](https://developers.arcgis.com/javascript/latest/sample-code/visualization-webstylesymbol/)
 *
 ...
 * [Esri Web Style Symbols (2D)](https://developers.arcgis.com/javascript/latest/visualization/symbols-color-ramps/esri-web-style-symbols-2d/) and
 * [Esri Web Style Symbols (3D)](https://developers.arcgis.com/javascript/latest/visualization/symbols-color-ramps/esri-web-style-symbols-3d/) can be used in conjunction with this class.
 * Note that the 2D web style symbols are only supported in 2D and 3D web style symbols are only supported in 3D with an
 * exception of [`EsriIconsStyle`](https://developers.arcgis.com/javascript/latest/visualization/symbols-color-ramps/esri-web-style-symbols-3d/#icons) which can be used in both 2D and 3D.
 *
 ...
 * @see [Guide - WebStyleSymbol reference list](https://developers.arcgis.com/javascript/latest/visualization/symbols-color-ramps/esri-web-style-symbols-3d/)
...
export default class WebStyleSymbol extends Symbol {
   ...
   * by a unique name. Only [Esri Web Style Symbols (2D)](https://developers.arcgis.com/javascript/latest/visualization/symbols-color-ramps/esri-web-style-symbols-2d/) and
   * [Esri Web Style Symbols (3D)](https://developers.arcgis.com/javascript/latest/visualization/symbols-color-ramps/esri-web-style-symbols-3d/) can be referenced here.
   *
   * @see [Guide - WebStyleSymbol reference list](https://developers.arcgis.com/javascript/latest/visualization/symbols-color-ramps/esri-web-style-symbols-3d/)
   */
