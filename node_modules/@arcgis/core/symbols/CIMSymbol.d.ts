 ...
 * - [MoveAlongLine](https://developers.arcgis.com/javascript/latest/references/core/symbols/cim/types/#CIMSymbolAnimationMoveAlongLine) (beta) - _since 5.1_
 *
 * #### Global animations
 * Global animations are defined on the `animations` property of `CIMPointSymbol`, `CIMLineSymbol`, and `CIMPolygonSymbol` and are applied to the entire symbol.
 *
 * ```js
 * const symbol = new CIMSymbol({
 *  data: {
 ...
 *
 * ![CIM symbols](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/cim/CIMSymbols.avif)
 *
 ...
 * @see [Guide - WebStyleSymbol reference list](https://developers.arcgis.com/javascript/latest/visualization/symbols-color-ramps/esri-web-style-symbols-2d/)
