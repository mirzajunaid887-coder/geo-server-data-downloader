 ...
 *
 * ![symbols-3d-line-markers](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-3d-line-markers.avif)
 *
 * @since 4.23
...
export default class LineStyleMarker3D extends LineStyleMarker3DSuperclass {
   ...
   * Value  | Example
   * -------|--------
   * arrow  | ![lsm-arrow](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-lsm-arrow.avif)
   * circle | ![lsm-circle](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-lsm-circle.avif)
   * square | ![lsm-square](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-lsm-square.avif)
   * diamond| ![lsm-diamond](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-lsm-diamond.avif)
   * cross  | ![lsm-cross](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-lsm-cross.avif)
   * x      | ![lsm-x](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-lsm-x.avif)
   *
   * @default "arrow"
   */
