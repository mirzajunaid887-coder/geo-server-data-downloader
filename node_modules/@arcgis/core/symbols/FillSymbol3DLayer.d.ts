...
export interface FillSymbol3DLayerProperties extends Symbol3DLayerProperties, Partial<Pick<FillSymbol3DLayer, "castShadows">> {
   ...
   *
   * ![symbol3D-edges-solid](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbol3d-edges-solid-2.avif)
   *
   * @since 4.7
   * @example
   * const symbol = {
 ...
 *
 * ![symbols-3d-fill](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbols-3d-fill.avif)
 *
