...
export interface DateTimeFormatOptions {
  ...
  type: "date";
  /**
   * The date format options for the [Intl.DateTimeFormat](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat) object.
   *
   * @since 5.0
   */
...
export interface NumberFormatOptions {
  ...
  type: "number";
  /**
   * The Intl number format options for the [Intl.NumberFormat](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/NumberFormat) object.
   *
   * @since 5.0
   */
