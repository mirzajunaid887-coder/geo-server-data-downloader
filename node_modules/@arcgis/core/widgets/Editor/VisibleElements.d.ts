...
/** @since 5.0 */
export interface VisibleElementsProperties extends Partial<Pick<VisibleElements, "createFeaturesSection" | "editFeaturesSection" | "flow" | "labelsToggle" | "mergeButton" | "selectionToolbar" | "settingsMenu" | "sketch" | "snappingControls" | "splitButton" | "tooltipsToggle" | "undoRedoButtons" | "zoomToButton">> {
  /**
...
export default class VisibleElements extends Accessor {
  ...
  /**
   * Whether to use the fully featured selection experience. This includes the
   ...
   *
   * If set to `false`, the widget will use a simplified selection experience,
   * consisting of a single "Select" button.
   *
   * @default true
   * @internal
   */
  accessor selectionToolbar: boolean;
  /**
