...
export interface EditorViewModelProperties extends Partial<Pick<EditorViewModel, "formSystem" | "layerInfos" | "selectionManager" | "syncViewSelection" | "useLegacyCreateTools" | "view">> {
...
export default class EditorViewModel extends EventedAccessor {
   ...
   * @since 5.1
   */
  accessor formSystem: "legacy" | "next";
  /**
