...
export interface SnappingControlsProperties extends WidgetProperties, Partial<Pick<SnappingControls, "view">> {
   ...
   *
   * ![snapping-controls-default](https://developers.arcgis.com/javascript/latest/assets/references/core/widgets/snapping-controls/snapping-controls-visible-elements-default.avif)
   *
   ...
   *
   * ![snapping-controls-example](https://developers.arcgis.com/javascript/latest/assets/references/core/widgets/snapping-controls/snapping-controls-visible-elements-example.avif)
   *
   * @example
 ...
 *
 * [![sketch-geometries](https://developers.arcgis.com/javascript/latest/assets/references/core/widgets/snapping-controls/sketch-snapping-controls.avif)](https://developers.arcgis.com/javascript/latest/sample-code/sketch-geometries/)
 *
 * ## Using the widget
 *
 ...
 *
 * [![widgets-editor-basic](https://developers.arcgis.com/javascript/latest/assets/references/core/widgets/snapping-controls/snapping-controls-editor.avif)](https://developers.arcgis.com/javascript/latest/sample-code/widgets-editor-basic/)
 *
 * > [!WARNING]
 * >
 * > **Known Limitations**
