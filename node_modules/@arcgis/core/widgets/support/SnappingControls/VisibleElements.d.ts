...
export default class SnappingControlsVisibleElements extends Accessor {
   ...
   * ![layerlist-toggle-layers-btn](https://developers.arcgis.com/javascript/latest/assets/references/core/widgets/snapping-controls/layerlist-toggle-layers-btn.avif)
   *
   * @default true
   * @since 5.0
   */
