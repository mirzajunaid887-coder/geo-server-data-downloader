...
/**
 * The Print widget connects your application with a [printing service](https://doc.esri.com/en/arcgis-enterprise/latest/administer/configure-the-portal-to-print-maps.html) to allow the map to be printed.
 ...
 * @see [Printing in web applications](https://doc.esri.com/en/arcgis-enterprise/latest/administer/printing-in-web-applications.html)
 * @see [Configure the portal to print maps](https://doc.esri.com/en/arcgis-enterprise/latest/administer/configure-the-portal-to-print-maps.html)
