...
export default class LayerSearchSource<Layer extends LayerBase = LayerBase> extends SearchSource {
   ...
   *
   * For `string` field searches, there is no leading wildcard. This effectively makes
   * `exactMatch` value `true`, which will remove unnecessary search results and suggestions.
   *
   * @default false
   */
