...
export default class SearchViewModel extends SearchViewModelSuperclass {
   ...
   *
   * ![locationEnabled](https://developers.arcgis.com/javascript/latest/assets/references/core/widgets/search-locationEnabled.avif)
   *
   * > [!WARNING]
   * >
   ...
   * > for easy testing in browsers that supports [Window.isSecureContext](https://developer.mozilla.org/docs/Web/API/isSecureContext#browser_compatibility)
   ...
   *
   * ![search-searchAllEnabled-true](https://developers.arcgis.com/javascript/latest/assets/references/core/widgets/search-enablesearchingall-true.avif)
   *
   * When `false`, no option to search all sources at once is available:
   *
   * ![search-searchAllEnabled-true-false](https://developers.arcgis.com/javascript/latest/assets/references/core/widgets/search-enablesearchingall-false.avif)
   *
   * @default true
   */
   ...
   * supports [geolocation](https://developer.mozilla.org/docs/Web/API/Geolocation/Using_geolocation),
