...
export interface ActionColumnConfig {
  ...
  /**
   * Indicates the column should be frozen to the start of the table, after the selection column. The ActionColumn is typically
   * 'frozenToEnd' by default so 'frozen' needs to be explicitly set. Columns cannot be 'frozen' and 'frozenToEnd' at the same time.
   * If both the 'frozen' and 'frozenToEnd' properties are set to true then the 'frozen' property takes precedence.
   *
   * @since 5.1
   */
  frozen?: boolean;
  /**
   * Indicates the column should be frozen to the end of the table. The ActionColumn is typically 'frozenToEnd' by default without
   * requiring this property to be set. However, columns cannot be 'frozen' and 'frozenToEnd' at the same time.
   * If both the 'frozen' and 'frozenToEnd' properties are set to true then the 'frozen' property takes precedence.
   *
   * @since 5.0
   */
