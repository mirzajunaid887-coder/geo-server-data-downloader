...
export interface ColumnTemplateBaseProperties extends Partial<Pick<ColumnTemplateBase, "autoWidth" | "description" | "direction" | "fieldName" | "flexGrow" | "formatFunction" | "frozen" | "frozenToEnd" | "icon" | "iconText" | "initialSortPriority" | "invalid" | "label" | "labelTooltipText" | "menuConfig" | "resizable" | "sortable" | "textAlign" | "textWrap" | "timeZone" | "visible" | "width">> {}
...
export default abstract class ColumnTemplateBase extends ColumnTemplateBaseSuperclass {
  ...
  /**
   * Controls the [flex-grow](https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/flex-grow) property for the column. When set to `0`, cell width is fixed.
   *
   * @default 1
   * @since 4.30
   */
