...
export default class SmartMappingSliderViewModel<StopType extends SmartMappingSupportedStop = SmartMappingSupportedStop, BreakType extends any = any> extends SliderViewModel {
   ...
   * max is `200`.
   *
   * ![slider-zoom](https://developers.arcgis.com/javascript/latest/assets/references/core/widgets/sliders/slider-zoomed.avif)
   *
   ...
   *
   * ![slider-not-zoomed](https://developers.arcgis.com/javascript/latest/assets/references/core/widgets/sliders/slider-skewed-not-zoomed.avif)
   *
