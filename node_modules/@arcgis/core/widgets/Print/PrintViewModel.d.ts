...
export interface PrintViewModelProperties extends LoadableMixinProperties, Partial<Pick<PrintViewModel, "allowedFormats" | "allowedLayouts" | "cimVersion" | "datumTransformations" | "extraParameters" | "includeDefaultTemplates" | "printServiceUrl" | "printTimeout" | "showPrintAreaEnabled" | "templateCustomTextElements" | "updateDelay" | "view">> {
  /**
...
export default class PrintViewModel extends PrintViewModelSuperclass {
  ...
  /** @internal */
  accessor cimVersion: string | undefined;
  /**
