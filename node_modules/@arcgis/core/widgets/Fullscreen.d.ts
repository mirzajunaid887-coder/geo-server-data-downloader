...
/**
 * Provides a simple widget to present the [View](https://developers.arcgis.com/javascript/latest/references/core/views/View/) or a user-defined [HTMLElement](https://developer.mozilla.org/docs/Web/API/HTMLElement) using the entire screen.
 *
 * > [!WARNING]
 * >
 * > **Note:**
 ...
 * > the [Fullscreen API](https://developer.mozilla.org/docs/Web/API/Fullscreen_API). Thus, iOS Safari is not supported.
 *
