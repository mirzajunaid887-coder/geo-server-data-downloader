 ...
 *
 * ![widgets-scaleRangeSlider](https://developers.arcgis.com/javascript/latest/assets/references/core/widgets/widgets-scaleRangeSlider-v2.avif)
 *
 * @deprecated since version 5.0. Use the [Scale Range Slider component](https://developers.arcgis.com/javascript/latest/references/map-components/components/arcgis-slider-scale-range/) instead. For information on widget deprecation, read about [Esri's move to web components](https://developers.arcgis.com/javascript/latest/components-transition-plan/).
 * @since 4.13
