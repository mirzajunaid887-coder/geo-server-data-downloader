...
export interface WebDocument2DProperties extends EsriMapProperties, LoadableMixinProperties, Partial<Pick<WebDocument2D, "authoringApp" | "authoringAppVersion" | "portalItemResourcePath" | "thumbnailUrl">> {
...
export default abstract class WebDocument2D extends WebDocument2DSuperclass {
  ...
  /**
   * Path of a resource (relative to {ITEM}/resources/) within the portal item specified by `portalItem`.
   * This resource should contain a Web Map or Web Link Chart.
   * Applicable only when `portalItem` is a "Knowledge Studio Project" item.
   *
   * @internal
   */
  accessor portalItemResourcePath: string | null | undefined;
  /**
  ...
  destroy(): void;
  /**
   * Returns paths of resources within [portalItem](https://developers.arcgis.com/javascript/latest/references/core/WebDocument2D/#portalItem) (relative to `{ITEM}/resources/`)
   * that are referenced by layers in this [WebMap](https://developers.arcgis.com/javascript/latest/references/core/WebMap/) or [WebLinkChart](https://developers.arcgis.com/javascript/latest/references/core/WebLinkChart/).
   *
   * @internal
   * @see [PortalItemResource.path](https://developers.arcgis.com/javascript/latest/references/core/portal/PortalItemResource/#path)
   */
  getReferencedResourcePaths(): string[];
  /**
