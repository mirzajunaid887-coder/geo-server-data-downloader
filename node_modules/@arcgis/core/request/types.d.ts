...
export interface RequestOptions extends AbortOptions {
   ...
   * See also [`keepalive`](https://developer.mozilla.org/docs/Web/API/Request/keepalive) for more details.
   *
   * @default false
   * @since 5.0
   */
   ...
   * [json](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object),
   * [text](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String),
   * [array-buffer](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer),
   * [blob](https://developer.mozilla.org/docs/Web/API/Blob),
   * [image](https://developer.mozilla.org/docs/Web/API/HTMLImageElement),
   * [native](https://developer.mozilla.org/docs/Web/API/Response),
   * [native-request-init](https://developer.mozilla.org/docs/Web/API/RequestInit),
   * [document](https://developer.mozilla.org/docs/Web/API/HTMLDocument), and
   * [xml](https://developer.mozilla.org/docs/Web/API/XMLDocument)
   *
   * @default json
   * @since 5.0
   */
 ...
 * CORS only allows a few response headers to be read by default, see: [Access-Control-Expose-Headers](https://developer.mozilla.org/docs/Web/HTTP/Reference/Headers/Access-Control-Expose-Headers).
 *
...
export interface RequestInterceptor {
   ...
   * If using a [`RegExp`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/RegExp), the [`g`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/RegExp/global) and [`y`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/RegExp/sticky) flags should not be used.
   *
   * @since 5.0
   */
