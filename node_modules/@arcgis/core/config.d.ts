...
export interface Config {
   ...
   * For more information, see the [prefers-reduced-motion](https://developer.mozilla.org/docs/Web/CSS/Reference/At-rules/@media/prefers-reduced-motion) documentation.
   *
   * > [!WARNING]
   * >
   * > **Known Limitations**
