...
export default class ServerInfo extends JSONSupport {
  ...
  /**
   * Indicates whether the [server](https://developers.arcgis.com/javascript/latest/references/core/identity/ServerInfo/#server) is an [ArcGIS Server](https://doc.esri.com/en/arcgis-enterprise/latest/plan/what-is-arcgis-server.html) instance.
   *
   * @see [IdentityManagerBase.registerServers()](https://developers.arcgis.com/javascript/latest/references/core/identity/IdentityManagerBase/#registerServers)
   * @example
   ...
   *
   * @see [ArcGIS Server authentication tier](https://doc.esri.com/en/arcgis-server/latest/stand-alone-server/configuring-arcgis-server-s-authentication-tier.html)
   */
