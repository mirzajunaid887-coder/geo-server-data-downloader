...
export interface ViewshedProperties extends Partial<Pick<Viewshed, "farDistance" | "feature" | "heading" | "horizontalFieldOfView" | "tilt" | "verticalFieldOfView">> {
   ...
   * > If the elevation info is not specified, the effective elevation depends on the [observer](https://developers.arcgis.com/javascript/latest/references/core/analysis/Viewshed/#observer) properties.
   *
   * @since 5.1
   */
