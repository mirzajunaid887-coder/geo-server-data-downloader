 ...
 * @see [Trace utility networks](https://doc.esri.com/en/arcgis-pro/latest/help/data/utility-network/about-tracing-utility-networks.html)
...
export default class UNTraceConfiguration extends UNTraceConfigurationSuperclass {
   ...
   *
   * @since 5.1
   * @see [Learn more about flow direction in a utility network](https://doc.esri.com/en/arcgis-pro/latest/help/data/utility-network/about-tracing-utility-networks.html#598)
   */
