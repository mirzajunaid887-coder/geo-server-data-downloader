 ...
 *
 * @since 4.20
 * @see [Learn more about Named Trace Configurations](https://doc.esri.com/en/arcgis-pro/latest/help/data/utility-network/about-trace-configurations.html)
...
export default class NamedTraceConfiguration extends NamedTraceConfigurationSuperclass {
   ...
   *
   * @returns A deep clone of the [NamedTraceConfiguration](https://developers.arcgis.com/javascript/latest/references/core/networks/support/NamedTraceConfiguration/) instance.
   * @since 5.1
   * @example
   * ```ts
   * const namedConfig = utilityNetwork.sharedNamedTraceConfigurations.at(0);
   * const clonedConfig = namedConfig.clone();
   * ```
   */
  clone(): NamedTraceConfiguration;
}
