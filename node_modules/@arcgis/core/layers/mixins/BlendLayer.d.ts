...
/**
 * BlendLayer is a mixin that adds [blendMode](https://developers.arcgis.com/javascript/latest/references/core/layers/mixins/BlendLayer/#blendMode) and [effect](https://developers.arcgis.com/javascript/latest/references/core/layers/mixins/BlendLayer/#effect) properties to a layer.
 *
 * @since 4.17
 */
export abstract class BlendLayer {
  constructor(...args: any[]);
  /**
   * Blend modes are used to blend layers together to create an interesting effect in a layer, or even to produce what seems like a new layer.
   * Unlike the method of using [transparency](https://developers.arcgis.com/javascript/latest/references/core/layers/Layer/#opacity) which can result in a washed-out top layer, blend modes can create a variety of very vibrant and intriguing
   ...
   *
   * The layers in a [GroupLayer](https://developers.arcgis.com/javascript/latest/references/core/layers/GroupLayer/) are blended together in isolation from the rest of the map.
   *
   * In the following screenshots, the [vintage shaded relief](https://www.arcgis.com/home/item.html?id=a8588e0401e246469260f03ee44d69f1)
   ...
   *
   * <img src="https://developers.arcgis.com/javascript/latest/assets/references/core/layers/blendMode/color-blend.avif" alt="color-blend" style="width:800px;"/>
   *
   * > [!WARNING]
   * >
   * > **Known Limitations**
   * >
   * > - In 3D [SceneViews](https://developers.arcgis.com/javascript/latest/references/core/views/SceneView/), the blendMode is supported on [BaseTileLayer](https://developers.arcgis.com/javascript/latest/references/core/layers/BaseTileLayer/), [ImageryTileLayer](https://developers.arcgis.com/javascript/latest/references/core/layers/ImageryTileLayer/),
   ...
   * > [WebTileLayer](https://developers.arcgis.com/javascript/latest/references/core/layers/WebTileLayer/), [WMTSLayer](https://developers.arcgis.com/javascript/latest/references/core/layers/WMTSLayer/) and [GroupLayer](https://developers.arcgis.com/javascript/latest/references/core/layers/GroupLayer/).
   * > - When working with [GroupLayers](https://developers.arcgis.com/javascript/latest/references/core/layers/GroupLayer/) in a 3D [SceneView](https://developers.arcgis.com/javascript/latest/references/core/views/SceneView/), the blendMode is only applied to the sublayers that support it.
   * > - The blendMode is not supported in the [Legend](https://developers.arcgis.com/javascript/latest/references/core/widgets/Legend/).
   ...
   * * By default, the very bottom layer in a map is drawn on a transparent background. You can change the [MapView's background](https://developers.arcgis.com/javascript/latest/references/core/views/MapView/#background) color.
   *
   * <details>
   ...
   * White in the top layer will stay unchanged. Any color that is lighter than pure black is going to lighten colors in the top layer to varying degrees all way to pure white.
   *
   ...
   * lighter | Colors in top and background layers are multiplied by their alphas (layer [opacity](https://developers.arcgis.com/javascript/latest/references/core/layers/Layer/#opacity) and layer's [data opacity](https://developers.arcgis.com/javascript/latest/references/core/renderers/visualVariables/OpacityVariable/). Then the resulting colors are added together. All overlapping midrange colors are lightened in the top layer. The opacity of layer and layer's data will affect the blend result.
   ...
   * displayed over hillshade when you want to have your elevation show through the topographic layer. See the [intro to layer blending](https://developers.arcgis.com/javascript/latest/sample-code/intro-blendmode-layer/) sample.
   *
   * The `multiply` and `darken` modes can be used to have dark labels of the basemap to show through top layers. See the [darken blending sample](https://developers.arcgis.com/javascript/latest/sample-code/blendmode-darkening/).
   *
   ...
   * <img src="https://developers.arcgis.com/javascript/latest/assets/references/core/layers/blendMode/multiply-blend.avif" alt="multiply-blend" style="width:800px;"/>
   *
   * Blend mode | Description |
   * ---------- | ----------- |
   ...
   * See [this in action](https://developers.arcgis.com/javascript/latest/sample-code/featurelayerview-query-geometry/).
   *
   ...
   *
   * <img src="https://developers.arcgis.com/javascript/latest/assets/references/core/layers/blendMode/lumonisity-blend.avif" alt="color-blend" style="width:800px;"/>
   *
   * Blend mode | Description |
   * ---------- | ----------- |
   ...
   * providing a bird's eye view of the phenomenon. Check out [multiple blending](https://developers.arcgis.com/javascript/latest/sample-code/blendmode-multiple-layers/) and [groupLayer blending](https://developers.arcgis.com/javascript/latest/sample-code/blendmode-grouplayer/)
   ...
   *
   * <img src="https://developers.arcgis.com/javascript/latest/assets/references/core/layers/blendMode/destination-in-blend-grouplayer.avif" alt="destination-in" style="width:800px;"/>
   *
   * Blend mode | Description |
   * ---------- | ----------- |
   ...
   *
   * <img src="https://developers.arcgis.com/javascript/latest/assets/references/core/layers/blendMode/invert-blendmode.avif" alt="color-blend" style="width:800px;"/>
   *
   * Blend mode | Description |
   * ---------- | ----------- |
   ...
   * @default "normal"
   * @since 4.16
   * @see [Layer blending samples](https://developers.arcgis.com/javascript/latest/sample-code/?search=blendMode)
   */
   ...
   * how image filters work. This powerful capability allows you to apply [css filter-like](https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/filter)
   ...
   * > **Notes**
   * >
   * > Set [featureEffect](https://developers.arcgis.com/javascript/latest/references/core/layers/mixins/FeatureEffectLayer/#featureEffect) property on a layer if different effects need to be applied features that meet or fail a
   * > specified [filter](https://developers.arcgis.com/javascript/latest/references/core/layers/support/FeatureEffect/#filter).
   ...
   *
   * @since 4.18
   * @see [featureEffect](https://developers.arcgis.com/javascript/latest/references/core/layers/mixins/FeatureEffectLayer/#featureEffect)
   * @see [More information on how to set effect](https://developers.arcgis.com/javascript/latest/references/core/layers/support/FeatureEffect/#Effect)
   ...
   * ];
   */
  accessor effect: Effect | null | undefined;
}