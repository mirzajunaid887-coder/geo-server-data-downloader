 ...
 *
 * ![voxel-layer](https://developers.arcgis.com/javascript/latest/assets/references/core/layers/voxel-layer.avif)
 *
 * > [!WARNING]
 * >
 * > **Known Limitations**
 ...
 * voxel layer and [publish](https://doc.esri.com/en/arcgis-enterprise/latest/share/publish-scenes.html)
 * it as a [Scene Service](https://doc.esri.com/en/arcgis-enterprise/latest/administer/approaches-for-publishing-services-with-arcgis.html).
 ...
 * before [publishing](https://doc.esri.com/en/arcgis-enterprise/latest/administer/approaches-for-publishing-services-with-arcgis.html)
 * the voxel layer as a [scene service](https://doc.esri.com/en/arcgis-enterprise/latest/share/publish-scenes.html).
 *
 ...
 *
 * ![voxellayer_voxelslice](https://developers.arcgis.com/javascript/latest/assets/references/core/layers/voxellayer_voxelslice.avif)
 *
 * ### VoxelDynamicSection
 ...
 * real-time rendering updates.
 *
 * ![voxellayer_dynamicsection](https://developers.arcgis.com/javascript/latest/assets/references/core/layers/voxellayer_dynamicsection.avif)
 *
 * ### VoxelIsosurface
 ...
 *
 * ![voxellayer_isosurface](https://developers.arcgis.com/javascript/latest/assets/references/core/layers/voxellayer_isosurface.avif)
 *
 * ### Analysis Tool
 ...
 * of a VoxelLayer.
 *
 * ![voxellayer_popup.png](https://developers.arcgis.com/javascript/latest/assets/references/core/layers/voxellayer_popup.avif)
 *
 ...
 *
 *  ![voxellayer_xyz](https://developers.arcgis.com/javascript/latest/assets/references/core/layers/voxellayer_xyz.avif)
 *
 * * X, Y, T in which X and Y represent a geographic coordinate and T represents time as a level
 *
 * ![voxellayer_xyt](https://developers.arcgis.com/javascript/latest/assets/references/core/layers/voxellayer_xyt.avif)
 *
 * * X, Y, Z, T in which each dimension represents geographic coordinates and includes a fourth dimension representing time.
 *
 * ![voxellayer_xyzt](https://developers.arcgis.com/javascript/latest/assets/references/core/layers/voxellayer_xyzt.avif)
 *
