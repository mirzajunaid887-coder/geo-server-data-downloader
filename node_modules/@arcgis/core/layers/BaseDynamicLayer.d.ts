 ...
 * method to generate
 * an [html image element](https://developer.mozilla.org/docs/Web/API/HTMLImageElement) or
 * [canvas element](https://developer.mozilla.org/docs/Web/API/HTMLCanvasElement) by
 * processing the data returned by the server. For example, if you need to apply a
 * [compositing operation](https://developer.mozilla.org/docs/Web/API/CanvasRenderingContext2D/globalCompositeOperation)
...
export default abstract class BaseDynamicLayer extends BaseDynamicLayerSuperclass {
   ...
   * [HTMLImageElement](https://developer.mozilla.org/docs/Web/API/HTMLImageElement) or
