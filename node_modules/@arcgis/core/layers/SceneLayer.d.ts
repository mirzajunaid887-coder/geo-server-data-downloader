...
import type ModelInfo from "./scene/ModelInfo.js";
...
import type { QueryModelOptions, SaveAsOptions } from "./scene/types.js";
...
export interface SceneLayerProperties extends LayerProperties, APIKeyMixinProperties, CustomParametersMixinProperties, ScaleRangeLayerProperties, PortalLayerProperties, OperationalLayerProperties, SceneServiceProperties, Partial<Pick<SceneLayer, "definitionExpression" | "labelsVisible" | "legendEnabled" | "objectIdField" | "outFields" | "popupEnabled" | "screenSizePerspectiveEnabled">> {
   ...
   *
   * [<video src="https://developers.arcgis.com/javascript/latest/assets/images/samples/city-points-declutter.webm" aria-label="declutter" autoplay muted playsinline loop></video>](https://developers.arcgis.com/javascript/latest/sample-code/visualization-point-styles/)
   *
   * > [!WARNING]
   * >
   * > **Known Limitation**
 ...
 * amounts of data in a [SceneView](https://developers.arcgis.com/javascript/latest/references/core/views/SceneView/). SceneLayers support point and 3D object features, such as buildings.
 *
 * [![san-francisco-buildings](https://developers.arcgis.com/javascript/latest/assets/references/core/layers/scenelayer-buildings.avif)](https://tiles.arcgis.com/tiles/z2tnIkrLQ2BRzr6P/arcgis/rest/services/SanFrancisco_Bldgs/SceneServer)
 *
 * You can find many samples of SceneLayers in ArcGIS Online by
 * [searching the gallery](https://www.arcgis.com/home/search.html?restrict=false&sortField=relevance&sortOrder=desc&focus=layers-weblayers-3Dlayers).
 *
 * [![city-scene-layer-guide](https://developers.arcgis.com/javascript/latest/assets/references/core/layers/city-scene-layer-guide.avif)](https://www.arcgis.com/home/search.html?restrict=false&sortField=relevance&sortOrder=desc&focus=layers-weblayers-3Dlayers)
 *
 ...
 *
 * [![scenelayer-ny](https://developers.arcgis.com/javascript/latest/assets/references/core/layers/scenelayer-ny.avif)](https://tiles.arcgis.com/tiles/z2tnIkrLQ2BRzr6P/arcgis/rest/services/New_York_LoD2_3D_Buildings/SceneServer/layers/0)
 *
 ...
 * ## Data Visualization
 *
 * Just like other layers, SceneLayers can be visualized using renderers. 3D object features in a SceneLayer can be styled
 ...
 * colors. To improve the perception of shapes of 3D object scene layers, they can also be visualized with
 ...
 *
 * [![scenelayer-edges](https://developers.arcgis.com/javascript/latest/assets/references/core/symbols/symbol3d-edges-solid-2.avif)](https://developers.arcgis.com/javascript/latest/sample-code/layers-scenelayer-edges/)
 *
 ...
 * ## Popups
 *
 * Point and 3D object scene layers can have customized popup content using the
 ...
 *
 * ![custom-popups](https://developers.arcgis.com/javascript/latest/assets/images/guide/scene-layer/custom-popups.avif)
 *
 * <span id="querying"></span>
 * ## Query SceneLayer data
 *
 ...
 * of the query. Note that for 3D object scene layers these spatial relationships are evaluated based on the
 ...
 * ## Get feature source and derived models
 *
 * 3D object scene layer features can have multiple associated models. This can include a source model and one or more
 * derived models generated from it by the service for specific uses, such as a `.glb` model prepared for web display.
 * Use [queryModel()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#queryModel) to retrieve a model for a feature, or
 * [queryModels()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#queryModels) to retrieve model metadata for multiple features. Requestable model formats
 * are listed in `capabilities.data.queryFormats`.
 *
 * <span id="get-geometry-extent"></span>
 * ## Get feature geometry
 *
 * For 3D object scene layers, feature geometry is a displayable [Mesh](https://developers.arcgis.com/javascript/latest/references/core/geometry/Mesh/) derived from the
 * feature's model and used to render the feature in the scene.
 * Retrieve it with [queryFeatures()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#queryFeatures) by setting [Query.returnGeometry](https://developers.arcgis.com/javascript/latest/references/core/rest/support/Query/#returnGeometry)
 * to `true` when `capabilities.query.supportsReturnMesh` is `true`.
 *
 * Point scene layers return [Point](https://developers.arcgis.com/javascript/latest/references/core/geometry/Point/) geometry when setting [Query.returnGeometry](https://developers.arcgis.com/javascript/latest/references/core/rest/support/Query/#returnGeometry)
 * to `true` on any of the query methods.
 *
 * <span id="get-extent"></span>
 * ## Get feature extent
 *
 * The 2D extent can be retrieved for all features (even the ones that are not loaded yet) with the
 * [queryExtent()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#queryExtent) method on the SceneLayer. This method only succeeds if the layer has an
 * associated feature layer. The 3D extent can only be queried for the features that are already loaded, by using the
 * [SceneLayerView.queryExtent()](https://developers.arcgis.com/javascript/latest/references/core/views/layers/SceneLayerView/#queryExtent) method on the [SceneLayerView](https://developers.arcgis.com/javascript/latest/references/core/views/layers/SceneLayerView/).
 *
...
export default class SceneLayer extends SceneLayerSuperclass {
   ...
   * [getFieldUsageInfo()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#getFieldUsageInfo) to query
   ...
   * appear as defined in the [labelingInfo](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#labelingInfo) property.
   *
   * @default true
   * @see [labelingInfo](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#labelingInfo)
   */
   ...
   * derived from the [fields](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#fields) of the service by taking
   * the first field of type `oid`.
   *
   * @see [fields](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#fields)
   */
  accessor objectIdField: string;
  /**
   * An array of field names from the service to include with each feature.
   * To fetch the values from all fields in the layer, use `["*"]`. Fields specified in
   * `outFields` will be requested alongside with required fields for [rendering](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#renderer),
   * [labeling](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#labelingInfo) and setting the [elevation info](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#elevationInfo) for the layer.
   * The required fields and `outFields` are used to populate
   * [SceneLayerView.availableFields](https://developers.arcgis.com/javascript/latest/references/core/views/layers/SceneLayerView/#availableFields).
   * Set this property to include the fields that will be used for client-side
   * [queries](https://developers.arcgis.com/javascript/latest/references/core/views/layers/SceneLayerView/#queryFeatures)
   * if the fields are not part of required fields used for rendering.
   *
   * @since 4.12
   * @see [SceneLayerView.availableFields](https://developers.arcgis.com/javascript/latest/references/core/views/layers/SceneLayerView/#availableFields)
  ...
  /**
   * Indicates whether to display popups when features in the layer are clicked. The layer needs to have a [popupTemplate](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#popupTemplate) to define what
  ...
  /**
   * Array of [relationships](https://developers.arcgis.com/javascript/latest/references/core/layers/support/Relationship/) set up for the layer.
   ...
   *
   * @since 4.28
   * @see [queryRelatedFeatures()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#queryRelatedFeatures)
   * @example
  ...
  /**
   * Applies edits to the features in the associated [FeatureLayer](https://developers.arcgis.com/javascript/latest/references/core/layers/FeatureLayer/).
   * The prerequisite for an editable SceneLayer is an associated FeatureLayer with editing and change tracking enabled.
   * Editing capabilities depend on the capabilities of the associated [FeatureLayer](https://developers.arcgis.com/javascript/latest/references/core/layers/FeatureLayer/). Adding, updating and deleting
   ...
   * the layer in a [SceneView](https://developers.arcgis.com/javascript/latest/references/core/views/SceneView/) unless there are too many edits. In this case the scene layer cache
   ...
   * ----------------------|---------|------------
   * supportsRenderer      | boolean | Indicates that a field can be used in a renderer (e.g. in visual variables), [see renderer](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#renderer).
   * supportsLabelingInfo  | boolean | Indicates that a field can be used for labeling, [see labelingInfo](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#labelingInfo).
   * supportsPopupTemplate | boolean | Indicates that a field can be used in a popup template, [see popupTemplate](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#popupTemplate).
   * supportsLayerQuery    | boolean | Indicates that a field can be used in layer queries, [see queryFeatures()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#queryFeatures).
   *
   ...
   * [capabilities.data.supportsAttachment](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#capabilities) property is `false`.
   * Attachments for multiple features can be queried if the layer's [capabilities.operations.supportsQueryAttachments](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#capabilities)
   * is `true`.
   *
   * > [!WARNING]
   * >
   * > **Known Limitations**
   * >
   * > When the layer's[capabilities.operations.supportsQueryAttachments](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#capabilities) property is
   ...
   * feature objectIds.
   * @since 4.28
   * @see [capabilities.data.supportsAttachment](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#capabilities)
   * @see [capabilities.operations.supportsQueryAttachments](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#capabilities)
   */
   ...
   * [SceneLayerView.queryExtent()](https://developers.arcgis.com/javascript/latest/references/core/views/layers/SceneLayerView/#queryExtent),
   ...
   * with the name `scenelayer:query-not-available` is thrown. Read more about queries in the [Querying](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#querying)
   ...
   * @see [FeatureLayer.queryExtent()](https://developers.arcgis.com/javascript/latest/references/core/layers/FeatureLayer/#queryExtent)
   */
  ...
  /**
   * Executes a [Query](https://developers.arcgis.com/javascript/latest/references/core/rest/support/Query/) against the associated feature service and returns the number of
   * features that satisfy the query. The query succeeds only if
   * the layer's `supportsLayerQuery` capability is enabled. Use the
   * [getFieldUsageInfo()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#getFieldUsageInfo) method to check if the layer supports queries.
   ...
   * @see [FeatureLayer.queryFeatureCount()](https://developers.arcgis.com/javascript/latest/references/core/layers/FeatureLayer/#queryFeatureCount)
   */
  ...
  /**
   * Queries a single model for the feature identified by object ID. This method is available for 3D object scene layers
   * that have an associated feature layer with 3D object support.
   *
   * If the format is not specified, this method returns the source model of the feature when one is available. If a
   * format is specified, the method returns the matching source or derived model for that feature. Known possible
   * formats include `dae`, `dwg`, `fbx`, `glb`, `glt`, `ifc`, `obj`, `shapebuffer`, `shapebufferg`, `usd`, `usda`,
   * `usdc` and `usdz`. The formats supported by the service are listed in `capabilities.data.queryFormats` on the
   * layer's [capabilities](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#capabilities).
   *
   * Use this method when you need one model for one feature. To query all model formats for one or more features, use
   * [queryModels()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#queryModels). To retrieve displayable [Mesh](https://developers.arcgis.com/javascript/latest/references/core/geometry/Mesh/) geometry instead, use
   * [queryFeatures()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#queryFeatures) with [Query.returnGeometry](https://developers.arcgis.com/javascript/latest/references/core/rest/support/Query/#returnGeometry) set to `true`.
   *
   * @param objectId - Object ID of the feature whose model should be queried.
   * @param options - Optional model query options.
   * @returns Resolves to a single model or `undefined` when no matching source or format-specific model is available.
   * @since 5.1
   * @see [queryModels()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#queryModels)
   * @see [Sample - Query 3D models](https://developers.arcgis.com/javascript/latest/sample-code/query-models/)
   */
  queryModel(objectId: ObjectId, options?: QueryModelOptions): Promise<ModelInfo | undefined>;
  /**
   * Queries model metadata for features matching the given query. This method is available for 3D object scene layers
   * that have an associated feature layer with 3D object support.
   *
   * A feature may have multiple models associated with it. For example, a feature can have a source model in one
   * format and one or more derived models, such as a `.glb` model for display in web browsers.
   *
   * This method returns metadata only. Use [ModelFileInfo.arrayBuffer()](https://developers.arcgis.com/javascript/latest/references/core/layers/scene/ModelFileInfo/#arrayBuffer) to download file content
   * on demand. To retrieve displayable [Mesh](https://developers.arcgis.com/javascript/latest/references/core/geometry/Mesh/) geometry instead, use
   * [queryFeatures()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#queryFeatures) with [Query.returnGeometry](https://developers.arcgis.com/javascript/latest/references/core/rest/support/Query/#returnGeometry) set to `true`.
   *
   * If you are only interested in querying a single model format for a feature, use
   * [queryModel()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#queryModel) instead.
   *
   * @param query - Specifies the query parameters used to select features.
   * @param options - Optional abort options.
   * @returns Resolves to a map keyed by object ID containing model metadata for each matching feature.
   * @since 5.1
   * @see [queryModel()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#queryModel)
   * @see [Sample - Query 3D models](https://developers.arcgis.com/javascript/latest/sample-code/query-models/)
   */
  queryModels(query?: QueryProperties | null | undefined, options?: AbortOptions): Promise<Map<ObjectId, ModelInfo[]>>;
  /**
  ...
  /**
   * Executes a [RelationshipQuery](https://developers.arcgis.com/javascript/latest/references/core/rest/support/RelationshipQuery/) against the feature service
   ...
   * @since 4.28
   * @see [relationships property](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#relationships)
   * @example
  ...
  /**
   * Executes a [RelationshipQuery](https://developers.arcgis.com/javascript/latest/references/core/rest/support/RelationshipQuery/) against the feature service associated
   ...
   * [PortalItem](https://developers.arcgis.com/javascript/latest/references/core/portal/PortalItem/), then you should use [saveAs()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#saveAs).
   *
   * @returns When resolved, returns the portal item to which the layer is saved.
   * @since 4.31
   * @see [saveAs()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#saveAs)
   ...
   * @returns When resolved, returns the portal item to which the layer is saved.
   * @since 4.31
   * @see [save()](https://developers.arcgis.com/javascript/latest/references/core/layers/SceneLayer/#save)
   * @example
...
declare const SceneLayerSuperclass: typeof Layer & typeof ClonableMixin & typeof APIKeyMixin & typeof CustomParametersMixin & typeof MultiOriginJSONSupportMixin & typeof ScaleRangeLayer & typeof PortalLayer & typeof OperationalLayer & typeof SceneService & typeof EditBusLayer
