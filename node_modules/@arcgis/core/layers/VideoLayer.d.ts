...
import type { Coverage, LivestreamStatus, PreviewsInfo, SensorOrientationInfo, VideoMetadataEntry, VideoState } from "./video/types.js";
 ...
 *
 * ![VideoLayer and VideoPlayer](https://developers.arcgis.com/javascript/latest/assets/references/core/widgets/video-player.avif)
 *
 * @since 4.30
...
export default class VideoLayer extends VideoLayerSuperclass {
   ...
   * detail [here](https://developer.mozilla.org/docs/Web/Media/Guides/Formats).
   *
   * @since 4.33
   */
  ...
  /**
   * Contains metadata about preview thumbnails available as a sprite sheet.
   *
   * @since 5.1
   */
  get previewsInfo(): PreviewsInfo | null | undefined;
  /**
