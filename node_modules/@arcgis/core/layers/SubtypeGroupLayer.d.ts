 ...
 * each subtype in its corresponding [feature service](https://doc.esri.com/en/arcgis-enterprise/latest/administer/what-is-a-feature-service-.html). This allows for each
...
export default class SubtypeGroupLayer extends SubtypeGroupLayerSuperclass {
   ...
   * > [SubtypeGroupLayerView.queryExtent()](https://developers.arcgis.com/javascript/latest/references/core/views/layers/SubtypeGroupLayerView/#queryExtent).
   * 
   *
   ...
   * > [SubtypeGroupLayerView.queryFeatureCount()](https://developers.arcgis.com/javascript/latest/references/core/views/layers/SubtypeGroupLayerView/#queryFeatureCount).
   * 
   *
   ...
   * > [SubtypeGroupLayerView.queryFeatures()](https://developers.arcgis.com/javascript/latest/references/core/views/layers/SubtypeGroupLayerView/#queryFeatures).
   ...
   * > based on `meter` units, then [FeatureLayer.queryFeatures()](https://developers.arcgis.com/javascript/latest/references/core/layers/FeatureLayer/#queryFeatures) automatically converts the values from `feet` to `meter` units.
   * 
   *
   ...
   * > [SubtypeGroupLayerView.queryObjectIds()](https://developers.arcgis.com/javascript/latest/references/core/views/layers/SubtypeGroupLayerView/#queryObjectIds).
   * 
   *
