 ...
 * MediaLayer can display videos that are supported by web browsers. Refer to the [common codecs](https://developer.mozilla.org/docs/Web/Media/Formats/Video_codecs) document for supported video types.
 *
