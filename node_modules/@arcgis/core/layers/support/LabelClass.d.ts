...
export default class LabelClass extends JSONSupport {
   ...
   * static (default) | none
   * -----------------|------
   * ![layer-deconfliction-on](https://developers.arcgis.com/javascript/latest/assets/references/core/layers/clustering/layer-deconfliction-on.avif) | ![layer-deconfliction-off](https://developers.arcgis.com/javascript/latest/assets/references/core/layers/clustering/layer-deconfliction-off.avif)
   *
   ...
   * static (default) | none
   * -----------------|------
   * ![cluster-deconfliction-on](https://developers.arcgis.com/javascript/latest/assets/references/core/layers/clustering/cluster-deconfliction-on.avif) | ![cluster-deconfliction-off](https://developers.arcgis.com/javascript/latest/assets/references/core/layers/clustering/cluster-deconfliction-off.avif)
   *
   * </details>
   *
   * > [!WARNING]
