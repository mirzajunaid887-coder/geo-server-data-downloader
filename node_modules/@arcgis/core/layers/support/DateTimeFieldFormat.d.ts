 ...
 *
 * @since 4.34
 * @see [MDN documentation - DateTimeFormat](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat)
...
export default class DateTimeFieldFormat extends FieldFormat {
  ...
  /**
   * Defines the date format. For more options, refer to the [MDN documentation](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat#parameters).
   *
   * @since 4.34
   * @see [MDN documentation](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat)
   */
   ...
   * @default "auto"
   * @since 4.34
   * @see [MDN documentation](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat#parameters)
   */
  accessor hour12: Hour12;
  /**
   * Specifies how the month is displayed. For more options, refer to the [MDN documentation](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat).
   *
   * @since 4.34
   * @see [MDN documentation](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat)
   */
  ...
  /**
   * Defines the time format. For more options, refer to the [MDN documentation](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat#parameters).
   *
   * @since 4.34
   * @see [MDN documentation](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat)
   */
  ...
  get type(): "date-time";
  /**
   * Specifies how the year is displayed. Currently, only supports `numeric`. For more options, refer to the [MDN documentation](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat).
   *
   * @since 4.34
   * @see [MDN documentation](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat)
   */
