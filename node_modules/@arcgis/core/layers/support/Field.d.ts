...
export default class Field extends JSONSupport {
   ...
   * > The JavaScript SDK only supports safe integers that fall between  -9007199254740991 [(minimum)](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Number/MIN_SAFE_INTEGER)
   * > and 9007199254740991 [(maximum)](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Number/MAX_SAFE_INTEGER). Numbers that fall outside of this
   ...
   * | url | Text that represents a web address. |
   *
   * @since 4.12
   * @see [Blog - Describing layer attributes with field descriptions](https://www.esri.com/arcgis-blog/products/arcgis-online/data-management/describing-layer-attributes-with-field-descriptions-march-2019/)
   * @see [Describe attribute fields - ArcGIS Online Help](https://doc.arcgis.com/en/arcgis-online/manage-data/describe-fields.htm)
