 ...
 * how image filters (photo apps) work. The [CSS filters](https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/filter) are supported as effects in the API
 * with the following differences:
 *
 * * No [url()](https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/filter) css filter support.
 * * Only [absolute length](https://developer.mozilla.org/docs/Web/CSS/length) units are allowed for the effects where lengths are accepted.
 ...
 *
 * <figure>
 *   <img src="https://developers.arcgis.com/javascript/latest/assets/references/core/layers/effects/water-effects-layer.avif" alt="bloom" style="width:800px;"/>
 ...
 * | radius | Determines the radius of the blur in an [absolute length](https://developer.mozilla.org/docs/Web/CSS/length). Default value is 0. Negative values are not allowed. Leaves the features inside the radius untouched. |
 ...
 *
 * <figure>
 *   <img src="https://developers.arcgis.com/javascript/latest/assets/references/core/layers/effects/bloom-effect-layer.avif" alt="bloom" style="width:800px;"/>
 ...
 * ```
 *
 * [blur(radius)](https://developer.mozilla.org/docs/Web/CSS/Reference/Values/filter-function/blur) - Applies a [Gaussian blur](https://en.wikipedia.org/wiki/Gaussian_blur#:~:text=In%20image%20processing%2C%20a%20Gaussian,image%20noise%20and%20reduce%20detail.)
 ...
 * specified in a [absolute length](https://developer.mozilla.org/docs/Web/CSS/length).
 ...
 *
 * <figure>
 *   <img src="https://developers.arcgis.com/javascript/latest/assets/references/core/layers/effects/blur-effect-layer.avif" alt="bloom" style="width:800px;" alt="Grizzly Bear habitat ranges">
 ...
 * ```
 *
 * [brightness(percent | number)](https://developer.mozilla.org/docs/Web/CSS/Reference/Values/filter-function/brightness) - Applies a linear multiplier to a layer or a layerView, making it appear brighter or darker.
 *
 * | Values | Effect |
 * | ------ | ------ |
 ...
 *
 * [contrast(percent | number)](https://developer.mozilla.org/docs/Web/CSS/Reference/Values/filter-function/contrast) –
 * Adjusts the contrast of a layer or a layerView. Negative values are not allowed.
 *
 * | Values | Effect |
 * | ------ | ------ |
 ...
 *
 * [drop-shadow(offsetX, offsetY, blurRadius?, color?)](https://developer.mozilla.org/docs/Web/CSS/Reference/Values/filter-function/drop-shadow) - Applies a drop shadow effect to a layer or a layerView that follows
 ...
 * | Parameter | Description |
 * | --------- | ----------- |
 * | offset-x | An [absolute length](https://developer.mozilla.org/docs/Web/CSS/length) value that determines the shadow offset in the horizontal distance. Negative values place the shadow to the left of the layer. If both x and y offsets are 0, the shadow is placed directly underneath the layer. |
 * | offset-y | An [absolute length](https://developer.mozilla.org/docs/Web/CSS/length) value that determines the shadow offset in the vertical distance. Negative values place the shadow above the layer. |
 ...
 * | color | The [color](https://developer.mozilla.org/docs/Web/CSS/color_value) of the shadow. If unspecified, it defaults to black color. |
 *
 * ```js
 ...
 *
 * <figure>
 *   <img src="https://developers.arcgis.com/javascript/latest/assets/references/core/layers/effects/drop-shadow-effect-layer.avif" alt="drop-shadow" style="width:800px;"/>
 ...
 * </figure>
 *
 * [grayscale(percent | number)](https://developer.mozilla.org/docs/Web/CSS/Reference/Values/filter-function/grayscale) - Converts a layer or a layerView to grayscale. The value of amount defines the proportion
 ...
 *
 * [hue-rotate(angle)](https://developer.mozilla.org/docs/Web/CSS/Reference/Values/filter-function/hue-rotate) - Applies a hue rotation on a layer or a layerView. The value of angle defines the number of degrees
 ...
 * | Parameter | Description |
 * | --------- | ----------- |
 * | angle | The relative change in hue of the input sample, specified as an [angle](https://developer.mozilla.org/docs/Web/CSS/angle) such as `deg`, `rad`, `grad` and `turn`. |
 *
 * [invert(percent | number)](https://developer.mozilla.org/docs/Web/CSS/Reference/Values/filter-function/invert) - Inverts the samples in the layer. The value of amount defines the proportion
 ...
 * | > 100% or > 1 |Same as 100% or 1 |
 *
 * [opacity(percent | number)](https://developer.mozilla.org/docs/Web/CSS/Reference/Values/filter-function/opacity) - Applies transparency to a layer or a layerView. The value of amount
 ...
 * | > 100% or > 1 | Same as 100% or 1 |
 *
 * [saturate(percent | number)](https://developer.mozilla.org/docs/Web/CSS/Reference/Values/filter-function/opacity) - Saturates or desaturates a layer or a layerView.
 *
 * | Values | Effect |
 * | ------ | ------ |
 ...
 *
 * [sepia(percent | number)](https://developer.mozilla.org/docs/Web/CSS/Reference/Values/filter-function/opacity) - Converts colors in a layer or a layerView to sepia, giving it a warmer, more yellow/brown appearance.
 ...
 * [excludedEffect](https://developers.arcgis.com/javascript/latest/references/core/layers/support/FeatureEffect/#excludedEffect) properties allow you to apply [CSS filters](https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/filter)
...
export default class FeatureEffect extends JSONSupport {
   ...
   * the [filter](https://developers.arcgis.com/javascript/latest/references/core/layers/support/FeatureEffect/#filter) requirements. Effect allows you to apply [css filter-like](https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/filter)
   ...
   * Effect allows you to apply [css filter-like](https://developer.mozilla.org/docs/Web/CSS/Reference/Properties/filter)
   * functions to layers and layerViews to create custom visual effects to enhance the cartographic quality of your maps.
   *
   * @see [Sample - Apply effects to features](https://developers.arcgis.com/javascript/latest/sample-code/featureeffect-geometry/)
   * @see [Sample - Apply drop-shadow effect to a layerView](https://developers.arcgis.com/javascript/latest/sample-code/featureeffect-drop-shadow/)
