 ...
 * MediaLayer can display images that are supported by web browsers. Refer to the [common image file types](https://developer.mozilla.org/docs/Web/Media/Formats/Image_types#common_image_file_types)
