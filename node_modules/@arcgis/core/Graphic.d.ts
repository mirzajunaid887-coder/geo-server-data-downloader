...
export default class Graphic extends GraphicSuperclass {
  ...
  /**
   * Distance value returned in a query result when [outDistance](https://developers.arcgis.com/javascript/latest/references/core/rest/support/Query/#outDistance) is specified.
   * It represents the distance of each feature from the input geometry's buffer in a query result.
   *
   * @internal
   * @since 5.1
   */
