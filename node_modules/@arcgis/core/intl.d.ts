 ...
 * ## Setting the locale
 *
 * The SDK will automatically use locale defined via [`lang` attribute](https://developer.mozilla.org/docs/Web/HTML/Global_attributes/lang) on the root `html` element, or the locale of the browser.
 ...
 * around the Intl APIs that cache the created [Intl.DateTimeFormat](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat)
 * and [Intl.NumberFormat](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/NumberFormat) formatter objects for a set of `options`.
 ...
 *
 * @since 4.12
 * @see [Intl on MDN Web Docs](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Intl)
 * @see [Intl.DateTimeFormat on MDN Web Docs](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat)
 * @see [Intl.NumberFormat on MDN Web Docs](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/NumberFormat)
...
/**
 * Converts a [web map date format string](https://developers.arcgis.com/web-map-specification/objects/format/) to an [Intl.DateTimeFormat](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat#Parameters) options object.
 *
 ...
 *
 * // See https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat#Parameters
...
/**
 * Converts a [DateTimeFieldFormat](https://developers.arcgis.com/javascript/latest/references/core/layers/support/DateTimeFieldFormat/) to an [Intl.DateTimeFormatOptions](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat#Parameters) options object.
 *
 ...
 * @returns The [Intl date format](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DateTimeFormat#Parameters) options.
 * @since 4.34
...
/**
 * Converts a [NumberFieldFormat](https://developers.arcgis.com/javascript/latest/references/core/layers/support/NumberFieldFormat/) to an [Intl.NumberFormatOptions](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/NumberFormat#Parameters) options object.
 *
 ...
 * @returns The [Intl number format](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/NumberFormat#Parameters) options.
 * @since 4.34
 * @see [FieldInfo.fieldFormat](https://developers.arcgis.com/javascript/latest/references/core/popup/FieldInfo/#fieldFormat)
 * @example
...
/**
 * Converts a [NumberFormat](https://developers.arcgis.com/javascript/latest/references/core/intl/number/#NumberFormat) to an [Intl.NumberFormatOptions](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/NumberFormat#Parameters) object.
 *
 ...
 * });
 *
 * // See https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/NumberFormat#Parameters
 ...
 * > [!WARNING]
 * >
 * > Internally `formatDate` creates [Intl formatter](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Intl) instances for the current locale.
 * > The formatters are cached using their `options` as a cache key.
 * > Reuse the same `options` objects for best performance.
 *
 * @param value - The [Date](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date) object, or the number of milliseconds elapsed since January 1, 1970 00:00:00 UTC, to be formatted.
 ...
 * > [!WARNING]
 * >
 * > Internally `formatDateOnly` creates [Intl formatter](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Intl) instances for the current locale.
 * > The formatters are cached using their `options` as a cache key.
 * > Reuse the same `options` objects for best performance.
 *
 ...
 * > [!WARNING]
 * >
 * > Internally `formatNumber` creates [Intl formatter](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Intl) instances for the current locale.
 * > The formatters are cached using their `options` as a cache key.
 * > Reuse the same `options` objects for best performance.
 *
 ...
 * > [!WARNING]
 * >
 * > Internally `formatTimeOnly` creates [Intl formatter](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Intl) instances for the current locale.
 * > The formatters are cached using their `options` as a cache key.
 * > Reuse the same `options` objects for best performance.
 *
 ...
 * > [!WARNING]
 * >
 * > Internally `formatTimestamp` creates [Intl formatter](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Intl) instances for the current locale.
 * > The formatters are cached using their `options` as a cache key.
 * > Reuse the same `options` objects for best performance.
 *
 ...
 *  1. The [`lang` attribute](https://developer.mozilla.org/docs/Web/HTML/Global_attributes/lang) defined on the root `html` element.
 *  1. What is set [`navigator.language`](https://developer.mozilla.org/docs/Web/API/NavigatorLanguage/language), the locale defined by the web browser's user's preferences.
 *
 * The preferred way of setting a locale is via the [`lang` attribute](https://developer.mozilla.org/docs/Web/HTML/Global_attributes/lang) on the root `html` element.
 ...
 * @since 4.16
 * @see [NavigatorLanguage on MDN Web Docs](https://developer.mozilla.org/docs/Web/API/NavigatorLanguage)
 ...
 * Prefer setting the [`lang` attribute](https://developer.mozilla.org/docs/Web/HTML/Global_attributes/lang) on the root `html` element.
 *
 ...
 * @since 4.16
 * @see [More info on locale on MDN Web Docs](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Intl#Locale_identification_and_negotiation)
 * @see [getLocale()](https://developers.arcgis.com/javascript/latest/references/core/intl/#getLocale)
 * @see [onLocaleChange()](https://developers.arcgis.com/javascript/latest/references/core/intl/#onLocaleChange)
 * @example
 ...
 * > [!WARNING]
 * >
 * > Internally `substitute` creates [Intl formatter](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Intl) instances for the current locale.
