...
import type LayerOptions from "./popup/LayerOptions.js";
import type { ClonableMixin } from "./core/Clonable.js";
import type { JSONSupport } from "./core/JSONSupport.js";
import type { PopupTemplateContent, PopupTemplateContentCreated, PopupTemplateCreatorEvent, PopupTemplateTitle } from "./popup/types.js";
import type { ContentProperties } from "./popup/content/Content.js";
import type { PopupAction } from "./widgets/Popup/types.js";
...
import type { ExpressionInfoProperties } from "./popup/ExpressionInfo.js";
import type { FieldInfoProperties } from "./popup/FieldInfo.js";
import type { LayerOptionsProperties } from "./popup/LayerOptions.js";

export interface PopupTemplateProperties extends Partial<Pick<PopupTemplate, "lastEditInfoEnabled" | "outFields" | "overwriteActions" | "returnGeometry" | "title">> {
  /**
   * A [Collection](https://developers.arcgis.com/javascript/latest/references/core/core/Collection/) of [action](https://developers.arcgis.com/javascript/latest/references/core/support/actions/ActionButton/) or [action toggle](https://developers.arcgis.com/javascript/latest/references/core/support/actions/ActionToggle/) objects.
   ...
   * let zoomOutAction = new ActionButton({
   ...
   * });
   */
  actions?: ReadonlyArrayOrCollection<((ActionButtonProperties & { type: "button" }) | (ActionToggleProperties & { type: "toggle" }))> | null;
  /**
   ...
   * @see [Sample - Custom popup content](https://developers.arcgis.com/javascript/latest/sample-code/popup-customcontent/)
   * @example
   ...
   * };
   */
  content?: PopupTemplateContentCreated | ContentProperties[] | Promise<PopupTemplateContentCreated | ContentProperties[]> | ((event: PopupTemplateCreatorEvent) => PopupTemplateContentCreated | ContentProperties[] | Promise<PopupTemplateContentCreated | ContentProperties[]>) | null;
  /**
   * An array of objects or [ExpressionInfo[]](https://developers.arcgis.com/javascript/latest/references/core/popup/ExpressionInfo/) that reference
  ...
  /**
   * An array of [FieldInfo](https://developers.arcgis.com/javascript/latest/references/core/popup/FieldInfo/) that defines how fields in the dataset
...
/**
 * A PopupTemplate formats and defines the content of a [Popup](https://developers.arcgis.com/javascript/latest/references/core/widgets/Popup/) for
 ...
 * @see [FieldInfo](https://developers.arcgis.com/javascript/latest/references/core/popup/FieldInfo/)
 * @see [Map component popup](https://developers.arcgis.com/javascript/latest/references/map-components/components/arcgis-map/#popup)
 * @see [Scene component popup](https://developers.arcgis.com/javascript/latest/references/map-components/components/arcgis-scene/#popup)
 * @see [Link Chart component popup](https://developers.arcgis.com/javascript/latest/references/map-components/components/arcgis-link-chart/#popup)
 * @see [MapView.popup](https://developers.arcgis.com/javascript/latest/references/core/views/MapView/#popup)
 * @see [SceneView.popup](https://developers.arcgis.com/javascript/latest/references/core/views/SceneView/#popup)
 * @see [PopupTemplate samples](https://developers.arcgis.com/javascript/latest/sample-code/?tagged=PopupTemplate)
 * @see [Popup samples](https://developers.arcgis.com/javascript/latest/sample-code/?tagged=popup)
 */
export default class PopupTemplate extends PopupTemplateSuperclass {
  constructor(properties?: PopupTemplateProperties);
  /**
   * A [Collection](https://developers.arcgis.com/javascript/latest/references/core/core/Collection/) of [action](https://developers.arcgis.com/javascript/latest/references/core/support/actions/ActionButton/) or [action toggle](https://developers.arcgis.com/javascript/latest/references/core/support/actions/ActionToggle/) objects.
   * Each object represents an action or function that may be executed by clicking the icon
   * or image symbolizing them in the [Popup](https://developers.arcgis.com/javascript/latest/references/core/widgets/Popup/). By default, every
   ...
   * });
   */
  get actions(): Collection<PopupAction> | null | undefined;
  set actions(value: ReadonlyArrayOrCollection<((ActionButtonProperties & { type: "button" }) | (ActionToggleProperties & { type: "toggle" }))> | null | undefined);
  /**
   * The template for defining and formatting a popup's content.
   *
   * * **String** - A popup's content can be a simple text or string value referencing field
   ...
   * };
   */
  get content(): PopupTemplateContent | null | undefined;
  set content(value: PopupTemplateContentCreated | ContentProperties[] | Promise<PopupTemplateContentCreated | ContentProperties[]> | ((event: PopupTemplateCreatorEvent) => PopupTemplateContentCreated | ContentProperties[] | Promise<PopupTemplateContentCreated | ContentProperties[]>) | null | undefined);
  /**
   * An array of objects or [ExpressionInfo[]](https://developers.arcgis.com/javascript/latest/references/core/popup/ExpressionInfo/) that reference
   * [Arcade](https://developers.arcgis.com/javascript/latest/arcade/) expressions following
   * the specification defined by the [Arcade Popup Profile](https://developers.arcgis.com/javascript/latest/arcade/#popup).
   ...
   * @since 4.10
   */
  accessor lastEditInfoEnabled: boolean;
  /**
   * Additional options that can be defined for the popup layer.
   *
   * @since 4.5
   */
  get layerOptions(): LayerOptions | null | undefined;
  set layerOptions(value: LayerOptionsProperties | null | undefined);
  /**
   ...
   *
   * @since 4.9
   * @see [FeatureLayer.outFields](https://developers.arcgis.com/javascript/latest/references/core/layers/FeatureLayer/#outFields)
   * @example
  ...
  /**
   * Indicates whether actions should replace existing [popup actions](https://developers.arcgis.com/javascript/latest/references/core/widgets/Popup/#actions).
   *
   * @default false
   * @example
   ...
   */
  accessor overwriteActions: boolean;
  /**
   * Indicates whether to include the feature's geometry for use by the template. This
   ...
   *
   * @default ""
   * @see [content](https://developers.arcgis.com/javascript/latest/references/core/PopupTemplate/#content)
   * @see [Sample - Create a FeatureLayer with client-side graphics (popupTemplate.title returns a promise)](https://developers.arcgis.com/javascript/latest/sample-code/layers-featurelayer-collection/)
   * @example
   ...
   * };
   */
  accessor title: PopupTemplateTitle;
}
declare const PopupTemplateSuperclass: typeof JSONSupport & typeof ClonableMixin