...
export interface AbortOptions {
   ...
   *   See also [AbortController](https://developer.mozilla.org/docs/Web/API/AbortController) for more information on how to construct a controller that
 ...
 * due to [abort signals](https://developer.mozilla.org/docs/Web/API/AbortSignal) should reject with this kind
 * of error.
 *
 ...
 * promise rejected. This is similar to the native [`Promise.allSettled`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise/allSettled)
