 ...
 * from the Collection.
 *
 * As of version 4.18, you can iterate through the items of a Collection using [for...of](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Statements/for...of).
 *
 * ```js
...
export default class Collection<T = any> extends EventedAccessor {
   ...
   * @since 4.23
   * @see [Array.prototype.at()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/at)
   * @example
   ...
   * @see [Array.prototype.concat()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/concat)
   * @example
   ...
   * @see [Array.prototype.every()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/every)
   * @example
   ...
   * @see [Array.prototype.filter()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/filter)
   * @example
   ...
   * @see [Array.prototype.find()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/find)
   * @example
   ...
   * @see [Array.prototype.findIndex()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/findIndex)
   * @example
   ...
   * @param callback - The function to call for each item in the Collection.
   * @param thisArg - Value to use as `this` when executing `callback`.
   * @see [Array.prototype.forEach()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/forEach)
   * @example
   ...
   * @see [Array.prototype.includes()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/includes)
   * @example
   ...
   *                  there is no match.
   * @see [Array.prototype.indexOf()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/indexOf)
   * @example
   ...
   * @see [Array.prototype.join()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/join)
   * @example
   ...
   *                  there is no match.
   * @see [Array.prototype.lastIndexOf()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/lastIndexOf)
   * @example
   * // index is the index of the first graphic in the
   * // graphics layer that matches the input graphic
   ...
   * @see [Array.prototype.map()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/map)
   * @example
   ...
   * @see [Array.prototype.pop()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/pop)
   * @example
   ...
   * @see [Array.prototype.push()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/push)
   * @example
   ...
   * @see [Array.prototype.reduce()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/Reduce)
   ...
   * @param initialValue - Item to use as the first element to process in `callback`.
   * @returns Returns the value representing the reduction of the Collection's items.
   * @see [Array.prototype.reduceRight()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/ReduceRight)
   ...
   * @see [Array.prototype.reverse()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/reverse)
   * @example
   ...
   * @see [Array.prototype.shift()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/shift)
   * @example
   ...
   *                                       specified range.
   * @see [Array.prototype.slice()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/slice)
   * @example
   ...
   * @see [Array.prototype.some()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/some)
   * @example
   ...
   * @see [Array.prototype.sort()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/sort)
   * @example
   ...
   * @see [Array.prototype.splice()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/splice)
   * @example
   ...
   * @returns The new length of the collection.
   * @see [Array.prototype.unshift()](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/unshift)
   * @example
