 ...
 * [primitive type](https://developer.mozilla.org/docs/Web/JavaScript/Data_structures#Primitive_values),
 ...
 * or a [JavaScript Promise](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)
 ...
 * chuck of memory with [ArrayBuffers](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer),
 * a [MessagePort](https://developer.mozilla.org/docs/Web/API/MessagePort),
 * or an [ImageBitmap](https://developer.mozilla.org/docs/Web/API/ImageBitmap).
 *
 * > [!CAUTION]
 * >
 * > **Note**
 ...
 * > (technically speaking, using the `[Transferable]` [WebIDL](https://developer.mozilla.org/docs/Glossary/WebIDL)
 * > extended attribute). See also [Transferable objects](https://developer.mozilla.org/docs/Web/API/Web_Workers_API/Transferable_objects).
 *
 ...
 * Then we recreate a [Float64Array](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Float64Array) back from the returned buffer.
 *
 * ```js
 * // Module loaded in main thread
