...
import type PortalItemResource from "../../portal/PortalItemResource.js";
...
/**
 * @param portalItemResource - The PortalItemResource instance.
 * @returns The relative URL to the item resource, or null if it cannot be determined.
 * @internal
 * @since 5.1
 * @internal
 */
export function getPortalItemResourceRelativeUrl(portalItemResource: PortalItemResource): string | null | undefined;