...
/**
 * Load all standard feature templates for a layer
 *
 * @param layer
 * @returns An array of standard feature templates for the layer. Returns an empty array if the layer does not support feature templates or if no standard templates are available.
 * @internal
 * @internal
 */
export function getAllStandardFeatureTemplatesForLayer(layer: unknown): FeatureTemplate[];