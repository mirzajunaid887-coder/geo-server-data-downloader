...
export default abstract class ActionBase extends ActionBaseSuperclass {
   ...
   *
   * @deprecated since version 5.1. Use the `icon` property to set a Calcite icon instead.
   */
   ...
   *
   * @deprecated since 5.1. We can remove this for 6.0 - https://devtopia.esri.com/WebGIS/arcgis-js-api/issues/78974
   * @param className - The CSS class name to set on the action button.
   * @internal
   */
  _internalSetClassName(className: string | null | undefined): this;
  /**
