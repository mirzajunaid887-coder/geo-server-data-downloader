...
async function o2(o3) {
  var _a;
  const a2 = "portalItem" in o3 ? o3 : { portalItem: o3 }, { fromItem: e } = await import("./portalLayers-JJ7WEQKI.js");
  try {
    return await e(a2);
  } catch (p2) {
...
var b = class extends n2(o(u)) {
  ...
  static async fromArcGISServerUrl(t) {
    ...
    return (await import("./arcgisLayers-2TIWPO4H.js")).fromUrl(e);
  }
...
//# sourceMappingURL=chunk-GMGGQLGH.js.map
