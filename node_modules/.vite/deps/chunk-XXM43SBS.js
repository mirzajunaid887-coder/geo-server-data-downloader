...
var g2 = class _g {
  ...
  toUnitRGBA(t) {
    return t ?? (t = [0, 0, 0, 0]), t[0] = this.r / 255, t[1] = this.g / 255, t[2] = this.b / 255, t[3] = null != this.a ? this.a : 1, t;
  }
  constructor(t) {
  ...
  setColor(t) {
    ...
    else if (B(t)) _g.fromArray(t, this);
    else {
      const r2 = t;
  ...
  toHex(t) {
    const r2 = (t == null ? void 0 : t.capitalize) ?? false, s3 = (t == null ? void 0 : t.digits) ?? 6, i = 3 === s3 || 4 === s3, h2 = 4 === s3 || 8 === s3, e = `#${u(this.r, i)}${u(this.g, i)}${u(this.b, i)}${h2 ? u(Math.round(255 * this.a), i) : ""}`;
...
//# sourceMappingURL=chunk-XXM43SBS.js.map
