...
var p = class _p {
  ...
  _setVertexTransformer() {
    ...
    this._transformInPlace ?? (this._transformInPlace = e2(this.featureSet, r2));
  }
  feature() {
    var _a;
    this._attributesClass ?? (this._attributesClass = t(((_a = this.featureSet.fields) == null ? void 0 : _a.map((t3) => t3.name)) ?? [])), this.featureSet.features.push(new d(e(), null, new this._attributesClass())), this._options.applyTransform && this._setVertexTransformer();
  }
  finishFeature() {
  ...
  geometry(t3, e3, s2) {
    ...
    switch (a ?? (a = false), n ?? (n = false), this._vertex = [0, 0], a && this._vertex.push(0), n && this._vertex.push(0), this._finishVertex = _p._finishVertexNonPoint, e3) {
...
var t2 = class {
  _parseFeatureQuery(t3) {
    var _a;
    const s2 = new p(t3.options), i2 = r(t3.buffer, s2), o = { ...i2, spatialReference: (_a = i2.spatialReference) == null ? void 0 : _a.toJSON(), fields: i2.fields ? i2.fields.map((e3) => e3.toJSON()) : void 0, missingAttributes: s2.missingAttributes };
...
//# sourceMappingURL=PBFDecoderWorker-HUHUQOHV.js.map
