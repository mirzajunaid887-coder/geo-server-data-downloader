...
function g(e2, s2, o2) {
  ...
  for (let u3 = 0; u3 < l3.length; u3++) {
    ...
    if (null == e3) continue;
    const c5 = ((_a2 = i2 == null ? void 0 : i2[u3]) == null ? void 0 : _a2.minValue) ?? b2[0], m3 = ((_b = i2 == null ? void 0 : i2[u3]) == null ? void 0 : _b.maxValue) ?? b2[1];
...
var c3 = (_a = class extends n2 {
  ...
  getPlaneCount() {
    var _a2;
    return (_a2 = this.pixels) == null ? void 0 : _a2.length;
  }
  addData(t2) {
  ...
  extractBands(t2) {
    ...
    const n4 = ((_a2 = this.bandMasks) == null ? void 0 : _a2.length) === i2 ? t2.map((t3) => this.bandMasks[t3]) : void 0;
    let { mask: o2, validPixelCount: a4 } = this;
    const { width: h2, height: c4 } = this;
    return (n4 == null ? void 0 : n4.length) && (o2 = p.combineBandMasks(n4), a4 = o2.filter((t3) => !!t3).length), new p({ pixelType: this.pixelType, width: h2, height: c4, mask: o2, bandMasks: n4, validPixelCount: a4, maskIsAlpha: this.maskIsAlpha, pixels: t2.map((t3) => e2[t3]), statistics: s2 && t2.map((t3) => s2[t3]) });
  }
  clone() {
  ...
  _fillFrom8Bit(t2) {
    ...
    if (!t2 || !(r3 == null ? void 0 : r3.length)) return void n.getLogger(this).error("getAsRGBA()", "Unable to convert to RGBA. The input pixel block is empty.");
    let n4, o2, a4, h2;
  ...
  _fillFromNon8Bit(t2) {
    ...
    if (!t2 || !(e2 == null ? void 0 : e2.length)) return void n.getLogger(this).error("getAsRGBA()", "Unable to convert to RGBA. The input pixel block is empty.");
  ...
  _fillFrom32Bit(t2) {
    ...
    if (!t2 || !(e2 == null ? void 0 : e2.length)) return n.getLogger(this).error("getAsRGBAFloat()", "Unable to convert to RGBA. The input pixel block is empty.");
    let i2, r3, n4, o2;
...
//# sourceMappingURL=chunk-F4XFGC2I.js.map
