import {
  SLOTS as SLOTS2,
  isActionGroup
} from "./chunk-AVWXPOIP.js";
import {
  useCancelable
} from "./chunk-GEU4PNAZ.js";
import {
  SLOTS
} from "./chunk-DO4TXN5V.js";
import "./chunk-ZSYEQI2B.js";
import "./chunk-AKKV4XIA.js";
import "./chunk-RPDTW6Z3.js";
import {
  debounce
...
import {
  isAction
} from "./chunk-2PWVUYZS.js";
import "./chunk-HCJXIPRV.js";
...
var ExpandToggle = ({ collapseText, collapseLabel, direction, expanded, expandText, expandLabel, toggle, el, position, tooltip, ref: ref$1, scale }) => {
...
var _ActionBar = class _ActionBar extends LitElement {
  ...
  renderExpandTooltipSlot() {
    return html`<slot name=${SLOTS3.expandTooltip} @slotchange=${this.handleTooltipSlotChange}></slot>`;
  }
  renderExpandToggle() {
    const { el, expanded, toggleExpand, messages, position, scale } = this;
    return ExpandToggle({ collapseLabel: messages.collapseLabel, collapseText: messages.collapse, direction: this.direction, el, expanded, expandLabel: messages.expandLabel, expandText: messages.expand, position, ref: this.setExpandToggleEl, scale, toggle: toggleExpand, tooltip: this.expandTooltip });
  }
  renderActionsGroup(position) {
    ...
    const slotName = isStart ? SLOTS3.actionsStart : SLOTS3.actionsEnd;
...
//# sourceMappingURL=calcite-action-bar-SGQJCVPJ.js.map
