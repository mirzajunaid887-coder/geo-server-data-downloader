...
var n2 = class extends y {
  constructor(t) {
    ...
    if (t.copy) {
      ...
      return __super(s2, t.copy.N, t.copy.M), this.buffer = s2, void this.assignCopy(t.copy);
    }
    const s = new Float64Array(t.NN * t.MM);
    __super(s, t.NN, t.MM), this.buffer = s, t.initializerList && Dt(this.buffer, t.initializerList, 0, 0, t.initializerList.length);
  }
  assignCopy(t) {
...
var x = class _x {
  constructor(t) {
    __publicField(this, "m_TransformationType", 1);
    ...
    void 0 === t ? this.setIdentity() : t instanceof _x ? this.set(t) : this.setScale(t);
  }
  set(t) {
  ...
  initializeFromTwoPointsArray(t, o) {
    ...
    const i = li.distance(t[0], t[1]), h = li.distance(o[0], o[1]), r = h / i;
    this.scale(r, r);
    const a = t[1].sub(t[0]);
    a.divThis(i);
    const l = o[1].sub(o[0]);
  ...
  invertPreciseThis() {
    const t = ii.constructDouble(this.xy), s = ii.constructDouble(this.xx), o = s.mulDouble(this.yy).sub(t.mulDouble(this.yx));
    if (o.isZero()) return this.setZero(), this;
    const i = o.clone();
    i.invertThis();
    const e = ii.constructDouble(this.xd), h = t.mulDouble(this.yd).sub(e.mulDouble(this.yy)).mul(i).toDouble(), a = e.mulDouble(this.yx).sub(s.mulDouble(this.yd)).mul(i).toDouble(), l = i.mulDouble(this.yy).toDouble(), y2 = i.mulDouble(-this.xy).toDouble(), n3 = i.mulDouble(-this.yx).toDouble(), x2 = i.mulDouble(this.xx).toDouble();
  ...
  calculateErrors(s, o, i, h) {
    ...
    let r = 0;
    for (let t = 0; t < s; ++t) {
      const s2 = this.transform(o[t]), a = li.sqrDistance(i[t], s2);
...
function C(t, s, i, h, r) {
  const a = li.average(i, s), l = li.average(h, s), y2 = new n2({ NN: 2, MM: 2 });
  y2.setZero();
  ...
  y2.pseudoInverse(w2, true) || P("Failed to compute pseudo inverse"), x2.mul(w2, x2), u(t, x2);
  const C2 = a.clone();
  t.transformInPlace(C2), t.xd = l.x - C2.x, t.yd = l.y - C2.y, r && (x2.pseudoInverse(w2, false) || P("Failed to compute pseudo inverse"), u(r, w2), r.transformInPlace(l), r.xd = a.x - l.x, r.yd = a.y - l.y);
}
function f(s, i, h, r, a, l) {
  n(1 === s || 0 === s || 2 === s || 3 === s), i.setIdentity();
  const y2 = li.average(r, h), C2 = li.average(a, h);
  if (n(s < w.length && s > 0), 8 & w[s]) {
    ...
    t.svd(e, l2, f3) || P("Failed to compute svd");
...
//# sourceMappingURL=chunk-QJ5IPXDT.js.map
