...
async function i() {
  if (!o()) {
    const [n2, o2] = await Promise.all([import("./OperatorGeodeticArea-TQEAC3RW.js"), import("./SpatialReference-S7XEVCCE.js").then((e2) => e2.aP).then(({ injectPe: e2 }) => e2), P()]);
...
async function m() {
  if (!c()) {
    const [e2] = await Promise.all([import("./apiConverter-HFIQ4ABJ.js"), i()]);
...
//# sourceMappingURL=chunk-TFEZFTVY.js.map
