...
var I = d = class extends l2 {
  static ofType(t3) {
    ...
    return __decorate([n2({ Type: t3, ensureType: "function" == typeof t3 ? w(t3) : x(t3) })], i.prototype, "itemType", void 0), i = __decorate([l(`esri.core.Collection<${s2}>`)], i), B2.set(t3, i), i;
  }
  ...
  normalizeCtorArgs(e3) {
    return e3 ? B(e3) || e3 instanceof d ? { items: e3 } : e3 : {};
  }
  destroy() {
  ...
  *[Symbol.iterator]() {
  ...
  set items(e3) {
    this._emitBeforeChanges(1) || (this._splice(0, this.length, A2(e3)), this._emitAfterChanges(1));
  }
  hasEventListener(e3) {
  ...
  addMany(e3, t3 = this._items.length) {
    ...
    return this._splice(s2, 0, A2(e3)), this._emitAfterChanges(1), this;
  }
  at(e3) {
...
//# sourceMappingURL=chunk-RVQ2R4Y7.js.map
