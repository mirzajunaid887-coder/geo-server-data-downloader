...
var d = class extends r {
  constructor(s, r3) {
    super(`${e}-layer:upload-failed`, `Failed to upload mesh file ${s}. Error code: ${(r3 == null ? void 0 : r3.code) ?? "-1"}. Error message: ${(r3 == null ? void 0 : r3.messages) ?? "unknown"}`, o());
  }
};
...
//# sourceMappingURL=chunk-CWPYGRU7.js.map
