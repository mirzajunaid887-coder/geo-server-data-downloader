...
var s = class extends n2 {
  constructor() {
    super(...arguments), this.vertex = new c(), this.fragment = new c(), this.attributes = new h(), this.varyings = new m(), this.outputs = new l();
  }
  get attributeNames() {
  ...
  generate(e, t = false) {
    const r3 = this.attributes.generateSource(e), n3 = this.varyings.generateSource(e), s2 = "vertex" === e ? this.vertex : this.fragment, i2 = s2.uniforms.generateSource(), o2 = s2.code.generateSource(), a2 = s2.main.generateSource(t), u2 = this.debugName ? `// ${this.debugName}
` : "", c2 = "vertex" === e ? _ : p, h2 = s2.constants.generateSource(), m2 = this.outputs.generateSource(e);
...
${a2.join("\n")}`;
  ...
  generateBindDraw(e) {
    ...
    const r3 = Array.from(t.values()), n3 = r3.length;
    return (t2, s2, i2) => {
      for (let o2 = 0; o2 < n3; ++o2) r3[o2](e, i2, t2, s2);
    };
  }
};
var i = class {
...
var o = class {
  ...
  add(t, r3) {
    if (this._entries.has(t)) throw new r("shaderbuilder:duplicate-input", `Duplicate input for ${t}`);
    this._entries.set(t, r3);
  }
  get(t) {
    const r3 = this._entries.get(t);
    if (null == r3) throw new r("shaderbuilder:input-resolver-error", `No resolver for input ${t} found.`);
    return r3();
  }
};
var a = class {
...
var c = class extends n2 {
  constructor() {
    super(...arguments), this.uniforms = new i(this), this.main = new a(this), this.code = new u(this), this.constants = new d(this), this.inputs = new o();
  }
  get builder() {
    return this;
  }
...
var m = class {
  ...
  add(e, t, n3) {
    this._entries.has(e) ? r2().warn(`Ignoring duplicate varying ${t} ${e}`) : this._entries.set(e, { type: t, invariant: (n3 == null ? void 0 : n3.invariant) ?? false });
  }
  generateSource(e) {
    const t = new Array();
...
var _l = class _l {
  ...
  add(e, t, n3 = 0) {
    ...
    (s2 == null ? void 0 : s2.name) !== e || (s2 == null ? void 0 : s2.type) !== t ? this._entries.set(n3, { name: e, type: t }) : r2().warn(`Fragment shader output location ${n3} occupied`);
  }
  generateSource(e) {
    if ("vertex" === e) return [];
...
_l.DEFAULT_TYPE = "vec4";
_l.DEFAULT_NAME = "fragColor";
var l = _l;
var d = class _d {
  constructor(e) {
...
//# sourceMappingURL=chunk-X7QEPCUU.js.map
