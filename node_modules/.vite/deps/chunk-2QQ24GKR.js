...
function p(r, t, o) {
  return v(r.map((r2, e2) => t.apply(o, [r2, e2])));
}
async function h(r, t, o) {
  return (await v(r.map((r2, e2) => t.apply(o, [r2, e2])))).map((r2) => r2.value);
}
function m3(r) {
...
var k = class extends b {
  ...
  constructor(r, t) {
    super({}), this._result = null, this._abortHandle = null, this.abort = () => {
      this._abortController = l(this._abortController);
    ...
    this.promise = r(o), this.promise.then((r2) => {
      this._result = m3(r2), this._cleanup();
    }, (r2) => {
...
__decorate([m2()], k.prototype, "value", null), __decorate([m2()], k.prototype, "error", null), __decorate([m2()], k.prototype, "finished", null), __decorate([m2()], k.prototype, "promise", void 0), __decorate([m2()], k.prototype, "_result", void 0), k = __decorate([l2("esri.core.asyncUtils.ReactiveTask")], k);
var C = class {
  constructor() {
...
//# sourceMappingURL=chunk-2QQ24GKR.js.map
