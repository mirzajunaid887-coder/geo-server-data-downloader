...
function d(d2, r) {
  if (11 !== r.output) return d2.vertex.code.add(t`void forwardObjectAndLayerIdColor() {}`), void d2.fragment.code.add(t`void outputObjectAndLayerIdColor() {}`);
  const e = r.instanced;
...
//# sourceMappingURL=chunk-F6VYKY5P.js.map
