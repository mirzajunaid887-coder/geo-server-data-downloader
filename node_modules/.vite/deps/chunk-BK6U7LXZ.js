...
var i = class {
  ...
  async fetchResource(e, i2) {
    ...
    return r ? r.then((e2) => ({ width: e2.width, height: e2.height })) : (r = p(e, i2), this._inFlightResourceMap.set(e, r), r.then((t) => (this._inFlightResourceMap.delete(e), this._resourceMap.set(e, t), { width: t.width, height: t.height }), () => (this._inFlightResourceMap.delete(e), { width: 0, height: 0 })));
  }
  deleteResource(e) {
...
//# sourceMappingURL=chunk-BK6U7LXZ.js.map
