...
function c3(e, o, s) {
  var _a;
  const r = ((_a = s == null ? void 0 : s.createCollection) == null ? void 0 : _a.call(s)) ?? new q(), n = !!(s == null ? void 0 : s.recycleItems) ? new d2() : null, i2 = (e2, t = 0) => {
    ...
    r.addMany(s2, t);
  }, l3 = a(e, "after-splice", ({ added: e2, start: t, removed: o2 }) => {
    i2(o2, t), c4(e2, t);
  }, { sync: true, onListenerRemove: (e2) => i2(e2.items), onListenerAdd: (e2) => c4(e2.items) });
...
function u(s, a2, d3) {
  const l3 = new q(), u2 = c3(s, (t) => w(async (e) => {
    const o = await a2(t, e);
    if (c2(e)) throw m(o), i();
    return o;
  }), d3), f = () => null, g = async (e) => {
    const t = await e.promise, o = u2.indexOf(e);
    o < 0 || l3.splice(o, 1, t);
  };
  l3.addMany(u2.items.map(f));
  for (const e of u2) d(g(e));
  const h = u2.on("after-splice", ({ added: e, start: t, deleteCount: o }) => {
    const s2 = l3.splice(t, o);
    for (const r of s2) m(r);
    if (e == null ? void 0 : e.length) {
      l3.addMany(e.map(f), t);
      for (const t2 of e) d(g(t2));
    }
  });
  return l3.addHandles([c(u2), h]), l3;
}
...
//# sourceMappingURL=chunk-NBX42F3E.js.map
