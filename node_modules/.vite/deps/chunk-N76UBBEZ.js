...
var m2 = a4 = class extends s {
  ...
  writeColorRamps(o2, r3, t, e) {
    const s2 = o2 == null ? void 0 : o2.map((o3) => o3.toJSON(e)), { weights: p2 } = this;
    if (s2 && (p2 == null ? void 0 : p2.length) && s2.length === (p2 == null ? void 0 : p2.length)) {
...
function p(o2) {
  return (o2 == null ? void 0 : o2.type) ? "algorithmic" === o2.type ? a3.fromJSON(o2) : "multipart" === o2.type ? m2.fromJSON(o2) : null : null;
}
...
//# sourceMappingURL=chunk-N76UBBEZ.js.map
