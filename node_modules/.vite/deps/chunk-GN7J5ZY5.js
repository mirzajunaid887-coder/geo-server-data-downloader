...
var s = class extends b {
  ...
  get isAdvanced() {
    ...
    return (t == null ? void 0 : t.length) > 1 && !Number.isNaN(o2) && (e == null ? void 0 : e.length) > 1 && (i2 == null ? void 0 : i2.length) > 1 && (r == null ? void 0 : r.length) > 1;
  }
};
...
var s2 = class extends l(a2(n2)) {
  ...
  toString() {
    ...
    return this.isAdvanced && (f2 == null ? void 0 : f2.forEach((o3) => d2.push(o3)), d2.push(y2), c3 == null ? void 0 : c3.forEach((o3) => d2.push(o3)), m2 == null ? void 0 : m2.forEach((o3) => d2.push(o3)), u2 == null ? void 0 : u2.forEach((o3) => d2.push(o3))), d2.map((o3) => Number.isNaN(o3) ? "" : o3).join("|");
  }
};
...
var s4 = class extends l(a2(n2)) {
  ...
  toString() {
    ...
    return this.isAdvanced && (f2 == null ? void 0 : f2.forEach((o3) => d2.push(o3)), d2.push(y2), m2 == null ? void 0 : m2.forEach((o3) => d2.push(o3)), c3 == null ? void 0 : c3.forEach((o3) => d2.push(o3)), u2 == null ? void 0 : u2.forEach((o3) => d2.push(o3))), d2.map((o3) => isNaN(o3) ? "" : o3).join("|");
  }
};
...
var s5 = class extends l(a2(n2)) {
  ...
  get isAdvanced() {
    ...
    return (t == null ? void 0 : t.length) > 1 || !Number.isNaN(o2) || (e == null ? void 0 : e.length) > 1 || (r == null ? void 0 : r.length) > 1 || (i2 == null ? void 0 : i2.length) > 1;
  }
  toString() {
    ...
    return this.isAdvanced && (f2 == null ? void 0 : f2.forEach((t2) => u2.push(t2)), u2.push(c3), y2 == null ? void 0 : y2.forEach((t2) => u2.push(t2)), y2 == null ? void 0 : y2.forEach((t2) => u2.push(t2)), m2 == null ? void 0 : m2.forEach((t2) => u2.push(t2)), l4 == null ? void 0 : l4.forEach((t2) => u2.push(t2))), u2.map((t2) => Number.isNaN(t2) ? "" : t2).join("|");
  }
};
...
function a3(e, t, r) {
  let { url: n7 } = e;
  return n7 ? (n7 = l3(n7, t, r), new i({ ...e, url: n7 })) : null;
}
function c2(e, t, r) {
...
var m = new o({ 360: "360", Horizontal: "horizontal", Inspection: "inspection", Nadir: "nadir", Oblique: "oblique", Terrestrial360Video: "terrestrial-360-video", TerrestrialFrameVideo: "terrestrial-frame-video", Aerial360Video: "aerial-360-video", AerialFrameVideo: "aerial-frame-video", "": null });
var d = /* @__PURE__ */ new Map();
function p2(e) {
  const [t, r, n7, o2, i2, s7, l4, a4, c3, u2, f2, m2, d2, p3, h2, w2, y2, v2, D, L2, C2, z] = e.slice(1);
  return { horizontalWKID: t, verticalWKID: r, x: n7, y: o2, z: i2, omega: s7, phi: l4, kappa: a4, ...g([c3, u2, f2, m2, d2, p3], [w2, y2], [v2, D, L2], [C2, z], h2) };
}
d.set("1", w), d.set("3", y), d.set("2", p2), d.set("4", v);
var h = (e) => {
  const t = e.map((e2) => parseFloat(e2)).filter((e2) => !isNaN(e2));
  if (t.length === e.length) return t;
};
function g(e, t, r, n7, o2) {
  const i2 = h(e), s7 = h(t), l4 = h(r), a4 = h(n7);
  return { affineTransformations: 6 === (i2 == null ? void 0 : i2.length) ? i2 : void 0, focalLength: 6 === (i2 == null ? void 0 : i2.length) ? parseFloat(o2) : void 0, principalOffsetPoint: 2 !== (s7 == null ? void 0 : s7.length) ? [0, 0] : s7, radialDistortionCoefficients: 3 !== (l4 == null ? void 0 : l4.length) ? [0, 0, 0] : l4, tangentialDistortionCoefficients: 2 !== (a4 == null ? void 0 : a4.length) ? [0, 0] : a4 };
}
function w(e) {
  const [t, r, n7, o2, i2, s7, l4, a4, c3, u2, f2, m2, d2, p3, h2, w2, y2, v2, D, L2, C2, z] = e.slice(1);
  return { horizontalWKID: t, verticalWKID: r, x: n7, y: o2, z: i2, heading: s7, pitch: l4, roll: a4, ...g([c3, u2, f2, m2, d2, p3], [w2, y2], [v2, D, L2], [C2, z], h2) };
}
function y(e) {
  const [t, r, n7, o2, i2, s7, l4, a4, c3, u2, f2, m2, d2, p3, h2, w2, y2, v2, D, L2, C2, z] = e.slice(1);
  return { horizontalWKID: t, verticalWKID: r, x: n7, y: o2, z: i2, yaw: s7, pitch: l4, roll: a4, ...g([c3, u2, f2, m2, d2, p3], [w2, y2], [v2, D, L2], [C2, z], h2) };
}
function v(e) {
  var _a;
  const [t, r, o2, i2, s7, ...l4] = e.slice(1), a4 = d.get(s7), c3 = (_a = n6.get(s7)) == null ? void 0 : _a.constructor;
  if (!a4 || !c3) return null;
  return { latitude: t, longitude: r, ellipsoidRadius: o2, squaredEccentricity: i2, properties: new c3(a4([s7, "", ...l4])) };
}
function L(e) {
  return Array.isArray(e) && (e == null ? void 0 : e.length) > 5 && !e.some(isNaN);
}
function C(e) {
...
var W = "sequenceorder";
function j2(e, t) {
  if (!(e == null ? void 0 : e.length)) return null;
  return e.map(({ field: e2, order: r }) => {
    const n7 = t.find((t2) => t2.name.toLowerCase() === e2.toLowerCase());
    return n7 ? { fieldName: n7.name, sortOrder: "desc" === (r == null ? void 0 : r.toLowerCase()) ? "desc" : "asc" } : null;
  }).filter((e2) => null != e2);
}
function K(e, t, r) {
  const n7 = j2(r, t);
  if (n7 == null ? void 0 : n7.length) return n7;
  if (!e) {
    const e2 = t.find((e3) => e3.name.toLocaleLowerCase() === W.toLocaleLowerCase());
    return e2 ? [{ fieldName: e2.name, sortOrder: "asc" }] : null;
  }
  const o2 = t.find((t2) => t2.name.toLowerCase() === e.trim().toLowerCase());
  return o2 ? [{ fieldName: o2.name, sortOrder: "asc" }] : null;
}
...
//# sourceMappingURL=chunk-GN7J5ZY5.js.map
