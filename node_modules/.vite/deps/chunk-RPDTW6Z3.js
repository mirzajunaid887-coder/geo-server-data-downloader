...
var useTopLayer = (options) => {
  return makeGenericController((component, controller) => {
    ...
    async function togglePopover(open) {
      ...
      const isDisabled = ((_a = options.disabledOverride) == null ? void 0 : _a.call(options)) || "topLayerDisabled" in component && component.topLayerDisabled === true;
      if (isDisabled || !open) {
        opened = false;
...
var useReferenceElement = (options) => {
...
var HOVER_OPEN_DELAY_MS = 300;
var HOVER_QUICK_OPEN_DELAY_MS = HOVER_OPEN_DELAY_MS / 3;
var HOVER_CLOSE_DELAY_MS = HOVER_OPEN_DELAY_MS * 1.5;
function isDrag({
  startX,
  startY,
  endX,
...
var referenceElementManager = (options) => {
  ...
  const queryComponents = (composedPath, type) => {
    ...
    return type ? components == null ? void 0 : components.filter((component) => component.referenceElementType === type) : components;
  };
  const toggleComponents = (event, type) => {
    ...
    Array.from(registeredElements.values()).flat().filter(
      (component) => !(components == null ? void 0 : components.includes(component)) && component.autoClose && component.open && !composedPath.includes(component.el)
  ...
  const pathHasOpenHoverComponent = (components, composedPath) => {
    return (activeComponents == null ? void 0 : activeComponents.some((component) => (component == null ? void 0 : component.open) && composedPath.includes(component.el))) || (components == null ? void 0 : components.some((component) => (component == null ? void 0 : component.open) && composedPath.includes(component.el)));
  };
  const toggleHoverComponents = (components, open) => {
    components == null ? void 0 : components.forEach((component) => component.open = open);
  ...
  const hoverKeyDownHandler = (event) => {
    if (event.key === "Escape" && !event.defaultPrevented) {
      const openActiveHoverComponents = activeComponents == null ? void 0 : activeComponents.filter((component) => component == null ? void 0 : component.open);
      if (openActiveHoverComponents == null ? void 0 : openActiveHoverComponents.length) {
        clearHoverTimeout();
  ...
  const hoverClickHandler = (event) => {
    ...
    if (closeOnClickHoverComponents == null ? void 0 : closeOnClickHoverComponents.length) {
  ...
  const onReferenceElementKeyDown = (event) => {
    ...
    components == null ? void 0 : components.forEach((component) => {
      var _a;
      return (_a = component.onReferenceElementKeyDown) == null ? void 0 : _a.call(component, event);
    });
  };
  ...
  const openHoveredComponents = (components) => {
    hoverOpenTimeout = window.setTimeout(
      ...
      (activeComponents == null ? void 0 : activeComponents.some((component) => component.open)) ? HOVER_QUICK_OPEN_DELAY_MS : HOVER_OPEN_DELAY_MS
    );
  };
  ...
  const pointerMoveHandler = (event) => {
    ...
    if (components == null ? void 0 : components.some((component) => clickedComponents == null ? void 0 : clickedComponents.includes(component))) {
      return;
    }
    if (!(components == null ? void 0 : components.some((component) => hoveredComponents == null ? void 0 : hoveredComponents.includes(component)))) {
      clearHoverOpenTimeout();
    }
    hoveredComponents = components;
    if (components == null ? void 0 : components.length) {
      openHoveredComponents(components);
    } else if (activeComponents == null ? void 0 : activeComponents.some((component) => component == null ? void 0 : component.open)) {
  ...
  const updateElement = (component, referenceEl) => {
    ...
    if (options.click && "ariaExpanded" in referenceEl) {
      ...
      const existingComponentOpen = (existingComponents == null ? void 0 : existingComponents.some((component2) => component2.open)) ?? false;
  ...
  const unregisterElement = (component, referenceEl) => {
    ...
    if (options.click && "ariaControlsElements" in referenceEl) {
      const newElements = (_a = referenceEl.ariaControlsElements) == null ? void 0 : _a.filter((element) => element !== component.el);
      referenceEl.ariaControlsElements = (newElements == null ? void 0 : newElements.length) > 0 ? newElements : null;
    }
    if (options.click && "ariaExpanded" in referenceEl) {
      const hasRegisteredComponents = ((updatedComponents == null ? void 0 : updatedComponents.length) ?? 0) > 0;
      if (hasRegisteredComponents) {
        const existingComponentOpen = (updatedComponents == null ? void 0 : updatedComponents.some((component2) => component2.open)) ?? false;
    ...
    if (options.hover && "ariaDescribedByElements" in referenceEl) {
      const newElements = (_b = referenceEl.ariaDescribedByElements) == null ? void 0 : _b.filter((element) => element !== component.el);
      referenceEl.ariaDescribedByElements = (newElements == null ? void 0 : newElements.length) > 0 ? newElements : null;
    }
  };
  return {
    registerElement,
...
//# sourceMappingURL=chunk-RPDTW6Z3.js.map
