  ...
  if (!e.isEmpty()) {
    switch (e.getGeometryType()) {
      ...
      case a.enumPoint:
        return e.getXY();
      default:
        return li.construct(Number.NaN, Number.NaN);
    }
  }
  return li.construct(Number.NaN, Number.NaN);
}
...
function s(t, e, a3, u2, o2) {
  ...
  g2.subThis(i2);
  const d2 = new n(0), m2 = e.hasNonLinearSegments(), f2 = 1 / 3, h = new li();
...
function c(t, n2, r, a3) {
  let u2;
  for (n2.nextPath() || T("centroid"); null !== (u2 = n2.nextCurve()); ) {
...
function g(t) {
  const e = new n(0), a3 = new n(0), u2 = t.getImpl(), o2 = u2.getAttributeStreamRef(0), s2 = u2.getPointCount(), c2 = new li();
...
function f(t, e = -1) {
  ...
  return li.construct(a3.getResult(), u2.getResult()).mul(1 / t.getPathCount());
}
...
//# sourceMappingURL=chunk-6MP66NAP.js.map
