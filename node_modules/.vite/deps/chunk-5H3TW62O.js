...
var y3 = class extends b {
  ...
  hitTestVisualDistance(e, t) {
    ...
    if (!((_a = r2 == null ? void 0 : r2.graphic) == null ? void 0 : _a.geometry)) return null;
  ...
  _refreshSymbols() {
    for (const { graphic: e, props: t } of this._visualPropsStore.values()) {
      ...
      e.symbol = this._symbolDictionary.get(r2 == null ? void 0 : r2.type, i2, o);
    }
  }
  _updateVisual(e, t) {
    var _a, _b;
    ...
    r2.props = a2;
    let c2 = false;
    i2.geometry !== a2.geometry && (r2.graphic.geometry = a2.geometry, c2 = ((_a = i2.geometry) == null ? void 0 : _a.type) !== ((_b = a2.geometry) == null ? void 0 : _b.type)), null == i2.geometry || null != a2.geometry ? (i2.role === a2.role && i2.state === a2.state || (r2.zIndex = g(a2.role, a2.state), r2.graphic.setAttribute(n2, r2.zIndex), c2 = true), c2 && a2.geometry && (r2.graphic.symbol = this._symbolDictionary.get(a2.geometry.type, a2.role, a2.state)), null != i2.geometry || null == a2.geometry ? s !== r2.zIndex && (this._removeViewGraphic(r2.graphic), this._addViewGraphic(r2.graphic, r2.zIndex, r2.sequence)) : this._addViewGraphic(r2.graphic, r2.zIndex, r2.sequence)) : this._removeViewGraphic(r2.graphic);
  }
  get test() {
...
function u2(e, t, r2) {
  let i2 = 0, o = e.length;
  for (; i2 < o; ) {
    const s = i2 + o >>> 1, a2 = e.getItemAt(s), c2 = _(a2), h2 = v2(a2);
    c2 < t || c2 === t && h2 < r2 ? i2 = s + 1 : o = s;
  }
  return i2;
}
function _(e) {
...
//# sourceMappingURL=chunk-5H3TW62O.js.map
