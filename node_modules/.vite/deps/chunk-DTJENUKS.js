...
var s = class {
  ...
  destroy() {
    this.clear(), Y.prune(), B.prune(), w.prune(), j2.prune();
  }
  all(t2) {
    r3(this._data, t2);
  }
  ...
  remove(i) {
    ...
    for (w.clear(), j2.clear(); h || w.length > 0; ) {
      if (h || (h = w.pop(), s2 = w.data[w.length - 1], a2 = j2.pop() ?? 0, r4 = true), h.leaf && (e = j(h.children, r(i), h.children.length, h.indexHint), -1 !== e)) return h.children.splice(e, 1), w.push(h), this._condense(w), this;
      r4 || h.leaf || !g(h, o2) ? s2 ? (a2++, h = s2.children[a2], r4 = false) : h = null : (w.push(h), j2.push(a2), a2 = 0, s2 = h, h = h.children[0]);
    }
    return this;
  }
  toJSON() {
  ...
  _condense(i) {
    for (let n = i.length - 1; n >= 0; n--) {
      ...
      if (0 === e.children.length) if (n > 0) {
        ...
        s2.splice(j(s2, e, s2.length, h.indexHint), 1);
      } else this.clear();
...
var B = new r2();
var w = new r2();
var j2 = new r2({ deallocator: void 0 });
var b = class {
  constructor() {
...
var S = class extends b {
  constructor() {
    super(...arguments), this.height = 1, this.indexHint = new A();
  }
};
...
//# sourceMappingURL=chunk-DTJENUKS.js.map
