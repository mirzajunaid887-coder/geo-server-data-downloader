...
var d2 = new o({ asc: "ascending", desc: "descending" });
var m2 = class extends l(n) {
  constructor(t) {
    super(t), this.fieldName = void 0, this.fieldOrder = void 0, this.outStatistic = void 0, this.type = "pivot";
  }
};
__decorate([a({ type: String, json: { name: "pivotParameters.pivotFieldName", write: true } })], m2.prototype, "fieldName", void 0), __decorate([r(d2, { name: "pivotParameters.pivotFieldOrder" })], m2.prototype, "fieldOrder", void 0), __decorate([a({ type: p, json: { name: "pivotParameters.outStatistic", write: true } })], m2.prototype, "outStatistic", void 0), __decorate([r({ Pivot: "pivot" }, { name: "pivotType", readOnly: true })], m2.prototype, "type", void 0), m2 = __decorate([c("esri.rest.support.PivotDefinition")], m2);
var n2 = m2;
