...
var g = (_a = class extends l(n) {
  ...
  get transparent() {
    const { data: t, url: e } = this, a2 = (t2) => (t2 == null ? void 0 : t2.toLowerCase().endsWith(".png")) || (t2 == null ? void 0 : t2.toLocaleLowerCase().startsWith("data:image/png;"));
  ...
  clone(t) {
    var _a2, _b;
    const e = u(t), a2 = (_a2 = e == null ? void 0 : e.textureMap) == null ? void 0 : _a2.get(this);
    if (a2) return a2;
    const r2 = super.clone(t);
    return (_b = e == null ? void 0 : e.textureMap) == null ? void 0 : _b.set(this, r2), r2;
  }
  static from(t) {
...
//# sourceMappingURL=chunk-QBZBYCOY.js.map
