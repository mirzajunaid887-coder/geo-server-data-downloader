...
var p = class _p {
  static async create(e3, r3, i2, n) {
    ...
    const u3 = { vars: n.reduce((e4, t2) => ({ ...e4, [t2]: null }), {}), spatialReference: r3, useAsync: false }, d = s.compileScript(c, u3);
    let h2 = null;
  ...
  evaluate(t2, r3) {
    var _a;
    const i2 = (_a = r3.$view) == null ? void 0 : _a.timeZone;
    if (r3.$view) {
      let t3;
...
//# sourceMappingURL=chunk-4MZD5A6T.js.map
