...
function u(u2, c2) {
  ...
  c2.hasVVInstancing && (c2.hasVVSize || c2.hasVVColor) && d.add("instanceFeatureAttribute", "vec4"), c2.hasVVSize ? (m.uniforms.add(new e("vvSizeMinSize", (o) => o.vvSize.minSize)), m.uniforms.add(new e("vvSizeMaxSize", (o) => o.vvSize.maxSize)), m.uniforms.add(new e("vvSizeOffset", (o) => o.vvSize.offset)), m.uniforms.add(new e("vvSizeFactor", (o) => o.vvSize.factor)), m.uniforms.add(new e("vvSizeFallback", (o) => o.vvSize.fallback)), m.uniforms.add(new t3("vvSymbolRotationMatrix", (o) => o.vvSize.symbolRotationMatrix)), m.uniforms.add(new e("vvSymbolAnchor", (o) => o.vvSize.symbolAnchor)), m.code.add(t`vec3 vvScale(vec4 _featureAttribute) {
...
return vec4(vvSymbolRotationMatrix * ( vvScale(_featureAttribute) * (position + vvSymbolAnchor)), 1.0);
    ...
    `), u2.vertex.include(r2), c2.hasVVColor ? (m.constants.add("vvColorNumber", "int", t2), m.uniforms.add(new r("vvColorValues", t2, (o) => o.vvColor.values), new e3("vvColorColors", t2, (o) => o.vvColor.colors), new e2("vvColorFallback", (o) => o.vvColor.fallback, { supportsNaN: true })), c2.hasVVInstancing && (u2.vertex.include(c), u2.vertex.include(l)), m.code.add(t`
...
//# sourceMappingURL=chunk-HQUHDE7Q.js.map
