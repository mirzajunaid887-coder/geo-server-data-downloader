...
function p(t4, n3, r3) {
  ...
  for (u2 = 0; u2 < t4; u2 += 1) {
    if (i2 = n3[u2], i2 > 0) {
      if (o3.push(b2(r3, a3, i2 - 1)), 0 !== r3[a3 + i2 - 1]) throw new r("string-array-error", "Invalid string array: missing null termination.");
    } else o3.push(null);
    a3 += i2;
  }
  return o3;
...
function v(e2, t4) {
  if (!e2) return null;
  const n3 = e2[t4];
  if (o(e2)) return n3 === I ? null : n3;
  if (e(e2)) return n3 === b ? null : n3;
...
function h2(n3, r3, o3) {
  ...
  for (let s2 = 0; s2 < r3.ordering.length; s2++) {
    ...
    if (o4.count = i2.fields.count ?? 0, "String" === o4.valueType) {
      ...
      if (!F(o4.valueType)) throw new r("unsupported-value-type", "Unsupported binary valueType", { valueType: o4.valueType });
      {
...
function U(e2, t4) {
  ...
  for (const c2 of t4.ordering) {
    ...
    const e3 = { ...t4.vertexAttributes[c2], byteOffset: r3, count: u2 }, n4 = D[c2] || "_" + c2;
  ...
  if (t4.faces && a3) {
    ...
    for (const e3 of t4.ordering) {
      ...
      const n4 = { ...t4.faces[e3], byteOffset: r3, count: a3 };
  ...
  if (t4.featureAttributes && t4.featureAttributeOrder && s2) {
    ...
    for (const e3 of t4.featureAttributeOrder) {
      ...
      const n4 = { ...t4.featureAttributes[e3], byteOffset: r3, count: s2 };
...
function B(e2) {
  return F(e2) ? x[e2].BYTES_PER_ELEMENT : 0;
}
...
//# sourceMappingURL=chunk-5X6USGQX.js.map
