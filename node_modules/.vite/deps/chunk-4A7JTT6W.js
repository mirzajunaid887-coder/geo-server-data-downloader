...
_e.byteSizeHint = 2 * Uint32Array.BYTES_PER_ELEMENT + t.byteSizeHint;
var e2 = _e;
  ...
  switch (s2.type) {
    ...
    case R.HALF_FLOAT:
      if (1 === s2.count) e3.setUint16(f + s2.offset, A(o2 * r2), true);
        ...
        const E2 = n2 * Uint16Array.BYTES_PER_ELEMENT;
        e3.setUint16(f + s2.offset + E2, A(o2[n2] * r2), true);
      }
  }
}
function s(t2, o2, s2) {
...
var h = class _h {
  ...
  colliders(i2) {
    var _a;
    if (!this._colliders) {
      const t2 = i2.attributeView, s2 = E;
      let h2 = ((_a = this.referenceBounds) == null ? void 0 : _a.size) ?? 0;
...
//# sourceMappingURL=chunk-4A7JTT6W.js.map
