...
var n4 = Symbol("idFieldsProviderSymbol");
function o(o2) {
  return !!o2 && n4 in o2;
}
function i2(i3) {
...
var _a;
var j = (_a = class extends l(n2) {
  constructor(t3) {
    super(t3), this[b] = true, this.distance = null, this.isAggregate = false, this.layer = null, this.origin = null, this.sourceLayer = null, this.statisticsAggregatedIds = void 0, this._version = 0, Object.defineProperty(this, "uid", { value: e(), configurable: true }), Object.defineProperty(this, "_lastMeshTransform", { value: {}, configurable: true, writable: true, enumerable: false }), arguments.length > 1 && p(n.getLogger(this), "Graphic", { version: "4.30" });
  }
  initialize() {
  ...
  toJSON() {
    var _a2, _b, _c, _d;
    const t3 = { aggregateGeometries: T(this.aggregateGeometries), geometry: ((_a2 = this.geometry) == null ? void 0 : _a2.toJSON()) ?? null, symbol: ((_b = this.symbol) == null ? void 0 : _b.toJSON()) ?? null, attributes: t(this.attributes) ? this.attributes.toJSON() : { ...this.attributes }, popupTemplate: ((_c = this.popupTemplate) == null ? void 0 : _c.toJSON()) ?? null };
    return ((_d = this.statisticsAggregatedIds) == null ? void 0 : _d.length) && (t3.aggregateIds = [...this.statisticsAggregatedIds]), null != this.distance && (t3.distance = this.distance), t3;
  }
