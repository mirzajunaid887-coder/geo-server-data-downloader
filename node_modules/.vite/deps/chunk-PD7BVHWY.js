...
async function v(t, r2) {
  const n3 = U((await f(t, { responseType: "text", query: { SERVICE: "WFS", REQUEST: "GetCapabilities", VERSION: S2, ...r2 == null ? void 0 : r2.customParameters }, signal: r2 == null ? void 0 : r2.signal })).data);
  return D(t, n3), n3;
}
function U(e) {
  const t = te(e);
...
async function X(e, r2, n3, a = {}) {
  const o3 = e.readFeatureTypes(), s = r2 ? Y(o3, r2, n3) : o3.next().value, { spatialReference: i = new S({ wkid: s == null ? void 0 : s.defaultSpatialReference }) } = a;
...
async function q(e, r2, n3, a = {}) {
  ...
  const { fields: u, errors: l } = s.value ?? {}, c = ((_a = s.value) == null ? void 0 : _a.geometryType) || ((_b = i.value) == null ? void 0 : _b.geometryType), m2 = ((_c = i.value) == null ? void 0 : _c.swapXY) ?? false;
  ...
  return { ...z2(u ?? []), geometryType: c, swapXY: m2 };
}
function z2(e) {
  const t = e.find((e2) => "geometry" === e2.type);
  let r2 = e.find((e2) => "oid" === e2.type);
  return e = e.filter((e2) => "geometry" !== e2.type), r2 || (r2 = new m({ name: F2, type: "oid", alias: F2 }), e.unshift(r2)), { geometryField: (t == null ? void 0 : t.name) ?? null, objectIdField: r2.name, fields: e };
}
async function _(t, r2, n3, a = {}) {
  var _a;
  let o3, s = false;
  const [i, p] = await Promise.all([K(t.operations.GetFeature.url, r2, n3, t.operations.GetFeature.outputFormat, { ...a, count: 1 }), f(t.operations.GetFeature.url, { responseType: "text", query: Z(r2, n3, void 0, { ...a, count: 1 }), signal: a == null ? void 0 : a.signal })]), u = "FeatureCollection" === i.type && ((_a = i.features[0]) == null ? void 0 : _a.geometry);
  if (u) {
    let e;
...
async function J(t, r2, n3) {
  return Q(r2, (await f(t, { responseType: "text", query: { SERVICE: "WFS", REQUEST: "DescribeFeatureType", VERSION: S2, TYPENAME: r2, TYPENAMES: r2, ...n3 == null ? void 0 : n3.customParameters }, signal: n3 == null ? void 0 : n3.signal })).data);
}
function Q(e, n3) {
...
async function K(r2, n3, a, o3, s) {
  let { data: i } = await f(r2, { responseType: "text", query: Z(n3, a, o3, s), signal: s == null ? void 0 : s.signal });
...
function Z(e, t, r2, n3) {
  ...
  return { SERVICE: "WFS", REQUEST: "GetFeature", VERSION: S2, TYPENAMES: e, OUTPUTFORMAT: r2, SRSNAME: "EPSG:" + a, STARTINDEX: n3 == null ? void 0 : n3.startIndex, COUNT: n3 == null ? void 0 : n3.count, ...n3 == null ? void 0 : n3.customParameters };
}
async function ee(t, r2, n3) {
  const a = await f(t, { responseType: "text", query: { SERVICE: "WFS", REQUEST: "GetFeature", VERSION: S2, TYPENAMES: r2, RESULTTYPE: "hits", ...n3 == null ? void 0 : n3.customParameters }, signal: n3 == null ? void 0 : n3.signal }), o3 = /numberMatched=["'](?<numberMatched>\d+)["']/gi.exec(a.data);
...
function ne(e) {
  var _a;
  const r2 = (_a = e.firstElementChild) == null ? void 0 : _a.getAttribute("version");
...
function oe(e, t, r2) {
  const n3 = { wkid: t.defaultSpatialReference }, a = null != (r2 == null ? void 0 : r2.wkid) ? { wkid: r2.wkid } : n3;
...
//# sourceMappingURL=chunk-PD7BVHWY.js.map
