...
function I2(n, t) {
  const { r: r3, g: o, b: e } = (t == null ? void 0 : t.ignoreAlpha) ? n : G(n);
  return 0.2126 * r3 + 0.7152 * o + 0.0722 * e;
}
function P(t, r3 = 225) {
  return I2(t, { ignoreAlpha: true }) > r3 ? new g([0, 0, 0, t.a]) : new g([255, 255, 255, t.a]);
}
function R(n, t) {
  const r3 = q(n);
  r3.l *= 1 - t;
  const o = C(r3), e = n.clone();
...
function Q(r3, e, u = {}) {
  ...
  if (u.shuffle && (r3 = O(a(r3), u.seed)), r3.length >= e) {
...
function S(n, r3, o = {}) {
  ...
  return [...n.map((n2) => n2.clone()), ...O(e, o.seed ?? 1)];
}
var T = (n, t) => {
...
//# sourceMappingURL=chunk-UHRDRA5J.js.map
