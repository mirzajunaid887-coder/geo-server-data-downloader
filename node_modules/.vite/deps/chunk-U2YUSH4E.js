...
// node_modules/@arcgis/core/chunks/GlobalIlluminationUpscale.glsl.js
var m = 5e4;
var c4 = 100;
var g = class extends c {
};
function p() {
  const u = new s(), g2 = u.fragment;
  return u.include(o), u.include(c2), u.include(r2), g2.include(a), g2.include(c3), g2.uniforms.add(new e("depthMap", (e3) => e3.depthTexture), new e("normalMap", (e3) => e3.normalTexture), new e2("tex", (e3) => e3.colorTexture), new e2("globalIlluminationWeightTexture", (e3) => e3.weightTexture), new r("projScale", (e3, t2) => {
    const l = t2.camera.distance;
    return l > m ? Math.max(0, e3.projScale - (l - m)) : e3.projScale;
  })), g2.code.add(t`
    ...
    void sampleJointBilateralUpscale(vec2 sampleUv, out vec4 upscaledColor, out float upscaledWeight) {
      ...
      float depthSharpness = ${t.float(c4)} * globalIlluminationDepthSharpness(projScale, centerDepth, centerNormal);
  ...
  `), u.outputs.add("fragColor", "vec4", 0), u.outputs.add("fragWeight", "float", 1), g2.main.add(t`sampleJointBilateralUpscale(uv, fragColor, fragWeight);
fragColor.rgb = quantizeGlobalIlluminationColor(fragColor.rgb);`), u;
}
var d = Object.freeze(Object.defineProperty({ __proto__: null, GlobalIlluminationUpscaleDrawParameters: g, build: p }, Symbol.toStringTag, { value: "Module" }));
...
//# sourceMappingURL=chunk-U2YUSH4E.js.map
