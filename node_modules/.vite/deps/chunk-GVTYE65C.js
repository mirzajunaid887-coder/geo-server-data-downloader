...
var z = (_a2 = class extends n {
  static create(e2 = {}) {
    ...
    const f = G(i2), h = e2.origin ? new _({ x: e2.origin.x, y: e2.origin.y, spatialReference: i2 }) : new _(f ? { x: f.origin[0], y: f.origin[1], spatialReference: i2 } : { x: 0, y: 0, spatialReference: i2 }), d = 96, g = 1 / (ae(i2) * 39.37 * d), y2 = [];
  ...
  tileAt(e2, t, s, o3) {
    ...
    return o3 ?? (o3 = new e(0, 0, 0)), o3.level = e2, o3.row = Math.floor((this.origin.y - l2) / p + 1e-3), o3.col = Math.floor((i2 - this.origin.x) / n2 + 1e-3), this.updateTileInfo(o3), o3;
  }
...
//# sourceMappingURL=chunk-GVTYE65C.js.map
