...
function s() {
  return n2 || (n2 = 1, e = function() {
    return function(e2) {
      ...
      Object.defineProperty(t, "__esModule", { value: true }), t.isNotPNG = u3, t.isNotAPNG = h2, t.default = c;
      var n3 = s2(r(1)), i2 = r(2);
      function s2(e3) {
      ...
      function c(e3) {
        ...
        var n4 = [], s3 = [], u4 = null, h3 = null, c2 = 0, p2 = new i2.APNG();
        if (f(t2, function(e4, t3, r3, a3) {
          var o4 = new DataView(t3.buffer);
          switch (e4) {
            case "IHDR":
              u4 = t3.subarray(r3 + 8, r3 + 8 + a3), p2.width = o4.getUint32(r3 + 8), p2.height = o4.getUint32(r3 + 12);
              break;
            case "acTL":
        ...
        var m2 = new Blob(n4), g = new Blob(s3);
        return p2.frames.forEach(function(e4) {
          var t3 = [];
          t3.push(l2), u4.set(_(e4.width), 0), u4.set(_(e4.height), 4), t3.push(v("IHDR", u4)), t3.push(m2), e4.dataParts.forEach(function(e5) {
            return t3.push(v("IDAT", e5));
          }), t3.push(g), e4.imageData = new Blob(t3, { type: "image/png" }), delete e4.dataParts, t3 = null;
        }), p2;
      }
      function f(e3, t2) {
        var r2 = new DataView(e3.buffer), n4 = 8, i3 = void 0, s3 = void 0, a3 = void 0;
        do {
          s3 = r2.getUint32(n4), a3 = t2(i3 = p(e3, n4 + 4, 4), e3, n4, s3), n4 += 12 + s3;
      ...
      var v = function(e3, t2) {
        var r2 = e3.length + t2.length, i3 = new Uint8Array(r2 + 8), s3 = new DataView(i3.buffer);
        s3.setUint32(0, t2.length), i3.set(m(e3), 4), i3.set(t2, 8);
      ...
      Object.defineProperty(t, "__esModule", { value: true }), t.default = function(e3) {
        for (var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, n4 = -1, i3 = t2, s3 = t2 + (arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : e3.length - t2); i3 < s3; i3++) n4 = n4 >>> 8 ^ r[255 & (n4 ^ e3[i3])];
        return -1 ^ n4;
      };
      for (var r = new Uint32Array(256), n3 = 0; n3 < 256; n3++) {
        for (var i2 = n3, s2 = 0; s2 < 8; s2++) i2 = 1 & i2 ? 3988292384 ^ i2 >>> 1 : i2 >>> 1;
        r[n3] = i2;
      }
    }, function(e2, t, r) {
      ...
      e2.exports = r, r.EventEmitter = r, r.prototype._events = void 0, r.prototype._maxListeners = void 0, r.defaultMaxListeners = 10, r.prototype.setMaxListeners = function(e3) {
        ...
        var t2, r2, i3, o3, u3, h2;
        if (this._events || (this._events = {}), "error" === e3 && (!this._events.error || s2(this._events.error) && !this._events.error.length)) {
        ...
        else if (s2(r2)) for (o3 = Array.prototype.slice.call(arguments, 1), i3 = (h2 = r2.slice()).length, u3 = 0; u3 < i3; u3++) h2[u3].apply(this, o3);
        return true;
      }, r.prototype.addListener = function(e3, t2) {
        var i3;
        if (!n3(t2)) throw TypeError("listener must be a function");
        return this._events || (this._events = {}), this._events.newListener && this.emit("newListener", e3, n3(t2.listener) ? t2.listener : t2), this._events[e3] ? s2(this._events[e3]) ? this._events[e3].push(t2) : this._events[e3] = [this._events[e3], t2] : this._events[e3] = t2, s2(this._events[e3]) && !this._events[e3].warned && (i3 = a2(this._maxListeners) ? r.defaultMaxListeners : this._maxListeners) && i3 > 0 && this._events[e3].length > i3 && (this._events[e3].warned = true, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[e3].length), "function" == typeof console.trace && console.trace()), this;
...
async function o2(e, n3) {
  ...
  await i2.createImages(), u(n3);
  const { frames: s2, width: o3, height: u3 } = i2, h2 = document.createElement("canvas");
  h2.width = o3, h2.height = u3;
  ...
  for (const t of s2) {
    ...
    const s3 = l2.getImageData(0, 0, o3, u3);
    c.push(s3), 0 === t.disposeOp || (1 === t.disposeOp ? l2.clearRect(t.left, t.top, t.width, t.height) : 2 === t.disposeOp && l2.putImageData(i3, t.left, t.top));
  }
  return { frameCount: s2.length, duration: p, frameDurations: f, getFrame: (e2) => c[e2], width: o3, height: u3 };
}
var u2 = [137, 80, 78, 71, 13, 10, 26, 10];
function h(e) {
  const t = new Uint8Array(e);
  return !u2.some((e2, r) => e2 !== t[r]);
}
function l(e) {
  if (!h(e)) return false;
...
//# sourceMappingURL=apng-56HMSMRB.js.map
