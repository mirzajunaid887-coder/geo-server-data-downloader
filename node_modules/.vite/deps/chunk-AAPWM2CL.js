...
async function t(l, o, r2) {
  ...
  return (await Promise.all(u2.map(async (e, r3) => {
    const n2 = "opacity" === l.type ? await a(e, l, o) : (await import("./visualVariableUtils-Q4CTQEWO.js")).getColor(l, e), u3 = t2 ? s2[r3] : (p == null ? void 0 : p[r3]) ?? "";
    return null == n2 ? null : { value: e, color: n2, label: u3 };
  }))).filter(U).reverse();
}
async function a(e, o, n2) {
  const t2 = new g(n2 ?? r), a2 = (await import("./visualVariableUtils-Q4CTQEWO.js")).getOpacity(o, e);
...
//# sourceMappingURL=chunk-AAPWM2CL.js.map
