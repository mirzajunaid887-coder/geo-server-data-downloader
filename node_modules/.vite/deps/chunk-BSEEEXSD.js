...
function g(e) {
  ...
  let a5 = ((_a = e.multidimensionalDefinition) == null ? void 0 : _a.length) ? e.multidimensionalDefinition : b(n3, { multidimensionalSubset: t });
  ...
  if (a5.some((e2) => !e2.dimensionName)) {
    ...
    i2 == null ? void 0 : i2.forEach((e3) => {
      var _a2;
      const n4 = a5 == null ? void 0 : a5.find(({ dimensionName: n5 }) => n5 === e3.dimensionName);
  ...
  if (null != a5 && null != s2 && (null != s2.start || null != s2.end)) {
    ...
    const e2 = (_c = (_b = i.variables.find(({ name: e3 }) => e3 === a5[0].variableName)) == null ? void 0 : _b.dimensions) == null ? void 0 : _c.find(({ name: e3 }) => "StdTime" === e3), n4 = a5.find(({ dimensionName: e3 }) => "StdTime" === e3);
...
function v(e, n3 = {}) {
  ...
  const { variableName: a5, multidimensionalSubset: s2, multidimensionalDefinition: r2 } = n3, l2 = null != r2 ? (_a = r2[0]) == null ? void 0 : _a.variableName : null, u2 = a5 || l2 || (i == null ? void 0 : i.DefaultVariable);
  let { variables: o3 } = t;
...
function b(e, n3 = {}) {
  ...
  for (let l2 = 0; l2 < s2.length; l2++) {
    ...
    "stdz" === e2.name.toLowerCase() && !e2.hasRanges && u2 && Math.abs(u2[1]) <= Math.abs(u2[0]) && (o3 = (t2 == null ? void 0 : t2.length) ? t2[t2.length - 1] : u2[1]), a5.push(new n2({ variableName: r2, dimensionName: e2.name, values: [o3], isSlice: !n3.useRangeForRangedDimensionInfo || !!e2.hasRanges }));
  }
  return a5;
}
function y(e) {
...
function D(n3, t) {
  ...
  return ((_a = n3 == null ? void 0 : n3.variables) == null ? void 0 : _a.length) && (i = i.filter(({ name: e }) => n3.variables.includes(e)), i.forEach((t2) => {
    t2.dimensions = t2.dimensions.map((e) => m(e, n3, t2.name)).filter(U);
  })), i;
}
function N(e, n3) {
  var _a;
...
//# sourceMappingURL=chunk-BSEEEXSD.js.map
