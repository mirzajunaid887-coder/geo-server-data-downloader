...
function x(n, { xmin: t, ymin: r2, xmax: i2, ymax: u2 }) {
  n[0] = Math.min(n[0], t), n[1] = Math.min(n[1], r2), n[2] = Math.max(n[2], i2), n[3] = Math.max(n[3], u2);
}
function s(n, t, r2) {
  if (null != t) if ("length" in t) P(t) ? (r2[0] = Math.min(n[0], t[0]), r2[1] = Math.min(n[1], t[1]), r2[2] = Math.max(n[2], t[2]), r2[3] = Math.max(n[3], t[3])) : 2 !== t.length && 3 !== t.length || (r2[0] = Math.min(n[0], t[0]), r2[1] = Math.min(n[1], t[1]), r2[2] = Math.max(n[2], t[0]), r2[3] = Math.max(n[3], t[1]));
  else switch (t.type) {
    case "extent":
...
function l(n, t) {
  n[0] = Math.min(n[0], t[0]), n[1] = Math.min(n[1], t[1]), n[2] = Math.max(n[2], t[2]), n[3] = Math.max(n[3], t[3]);
}
function y(n, t, r2 = n) {
  const i2 = t.length;
...
function J(n, t, r2, i2) {
  return i2 ?? (i2 = n), i2[0] = n[0] + t, i2[1] = n[1] + r2, i2[2] = n[2] + t, i2[3] = n[3] + r2, i2;
}
function O(n) {
  return n ? e(n, W) : u(W);
}
...
//# sourceMappingURL=chunk-YYPFYKHK.js.map
