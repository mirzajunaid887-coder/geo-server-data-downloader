...
var a7;
var p2 = new o({ percentTotal: "percent-of-total", ratio: "ratio", percent: "percent" });
...
var f3 = a7 = class extends n3 {
  constructor(e3) {
    super(e3), this.dataSeriesName = null, this.endTime = null, this.field = null, this.maxSliderValue = null, this.minSliderValue = null, this.startTime = null, this.type = null, this.units = null;
  }
  castEndTime(e3) {
  ...
  clone() {
    return new a7({ dataSeriesName: this.dataSeriesName, endTime: this.endTime, field: this.field, maxSliderValue: this.maxSliderValue, minSliderValue: this.minSliderValue, normalizationField: this.normalizationField, referenceSizeScale: this.referenceSizeScale, referenceSizeSymbolStyle: this.referenceSizeSymbolStyle, spikeSymbolStyle: this.spikeSymbolStyle, sizeStops: a(this.sizeStops), startTime: this.startTime, style: this.style, theme: this.theme, type: this.type, units: this.units });
  }
};
__decorate([a3({ type: String, json: { write: true, origins: { "web-scene": { write: false, read: false } } } })], f3.prototype, "dataSeriesName", void 0), __decorate([a3({ types: y, json: { write: true } })], f3.prototype, "endTime", void 0), __decorate([s2("endTime")], f3.prototype, "castEndTime", null), __decorate([a3({ type: String, json: { write: true } })], f3.prototype, "field", void 0), __decorate([a3({ type: Number, json: { write: true } })], f3.prototype, "maxSliderValue", void 0), __decorate([a3({ type: Number, json: { write: true } })], f3.prototype, "minSliderValue", void 0), __decorate([a3({ type: String, json: { origins: { "web-scene": { write: false } }, write: true } })], f3.prototype, "normalizationField", null), __decorate([a3({ type: Number, value: null, json: { origins: { "web-scene": { write: false } }, write: true } })], f3.prototype, "referenceSizeScale", null), __decorate([a3({ type: h, value: null, json: { origins: { "web-scene": { write: false } }, write: true } })], f3.prototype, "referenceSizeSymbolStyle", null), __decorate([a3({ type: d, value: null, json: { origins: { "web-scene": { write: false } }, write: true } })], f3.prototype, "spikeSymbolStyle", null), __decorate([a3({ types: y, json: { write: true } })], f3.prototype, "startTime", void 0), __decorate([s2("startTime")], f3.prototype, "castStartTime", null), __decorate([a3({ type: [l4], json: { origins: { "web-scene": { write: false } }, write: true } })], f3.prototype, "sizeStops", null), __decorate([a3({ type: p2.apiValues, value: null, json: { type: p2.jsonValues, read: p2.read, write: p2.write } })], f3.prototype, "style", null), __decorate([a3({ type: S, value: null, json: { type: S, origins: { "web-scene": { type: m3, write: { writer: (e3, t3) => {
  m3.includes(e3) && (t3.theme = e3);
} } } }, write: true } })], f3.prototype, "theme", null), __decorate([a3({ type: u2.apiValues, json: { type: u2.jsonValues, read: u2.read, write: u2.write } })], f3.prototype, "type", void 0), __decorate([a3({ type: c2, json: { type: c2, write: true } })], f3.prototype, "units", void 0), f3 = a7 = __decorate([c("esri.renderers.support.AuthoringInfoVisualVariable")], f3);
var g = f3;
...
var b2 = h2 = class extends n3 {
  constructor(e3) {
    super(e3), this.colorRamp = null, this.dataSeriesName = null, this.fadeRatio = null, this.isAutoGenerated = false, this.lengthUnit = null, this.maxSliderValue = null, this.minSliderValue = null, this.visualVariables = null;
  }
  get classificationMethod() {
    const e3 = this._get("classificationMethod"), t3 = this.type;
    return t3 && "relationship" !== t3 ? "class-breaks-size" === t3 || "class-breaks-color" === t3 ? e3 || "manual" : null : e3;
  }
  ...
  set type(e3) {
    let t3 = e3;
    "classed-size" === e3 ? t3 = "class-breaks-size" : "classed-color" === e3 && (t3 = "class-breaks-color"), this._set("type", t3);
  }
...
var t2 = class extends p3 {
  constructor(e3) {
    super(e3), this.customValues = null;
  }
};
__decorate([a3({ type: [Number], json: { write: true } })], t2.prototype, "customValues", void 0), t2 = __decorate([c("esri.renderers.visualVariables.support.SizeVariableLegendOptions")], t2);
var i6 = t2;
...
var g2 = new o({ unknown: "unknown", inch: "inches", foot: "feet", yard: "yards", mile: "miles", "nautical-mile": "nautical-miles", millimeter: "millimeters", centimeter: "centimeters", decimeter: "decimeters", meter: "meters", kilometer: "kilometers" });
function f5(e3) {
  if (null != e3) return "string" == typeof e3 || "number" == typeof e3 ? e2(e3) : "size" === e3.type ? i2(e3) ? e3 : (delete (e3 = { ...e3 }).type, new j(e3)) : void 0;
}
function V(e3, t3, i8) {
...
function b3(e3, t3, i8, s7) {
  "number" != typeof e3 ? "web-scene" !== (s7 == null ? void 0 : s7.origin) ? t3[i8] = e3.toJSON(s7) : a2(s7, "error", "property", `Size variable '${i8}' can only be a number in web scenes.`) : t3[i8] = e3;
}
var _a;
var j = w2 = (_a = class extends u3 {
  constructor(e3) {
    super(e3), this[x3] = true, this.axis = null, this.legendOptions = null, this.normalizationField = null, this.scaleBy = null, this.target = null, this.type = "size", this.useSymbolValue = null, this.valueExpression = null, this.valueRepresentation = null, this.valueUnit = null;
  }
  get cache() {
  ...
  set index(e3) {
    i2(this.maxSize) && (this.maxSize.index = `visualVariables[${e3}].maxSize`), i2(this.minSize) && (this.minSize.index = `visualVariables[${e3}].minSize`), this._set("index", e3);
  }
  get inputValueType() {
    return l2(this);
  }
  ...
  set maxSize(e3) {
    e3 && this.stops && (n2.getLogger(this).warn("cannot set maxSize when stops is not null."), e3 = null), this._set("maxSize", f5(e3));
  }
  readMaxSize(e3, t3, i8) {
    return V(e3, t3, i8);
  }
  writeMaxSize(e3, t3, i8, s7) {
    return b3(e3, t3, i8, s7);
  }
  set minDataValue(e3) {
  ...
  set minSize(e3) {
    e3 && this.stops && (n2.getLogger(this).warn("cannot set minSize when stops is not null."), e3 = null), this._set("minSize", f5(e3));
  }
  readMinSize(e3, t3, i8) {
    return V(e3, t3, i8);
  }
  writeMinSize(e3, t3, i8, s7) {
    return b3(e3, t3, i8, s7);
  }
  get arcadeRequired() {
  ...
  set stops(e3) {
    null == this.minDataValue && null == this.maxDataValue && null == this.minSize && null == this.maxSize ? e3 && Array.isArray(e3) && (e3 = e3.filter((e4) => !!e4)).sort((e4, t3) => e4.value - t3.value) : e3 && (n2.getLogger(this).warn("cannot set stops when one of minDataValue, maxDataValue, minSize or maxSize is not null."), e3 = null), this._set("stops", e3);
  }
  get transformationType() {
    return t(this, this.inputValueType);
  }
  readValueExpression(e3, t3) {
    return e3 || t3.expression && "$view.scale";
  }
  writeValueExpressionWebScene(e3, t3, i8, s7) {
    if (f2.test(e3)) {
      if (s7 == null ? void 0 : s7.messages) {
        const e4 = this.index;
  ...
  clone() {
    var _a2, _b;
    return new w2({ axis: this.axis, field: this.field, valueExpression: this.valueExpression, valueExpressionTitle: this.valueExpressionTitle, maxDataValue: this.maxDataValue, maxSize: i2(this.maxSize) ? this.maxSize.clone() : this.maxSize, minDataValue: this.minDataValue, minSize: i2(this.minSize) ? this.minSize.clone() : this.minSize, normalizationField: this.normalizationField, stops: (_a2 = this.stops) == null ? void 0 : _a2.map((e3) => e3.clone()), target: this.target, useSymbolValue: this.useSymbolValue, valueRepresentation: this.valueRepresentation, valueUnit: this.valueUnit, legendOptions: (_b = this.legendOptions) == null ? void 0 : _b.clone() });
  }
  flipSizes() {
    if ("clamped-linear" === this.transformationType) {
      const { minSize: e3, maxSize: t3 } = this;
      return this.minSize = t3, this.maxSize = e3, this;
    }
    if ("stops" === this.transformationType) {
      const e3 = this.stops;
      if (!e3) return this;
      const t3 = e3.map((e4) => e4.size).reverse(), i8 = e3.length;
      for (let s7 = 0; s7 < i8; s7++) e3[s7].size = t3[s7];
      return this;
    }
    return this;
  }
  _interpolateData() {
    var _a2;
    return (_a2 = this.stops) == null ? void 0 : _a2.map((e3) => e3.value || 0);
  }
}, x3 = n6, _a);
__decorate([a3({ readOnly: true })], j.prototype, "cache", null), __decorate([a3({ type: v3.apiValues, json: { type: v3.jsonValues, origins: { "web-map": { read: false } }, read: v3.read, write: v3.write } })], j.prototype, "axis", void 0), __decorate([a3()], j.prototype, "index", null), __decorate([a3({ type: String, readOnly: true })], j.prototype, "inputValueType", null), __decorate([a3({ type: i6, json: { write: true } })], j.prototype, "legendOptions", void 0), __decorate([a3({ type: Number, value: null, json: { write: true } })], j.prototype, "maxDataValue", null), __decorate([a3({ type: Number, useTypeForAutocast: false, value: null, json: { write: true } })], j.prototype, "maxSize", null), __decorate([o2("maxSize")], j.prototype, "readMaxSize", null), __decorate([r("maxSize")], j.prototype, "writeMaxSize", null), __decorate([a3({ type: Number, value: null, json: { write: true } })], j.prototype, "minDataValue", null), __decorate([a3({ type: Number, useTypeForAutocast: false, value: null, json: { write: true } })], j.prototype, "minSize", null), __decorate([o2("minSize")], j.prototype, "readMinSize", null), __decorate([r("minSize")], j.prototype, "writeMinSize", null), __decorate([a3({ type: String, json: { write: true } })], j.prototype, "normalizationField", void 0), __decorate([a3({ readOnly: true })], j.prototype, "arcadeRequired", null), __decorate([a3({ type: String })], j.prototype, "scaleBy", void 0), __decorate([a3({ type: [l5], value: null, json: { write: true } })], j.prototype, "stops", null), __decorate([a3({ type: ["outline"], json: { write: true } })], j.prototype, "target", void 0), __decorate([a3({ type: String, readOnly: true })], j.prototype, "transformationType", null), __decorate([a3({ type: ["size"], json: { type: ["sizeInfo"] } })], j.prototype, "type", void 0), __decorate([a3({ type: Boolean, json: { write: true, origins: { "web-map": { read: false } } } })], j.prototype, "useSymbolValue", void 0), __decorate([a3({ type: String, json: { write: true } })], j.prototype, "valueExpression", void 0), __decorate([o2("valueExpression", ["valueExpression", "expression"])], j.prototype, "readValueExpression", null), __decorate([r("web-scene", "valueExpression")], j.prototype, "writeValueExpressionWebScene", null), __decorate([a3({ type: ["radius", "diameter", "area", "width", "distance"], json: { write: true } })], j.prototype, "valueRepresentation", void 0), __decorate([a3({ type: g2.apiValues, json: { write: g2.write, origins: { "web-map": { read: false }, "web-scene": { write: true }, "portal-item": { write: true } } } })], j.prototype, "valueUnit", void 0), __decorate([o2("valueUnit")], j.prototype, "readValueUnit", null), j = w2 = __decorate([c("esri.renderers.visualVariables.SizeVariable")], j);
...
var l6 = i7 = class extends u3 {
  ...
  set stops(t3) {
    t3 && Array.isArray(t3) && (t3 = t3.filter((t4) => !!t4)).sort((t4, e3) => t4.value - e3.value), this._set("stops", t3);
  }
  clone() {
    var _a2;
    return new i7({ field: this.field, normalizationField: this.normalizationField, valueExpression: this.valueExpression, valueExpressionTitle: this.valueExpressionTitle, stops: this.stops && this.stops.map((t3) => t3.clone()), legendOptions: (_a2 = this.legendOptions) == null ? void 0 : _a2.clone() });
  }
  _interpolateData() {
...
var a10 = r3 = class extends u3 {
  ...
  clone() {
    var _a2;
    return new r3({ field: this.field, normalizationField: this.normalizationField, valueExpression: this.valueExpression, valueExpressionTitle: this.valueExpressionTitle, stops: this.stops && this.stops.map((t3) => t3.clone()), legendOptions: (_a2 = this.legendOptions) == null ? void 0 : _a2.clone() });
  }
  _interpolateData() {
    return this.stops && this.stops.map((t3) => t3.value || 0);
  }
...
var s6 = r4 = class extends u3 {
  ...
  clone() {
    var _a2;
    return new r4({ axis: this.axis, rotationType: this.rotationType, field: this.field, valueExpression: this.valueExpression, valueExpressionTitle: this.valueExpressionTitle, legendOptions: (_a2 = this.legendOptions) == null ? void 0 : _a2.clone() });
  }
};
...
var b4 = { color: l6, size: j, opacity: a10, rotation: s6 };
...
var h3 = class extends b {
  ...
  set visualVariables(r5) {
    if (this._resetVariables(), r5 = r5 == null ? void 0 : r5.filter((r6) => !!r6), r5 == null ? void 0 : r5.length) {
      for (const t3 of r5) switch (t3.type) {
        case "color":
          this.colorVariables.push(t3);
          break;
        case "opacity":
          this.opacityVariables.push(t3);
          break;
        case "rotation":
          this.rotationVariables.push(t3);
          break;
        case "size":
          this.sizeVariables.push(t3);
      }
      if (this.sizeVariables.length) {
        this.sizeVariables.some((r6) => !!r6.target) && r5.sort((r6, t3) => {
          let s7 = null;
          return s7 = r6.target === t3.target ? 0 : r6.target ? 1 : -1, s7;
        });
      }
  ...
  readVariables(r5, t3, s7) {
    const { rotationExpression: o5, rotationType: e3 } = t3, i8 = o5 == null ? void 0 : o5.match(V2), l8 = i8 == null ? void 0 : i8[1];
    if (l8 && (r5 || (r5 = []), r5.push({ type: "rotationInfo", rotationType: e3, field: l8 })), r5) return r5.map((r6) => {
      const t4 = u5.read(r6.type), o6 = b4[t4];
      o6 || (n2.getLogger(this).warn(`Unknown variable type: ${t4}`), a2(s7, "warning", "visual-variable", `visualVariable of type '${t4}' is not supported`, { definition: r6 }));
      const e4 = new o6();
      return e4.read(r6, s7), e4;
    });
  }
  writeVariables(r5, t3) {
    const s7 = [];
    for (const a12 of r5) {
      const r6 = a12.toJSON(t3);
      r6 && s7.push(r6);
    }
    return s7;
  }
...
var v4 = { base: u3, key: "type", typeMap: { opacity: a10, color: l6, rotation: s6, size: j } };
var m5 = (t3) => {
  const l8 = t3;
  let o5 = class extends l8 {
    ...
    get arcadeRequiredForVisualVariables() {
      var _a2;
      return ((_a2 = this.visualVariables) == null ? void 0 : _a2.some(({ arcadeRequired: a12 }) => a12)) ?? false;
    }
    ...
    getVisualVariablesForType(a12, r5) {
      var _a2;
      return ((_a2 = this.visualVariables) == null ? void 0 : _a2.filter((i8) => i8.type === a12 && ("string" == typeof r5 ? i8.target === r5 : false !== r5 || !i8.target))) ?? [];
    }
    async collectVVRequiredFields(a12, r5) {
      let i8 = [];
      this.visualVariables && (i8 = i8.concat(this.visualVariables));
      for (const t4 of i8) t4 && (t4.field && x2(a12, r5, t4.field), t4.normalizationField && x2(a12, r5, t4.normalizationField), t4.valueExpression && (y4(t4.valueExpression, a12, r5) || await v(a12, r5, null, t4.valueExpression)));
    }
  };
...
var a11 = { cast: (e3) => null == e3 || "string" == typeof e3 || "number" == typeof e3 ? e3 : `${e3}`, json: { type: String, write: { writer: (e3, r5) => {
  r5.value = e3 == null ? void 0 : e3.toString();
} } } };
...
//# sourceMappingURL=chunk-F6E3PR5S.js.map
