...
async function u() {
  if (!s()) {
    const [e, t2] = await Promise.all([import("./OperatorGeodesicBuffer-GYKRTPFX.js"), import("./SpatialReference-4CPSVTXJ.js").then((e2) => e2.aP).then(({ injectPe: e2 }) => e2), P()]);
...
//# sourceMappingURL=chunk-NEJN6HFG.js.map
