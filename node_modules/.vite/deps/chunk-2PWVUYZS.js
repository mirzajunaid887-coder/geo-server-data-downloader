...
function isAction(el) {
  return (el == null ? void 0 : el.tagName) === "CALCITE-ACTION";
}
...
var _Action = class _Action extends LitElement {
  ...
  renderButton() {
    ...
    if (this.dragHandle) {
      return html`<span .ariaBusy=${loading} .ariaControlsElements=${ariaControlsElements} .ariaDescribedByElements=${(_b = this.aria) == null ? void 0 : _b.describedByElements} .ariaExpanded=${(_c = this.aria) == null ? void 0 : _c.expanded} .ariaHasPopup=${(_d = this.aria) == null ? void 0 : _d.hasPopup} .ariaLabel=${ariaLabel} .ariaLabelledByElements=${(_e = this.aria) == null ? void 0 : _e.labelledByElements} .ariaOwnsElements=${(_f = this.aria) == null ? void 0 : _f.ownsElements} .ariaPressed=${(_g = this.aria) == null ? void 0 : _g.pressed} class=${safeClassMap(buttonClasses)} id=${buttonId ?? nothing} role=button tabindex=${(this.disabled ? void 0 : 0) ?? nothing} ${ref(this.buttonRef)}>${buttonContent}</span>`;
    }
    return html`<button .ariaBusy=${loading} .ariaChecked=${(_h = this.aria) == null ? void 0 : _h.checked} .ariaControlsElements=${ariaControlsElements} .ariaDescribedByElements=${(_i = this.aria) == null ? void 0 : _i.describedByElements} .ariaExpanded=${(_j = this.aria) == null ? void 0 : _j.expanded} .ariaHasPopup=${(_k = this.aria) == null ? void 0 : _k.hasPopup} .ariaLabel=${ariaLabel} .ariaLabelledByElements=${(_l = this.aria) == null ? void 0 : _l.labelledByElements} .ariaOwnsElements=${(_m = this.aria) == null ? void 0 : _m.ownsElements} .ariaPressed=${(_n = this.aria) == null ? void 0 : _n.pressed} class=${safeClassMap(buttonClasses)} .disabled=${disabled} id=${buttonId ?? nothing} .role=${(_o = this.aria) == null ? void 0 : _o.role} type=${this.type ?? nothing} ${ref(this.buttonRef)}>${buttonContent}</button>`;
  }
  render() {
...
//# sourceMappingURL=chunk-2PWVUYZS.js.map
