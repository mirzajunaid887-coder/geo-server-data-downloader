...
var r3 = class _r {
  ...
  toMilliseconds() {
    return null != this._millis ? this._millis : (null != this._date && (this._millis ?? (this._millis = this._date.toMillis())), this._millis ?? (this._millis = Date.parse(this._timeStampOffset)));
  }
  get isValid() {
...
function h(n3, e5) {
  ...
  switch (e5) {
    ...
    default:
      return "unknown" === (e5 == null ? void 0 : e5.toLowerCase()) ? DateTime.fromMillis(n3.getTime(), { zone: e.instance }) : DateTime.fromJSDate(n3, { zone: e5 });
  }
}
function T(n3) {
...
function v2(e5) {
  return !!v(e5) || (!!y(e5) || (!!x(e5) || !!S(e5)));
}
function I2(n3) {
  if (v(n3)) return n3.toMillis();
...
function T2(o3, s4, l4) {
  ...
  if (n(o3)) {
    ...
    if (v(s4)) throw new a("InvalidOperator");
    if (y(s4)) throw new a("InvalidOperator");
    ...
    if (O2(s4)) {
      if (i(o3.zone)) {
        if (v(s4) && !i(s4.zone)) return L(o3, s4, l4);
        if (x(s4)) return L(o3, s4, l4);
      } else if (v(s4) && i(s4.zone)) return L(o3, s4, l4);
...
function p3(a2) {
  return !f(a2) && (!y(a2) && (!v(a2) && (!S(a2) && !x(a2))));
}
function g3(a2) {
  return y(a2) || S(a2) ? a2.toString() : x(a2) ? a2.toSQLValue() : v(a2) ? 0 === a2.millisecond ? a2.toFormat("yyyy-LL-dd HH:mm:ss") : a2.toSQL({ includeOffset: false }) : f(a2) ? g3(DateTime.fromJSDate(a2)) : a2.toString();
}
function M2(a2) {
  if (f(a2)) return i2.fromDateJS(a2);
  if (v(a2)) return i2.fromParts(a2.year, a2.month, a2.day);
  if (y(a2)) return a2;
...
function x3(a2) {
  ...
  if (v(a2)) return r2.fromDateTime(a2);
...
var T3 = { extract: { minParams: 2, maxParams: 2, evaluate: ([a2, e5]) => {
  ...
  else if (v(e5)) switch (a2.toUpperCase()) {
    case "SECOND":
      return e5.second;
    case "MINUTE":
      return e5.minute;
...
} }, truncate: { minParams: 1, maxParams: 2, evaluate: (e5) => null == e5[0] ? null : 1 === e5.length || 0 === e5[1] ? Math.trunc(e5[0]) : G("trunc", e5[0], -Number(e5[1])) }, char_length: { minParams: 1, maxParams: 1, evaluate: (a2) => e2(a2[0]) ? a2[0].length : 0 }, concat: { minParams: 1, maxParams: 1 / 0, evaluate: (a2) => {
  let e5 = "";
...
function c3(a2, c4, ln, sn) {
  ...
  if (T(c4)) {
    ...
    if (y(ln)) return v3(c4, ln, a2);
    if (x(ln)) return p4(c4, ln, a2);
    if (v(ln)) return f4(c4, ln, a2);
    if (e2(ln)) return C3();
    throw new a("InvalidOperator");
  }
  if (v(c4)) {
  ...
  if (x(c4)) {
    ...
    if (S(ln)) return E2();
    if (y(ln)) return G2(c4, ln, a2);
    if (x(ln)) return J(c4, ln, a2);
    if (v(ln)) return H(c4, ln, a2);
    if (e2(ln)) return rn();
    throw new a("InvalidOperator");
  }
  if (e2(c4)) {
...
function n2(n3, e5) {
  ...
  function Fu() {
    let t4;
    return t4 = n3.charAt(Xo), At.test(t4) ? Xo++ : (t4 = r6, 0 === ru && pu(Pt)), t4 === r6 && (n3.substr(Xo, 2) === v4 ? (t4 = v4, Xo += 2) : (t4 = r6, 0 === ru && pu(Zt))), t4;
  }
  function Su() {
    let t4, n4, e6, o4, u5, i6;
    if (t4 = Xo, n4 = $u(), n4 !== r6) {
  ...
  function rc() {
    let t4, e6, o4, u5;
    return t4 = Xo, e6 = n3.substr(Xo, 4), e6.toLowerCase() === G4 ? Xo += 4 : (e6 = r6, 0 === ru && pu(Tn)), e6 !== r6 ? (o4 = Xo, ru++, u5 = Zu(), ru--, u5 === r6 ? o4 = void 0 : (Xo = o4, o4 = r6), o4 !== r6 ? (Jo = t4, t4 = bo()) : (Xo = t4, t4 = r6)) : (Xo = t4, t4 = r6), t4;
  }
  function oc() {
    let t4, e6, o4, u5;
  ...
  function Hc(t4, n4) {
    let e6 = t4;
    for (const { op: r7, expr: o4, location: { end: u5 } } of n4) e6 = Uc(r7, e6, o4, void 0, { ...e6.location, end: u5 });
    return e6;
  }
  function Pc(t4) {
...
var M4 = class _M {
  ...
  static convertValueToStorageFormat(e5, t4 = null) {
    if (null === t4) return f(e5) ? e5.getTime() : v(e5) ? e5.toMillis() : x(e5) ? e5.toStorageFormat() : S(e5) ? e5.toStorageString() : y(e5) ? e5.toStorageFormat() : e5;
    switch (t4) {
      case "date":
        return f(e5) ? e5.getTime() : v(e5) ? e5.toMillis() : x(e5) ? e5.toMilliseconds() : y(e5) ? e5.toNumber() : e5;
      case "date-only":
        return f(e5) ? i2.fromDateJS(e5).toString() : x(e5) ? i2.fromSqlTimeStampOffset(e5).toString() : v(e5) ? i2.fromDateTime(e5).toString() : e5;
      case "time-only":
        return f(e5) ? r2.fromDateJS(e5).toStorageString() : v(e5) ? r2.fromDateTime(e5).toStorageString() : x(e5) ? r2.fromSqlTimeStampOffset(e5).toStorageString() : S(e5) ? e5.toStorageString() : e5;
      case "timestamp-offset":
        if (f(e5)) return r3.fromJSDate(e5).toStorageFormat();
        if (v(e5)) return r3.fromDateTime(e5).toStorageFormat();
  ...
  _extractExpressionInfo(e5) {
    ...
    for (const o3 of s(this.parseTree)) switch (o3.type) {
      case "column-reference": {
        const t4 = e5 == null ? void 0 : e5.get(o3.column);
        let s5, n4;
  ...
  _evaluateNode(e5, a2, o3, l4, u4) {
    ...
    switch (e5.type) {
      ...
      case "binary-expression":
        switch (e5.operator) {
          case "AND":
            return G3(this._evaluateNode(e5.left, a2, o3, l4, u4), this._evaluateNode(e5.right, a2, o3, l4, u4));
          case "OR":
      ...
      case "number":
        return e5.value;
      case "date":
        return e5.parsedValue ?? (e5.parsedValue = D(e5.value, "unknown")), e5.parsedValue;
      case "timestamp":
        return e5.parsedValue ?? (e5.parsedValue = O(e5.value, "unknown")), e5.parsedValue;
      case "time":
        return e5.parsedValue ?? (e5.parsedValue = j(e5.value)), e5.parsedValue;
      case "current-time":
      ...
      case "function": {
        if (this.isAggregate && u2(e5.name, e5.args.value.length)) {
          const t4 = [];
          for (const r6 of ((_a = e5.args) == null ? void 0 : _a.value) || []) {
            const e6 = [];
...
function Q2(e5, t4) {
  ...
  for (const a2 of t4) if (null == a2) r6 = null;
    ...
    if (v2(e5) && v2(a2) && (r6 = T2(e5, a2, "="), r6)) break;
  }
  return r6;
}
function P2(e5) {
...
function re(e5, t4, r6) {
  ...
  try {
    ...
    if ("esriFieldTypeDate" !== (n3 == null ? void 0 : n3.type) && "date" !== (n3 == null ? void 0 : n3.type)) return false;
...
function se(e5, t4, r6, s4) {
  ...
  const i5 = r6 == null ? void 0 : r6.get(t4);
  switch (i5 == null ? void 0 : i5.type) {
    case "esriFieldTypeDate":
    case "date": {
      const e6 = r6 == null ? void 0 : r6.getTimeZone(i5.name);
...
//# sourceMappingURL=chunk-PLSJ77AD.js.map
