...
var _v = class _v {
  ...
  static findEffectOverrides(e, r) {
    if (!e) return null;
    if ("CIMGeometricEffectDashes" === e.type && q(e), !r || !e.primitiveName) return { type: "cim-effect-param", effect: e, overrides: [] };
    const i2 = J(e), s3 = e.primitiveName, t = [];
    for (const o of r) o.primitiveName === s3 && t.push(J(o));
    return { type: "cim-effect-param", effect: i2, overrides: H(t) };
  }
  static async resolveSymbolOverrides(e, r, t, o, a2, c, n) {
    ...
    if (r || (r = { attributes: {} }, y2 = false), m) {
      if (y2 || (f = f.filter((e2) => {
        ...
        const e2 = F(r.attributes), i2 = { spatialReference: t, fields: e2, geometryType: a2 };
        await _v.createRenderExpressions(f, i2), _v.evaluateOverrides(f, r, a2 ?? "esriGeometryPoint", c, n, new _(e2));
      }
  ...
  static evaluateOverrides(e, i2, s3, t, o, a2) {
    const c = { $view: { scale: o == null ? void 0 : o.scale } };
    for (const l2 of e) {
      ...
      o2 && (l2.value = s2(o2, i2, c, s3, a2, t));
    }
  }
      ...
      case "CIMTextSymbol":
        {
          ...
          if (!o) return;
          for (const a2 of o) a2 && "CIMVectorMarker" === a2.type && _v.applyDictionaryTextOverrides(a2, r, i2, s3, "CIMTextSymbol" === e.type ? e.textCase : t);
        }
        break;
      case "CIMVectorMarker":
        {
...
//# sourceMappingURL=chunk-INNOJDWF.js.map
