...
var h = class extends b {
  ...
  addOnCollectionChange(e2, s, { initial: i = false, final: d = false } = {}) {
    const r = ++this._handleId;
    return this.addHandles([a(e2, "after-changes", this._createSyncUpdatingCallback(), U), a(e2, "change", s, { onListenerAdd: i ? (e3) => s({ added: e3.toArray(), removed: [] }) : void 0, onListenerRemove: d ? (e3) => s({ added: [], removed: e3.toArray() }) : void 0 })], r), e(() => this.removeHandles(r));
  }
  consumePromise(e2) {
    var _a;
    (_a = this.addPromise(e2)) == null ? void 0 : _a.catch(() => {
    });
  }
  addPromise(e2) {
  ...
  _installWatch(e2, s, i = {}, d) {
    const n = ++this._handleId;
    i.sync || this._installSyncUpdatingWatch(e2, n);
    const a2 = d(e2, s, i);
    return this.addHandles(a2, n), e(() => this.removeHandles(n));
  }
  _installSyncUpdatingWatch(e2, s) {
    const t = this._createSyncUpdatingCallback(), d = l2(e2, t, { sync: true, equals: () => false });
    return this.addHandles(d, s), d;
  }
...
//# sourceMappingURL=chunk-YWJUPA6J.js.map
