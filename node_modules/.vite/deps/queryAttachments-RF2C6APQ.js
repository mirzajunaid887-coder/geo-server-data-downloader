...
function c(t3, e, n) {
  ...
  return n && (a2 = { ...n, ...a2, query: { ...n.query, ...a2.query } }), f(t3.path + "/queryAttachments", a2).then((t4) => t4.data.attachmentGroups);
}
...
//# sourceMappingURL=queryAttachments-RF2C6APQ.js.map
