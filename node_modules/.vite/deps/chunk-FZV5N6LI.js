...
var e = class {
  ...
  matches(e2) {
    ...
    for (const s3 of this.keyModifiers) if (!t3.has(s3) && !t3.has(s3.toLowerCase()) && !t3.has(s3.toUpperCase())) return false;
    return true;
  }
};
...
var t2 = class {
  ...
  registerIncoming(t3, i5, s3) {
    ...
    }, g2 = new n2(a2, s3, { onPause: r3, onRemove: r3, onResume: (e2) => {
      const t4 = this._incoming[e2.match.eventType];
      t4 && !t4.includes(e2) && (t4.push(e2), h(), this._manager && this._manager.updateDependencies());
    } });
    let c4 = this._incoming[a2.eventType];
    return c4 || (c4 = [], this._incoming[a2.eventType] = c4), c4.push(g2), h(), this._manager && this._manager.updateDependencies(), g2;
  }
  registerOutgoing(e2) {
    if (this._outgoing[e2]) throw new Error("There is already a callback registered for this outgoing InputEvent: " + e2);
    const t3 = new i(e2, { onEmit: (e3, t4, n3, i5) => {
      var _a;
      (_a = this._manager) == null ? void 0 : _a.emit(e3.eventType, t4, n3, i5);
    }, onRemove: (e3) => {
      var _a;
...
// node_modules/@arcgis/core/views/input/handlers/LatestPen.js
var i2 = class extends t2 {
  constructor(t3) {
    super(true), this._onChange = t3, this._onPointerEvent = ({ data: t4 }) => {
      const i5 = "pen" === t4.pointerType;
      if (!i5) return;
      const n3 = i5 ? t4.native.tiltX : void 0, e2 = i5 ? t4.native.tiltY : void 0;
      this._tiltX === n3 && this._tiltY === e2 || (this._tiltX = n3, this._tiltY = e2, this._onChange(n3, e2));
    }, this.registerIncoming("pointer-cancel", this._onPointerEvent), this.registerIncoming("pointer-capture-lost", this._onPointerEvent), this.registerIncoming("pointer-down", this._onPointerEvent), this.registerIncoming("pointer-enter", this._onPointerEvent), this.registerIncoming("pointer-leave", this._onPointerEvent), this.registerIncoming("pointer-move", this._onPointerEvent), this.registerIncoming("pointer-up", this._onPointerEvent);
  }
  get test() {
    return { reset: () => {
      this._tiltX = void 0, this._tiltY = void 0;
    } };
  }
};
...
var i3 = class extends t2 {
  ...
  _update(t3) {
    const i5 = t3.native.pointerType, s3 = "touch" === i5 ? "touch" : "pen" === i5 ? "pen" : "mouse", { x: e2, y: n3, native: { pointerId: h } } = t3;
    s3 === this._value && this._x === e2 && this._y === n3 && this._id === h || (this._value = s3, this._x = e2, this._y = n3, this._id = h, this._onChange(h, s3, e2, n3));
  }
};
...
var c3 = class {
  constructor() {
    this.id = 0, this.type = "mouse", this.location = c2();
  }
};
var _ = class {
  constructor() {
...
var f = class extends b {
  ...
  get latestPenInfo() {
    return this._latestPenInfo;
  }
  get updating() {
    return this.hasPendingInputs || this._paused;
  }
  installHandlers(e2, t3, i5 = y.INTERNAL) {
    if (this._nameToGroup[e2]) return;
    if (0 === t3.length) return;
    const n3 = { name: e2, handlers: t3.map((e3) => ({ handler: e3, active: true, removed: false, priorityIndex: 0, groupPriority: i5, eventCallback: null, uninstallCallback: null })) };
    this._nameToGroup[e2] = n3;
    for (let r3 = n3.handlers.length - 1; r3 >= 0; r3--) {
      const e3 = n3.handlers[r3];
      this._handlers.push(e3), e3.handler.onInstall({ updateDependencies: () => {
        this.updateDependencies();
      }, emit: (t4, i6, n4, r4, s3) => {
        this._emitInputEvent(e3.priorityIndex + 1, t4, i6, n4, s3, r4);
      }, setPointerCapture: (t4, i6) => {
        this._setPointerCapture(n3, e3, t4, i6);
      }, setEventCallback: (t4) => {
        e3.eventCallback = t4;
  ...
  updateDependencies() {
    ...
    for (let i5 = this._handlersPriority.length - 1; i5 >= 0; i5--) {
      const n3 = this._handlersPriority[i5];
      n3.priorityIndex = i5;
      let r3 = n3.handler.hasSideEffects;
      if (!r3) {
        for (const t4 of n3.handler.outgoingEventTypes) if (e2.has(t4)) {
          r3 = true;
          break;
        }
      }
      if (r3) for (const i6 of n3.handler.incomingEventMatches) {
        e2.add(i6.eventType);
  ...
  _setLatestPointer(e2, t3, i5, n3) {
    const r3 = this._latestPointerInfo;
    if (null == r3 || r3.id !== e2 || r3.type !== t3 || r3.location.x !== i5 || r3.location.y !== n3) {
      const r4 = this._propertiesPool.get("latestPointerInfo");
      r4.id = e2, r4.type = t3, r4.location.x = i5, r4.location.y = n3, this._latestPointerInfo = r4;
    }
  }
  _setLatestPen(e2, t3) {
    const i5 = this._latestPenInfo, n3 = null != i5 && 0 === e2 && 0 === t3, r3 = n3 ? i5 == null ? void 0 : i5.tiltX : e2, s3 = n3 ? i5 == null ? void 0 : i5.tiltY : t3;
    if (null != r3 && null != s3) {
      if (null == i5 || i5.tiltX !== r3 || i5.tiltY !== s3) {
        const e3 = this._propertiesPool.get("latestPenInfo");
        e3.tiltX = r3, e3.tiltY = s3, this._latestPenInfo = e3;
      }
    } else null != i5 && (this._latestPenInfo = void 0);
  }
  _onEventReceived(e2, t3) {
    ...
    const i5 = this._testTimestamp ?? ((_a = t3.native) == null ? void 0 : _a.timestamp), n3 = (_b = t3.native) == null ? void 0 : _b.cancelable;
    this._emitInputEventFromSource(e2, t3, i5, n3);
  }
  _updateKeyModifiers(e2, t3) {
    ...
    const n3 = () => {
      ...
      t4 && !this._activeKeyModifiers.has(e3) ? (n3(), this._activeKeyModifiers.add(e3)) : !t4 && this._activeKeyModifiers.has(e3) && (n3(), this._activeKeyModifiers.delete(e3));
    };
    if ("key-down" === e2 || "key-up" === e2) {
      const i6 = t3.key;
      this._keyModifiers.has(i6) && r3(i6, "key-down" === e2);
    }
    const s3 = t3.native;
    r3("Alt", !!(s3 == null ? void 0 : s3.altKey)), r3("Control", !!(s3 == null ? void 0 : s3.ctrlKey)), r3("Ctrl", !!(s3 == null ? void 0 : s3.ctrlKey)), r3("Shift", !!(s3 == null ? void 0 : s3.shiftKey)), r3("Meta", !!(s3 == null ? void 0 : s3.metaKey)), r3("Primary", this._activeKeyModifiers.has(this.primaryKey));
  }
  _installRecognizers() {
    this._latestPointerHandler = new i3((e2, t3, i5, n3) => this._setLatestPointer(e2, t3, i5, n3)), this._latestPenHandler = new i2((e2, t3) => this._setLatestPen(e2, t3)), this._multiTouchHandler = new i4(), this.installHandlers("input-manager-logic", [this._latestPointerHandler, this._latestPenHandler, this._multiTouchHandler], y.ALWAYS), this.recognizers.length > 0 && this.installHandlers("default", this.recognizers, y.INTERNAL);
  }
  _setPointerCapture(e2, t3, i5, n3) {
    const r3 = e2.name + "-" + t3.priorityIndex, s3 = this._pointerCaptures.get(i5.pointerId) || /* @__PURE__ */ new Set();
    this._pointerCaptures.set(i5.pointerId, s3), n3 ? (s3.add(r3), 1 === s3.size && this.eventSource && this.eventSource.setPointerCapture(i5, true)) : s3.has(r3) && (s3.delete(r3), 0 === s3.size && (this._pointerCaptures.delete(i5.pointerId), this.eventSource && this.eventSource.setPointerCapture(i5, false)));
  }
  _garbageCollectRemovedHandlers() {
    this._handlers = this._handlers.filter((e2) => !e2.removed), this.updateDependencies();
  }
  _emitInputEventFromSource(e2, t3, i5, n3) {
    this._emitInputEvent(0, e2, t3, i5, n3);
  }
  _emitInputEvent(e2, t3, i5, n3, r3, s3) {
    var _a;
    const o2 = n3 ?? ((_a = this._currentPropagation) == null ? void 0 : _a.timestamp) ?? performance.now(), a2 = r3 ?? false, l = { event: new g(t3, i5, o2, s3 || this._activeKeyModifiers, a2), priorityIndex: e2 };
  ...
  _continuePropagation() {
    ...
    if (e2) {
      for (; e2.events.length > 0; ) {
        const { event: t3, priorityIndex: i5 } = e2.events.pop(), n3 = (_a = t3.data) == null ? void 0 : _a.eventId;
        if (!(null != n3 && this._stoppedPropagationEventIds.has(n3))) for (e2.currentHandler = this._handlersPriority[i5]; e2.currentHandler; ) {
          if (e2.currentHandler.removed) e2.needsHandlerGarbageCollect = true;
            ...
            if (e2.currentHandler.active && !t3.shouldStopPropagation() && ((_c = (_b = e2.currentHandler).eventCallback) == null ? void 0 : _c.call(_b, t3)), t3.shouldStopPropagation()) {
              null != n3 && this._stoppedPropagationEventIds.add(n3);
              break;
            }
...
__decorate([a({ readOnly: true })], f.prototype, "hasPendingInputs", null), __decorate([a({ constructOnly: true })], f.prototype, "eventSource", void 0), __decorate([a({ constructOnly: true })], f.prototype, "recognizers", void 0), __decorate([a()], f.prototype, "multiTouchActive", null), __decorate([a()], f.prototype, "_latestPointerInfo", void 0), __decorate([a()], f.prototype, "latestPointerInfo", null), __decorate([a()], f.prototype, "_latestPenInfo", void 0), __decorate([a()], f.prototype, "latestPenInfo", null), __decorate([a()], f.prototype, "_paused", void 0), __decorate([a({ readOnly: true })], f.prototype, "updating", null), f = __decorate([c("esri.views.input.InputManager")], f);
var g = class {
  constructor(e2, t3, i5, n3, r3) {
    this.type = e2, this.data = t3, this.timestamp = i5, this.modifiers = n3, this.cancelable = r3, this._propagationState = 0, this._resumeCallback = null;
  }
  stopPropagation() {
...
var y = { ALWAYS: 1, DEFAULT: 0, TOOL: -1, WIDGET: -2, INTERNAL: -3 };
...
//# sourceMappingURL=chunk-FZV5N6LI.js.map
