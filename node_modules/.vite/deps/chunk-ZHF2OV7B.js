...
var m4 = (t) => (t == null ? void 0 : t.rasterFunction) ? g.fromJSON(t) : t;
var l = (t) => t && t instanceof g ? t.toJSON() : t;
var y2 = (t) => (t == null ? void 0 : t.functionName) && !t.declaredClass;
var F = (t) => y2(t) ? new g(t) : t;
var h2 = (t) => {
  if (null == t) return null;
  t = a(t);
  const n6 = {};
  for (const e of Object.keys(t)) p2.has(e.toLowerCase()) ? n6[e] = m4(t[e]) : f.has(e.toLowerCase()) && Array.isArray(t[e]) ? n6[e] = t[e].map(m4) : n6[e] = t[e];
  return n6;
};
var d2 = (t) => t ? a6.fromJSON({ type: "RasterFunctionTemplate", ...t }) : void 0;
var N = { types: { key: "type", base: null, typeMap: { RasterFunctionTemplate: a6 } }, json: { write: true, name: "rasterFunctionDefinition", read: d2 } };
var g = c4 = class extends n {
  ...
  readFunctionName(t, n6) {
    ...
    return r3 || ((e == null ? void 0 : e.length) && "None" !== e[0].name ? e[0].name : n6.rasterFunction || ((_a = n6.rasterFunctionDefinition) == null ? void 0 : _a.name));
  }
...
var y3 = m5 = class extends n {
  ...
  readOperation(e, t) {
    var _a;
    const o3 = t.mosaicOperation, i4 = (_a = t.mosaicOperator) == null ? void 0 : _a.toLowerCase(), r3 = o3 || (i4 ? h3.toJSON(i4) : null);
  ...
  clone() {
    return new m5({ ascending: this.ascending, itemRasterFunction: a(this.itemRasterFunction), lockRasterIds: a(this.lockRasterIds), method: this.method, multidimensionalDefinition: a(this.multidimensionalDefinition), objectIds: a(this.objectIds), operation: this.operation, sortField: this.sortField, sortValue: this.sortValue, viewpoint: a(this.viewpoint), where: this.where });
  }
};
...
} } } })], y3.prototype, "sortValue", void 0), __decorate([m("sortValue")], y3.prototype, "castSortValue", null), __decorate([a3({ type: _, json: { write: true } })], y3.prototype, "viewpoint", void 0), __decorate([a3({ type: String, json: { write: true } })], y3.prototype, "where", void 0), y3 = m5 = __decorate([c("esri.layers.support.MosaicRule")], y3);

// node_modules/@arcgis/core/layers/support/MultidimensionalSubset.js
var m6;
var p3 = { base: s, key: "type", typeMap: { extent: z, polygon: j } };
var u3 = m6 = class extends n {
  constructor(e) {
  ...
  clone() {
    var _a;
    const e = (_a = this.subsetDefinitions) == null ? void 0 : _a.map((e2) => e2.clone()), t = this.areaOfInterest ? this.areaOfInterest.clone() : this.areaOfInterest;
    return new m6({ areaOfInterest: t, subsetDefinitions: e });
  }
};
__decorate([a3({ types: p3, json: { read: u2, write: true } })], u3.prototype, "areaOfInterest", void 0), __decorate([a3({ readOnly: true })], u3.prototype, "dimensions", null), __decorate([a3({ readOnly: true })], u3.prototype, "variables", null), __decorate([a3({ type: [n3], json: { write: true } })], u3.prototype, "subsetDefinitions", void 0), u3 = m6 = __decorate([c("esri.layers.support.MultidimensionalSubset")], u3);

// node_modules/@arcgis/core/renderers/support/rasterTypeUtils.js
var l2 = { key: "type", base: null, typeMap: { "class-breaks": j2, flow: c2, "raster-colormap": m3, "raster-shaded-relief": c3, "raster-stretch": h, "unique-value": A, "vector-field": b } };
var p4 = { ...l2, typeMap: { ...l2.typeMap } };
delete p4.typeMap["vector-field"];
var d3 = { classBreaks: j2, flowRenderer: c2, rasterColormap: m3, rasterShadedRelief: c3, rasterStretch: h, uniqueValue: A, vectorField: b };
function u4(e) {
  return e && d3[e.type] || null;
}
function c5(e, r3) {
  if (!e) return null;
  ...
  return (r3 == null ? void 0 : r3.messages) && e && a2(r3, "warning", "renderer", `Renderers of type '${e.type ?? "unknown"} are not supported`, { definition: e }), null;
}

// node_modules/@arcgis/core/rest/support/ImageHistogramParameters.js
var c6;
var j3 = c6 = class extends n {
  constructor(t) {
...
__decorate([a3({ types: s2, json: { read: u2 } })], j3.prototype, "geometry", void 0), __decorate([r2("geometry")], j3.prototype, "writeGeometry", null), __decorate([a3({ type: y3, json: { write: true } })], j3.prototype, "mosaicRule", void 0), __decorate([a3({ type: g, json: { write: true, name: "renderingRule" } })], j3.prototype, "rasterFunction", void 0), __decorate([a3({ type: _, json: { write: true } })], j3.prototype, "pixelSize", void 0), __decorate([a3({ json: { write: true } })], j3.prototype, "raster", void 0), __decorate([a3({ type: d, json: { read: { source: "time" }, write: { target: "time" } } })], j3.prototype, "timeExtent", void 0), j3 = c6 = __decorate([c("esri.rest.support.ImageHistogramParameters")], j3);

// node_modules/@arcgis/core/rest/support/ImageSampleParameters.js
var d4;
var h4 = d4 = class extends n {
  constructor(t) {
  ...
  clone() {
    return new d4(a({ geometry: this.geometry, locations: this.locations, interpolation: this.interpolation, mosaicRule: this.mosaicRule, outFields: this.outFields, raster: this.raster, returnFirstValueOnly: this.returnFirstValueOnly, sampleDistance: this.sampleDistance, sampleCount: this.sampleCount, sliceId: this.sliceId, pixelSize: this.pixelSize, timeExtent: this.timeExtent }));
  }
};
__decorate([a3({ types: s2, json: { read: u2 } })], h4.prototype, "geometry", void 0), __decorate([r2("geometry")], h4.prototype, "writeGeometry", null), __decorate([a3({ type: [_] })], h4.prototype, "locations", null), __decorate([a3({ type: String, json: { type: a4.jsonValues, read: a4.read, write: a4.write } })], h4.prototype, "interpolation", void 0), __decorate([a3({ type: y3, json: { write: true } })], h4.prototype, "mosaicRule", void 0), __decorate([a3({ type: [String], json: { write: true } })], h4.prototype, "outFields", void 0), __decorate([a3({ type: _, json: { write: true } })], h4.prototype, "pixelSize", void 0), __decorate([a3({ type: String, json: { write: true } })], h4.prototype, "raster", void 0), __decorate([a3({ type: Boolean, json: { write: true } })], h4.prototype, "returnFirstValueOnly", void 0), __decorate([a3({ type: Number, json: { write: true } })], h4.prototype, "sampleDistance", void 0), __decorate([a3({ type: Number, json: { write: true } })], h4.prototype, "sampleCount", void 0), __decorate([a3({ type: Number, json: { write: true } })], h4.prototype, "sliceId", void 0), __decorate([a3({ type: d, json: { read: { source: "time" }, write: { target: "time" } } })], h4.prototype, "timeExtent", void 0), h4 = d4 = __decorate([c("esri.rest.support.ImageSampleParameters")], h4);
...
//# sourceMappingURL=chunk-ZHF2OV7B.js.map
