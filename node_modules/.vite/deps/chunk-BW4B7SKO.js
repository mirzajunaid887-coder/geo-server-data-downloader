...
var S = class extends b {
  ...
  async featureSetFromJSON(e, t, r2) {
    ...
    const { meshFeatureSetFromJSON: s } = await h(import("./meshFeatureSet-SSRBIO5U.js"), r2);
  ...
  async executeRelationshipQuery(e, t) {
    const [{ default: r2 }, { executeRelationshipQuery: s }] = await h(Promise.all([import("./RelationshipQuery-PGDJEXUK.js"), import("./executeRelationshipQuery-MTVBBFLE.js")]), t);
    let i2 = r2.from(e);
  ...
  async executeRelationshipQueryForCount(e, t) {
    const [{ default: r2 }, { executeRelationshipQueryForCount: s }] = await h(Promise.all([import("./RelationshipQuery-PGDJEXUK.js"), import("./executeRelationshipQuery-MTVBBFLE.js")]), t);
    let i2 = r2.from(e);
    return (this.gdbVersion || this.dynamicDataSource) && (i2 = i2.clone(), i2.gdbVersion = i2.gdbVersion || this.gdbVersion, i2.dynamicDataSource = i2.dynamicDataSource || this.dynamicDataSource), s(this.url, i2, t);
  }
  async executeAttachmentQuery(e, t) {
    const { executeAttachmentQuery: r2, fetchAttachments: s, processAttachmentQueryResult: i2 } = await h(import("./queryAttachments-RF2C6APQ.js"), t), u = f(this.url);
    return i2(u, await (this.queryAttachmentsSupported ? r2(u, e, t) : s(u, e, t)));
  }
  async executeAttributeBinsQuery(e, t) {
    const { executeAttributeBinsQuery: r2 } = await h(import("./executeAttributeBinsQuery-UNC265KE.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executePivotQuery(e, t) {
    const { executePivotQuery: r2 } = await h(import("./executePivotQuery-GHS6JPA6.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeTopFeaturesQuery(e, t) {
    const { executeTopFeaturesQuery: r2 } = await h(import("./executeTopFeaturesQuery-WTTWSXIV.js"), t);
    return r2(this.parsedUrl, e, this.sourceSpatialReference, t);
  }
  async executeForTopIds(e, t) {
    const { executeForTopIds: r2 } = await h(import("./executeForTopIds-DLRJ7B2I.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeForTopExtents(e, t) {
    const { executeForTopExtents: r2 } = await h(import("./executeForTopExtents-HB4YL7T6.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeForTopCount(e, t) {
    const { executeForTopCount: r2 } = await h(import("./executeForTopCount-QQLGIEES.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  _normalizeQuery(e) {
    let t = b2.from(e);
...
//# sourceMappingURL=chunk-BW4B7SKO.js.map
