...
var n3 = class extends b {
  ...
  async update(t, r2) {
    const { addOrUpdateResources: e } = await import("./resourceUtils-IJYRACYT.js");
...
var k = v = class extends a3(u) {
  ...
  async fetchResources(e = {}, t) {
    const { fetchResources: i } = await import("./resourceUtils-IJYRACYT.js");
    return i(this, e, t);
  }
  async addResource(e, t, i) {
    const { addOrUpdateResources: r2 } = await import("./resourceUtils-IJYRACYT.js");
  ...
  async removeResource(e, t) {
    const { removeResource: r2 } = await import("./resourceUtils-IJYRACYT.js");
  ...
  async removeAllResources(e) {
    const { removeAllResources: t } = await import("./resourceUtils-IJYRACYT.js");
    return t(this, e);
  }
  resourceFromPath(e) {
...
//# sourceMappingURL=chunk-JZBWJ6KK.js.map
