...
var m = class extends l(n) {
  ...
  clone(e) {
    var _a, _b;
    const r2 = r(e), o = (_a = r2 == null ? void 0 : r2.materialMap) == null ? void 0 : _a.get(this);
    if (o) return o;
    const t = super.clone(a2(e));
    return (_b = r2 == null ? void 0 : r2.materialMap) == null ? void 0 : _b.set(this, t), t;
  }
  get memoryUsage() {
...
//# sourceMappingURL=chunk-34Z6XTVN.js.map
