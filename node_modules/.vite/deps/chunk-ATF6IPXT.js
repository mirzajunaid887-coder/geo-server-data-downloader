...
var r2 = class {
  constructor(h) {
    ...
    }, this._hint = new A(), h && (h.initialSize && (this.data = new Array(h.initialSize)), h.allocator && (this._allocator = h.allocator), void 0 !== h.deallocator && (this._deallocator = h.deallocator), h.shrink && (this._shrink = () => o2(this)));
  }
  toArray() {
  ...
  remove(t2) {
    const i = j(this.data, r(t2), this.length, this._hint);
    if (-1 !== i) return this.data.splice(i, 1), this.length = this.length - 1, t2;
  }
  removeUnordered(t2) {
    return this.removeUnorderedIndex(j(this.data, r(t2), this.length, this._hint));
  }
  ...
  removeUnorderedMany(t2, h = t2.length, s) {
    this.length = C(this.data, t2, this.length, h, this._hint, s), this._shrink();
  }
  front() {
...
//# sourceMappingURL=chunk-ATF6IPXT.js.map
