  ...
  hostConnected() {
    __privateGet(this, _attributes).forEach((attribute) => {
      if (this.component.el.hasAttribute(attribute)) {
        __privateGet(this, _callback).call(this.component, this.component.el.getAttribute(attribute), null, attribute);
      }
    });
...
//# sourceMappingURL=chunk-IOGB43NI.js.map
