...
import {
  ...
  c,
  m
} from "./chunk-5X6USGQX.js";
import {
  G
} from "./chunk-NXNLTSJQ.js";
...
function c2(e2, r, o2) {
  return (e2 == null ? void 0 : e2.attributeInfo.useElevation) ? r ? a2(r, o2) : null : (e2 == null ? void 0 : e2.attributeInfo.storageInfo) ? S3(e2.attributeInfo.storageInfo, e2.buffer, o2, true) : null;
}
function a2(e2, r) {
...
var c3 = class {
  ...
  _transform(r) {
    ...
    if (r.filterInfo && r.filterInfo.length > 0 && null != r.filterAttributesData) {
      const f3 = r.filterAttributesData.filter(U).map((t2) => {
    ...
    const g2 = h(e2, o2, G.fromData(r.obbData), S.fromJSON(r.inSR), S.fromJSON(r.outSR));
...
function h(t2, r, o2, n3, u3) {
  ...
  for (let e2 = 0; e2 < r; e2++) {
    let r2 = 3 * e2;
    m2[0] = t2[r2] - l[0], m2[1] = t2[r2 + 1] - l[1], m2[2] = t2[r2 + 2] - l[2], N(b2, m2, g), p[0] = Math.max(p[0], Math.abs(b2[0])), p[1] = Math.max(p[1], Math.abs(b2[1])), p[2] = Math.max(p[2], Math.abs(b2[2])), c4[r2++] = m2[0], c4[r2++] = m2[1], c4[r2] = m2[2];
  }
...
//# sourceMappingURL=PointCloudWorker-G2ALXPSQ.js.map
