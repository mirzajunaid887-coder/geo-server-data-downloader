...
async function i() {
  if (!o()) {
    const [n2, o2] = await Promise.all([import("./OperatorGeodeticArea-WO5AE2I3.js"), import("./SpatialReference-4CPSVTXJ.js").then((e2) => e2.aP).then(({ injectPe: e2 }) => e2), P()]);
...
async function m() {
  if (!c()) {
    const [e2] = await Promise.all([import("./apiConverter-KLVJMTTV.js"), i()]);
...
function l(o2, t = {}) {
  ...
  return m2 && n2 && (m2 = F2(m2, "square-meters", n2)), m2;
}
...
//# sourceMappingURL=chunk-NBJGSNJ7.js.map
