...
async function r(r2 = {}) {
  ...
  function $(r3) {
    var _a;
    (_a = n.onAbort) == null ? void 0 : _a.call(n, r3), A(r3 = "Aborted(" + r3 + ")"), T = true, r3 += ". Build with -sASSERTIONS for more info.";
    var e2 = new WebAssembly.RuntimeError(r3);
    throw s == null ? void 0 : s(e2), e2;
  }
  function I() {
  ...
  var Rr, $r, Ir, Br, Cr, Ur, xr, Vr, kr = (r3) => {
    ...
    if (n2 ?? (n2 = 2147483647), n2 < 2) return 0;
    ...
    if (n2 ?? (n2 = 2147483647), n2 < 4) return 0;
  ...
  var ce, he = { a: q, n: Y, j: tr, r: ar, l: cr, i: pr, e: Mr, c: Dr, b: Lr, m: _r, g: Zr, s: re, o: ee, p: oe, k: fe, f: ve, q: de, h: ye, d: pe };
  ...
  function me() {
    function r3() {
      var _a;
      n.calledRun = true, T || (W(), u == null ? void 0 : u(n), (_a = n.onRuntimeInitialized) == null ? void 0 : _a.call(n), R());
    }
...
//# sourceMappingURL=libtess-f64-T2R53IJB.js.map
