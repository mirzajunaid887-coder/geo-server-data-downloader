...
var l5 = { type: Boolean, value: true, json: { origins: { service: { read: false, write: false }, "web-map": { read: false, write: false } }, name: "screenSizePerspective", write: { enabled: true, layerContainerTypes: a3 } } };
var p6 = { type: Boolean, value: true, json: { name: "disablePopup", read: { reader: (e, r2) => !r2.disablePopup }, write: { enabled: true, writer(e, r2, n4) {
  r2[n4] = !e;
} } } };
var y = { type: Boolean, value: true, nonNullable: true, json: { name: "showLabels", write: { enabled: true, layerContainerTypes: a3 } } };
var d2 = { type: String, json: { origins: { "portal-item": { write: false } }, write: { isRequired: true, ignoreOrigin: true, writer: h } } };
var m3 = { type: Boolean, value: true, nonNullable: true, json: { origins: { service: { read: { enabled: false } } }, name: "showLegend", write: { enabled: true, layerContainerTypes: a3 } } };
var c2 = { value: null, type: x, json: { origins: { service: { name: "elevationInfo", write: true } }, name: "layerDefinition.elevationInfo", write: { enabled: true, layerContainerTypes: a3 } } };
function w(e) {
...
var g = { type: Number, json: { origins: { "web-document": f, "portal-item": { write: { layerContainerTypes: a3 } } } } };
var u = { ...g, json: { ...g.json, origins: { "web-document": { ...f, write: { enabled: true, layerContainerTypes: a3, target: { opacity: { type: Number }, "layerDefinition.drawingInfo.transparency": { type: Number } } } } }, read: { source: ["layerDefinition.drawingInfo.transparency", "drawingInfo.transparency"], reader: (e, r2, n4) => {
  var _a;
  return n4 && "service" !== n4.origin || !r2.drawingInfo || void 0 === r2.drawingInfo.transparency ? ((_a = r2.layerDefinition) == null ? void 0 : _a.drawingInfo) && void 0 !== r2.layerDefinition.drawingInfo.transparency ? r(r2.layerDefinition.drawingInfo.transparency) : void 0 : r(r2.drawingInfo.transparency);
} } } };
var b = { type: z, readOnly: true, json: { origins: { service: { read: { source: ["fullExtent", "spatialReference"], reader: (e, r2) => {
  const a6 = z.fromJSON(e);
  return null != r2.spatialReference && "object" == typeof r2.spatialReference && (a6.spatialReference = S.fromJSON(r2.spatialReference)), a6;
} } } }, read: false } };
var j = { type: String, json: { origins: { service: { read: false }, "portal-item": { read: false } } } };
var v = { type: Number, json: { origins: { service: { write: { enabled: false } } }, name: "layerDefinition.minScale", write: { layerContainerTypes: a3 } } };
var T = { type: Number, json: { origins: { service: { write: { enabled: false } } }, name: "layerDefinition.maxScale", write: { layerContainerTypes: a3 } } };
var I = { json: { write: { ignoreOrigin: true, layerContainerTypes: a3 }, origins: { "web-map": { read: false, write: false } } } };
var C = { type: d, json: { name: "attributeTableInfo", write: true } };
var N = new o({ High: "high", Medium: "medium", Low: "low", None: "none" });
var h2 = { type: N.apiValues, json: { name: "layerDefinition.barrierWeight", default: "high", read: N.read, write: N.write, origins: { service: { read: false } } } };
...
//# sourceMappingURL=chunk-BITUAAE6.js.map
