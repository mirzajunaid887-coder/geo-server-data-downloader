...
var n2 = class extends n {
  ...
  readColor(e2) {
    return null != (e2 == null ? void 0 : e2[0]) ? [e2[0], e2[1], e2[2], e2[3] / 255] : e2;
  }
...
__decorate([r({ esriSLS: "simple-line" }, { readOnly: true })], d.prototype, "type", void 0), __decorate([a2({ type: p3.apiValues, json: { read: p3.read, write: p3.write } })], d.prototype, "style", void 0), __decorate([a2({ type: ["butt", "round", "square"], json: { write: { overridePolicy: (o4, r3, t) => ({ enabled: "round" !== o4 && null == (t == null ? void 0 : t.origin) }) } } })], d.prototype, "cap", void 0), __decorate([a2({ type: ["miter", "round", "bevel"], json: { write: { overridePolicy: (o4, r3, t) => ({ enabled: "round" !== o4 && null == (t == null ? void 0 : t.origin) }) } } })], d.prototype, "join", void 0), __decorate([a2({ types: { key: "type", base: null, defaultKeyValue: "line-marker", typeMap: { "line-marker": y } }, json: { write: true, origins: { "web-scene": { write: false } } } })], d.prototype, "marker", void 0), __decorate([a2({ type: Number, json: { read: false, write: false } })], d.prototype, "miterLimit", void 0), d = h = __decorate([c("esri.symbols.SimpleLineSymbol")], d);
...
//# sourceMappingURL=chunk-BC5A7P4I.js.map
