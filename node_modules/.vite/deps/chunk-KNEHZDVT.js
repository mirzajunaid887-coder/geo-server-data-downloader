...
// node_modules/@arcgis/core/chunks/GeometryCleaner-CIE8Wfmb.js
function i(i2, a3) {
  const f = i2.getGeometryType();
  return f === a.enumPoint ? r(i2) : h(f) ? u(i2) : f === a.enumMultiPoint ? o(i2) : f === a.enumEnvelope ? i2 : f === a.enumMultipatch ? (x("not implemented for multipatch"), i2) : i2;
}
function r(t) {
  return t;
}
...
//# sourceMappingURL=chunk-KNEHZDVT.js.map
