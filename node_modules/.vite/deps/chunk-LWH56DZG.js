...
var h = class extends b {
  ...
  get featureUtilsPromise() {
    return this._get("featureUtilsPromise") ?? import("./featureUtils-HA5UBCX6.js").then((e2) => this._featureUtils = e2);
  }
  ...
  async getTitles(e2, t, s2) {
    ...
    try {
      ...
      t.forEach((t2) => {
        ...
        (s2 == null ? void 0 : s2.removeHTML) && (p2 = s.sanitize(p2).replaceAll(f, " ")), i.set(d, p2);
      });
    } catch {
    }
    return i;
  ...
  async _checkAndReQueryGraphics(e2, t) {
    const i = t.map((t2) => t2.getObjectId() ?? t2.attributes[e2.objectIdField]).filter(U);
...
//# sourceMappingURL=chunk-LWH56DZG.js.map
