...
var n3 = class extends b {
  ...
  normalizeCtorArgs(t) {
    return (t == null ? void 0 : t.portalItem) && t.path ? { ...t, path: u2(t.path, t.portalItem) } : t;
  }
  set path(t) {
  ...
  async update(t, r2) {
    const { addOrUpdateResources: e } = await import("./resourceUtils-7WJQ6JVE.js");
    return await e(this.portalItem, [{ resource: this, content: t, compress: r2 == null ? void 0 : r2.compress, access: r2 == null ? void 0 : r2.access }], "update", r2), this;
  }
  hasPath() {
...
var k = v = class extends a3(u) {
  ...
  get iconUrl() {
    var _a;
    const e = ((_a = this.type) == null ? void 0 : _a.toLowerCase()) || "", i = this.typeKeywords || [], r2 = "esri/images/portal/", o2 = "16";
  ...
  update(e) {
    return this.id ? this.load().then(() => this.portal.signIn()).then(() => {
      const t = e == null ? void 0 : e.data, i = { method: "post" };
  ...
  async copy(e) {
    ...
    await t.signIn();
    const { copyResources: o2, folder: s2, tags: a4, title: n4 } = e || {}, l2 = { method: "post", query: { copyPrivateResources: "all" === o2, folder: "string" == typeof s2 ? s2 : s2 == null ? void 0 : s2.id, includeResources: !!o2, tags: a4 == null ? void 0 : a4.join(","), title: n4 } }, { itemId: p } = await t.request(`${r2}/copy`, l2);
  ...
  async fetchResources(e = {}, t) {
    const { fetchResources: i } = await import("./resourceUtils-7WJQ6JVE.js");
    return i(this, e, t);
  }
  async addResource(e, t, i) {
    const { addOrUpdateResources: r2 } = await import("./resourceUtils-7WJQ6JVE.js");
    return e.portalItem = this, await r2(this, [{ resource: e, content: t, compress: i == null ? void 0 : i.compress, access: i == null ? void 0 : i.access }], "add", i), e;
  }
  async removeResource(e, t) {
    const { removeResource: r2 } = await import("./resourceUtils-7WJQ6JVE.js");
  ...
  async removeAllResources(e) {
    const { removeAllResources: t } = await import("./resourceUtils-7WJQ6JVE.js");
    return t(this, e);
  }
  resourceFromPath(e) {
...
//# sourceMappingURL=chunk-2YCRWFJN.js.map
