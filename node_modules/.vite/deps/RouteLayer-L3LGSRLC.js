...
__decorate([a({ types: M })], p3.prototype, "break", void 0), __decorate([a({ types: M })], p3.prototype, "first", void 0), __decorate([a({ types: M })], p3.prototype, "unlocated", void 0), __decorate([a({ types: M })], p3.prototype, "last", void 0), __decorate([a({ types: M })], p3.prototype, "middle", void 0), __decorate([a({ types: M })], p3.prototype, "waypoint", void 0), p3 = __decorate([c("esri.layers.support.RouteStopSymbols")], p3);

// node_modules/@arcgis/core/layers/support/RouteSymbols.js
var c3 = class extends n2 {
  constructor(o6) {
    super(o6), this.directionLines = new d({ color: [0, 122, 194], width: 6 }), this.directionPoints = new u2({ color: [255, 255, 255], size: 6, outline: { color: [0, 122, 194], width: 2 } }), this.pointBarriers = new u2({ style: "x", size: 10, outline: { color: [255, 0, 0], width: 3 } }), this.polygonBarriers = new m4({ color: [255, 170, 0, 0.6], outline: { width: 7.5, color: [255, 0, 0, 0.6] } }), this.polylineBarriers = new d({ width: 7.5, color: [255, 85, 0, 0.7] }), this.routeInfo = new d({ width: 8, color: [20, 89, 127] }), this.stops = new p3();
  }
};
__decorate([a({ types: C2 })], c3.prototype, "directionLines", void 0), __decorate([a({ types: M })], c3.prototype, "directionPoints", void 0), __decorate([a({ types: M })], c3.prototype, "pointBarriers", void 0), __decorate([a({ types: h })], c3.prototype, "polygonBarriers", void 0), __decorate([a({ types: C2 })], c3.prototype, "polylineBarriers", void 0), __decorate([a({ types: C2 })], c3.prototype, "routeInfo", void 0), __decorate([a({ type: p3 })], c3.prototype, "stops", void 0), c3 = __decorate([c("esri.layers.support.RouteSymbols")], c3);
...
__decorate([a({ type: Number })], p4.prototype, "buildTime", void 0), __decorate([a({ type: String })], p4.prototype, "name", void 0), __decorate([a({ type: [m6] })], p4.prototype, "networkAttributes", void 0), __decorate([a()], p4.prototype, "networkSources", void 0), __decorate([a({ type: String })], p4.prototype, "state", void 0), p4 = __decorate([c("esri.rest.support.NetworkDataset")], p4);
var i2 = p4;
...
var c4 = class extends n2 {
  ...
  writeAccumulateAttributes(t4, e3, r5) {
    (t4 == null ? void 0 : t4.length) && (e3[r5] = t4.map((t5) => D.toJSON(t5)));
  }
  get capabilities() {
...
async function d4(t4, o6, s5) {
  if (!t4) throw new r("network-service:missing-url", "Url to Network service is missing");
  const n8 = s2({ f: "json", token: o6 }, s5), { data: l9 } = await f(t4, n8), u10 = l9.currentVersion >= 10.4 ? p5(t4, o6, s5) : v(t4, s5), { defaultTravelMode: f7, supportedTravelModes: c11 } = await u10;
...
async function v(r5, t4) {
  ...
  if (!(l9 == null ? void 0 : l9.owningSystemUrl)) return { supportedTravelModes: [], defaultTravelMode: null };
  const { owningSystemUrl: u10 } = l9, f7 = jt(u10) + "/sharing/rest/portals/self", { data: c11 } = await f(f7, i5), d5 = t("helperServices.routingUtilities.url", c11);
  if (!d5) return { supportedTravelModes: [], defaultTravelMode: null };
  const v2 = f2(u10), p11 = /\/solve$/i.test(v2.path) ? "Route" : /\/solveclosestfacility$/i.test(v2.path) ? "ClosestFacility" : "ServiceAreas", m10 = s2({ f: "json", serviceName: p11 }, t4), h2 = jt(d5) + "/GetTravelModes/execute", g4 = await f(h2, m10), w3 = [];
  let T2 = null;
  if ((_b = (_a3 = g4 == null ? void 0 : g4.data) == null ? void 0 : _a3.results) == null ? void 0 : _b.length) {
...
var p6 = new o2({ 0: "informative", 1: "process-definition", 2: "process-start", 3: "process-stop", 50: "warning", 100: "error", 101: "empty", 200: "abort" });
var i3 = class extends a4 {
  constructor(r5) {
    super(r5), this.type = null;
  }
};
__decorate([a({ type: String, json: { read: p6.read, write: p6.write } })], i3.prototype, "type", void 0), i3 = __decorate([c("esri.rest.support.NAMessage")], i3);
var a6 = i3;
...
function a8(e3) {
  ...
  const p11 = [];
  let n8, i5, a12, l9, u10, m10, c11, y3, f7 = 0, d5 = 0, h2 = 0;
  if (u10 = e3.match(/((\+|-)[^+\-|]+|\|)/g), u10 || (u10 = []), 0 === parseInt(u10[f7], 32)) {
    f7 = 2;
    const e4 = parseInt(u10[f7], 32);
    f7++, m10 = parseInt(u10[f7], 32), f7++, 1 & e4 && (d5 = u10.indexOf("|") + 1, c11 = parseInt(u10[d5], 32), d5++), 2 & e4 && (h2 = u10.indexOf("|", d5) + 1, y3 = parseInt(u10[h2], 32), h2++);
  ...
  for (; f7 < u10.length && "|" !== u10[f7]; ) {
    ...
    d5 && (l9 = parseInt(u10[d5], 32) + s5, d5++, s5 = l9, e4.push(l9 / c11)), h2 && (a12 = parseInt(u10[h2], 32) + o6, h2++, o6 = a12, e4.push(a12 / y3)), p11.push(e4);
  }
  return { paths: [p11], hasZ: d5 > 0, hasM: h2 > 0 };
}
...
var m7 = class extends g2 {
  ...
  get strings() {
    return this.features.flatMap(({ strings: e3 }) => e3).filter(U);
  }
};
...
__decorate([a({ type: g2, json: { write: true } })], n6.prototype, "directionLines", void 0), __decorate([a({ type: g2, json: { write: true } })], n6.prototype, "directionPoints", void 0), __decorate([a({ type: f6, json: { write: true } })], n6.prototype, "directions", void 0), __decorate([a({ type: j, json: { write: true } })], n6.prototype, "route", void 0), __decorate([a({ type: String, json: { write: true } })], n6.prototype, "routeName", void 0), __decorate([a({ type: [j], json: { write: true } })], n6.prototype, "stops", void 0), __decorate([a({ type: g2, json: { write: true } })], n6.prototype, "traversedEdges", void 0), __decorate([a({ type: g2, json: { write: true } })], n6.prototype, "traversedJunctions", void 0), __decorate([a({ type: g2, json: { write: true } })], n6.prototype, "traversedTurns", void 0), n6 = __decorate([c("esri.rest.support.RouteResult")], n6);
var u8 = n6;

// node_modules/@arcgis/core/rest/support/RouteSolveResult.js
function u9(r5) {
  return r5 ? g2.fromJSON(r5).features.filter(U) : [];
}
...
__decorate([a({ type: String })], y2.prototype, "checksum", void 0), __decorate([a({ type: [a6] })], y2.prototype, "messages", void 0), __decorate([a({ type: [j] })], y2.prototype, "pointBarriers", void 0), __decorate([o3("pointBarriers", ["barriers"])], y2.prototype, "readPointBarriers", null), __decorate([a({ type: [j] })], y2.prototype, "polylineBarriers", void 0), __decorate([o3("polylineBarriers")], y2.prototype, "readPolylineBarriers", null), __decorate([a({ type: [j] })], y2.prototype, "polygonBarriers", void 0), __decorate([o3("polygonBarriers")], y2.prototype, "readPolygonBarriers", null), __decorate([a({ type: [u8] })], y2.prototype, "routeResults", void 0), y2 = __decorate([c("esri.rest.support.RouteSolveResult")], y2);
...
async function l7(c11, f7, l9) {
  const y3 = [], d5 = [], h2 = {}, g4 = {}, R3 = f2(c11), { path: v2 } = R3;
  p7(f7.stops) && u5(f7.stops.features, d5, "stops.features", h2), p7(f7.pointBarriers) && u5(f7.pointBarriers.features, d5, "pointBarriers.features", h2), p7(f7.polylineBarriers) && u5(f7.polylineBarriers.features, d5, "polylineBarriers.features", h2), p7(f7.polygonBarriers) && u5(f7.polygonBarriers.features, d5, "polygonBarriers.features", h2);
  const B = await S2(d5);
  for (const e3 in h2) {
    const r5 = h2[e3];
  ...
  const E2 = { ...l9, query: { ...R3.query, ...n4(f7), f: "json" } }, T2 = v2.endsWith("/solve") ? v2 : `${v2}/solve`, { data: b4 } = await f(T2, E2);
  return m8(b4);
}
function m8(e3) {
  const { barriers: r5, checksum: t4, directionLines: s5, directionPoints: o6, directions: a12, messages: u10, polygonBarriers: i5, polylineBarriers: n8, routes: c11, stops: p11, traversedEdges: l9, traversedJunctions: m10, traversedTurns: y3 } = e3, d5 = (e4) => {
  ...
  c11 == null ? void 0 : c11.features.forEach((e4, r6) => {
  ...
  }), a12 == null ? void 0 : a12.forEach((e4) => {
    const { routeName: r6 } = e4;
    d5(r6).directions = e4;
  });
  const R3 = ((p11 == null ? void 0 : p11.features.every((e4) => null == e4.attributes.RouteName)) ?? false) && g4.length > 0 ? g4[0].routeName : null;
  return p11 == null ? void 0 : p11.features.forEach((e4) => {
    var _a3;
    e4.geometry && ((_a3 = e4.geometry).spatialReference ?? (_a3.spatialReference = p11.spatialReference ?? void 0));
    const r6 = R3 ?? e4.attributes.RouteName, t5 = d5(r6);
    t5.stops ?? (t5.stops = []), t5.stops.push(e4);
  }), s5 == null ? void 0 : s5.features.forEach((e4) => {
    const r6 = e4.attributes.RouteID, t5 = h2(r6), { geometryType: o7, spatialReference: a13 } = s5;
    t5.directionLines ?? (t5.directionLines = { features: [], geometryType: o7, spatialReference: a13 }), t5.directionLines.features.push(e4);
  }), o6 == null ? void 0 : o6.features.forEach((e4) => {
    const r6 = e4.attributes.RouteID, t5 = h2(r6), { geometryType: s6, spatialReference: a13 } = o6;
    t5.directionPoints ?? (t5.directionPoints = { features: [], geometryType: s6, spatialReference: a13 }), t5.directionPoints.features.push(e4);
  }), l9 == null ? void 0 : l9.features.forEach((e4) => {
    const r6 = e4.attributes.RouteID, t5 = h2(r6), { geometryType: s6, spatialReference: o7 } = l9;
    t5.traversedEdges ?? (t5.traversedEdges = { features: [], geometryType: s6, spatialReference: o7 }), t5.traversedEdges.features.push(e4);
  }), m10 == null ? void 0 : m10.features.forEach((e4) => {
    const r6 = e4.attributes.RouteID, t5 = h2(r6), { geometryType: s6, spatialReference: o7 } = m10;
    t5.traversedJunctions ?? (t5.traversedJunctions = { features: [], geometryType: s6, spatialReference: o7 }), t5.traversedJunctions.features.push(e4);
  }), y3 == null ? void 0 : y3.features.forEach((e4) => {
...
__decorate([m2({ json: { write: true } })], p8.prototype, "name", void 0), __decorate([m2({ json: { write: true } })], p8.prototype, "where", void 0), p8 = __decorate([l("esri.rest.support.LocateSettingSource")], p8);
var c7 = p8;
...
var p9 = class extends l8 {
  constructor(o6) {
    super(o6), this.tolerance = null, this.toleranceUnits = null;
  }
};
__decorate([m2({ type: Number, json: { write: true } })], p9.prototype, "tolerance", void 0), __decorate([r2(t2)], p9.prototype, "toleranceUnits", void 0), p9 = __decorate([l("esri.rest.support.LocateSetting")], p9);
var a9 = p9;
...
var p10 = class extends l2(n2) {
  constructor(o6) {
    super(o6), this.doNotLocateOnRestrictedElements = null, this.url = null;
  }
};
__decorate([a({ type: Boolean, json: { write: true } })], p10.prototype, "doNotLocateOnRestrictedElements", void 0), __decorate([a({ type: String, json: { write: true } })], p10.prototype, "url", void 0), p10 = __decorate([c("esri.rest.support.NetworkUrl")], p10);

// node_modules/@arcgis/core/rest/support/RouteParameters.js
var P;
var _a2;
var O = (_a2 = class extends l2(n2) {
  constructor(t4) {
  ...
  writeRestrictionAttributes(t4, e3, r5) {
    (t4 == null ? void 0 : t4.length) && (e3[r5] = t4.map((t5) => w.toJSON(t5)));
  }
  readStartTime(t4, e3) {
...
function Y(e3) {
  ...
  for (const i5 of t4) i5.objectId ?? (i5.objectId = ++o6);
}
function Z(e3, t4) {
...
function ae(e3, t4) {
  if (t4 && (e3 == null ? void 0 : e3.length) && !e3.every(({ symbol: e4 }) => !!e4)) for (const r5 of e3) r5.symbol = t4;
}
function le(e3, t4) {
  switch (t4) {
    case "seconds":
...
function ue(e3, t4) {
  return "decimal-degrees" === t4 || "points" === t4 || "unknown" === t4 ? e3 : F(e3, t4, "meters");
}
function pe(e3) {
...
var de = q.ofType(d3);
var he = q.ofType(w2);
var ge = class extends p2(l3(g3(_2(e2(b3))))) {
  constructor(e3) {
  ...
  readDirectionLines(e3, t4) {
    return this._getNetworkFeatures(t4, "DirectionLines", (e4) => d2.fromGraphic(e4));
  }
  ...
  get fullExtent() {
    ...
    if (null != ((_a3 = this.routeInfo) == null ? void 0 : _a3.geometry)) return this.routeInfo.geometry.extent ?? e3;
  ...
  readMaxScale(e3, t4) {
    var _a3;
    const r5 = $(t4) ? t4.layers : (_a3 = t4.featureCollection) == null ? void 0 : _a3.layers, o6 = r5 == null ? void 0 : r5.find((e4) => null != e4.layerDefinition.maxScale);
    return (o6 == null ? void 0 : o6.layerDefinition.maxScale) ?? 0;
  }
  readMinScale(e3, t4) {
    var _a3;
    const r5 = $(t4) ? t4.layers : (_a3 = t4.featureCollection) == null ? void 0 : _a3.layers, o6 = r5 == null ? void 0 : r5.find((e4) => null != e4.layerDefinition.minScale);
  ...
  readPolylineBarriers(e3, t4) {
    return this._getNetworkFeatures(t4, "PolylineBarriers", (e4) => d3.fromGraphic(e4));
  }
  readRouteInfo(e3, t4) {
  ...
  readSpatialReference(e3, t4) {
    var _a3, _b;
    const r5 = $(t4) ? t4.layers : (_a3 = t4.featureCollection) == null ? void 0 : _a3.layers;
    if (!(r5 == null ? void 0 : r5.length)) return S.WGS84;
    const { layerDefinition: o6, featureSet: i5 } = r5[0], s5 = i5.features[0], n8 = ((_b = s5 == null ? void 0 : s5.geometry) == null ? void 0 : _b.spatialReference) ?? i5.spatialReference ?? o6.spatialReference ?? o6.extent.spatialReference ?? g;
  ...
  async saveAs(e3, t4 = {}) {
    ...
    r5.extent ?? (r5.extent = await ne(this.fullExtent)), r5.id = null, r5.portal ?? (r5.portal = M3.getDefault()), r5.title ?? (r5.title = this.title), r5.type = "Feature Collection", r5.typeKeywords = ["Data", "Feature Collection", E.MULTI_LAYER, "Route Layer"];
    const { portal: o6 } = r5, i5 = { messages: [], origin: "portal-item", portal: o6, url: null, writtenProperties: [] };
    await o6.signIn();
    const s5 = t4 == null ? void 0 : t4.folder, a12 = this.write(void 0, i5);
  ...
  async solve(e3, t4) {
    ...
    const r5 = (e3 == null ? void 0 : e3.stops) ?? this.stops, o6 = (e3 == null ? void 0 : e3.pointBarriers) ?? H2(this.pointBarriers), i5 = (e3 == null ? void 0 : e3.polylineBarriers) ?? H2(this.polylineBarriers), a12 = (e3 == null ? void 0 : e3.polygonBarriers) ?? H2(this.polygonBarriers);
    ...
    const l9 = e3 == null ? void 0 : e3.apiKey, { checksum: u10, url: c11 } = this, m10 = await this._getServiceDescription(c11, l9, t4), y3 = (e3 == null ? void 0 : e3.travelMode) ?? m10.defaultTravelMode, f7 = (e3 == null ? void 0 : e3.accumulateAttributes) ?? [];
    y3 && (f7.push(y3.distanceAttributeName), y3.timeAttributeName && f7.push(y3.timeAttributeName));
    const d5 = { accumulateAttributes: f7, checksum: u10, directionsOutputType: "featuresets", ignoreInvalidLocations: true, pointBarriers: o6, polylineBarriers: i5, polygonBarriers: a12, preserveObjectID: true, returnBarriers: !!o6, returnDirections: true, returnPolygonBarriers: !!a12, returnPolylineBarriers: !!i5, returnRoutes: true, returnStops: true, stops: r5 }, h2 = O.from(e3 ?? {});
    let g4;
    h2.set(d5);
    try {
      g4 = await l7(c11, h2, t4);
    } catch (S3) {
      throw p(S3) ? S3 : new r("routelayer:failed-route-request", "the routing request failed", { error: S3 });
    }
  ...
  _getNetworkFeatures(e3, t4, i5, n8) {
    var _a3;
    const a12 = $(e3) ? e3.layers : (_a3 = e3.featureCollection) == null ? void 0 : _a3.layers, l9 = a12 == null ? void 0 : a12.find((e4) => e4.layerDefinition.name === t4);
    if (null == l9) return new q();
    const { layerDefinition: u10, popupInfo: p11, featureSet: c11 } = l9, m10 = u10.drawingInfo.renderer, { features: y3 } = c11, f7 = c11.spatialReference ?? u10.spatialReference ?? u10.extent.spatialReference ?? g, d5 = m10 && u3(m10), h2 = S.fromJSON(f7), g4 = y3.map((e4) => {
      const s5 = j.fromJSON(e4);
      s5.geometry && e4.geometry && null == e4.geometry.spatialReference && (s5.geometry.spatialReference = h2);
      const n9 = i5(s5);
      return n9.symbol ?? (n9.symbol = (d5 == null ? void 0 : d5.getSymbol(s5)) ?? this._getNetworkSymbol(t4)), n9.popupTemplate ?? (n9.popupTemplate = p11 && G.fromJSON(p11)), n9;
    });
  ...
  _setStopSymbol(e3) {
    ...
    const { first: r5, last: o6, middle: n8, unlocated: a12, waypoint: l9, break: u10 } = this.defaultSymbols.stops, p11 = t4.map(({ sequence: e4 }) => e4).filter(U), c11 = t4.length === p11.length;
    ...
    const m10 = Math.min(...p11), y3 = Math.max(...p11);
  ...
  _toRouteLayerSolution(e3) {
    ...
    const { checksum: t4, routeResults: r5 } = e3, o6 = (_a3 = r5[0].stops) == null ? void 0 : _a3.map((e4) => w2.fromJSON(e4.toJSON()));
    this._setStopSymbol(o6);
    const i5 = new he(o6), s5 = new fe((_b = e3.polygonBarriers) == null ? void 0 : _b.map((e4) => j2.fromJSON(e4.toJSON())));
    ae(s5, this.defaultSymbols.polygonBarriers);
    const n8 = new de((_c = e3.polylineBarriers) == null ? void 0 : _c.map((e4) => d3.fromJSON(e4.toJSON())));
    ae(n8, this.defaultSymbols.polylineBarriers);
    const a12 = new ye((_d = e3.pointBarriers) == null ? void 0 : _d.map((e4) => T.fromJSON(e4.toJSON())));
    ae(a12, this.defaultSymbols.pointBarriers);
    const l9 = (_e = r5[0].route) == null ? void 0 : _e.toJSON(), u10 = f4.fromJSON(l9);
    u10.symbol = this.defaultSymbols.routeInfo;
    const p11 = new me((_f = r5[0].directionPoints) == null ? void 0 : _f.features.map((e4) => c2.fromJSON(e4.toJSON())));
    ae(p11, this.defaultSymbols.directionPoints);
    const c11 = new ce((_g = r5[0].directionLines) == null ? void 0 : _g.features.map((e4) => d2.fromJSON(e4.toJSON())));
    return ae(c11, this.defaultSymbols.directionLines), { checksum: t4, directionLines: c11, directionPoints: p11, pointBarriers: a12, polygonBarriers: s5, polylineBarriers: n8, routeInfo: u10, stops: i5 };
  }
  _writeDirectionLines() {
    return this._writeNetworkFeatures(this.directionLines, this.defaultSymbols.directionLines, "esriGeometryPolyline", d2.fields, "DirectionLines", "Direction Lines");
  }
  ...
  _writeNetworkFeatures(e3, t4, r5, o6, i5, s5) {
    ...
    return { featureSet: { features: e3.toArray().map((e4) => pe(e4)), geometryType: r5, spatialReference: n8 }, layerDefinition: { capabilities: "Query,Update,Editing", drawingInfo: { renderer: { type: "simple", symbol: (t4 == null ? void 0 : t4.toJSON()) ?? Q(r5) } }, extent: a12.toJSON(), fields: o6, geometryType: r5, hasM: false, hasZ: false, maxScale: l9, minScale: u10, name: i5, objectIdField: "ObjectID", spatialReference: n8, title: s5, type: "Feature Layer", typeIdField: "" } };
  }
  _writePointBarriers() {
  ...
  _writePolylineBarriers() {
    return this._writeNetworkFeatures(this.polylineBarriers, this.defaultSymbols.polylineBarriers, "esriGeometryPolyline", d3.fields, "PolylineBarriers", "Line Barriers");
  }
  _writeRouteInfo() {
  ...
  _writeStops() {
    ...
    const { stops: t4 } = this.defaultSymbols, r5 = (_a3 = t4 == null ? void 0 : t4.first) == null ? void 0 : _a3.toJSON(), o6 = (_b = t4 == null ? void 0 : t4.middle) == null ? void 0 : _b.toJSON(), i5 = (_c = t4 == null ? void 0 : t4.last) == null ? void 0 : _c.toJSON();
  ...
  _populatePortalFields(e3, t4, r5) {
    ...
    const o6 = (_a3 = t4.networkDataset) == null ? void 0 : _a3.networkAttributes, i5 = (o6 == null ? void 0 : o6.filter(({ usageType: e4 }) => "cost" === e4)) ?? [], s5 = r5.travelMode ?? t4.defaultTravelMode;
    ...
    const { timeAttributeName: l9, distanceAttributeName: u10 } = s5, p11 = i5.find(({ name: e4 }) => e4 === l9), c11 = i5.find(({ name: e4 }) => e4 === u10), m10 = ((_b = r5.travelMode) == null ? void 0 : _b.impedanceAttributeName) ?? r5.impedanceAttribute ?? t4.impedance, y3 = p11 == null ? void 0 : p11.units, f7 = c11 == null ? void 0 : c11.units;
    if (!y3 || !f7) throw new r("routelayer:unknown-impedance-units", "the units of either the distance or time impedance are unknown");
    const d5 = r5.directionsLanguage ?? t4.directionsLanguage, h2 = r5.accumulateAttributes ?? t4.accumulateAttributeNames ?? [], g4 = new Set(i5.filter(({ name: e4 }) => e4 === l9 || e4 === u10 || e4 === m10 || null != e4 && h2.includes(e4)).map(({ name: e4 }) => e4)), w3 = (e4) => {
    ...
    const { routeInfo: S3 } = e3, { findBestSequence: b4, preserveFirstStop: v2, preserveLastStop: B, startTimeIsUTC: P2, timeWindowsAreUTC: I2 } = r5;
    S3.analysisSettings = new a5({ accumulateAttributes: h2, directionsLanguage: d5, findBestSequence: b4, preserveFirstStop: v2, preserveLastStop: B, startTimeIsUTC: P2, timeWindowsAreUTC: I2, travelMode: s5 }), S3.totalDuration = le(((_c = S3.totalCosts) == null ? void 0 : _c[l9]) ?? 0, y3), S3.totalDistance = ue(((_d = S3.totalCosts) == null ? void 0 : _d[u10]) ?? 0, f7), S3.totalLateDuration = le(((_e = S3.totalViolations) == null ? void 0 : _e[l9]) ?? 0, y3), S3.totalWaitDuration = le(((_f = S3.totalWait) == null ? void 0 : _f[l9]) ?? 0, y3), null != S3.totalCosts && w3(S3.totalCosts), null != S3.totalViolations && w3(S3.totalViolations), null != S3.totalWait && w3(S3.totalWait);
