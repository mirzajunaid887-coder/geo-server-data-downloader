...
function g2(t2, s3, i, f2) {
  ...
  return f(l, { query: { url: t2, model: "simple", folders: "", refresh: 0 !== i || void 0, outSR: JSON.stringify(s3) }, responseType: "json", signal: f2 });
}
...
async function b(e, o, r, s3) {
  const n = e[o];
  if (!n) return [];
  const i = g.fromJSON(n.featureSet).features, f2 = n.layerDefinition, a2 = t(f2.drawingInfo.renderer), l = G.fromJSON(n.popupInfo), u2 = [];
  for (const t2 of i) {
...
function I2(e) {
  ...
  const o = u(un), t2 = u(un);
  for (const r of e) {
    if ((_b = (_a = r.polygons) == null ? void 0 : _a.featureSet) == null ? void 0 : _b.features) for (const e2 of r.polygons.featureSet.features) v(o, e2.geometry), I(t2, o);
    if ((_d = (_c = r.polylines) == null ? void 0 : _c.featureSet) == null ? void 0 : _d.features) for (const e2 of r.polylines.featureSet.features) v(o, e2.geometry), I(t2, o);
    if ((_f = (_e = r.points) == null ? void 0 : _e.featureSet) == null ? void 0 : _f.features) for (const e2 of r.points.featureSet.features) v(o, e2.geometry), I(t2, o);
    if (r.mapImages) for (const e2 of r.mapImages) v(o, e2.extent), I(t2, o);
  }
  return tn(t2, un) ? void 0 : { xmin: t2[0], ymin: t2[1], zmin: t2[2], xmax: t2[3], ymax: t2[4], zmax: t2[5], spatialReference: S.WGS84 };
}
...
//# sourceMappingURL=chunk-KZE2BVZJ.js.map
