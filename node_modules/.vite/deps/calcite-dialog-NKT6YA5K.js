import {
  SLOTS
} from "./chunk-KEW4LF2A.js";
import "./chunk-DO4TXN5V.js";
import {
  useFocusTrap
} from "./chunk-ZSYEQI2B.js";
import "./chunk-AKKV4XIA.js";
import "./chunk-K5B5N2ES.js";
import {
  getDimensionClass
} from "./chunk-5N3CQDZ7.js";
import {
  useTopLayer
} from "./chunk-RPDTW6Z3.js";
import "./chunk-JAP6KF4O.js";
import "./chunk-5UKTAK3T.js";
import {
  toggleOpenClose
} from "./chunk-RXZI4KNJ.js";
import "./chunk-V6VFOUIX.js";
import "./chunk-2PWVUYZS.js";
import {
  keyed
} from "./chunk-HCJXIPRV.js";
import "./chunk-SIDXEI7N.js";
import "./chunk-XKA3X3YF.js";
import {
  useSetFocus
...
function clampAndApplySize(axis, size, bounds, el) {
...
function applyAxes(sizes, el, getBounds) {
  const bounds = (getBounds == null ? void 0 : getBounds()) ?? {
  ...
  return {
    resize(sizes) {
      ...
      if (typeof context.targetElement === "function") {
        ...
        targetElement = (refObject == null ? void 0 : refObject.value) ?? null;
      ...
      const bounds = ((_a = context.getBounds) == null ? void 0 : _a.call(context)) ?? {
        inline: { min: null, max: null },
        block: { min: null, max: null }
      };
      lastResizeValues = {
      ...
      (_b = context.onResize) == null ? void 0 : _b.call(context, lastResizeValues);
      return {
        inline: inlineSize,
        block: blockSize,
        minInlineSize: bounds.inline.min,
...
var _Dialog = class _Dialog extends LitElement {
  ...
  async scrollContentTo(options) {
    var _a;
    await ((_a = this.panelRef.value) == null ? void 0 : _a.scrollContentTo(options));
  }
  ...
  render() {
    ...
    })} @keydown=${this.handleKeyDown} ${ref(this.setTransitionEl)}>${assistiveText ? keyed("assistive-text", html`<div aria-live=polite class=${safeClassMap(CSS.assistiveText)}>${assistiveText}</div>`) : null}<slot name=${SLOTS2.customContent}><calcite-panel class=${safeClassMap(CSS.panel)} .closable=${!this.closeDisabled} .description=${description} .heading=${heading} .headingLevel=${this.headingLevel} .hidden=${!this.opened} .icon=${icon} .iconFlipRtl=${iconFlipRtl} .loading=${this.loading} .menuOpen=${this.menuOpen} .messageOverrides=${this.messageOverrides} @calcitePanelClose=${this.handleInternalPanelCloseClick} @calcitePanelScroll=${this.handleInternalPanelScroll} @keydown=${this.handlePanelKeyDown} .overlayPositioning=${this.overlayPositioning} .scale=${this.scale} .topLayerDisabled=${this.topLayerDisabled} ${ref(this.panelRef)}><slot name=${SLOTS2.actionBar} slot=${SLOTS.actionBar}></slot><slot name=${SLOTS2.alerts} slot=${SLOTS.alerts}></slot><slot name=${SLOTS2.headerActionsStart} slot=${SLOTS.headerActionsStart}></slot><slot name=${SLOTS2.headerActionsEnd} slot=${SLOTS.headerActionsEnd}></slot><slot name=${SLOTS2.description} slot=${SLOTS.description}></slot><slot name=${SLOTS2.heading} slot=${SLOTS.heading}></slot><slot name=${SLOTS2.headerContent} slot=${SLOTS.headerContent}></slot><slot name=${SLOTS2.headerMenuActions} slot=${SLOTS.headerMenuActions}></slot><slot name=${SLOTS2.fab} slot=${SLOTS.fab}></slot><slot name=${SLOTS2.contentTop} slot=${SLOTS.contentTop}></slot><slot name=${SLOTS2.contentBottom} slot=${SLOTS.contentBottom}></slot><slot name=${SLOTS2.footerStart} slot=${SLOTS.footerStart}></slot><slot name=${SLOTS2.footer} slot=${SLOTS.footer}></slot><slot name=${SLOTS2.footerEnd} slot=${SLOTS.footerEnd}></slot><slot></slot></calcite-panel></slot></div></div>`;
  }
};
...
//# sourceMappingURL=calcite-dialog-NKT6YA5K.js.map
