...
var f = class {
  ...
  upsertMany(t) {
    ...
    return this._emitChanged(), r2.filter(U);
  }
  clear() {
  ...
  _add(e2) {
    ...
    let i2;
    if (o2 ? (e2.displayId = o2.displayId, i2 = this._boundsStore.get(r2), this._boundsStore.delete(r2), this._usedMemory -= ((_a = this.estimateFeatureUsedMemory) == null ? void 0 : _a.call(this, o2)) ?? 0) : null != this.onFeatureAdd && this.onFeatureAdd(e2), !((_c = (_b = e2.geometry) == null ? void 0 : _b.coords) == null ? void 0 : _c.length)) return this._boundsStore.set(r2, null), void this._featuresById.set(r2, e2);
    i2 = ut(null != i2 ? i2 : u(), e2.geometry), null != i2 && this._boundsStore.set(r2, i2), this._featuresById.set(r2, e2), this._usedMemory += ((_d = this.estimateFeatureUsedMemory) == null ? void 0 : _d.call(this, e2)) ?? 0;
  }
  _upsert(e2) {
    var _a, _b;
    ...
    return i2 && (o2.geometry = i2, this._boundsStore.set(r2, ut(u(), i2) ?? null)), this._usedMemory += ((_b = this.estimateFeatureUsedMemory) == null ? void 0 : _b.call(this, o2)) ?? 0, o2;
  }
  _remove(e2) {
    var _a;
...
//# sourceMappingURL=chunk-ET4RTG4E.js.map
