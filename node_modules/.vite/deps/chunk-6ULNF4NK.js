...
var p = d2 = class extends n {
  ...
  write(e2, r2) {
    ...
    if (r2 == null ? void 0 : r2.origin) {
      if (l.filter) {
        const e3 = Object.keys(l.filter);
        if (e3.length > 1 || "where" !== e3[0]) return (_a = r2.messages) == null ? void 0 : _a.push(new r("web-document-write:unsupported-feature-effect", "Invalid feature effect 'filter'. A filter can only contain a 'where' property", { layer: r2.layer, effect: this })), null;
      }
      if ("showExcludedLabels" in l) return (_b = r2.messages) == null ? void 0 : _b.push(new r("web-document-write:unsupported-feature-effect", "Invalid value for property 'excludedLabelsVisible' which should always be 'true'", { layer: r2.layer, effect: this })), null;
    }
    return l;
  }
  clone() {
...
//# sourceMappingURL=chunk-6ULNF4NK.js.map
