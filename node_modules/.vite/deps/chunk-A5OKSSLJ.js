...
function m(y, n2, m2) {
  const a = new X(new C(1).divide(m2.x), 0), e = new X(0, new C(1).divide(m2.y)), r = n2.multiply(m2).subtract(0.5), c = p(Ne(r).x).xyz, s = p(Ne(r).y).xyz;
  ...
  let z = mn(y, o), f = mn(y, w);
  const v = mn(y, b), g = mn(y, x);
  return z = Ae(z, v, s.z), f = Ae(f, g, s.z), z = Ae(z, f, c.z), z;
}

export {
  m
};
//# sourceMappingURL=chunk-A5OKSSLJ.js.map
