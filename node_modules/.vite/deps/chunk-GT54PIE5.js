...
function e() {
  const e4 = new Float32Array(16);
  return e4[0] = 1, e4[5] = 1, e4[10] = 1, e4[15] = 1, e4;
}
function t(e4) {
...
function n2(e4, t3, n4, r3, o3, a2, c3, l3, u3, f2, s3, i, y2, _, b, m2) {
  const p2 = new Float32Array(16);
  return p2[0] = e4, p2[1] = t3, p2[2] = n4, p2[3] = r3, p2[4] = o3, p2[5] = a2, p2[6] = c3, p2[7] = l3, p2[8] = u3, p2[9] = f2, p2[10] = s3, p2[11] = i, p2[12] = y2, p2[13] = _, p2[14] = b, p2[15] = m2, p2;
}
var r2 = e();
var o = Object.freeze(Object.defineProperty({ __proto__: null, IDENTITY: r2, clone: t, create: e, fromValues: n2 }, Symbol.toStringTag, { value: "Module" }));
...
var c = (n4, o3) => {
  const s3 = Math.sin(o3 * Math.PI / 180), c3 = Math.cos(o3 * Math.PI / 180), e4 = r(n4, 0.213 + 0.787 * c3 - 0.213 * s3, 0.715 - 0.715 * c3 - 0.715 * s3, 0.072 - 0.072 * c3 + 0.928 * s3, 0, 0.213 - 0.213 * c3 + 0.143 * s3, 0.715 + 0.285 * c3 + 0.14 * s3, 0.072 - 0.072 * c3 - 0.283 * s3, 0, 0.213 - 0.213 * c3 - 0.787 * s3, 0.715 - 0.715 * c3 + 0.715 * s3, 0.072 + 0.928 * c3 + 0.072 * s3, 0, 0, 0, 0, 1);
  return s(e4, e4);
};
var e2 = (n4, o3) => {
  ...
  _updateMatrix() {
    ...
    switch (this.type) {
      ...
      case "grayscale":
        ...
        break;
      case "invert":
        this._colorMatrix = e2(t3, this.amount);
        break;
      case "saturate":
        this._colorMatrix = a(t3, this.amount);
        break;
      case "sepia":
        this._colorMatrix = u2(t3, this.amount);
    }
  }
};
var d = class _d {
...
function y(t3) {
  return Math.round(1e3 * u(t3)) / 1e3;
}
function x(s3) {
  switch (s3.type) {
    case "grayscale":
...
function t2(n4, t3) {
  const e4 = n4.length > t3.length ? n4 : t3;
  return (n4.length > t3.length ? t3 : n4).every((n5, t4) => n5.type === e4[t4].type);
}
function e3(t3, e4) {
  const l3 = t3.length > e4.length ? t3 : e4, r3 = t3.length > e4.length ? e4 : t3;
...
//# sourceMappingURL=chunk-GT54PIE5.js.map
