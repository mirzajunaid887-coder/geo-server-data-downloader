...
function m(n, t = i()) {
  ...
  let e = p.get(t);
  if (!e) {
    const n2 = o().formatToParts(12345.6), u2 = [...o({ useGrouping: false }).format(9876543210)].reverse(), i3 = new Map(u2.map((n3, t2) => [n3, t2])), r2 = new RegExp(`[${(_a = n2.find((n3) => "group" === n3.type)) == null ? void 0 : _a.value}]`, "g"), a2 = new RegExp(`[${(_b = n2.find((n3) => "decimal" === n3.type)) == null ? void 0 : _b.value}]`), l2 = new RegExp(`[${u2.join("")}]`, "g"), s3 = /[\u200E\u200F\u202A\u202B\u202C\u202D\u202E\u2066\u2067\u2068\u2069\u061C]/g, c2 = /[-\u2212\u2013\u2014\u2015]/g;
    e = (n3) => {
...
//# sourceMappingURL=chunk-XU76TE5Z.js.map
