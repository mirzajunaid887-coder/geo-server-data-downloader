...
function a2(r4, e, t3, i3, o2) {
  var _a, _b;
  const n6 = {};
  return (_b = (_a = e.write) == null ? void 0 : _a.writer) == null ? void 0 : _b.call(r4, i3, n6, t3, o2), n6;
}
function p(r4, o2, s3, u6, l2, a5) {
  ...
  if (l2.layerContainerTypes && (a5 == null ? void 0 : a5.layerContainerType) && !l2.layerContainerTypes.includes(a5.layerContainerType)) return false;
  if ((null === p2 && !l2.allowNull && !l2.writerEnsuresNonNull || void 0 === p2) && l2.isRequired) {
    ...
    return i3 && (a5 == null ? void 0 : a5.messages) ? a5.messages.push(i3) : i3 && !a5 && n.getLogger("esri.core.accessorSupport.write").error(i3.name, i3.message), false;
  }
  ...
  if (!l2.ignoreOrigin && (a5 == null ? void 0 : a5.origin) && o2.store.multipleOriginsSupported) {
...
function g(r4, e, t3) {
  ...
  for (const u6 in f3) {
    ...
    Object.keys(d2).length > 0 && (e = u(e, d2), ((_b = (_a = t3 == null ? void 0 : t3.resources) == null ? void 0 : _a.pendingOperations) == null ? void 0 : _b.length) && t3.resources.pendingOperations.push(Promise.all(t3.resources.pendingOperations).then(() => u(e, d2, () => "replace-arrays"))), (t3 == null ? void 0 : t3.writtenProperties) && t3.writtenProperties.push({ target: r4, propName: u6, oldOrigin: u3(n6.store.originOf(u6)), newOrigin: t3.origin }));
  }
  return e;
}
...
var s2 = class _s {
  ...
  get(i3, s3) {
    ...
    return null == s3 || (t3 == null ? void 0 : t3.origin) === s3 ? t3 == null ? void 0 : t3.value : void 0;
  }
  originOf(i3) {
    var _a;
    return ((_a = this._values.get(i3)) == null ? void 0 : _a.origin) ?? 7;
  }
  keys(i3) {
    i3 = this._normalizeOrigin(i3);
    const s3 = [...this._values.keys()];
    return null == i3 ? s3 : s3.filter((s4) => {
      var _a;
      return ((_a = this._values.get(s4)) == null ? void 0 : _a.origin) === i3;
    });
  }
  set(i3, s3, e) {
    if (0 === (e = this._normalizeOrigin(e))) {
      const s4 = this._values.get(i3);
      if (null != (s4 == null ? void 0 : s4.origin) && s4.origin > e) return;
    }
    this._values.set(i3, new t(s3, e));
  }
  delete(i3, s3) {
    var _a;
    null != (s3 = this._normalizeOrigin(s3)) && ((_a = this._values.get(i3)) == null ? void 0 : _a.origin) !== s3 || this._values.delete(i3);
  }
  has(i3, s3) {
    var _a;
    return null != (s3 = this._normalizeOrigin(s3)) ? ((_a = this._values.get(i3)) == null ? void 0 : _a.origin) === s3 : this._values.has(i3);
  }
  isAtOrigin(i3, s3) {
...
function f2(e, t3, r4, s3) {
  const n6 = r4.metadata, i3 = n3(n6[t3], s3), a5 = i3 == null ? void 0 : i3.default;
  if (void 0 === a5) return;
...
function u4(t3, o2, n6 = c2) {
  ...
  for (const r4 of Object.getOwnPropertyNames(d2)) {
    const a5 = i(u6[r4], n6).read, f3 = a5 == null ? void 0 : a5.source;
    let c3;
    c3 = f3 && "string" == typeof f3 ? u2(o2, f3) : o2[r4], (a5 == null ? void 0 : a5.reader) && (c3 = a5.reader.call(t3, c3, o2, n6)), void 0 !== c3 && i3.set(r4, c3);
  }
...
function d(e, t3, r4, s3 = c2) {
  var _a;
  const o2 = { ...s3, messages: [] };
  r4(o2), (_a = o2.messages) == null ? void 0 : _a.forEach((t4) => {
    "warning" !== t4.type || e.loaded ? (s3 == null ? void 0 : s3.messages) && s3.messages.push(t4) : e.loadWarnings.push(t4);
  });
}
...
//# sourceMappingURL=chunk-KCYQWYIJ.js.map
