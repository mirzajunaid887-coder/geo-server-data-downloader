...
} } } })], R.prototype, "outTimeZone", null), __decorate([a({ type: Boolean, json: { name: "returnAggIds", write: { overridePolicy: (e) => ({ enabled: null != e }) } } })], R.prototype, "returnAggregateIds", void 0), __decorate([a({ type: Boolean, json: { write: true } })], R.prototype, "returnDistinctValues", void 0), __decorate([r(s2, { name: "spatialRel" })], R.prototype, "spatialRelationship", void 0), __decorate([a({ type: d, json: { write: true } })], R.prototype, "timeExtent", void 0), __decorate([a({ type: String, json: { write: true } })], R.prototype, "upperBoundaryAlias", void 0), __decorate([a({ type: String, json: { read: g2.read, write: { writer: g2.write, overridePolicy(e) {
  return { enabled: null != e && !!this.distance };
...
//# sourceMappingURL=chunk-TEAAWUTC.js.map
