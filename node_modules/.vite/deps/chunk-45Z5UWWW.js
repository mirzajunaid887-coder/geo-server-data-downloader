...
// node_modules/@arcgis/core/chunks/Distance2DCalculator-DjIp2uQi.js
function v() {
  return { outPoint: new li(), index: -1, t: Number.NaN };
}
function N(e, t, n2) {
...
function M(e) {
  ...
  return Pe(e.getPointCount(), n2), n2;
}
function x(e, t) {
...
var b = class {
  constructor(e, t) {
    ...
    __publicField(this, "m_env2DgeometryA", null);
    __publicField(this, "m_env2DgeometryB", null);
    __publicField(this, "m_maxSqrDistance");
    __publicField(this, "m_maxDistance");
    __publicField(this, "m_progressCounter", 0);
    __publicField(this, "m_bIsNearCalc");
    if (this.m_progressTracker = t, this.m_maxSqrDistance = e * e, this.m_maxDistance = e, this.m_bIsNearCalc = false, Number.isNaN(this.m_maxDistance) ? this.m_maxDistance = Number.POSITIVE_INFINITY : this.m_maxDistance = e, this.m_maxSqrDistance = this.m_maxDistance * this.m_maxDistance, Number.isFinite(this.m_maxSqrDistance)) {
  ...
  calculate(e, t, n2, i) {
    ...
    const r = N(new li(), bs(), Number.NaN), s = N(new li(), bs(), Number.NaN), o = this._ExecuteBruteForce(e, t, r, s);
  ...
  isNear(e, t) {
    ...
    if (e === t) return true;
    let n2 = true;
    if (e.getGeometryType() !== se.type && e.getGeometryType() !== oe.type || t.getGeometryType() !== se.type && t.getGeometryType() !== oe.type || (n2 = false), n2) {
    ...
    const i = N(new li(), bs(), Number.NaN), r = N(new li(), bs(), Number.NaN);
  ...
  distancePointPoint(e, t, n2, i) {
    ...
    return f(n2, r, 0, 0), f(i, s, 0, 0), Math.sqrt(li.sqrDistance(r, s));
  }
  distancePointMultipoint(e, t, n2, i) {
    const r = e.getXY();
    let s = this.m_maxSqrDistance, o = s, m = false;
    const u = t.getPointCount(), c = new li();
    for (let h = 0; h < u; ++h) if (t.queryXY(h, c), o = li.sqrDistance(r, c), this.m_bIsNearCalc) {
      if (o <= s) return 0;
  ...
  distancePointMultipath(e, t, i, r) {
    ...
    for (; g.nextPath(); ) for (; g.hasNextSegment(); ) {
      ...
      if (c = li.sqrDistance(o, n2), this.m_bIsNearCalc) {
        if (c <= u) return 0;
  ...
  distanceMultipointMultipoint(n2, i, r, s, o, m) {
    ...
    try {
      if (this.m_bIsNearCalc && 1 === o && 1 === m) {
        const e = Math.trunc(Ys(Math.sqrt(n2.getPointCount()) + 1, 1, xs())), t2 = Math.trunc(Ys(Math.sqrt(i.getPointCount()) + 1, 1, xs()));
  ...
  distanceMultipathMultipath(n2, i, s, o) {
    ...
    try {
      ...
      if (this.m_bIsNearCalc) {
        const e = Math.trunc(Ys(Math.sqrt(y.getPointCount()) + 1, 1, xs())), t2 = Math.trunc(Ys(Math.sqrt(y.getPointCount()) + 1, 1, xs()));
      ...
      const f2 = M(y), x2 = [], E2 = new yu(), b2 = new n(), S = new n(), B = new n();
...
//# sourceMappingURL=chunk-45Z5UWWW.js.map
