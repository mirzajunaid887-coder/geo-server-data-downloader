...
function m(n, t2, { coordinateHelper: e, elevationInfo: o }, r2) {
  return n ? h(e.vectorToDehydratedPoint(n, x), t2, o, r2) : null;
}
function h(n, t2, e, r2 = f()) {
  return r2[0] = n.x, r2[1] = n.y, r2[2] = n.z ?? 0, null == t2 || ("2d" === t2.type ? r2[2] = 0 : r2[2] = E(t2, n, e, k) ?? 0), r2;
}
function y(n, e) {
  return t(n[0], n[1], n[2], e);
}
function g(n, t2, o) {
  return i(n, t2[0], t2[1], t2[2], o), n;
}
function I2(n, o, { z: u, m: l2 }, f2, c2) {
...
function j(n, t2, e, o, r2 = f()) {
  const [l2, c2] = n;
  return r2[0] = l2, r2[1] = c2, n.length > 3 && (r2[3] = n[3] ?? 0), "3d" !== (e == null ? void 0 : e.type) ? (r2[2] = t2.value, r2) : (r2[2] = I(e, l2, c2, t2.value, o, t2.elevationInfo, k) ?? 0, r2);
}
var x = t(0, 0, 0, null);
...
//# sourceMappingURL=chunk-S6Z7YQFY.js.map
