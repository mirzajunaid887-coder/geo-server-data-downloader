...
function d({ displayField: t, editFieldsInfo: i, fields: n2, objectIdField: o, title: r }, s) {
  ...
  return new G({ title: a, content: d2, fieldInfos: l2 });
}
...
function b(e, i) {
  const n2 = i == null ? void 0 : i.visibleFieldNames;
  return f({ fields: e.fields ?? [], ignoreFieldTypes: (i == null ? void 0 : i.ignoreFieldTypes) || C, sortDisabled: i == null ? void 0 : i.sortDisabled }).map((i2) => new u({ fieldName: i2.name, isEditable: K(i2, e), label: i2.alias, format: g(i2), visible: c(i2, { ...e, visibleFieldNames: n2 }) }));
}
function g(e) {
  switch (e.type) {
    case "small-integer":
...
//# sourceMappingURL=chunk-4QOENBHC.js.map
