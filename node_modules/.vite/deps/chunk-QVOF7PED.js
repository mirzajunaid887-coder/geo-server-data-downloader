...
async function t(l, o, r2) {
  ...
  return (await Promise.all(u2.map(async (e, r3) => {
    const n2 = "opacity" === l.type ? await a(e, l, o) : (await import("./visualVariableUtils-MFMTPJK6.js")).getColor(l, e), u3 = t2 ? s2[r3] : (p == null ? void 0 : p[r3]) ?? "";
    return null == n2 ? null : { value: e, color: n2, label: u3 };
  }))).filter(U).reverse();
}
async function a(e, o, n2) {
  const t2 = new g(n2 ?? r), a2 = (await import("./visualVariableUtils-MFMTPJK6.js")).getOpacity(o, e);
...
function u(l) {
  ...
  const u2 = e ? null : n(o);
  return o.map((o2, n2) => ({ value: o2, color: s(o2, l), label: e ? r2[n2] : (u2 == null ? void 0 : u2[n2]) ?? "" })).reverse();
}
function s(e, o) {
...
function c(e, o) {
  let r2 = [];
  if ("multipart" === (e == null ? void 0 : e.type)) e.colorRamps.reverse().forEach((n2, t2) => {
    ...
    let n2, t2;
    "algorithmic" === (e == null ? void 0 : e.type) ? (n2 = e.fromColor, t2 = e.toColor) : (n2 = [0, 0, 0, 1], t2 = [255, 255, 255, 1]), r2 = [{ value: o.max, color: new g(t2), label: "high" }, { value: o.min, color: new g(n2), label: "low" }];
  }
  return r2;
}
...
//# sourceMappingURL=chunk-QVOF7PED.js.map
