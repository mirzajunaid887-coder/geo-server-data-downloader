import {
  n as n3
} from "./chunk-OWK3O4AD.js";
import {
  i,
  m,
  m2
} from "./chunk-2MV6ZKGI.js";
import {
  n as n2
...
var S = class extends b {
  ...
  async executeJSON(e, t) {
    var _a;
    const r2 = this._normalizeQuery(e), o = null != ((_a = e.outStatistics) == null ? void 0 : _a[0]), s = has("featurelayer-pbf-statistics");
    let i2;
    ...
    return i2 ?? (i2 = await n2(this.url, r2, t, { uniqueIdFields: this.uniqueIdFields })), this._normalizeFields(i2.fields), i2;
  }
  async featureSetFromJSON(e, t, r2) {
    if (!this._queryGet3DObjectFormat(e) || null == this.infoFor3D || !t.features) return g.fromJSON(t);
    const { meshFeatureSetFromJSON: s } = await h(import("./meshFeatureSet-ALWDTFUF.js"), r2);
  ...
  async executeRelationshipQuery(e, t) {
    const [{ default: r2 }, { executeRelationshipQuery: s }] = await h(Promise.all([import("./RelationshipQuery-MGF2ZGAP.js"), import("./executeRelationshipQuery-QKTMMVBE.js")]), t);
    let i2 = r2.from(e);
  ...
  async executeRelationshipQueryForCount(e, t) {
    const [{ default: r2 }, { executeRelationshipQueryForCount: s }] = await h(Promise.all([import("./RelationshipQuery-MGF2ZGAP.js"), import("./executeRelationshipQuery-QKTMMVBE.js")]), t);
    let i2 = r2.from(e);
    return (this.gdbVersion || this.dynamicDataSource) && (i2 = i2.clone(), i2.gdbVersion = i2.gdbVersion || this.gdbVersion, i2.dynamicDataSource = i2.dynamicDataSource || this.dynamicDataSource), s(this.url, i2, t);
  }
  async executeAttachmentQuery(e, t) {
    const { executeAttachmentQuery: r2, fetchAttachments: s, processAttachmentQueryResult: i2 } = await h(import("./queryAttachments-CR7R6AFE.js"), t), u = f(this.url);
    return i2(u, await (this.queryAttachmentsSupported ? r2(u, e, t) : s(u, e, t)));
  }
  async executeAttributeBinsQuery(e, t) {
    const { executeAttributeBinsQuery: r2 } = await h(import("./executeAttributeBinsQuery-O5FIFRBH.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executePivotQuery(e, t) {
    const { executePivotQuery: r2 } = await h(import("./executePivotQuery-AHKTCNSJ.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeTopFeaturesQuery(e, t) {
    const { executeTopFeaturesQuery: r2 } = await h(import("./executeTopFeaturesQuery-AAR25KK4.js"), t);
    return r2(this.parsedUrl, e, this.sourceSpatialReference, t);
  }
  async executeForTopIds(e, t) {
    const { executeForTopIds: r2 } = await h(import("./executeForTopIds-YWCHIAPE.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeForTopExtents(e, t) {
    const { executeForTopExtents: r2 } = await h(import("./executeForTopExtents-PJO2OGEW.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeForTopCount(e, t) {
    const { executeForTopCount: r2 } = await h(import("./executeForTopCount-QYTMVBRL.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  _normalizeQuery(e) {
    let t = b2.from(e);
    ...
    if (null != o && s) {
      ...
      if (null == t.outFields || !t.outFields.includes("*")) {
        ...
        const { originX: r2, originY: s2, originZ: i2, translationX: u, translationY: n4, translationZ: a2, scaleX: c2, scaleY: p, scaleZ: l, rotationX: d, rotationY: m3, rotationZ: y, rotationDeg: h2 } = o.transformFieldRoles;
        t.outFields.push(r2, s2, i2, u, n4, a2, c2, p, l, d, m3, y, h2);
      }
    }
    return t;
  }
  ...
  _queryGet3DObjectFormat({ returnGeometry: e, multipatchOption: t, outStatistics: r2 }) {
    return true !== e || "xyFootprint" === t || r2 ? null : w(this.infoFor3D);
  }
};
...
//# sourceMappingURL=chunk-B5ZOMLVQ.js.map
