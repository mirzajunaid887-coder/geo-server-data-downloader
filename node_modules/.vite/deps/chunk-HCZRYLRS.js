...
function createFocusTrapOptions(hostEl, options) {
  ...
  return {
    ...
    onActivate: (params) => {
      var _a;
      if (options == null ? void 0 : options.escapeDeactivates) {
        abortController = new AbortController();
        hostEl.addEventListener(
          "keydown",
          (event) => {
            if (event.key === "Escape") {
              const escapeDeactivates = options == null ? void 0 : options.escapeDeactivates;
      ...
      (_a = options == null ? void 0 : options.onActivate) == null ? void 0 : _a.call(options, params);
    },
    onDeactivate: (params) => {
      var _a;
      abortController == null ? void 0 : abortController.abort();
      abortController = void 0;
      (_a = options == null ? void 0 : options.onDeactivate) == null ? void 0 : _a.call(options, params);
    },
    onPostDeactivate: () => {
...
var useFocusTrap = (options = {}) => {
  return makeGenericController((component, controller) => {
    ...
    controller.onDisconnected(() => deactivateTrap2());
    const utils = {
      get _instance() {
        if (false) {
          return focusTrap;
...
focus-trap/dist/focus-trap.esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-HCZRYLRS.js.map
