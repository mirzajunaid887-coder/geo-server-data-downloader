...
var h = class extends t2 {
  constructor({ referenceLine: i2, lineStart: a, targetPoint: f, isDraped: d }) {
    ...
    c(h2, e(h2, h2, g), o), super(f, new Rt(a, c2(h2)), d, 2), this._referenceLines = [{ edge: i2, fadeLeft: true, fadeRight: true }];
  }
  get hints() {
...
var m = class extends t2 {
  constructor({ targetPoint: e2, point1: p2, point2: a, isDraped: m2 }) {
    super(e2, new Lt(c2(I(n(), p2, a, 0.5)), 0.5 * p(s(p2), s(a))), m2, 2), this._p1 = p2, this._p2 = a;
  }
  get hints() {
...
//# sourceMappingURL=chunk-KDWY2E6D.js.map
