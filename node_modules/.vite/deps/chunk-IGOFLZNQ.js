...
function Q(t2, i, n3) {
  ...
  return e(n3.origin, n3.origin, s3), n3.plane[3] -= i, n3;
}
function X2(t2, i, n3) {
...
function it(t2, i, n3) {
  ...
  return e(n3, i.origin, x(c2.get(), i.direction, p(i.origin, s3) / a(i.direction))), n3;
}
function nt(t2, n3, s3) {
  ...
  for (const o3 of Vt) {
    ...
    if (L(r2, u2, g)) {
      const t3 = G(c2.get(), n3.origin, g), r3 = Math.abs(m(A(n3.direction, t3)));
      r3 < e3 && (e3 = r3, o2(s3, g));
    }
  }
...
function et(t2, i, n3) {
  const s3 = R(t2.plane, i, c2.get()), r2 = B(It(t2, t2.basis1), s3, -1, 1, c2.get()), e3 = B(It(t2, t2.basis2), s3, -1, 1, c2.get());
  return c(n3, e(c2.get(), r2, e3), t2.origin), n3;
}
function ot(t2, i, n3) {
  const { origin: s3, basis1: r2, basis2: e3 } = t2, o3 = c(c2.get(), i, s3), a2 = m2(r2, o3), c3 = m2(e3, o3), u2 = m2(ht(t2), o3);
...
function mt(t2, i, n3) {
  return t2 !== n3 && W(t2, n3), h(At, i), s(At, At), S(n3.basis1, t2.basis1, At), S(n3.basis2, t2.basis2, At), S(y(n3.plane), y(t2.plane), At), S(n3.origin, t2.origin, i), G2(n3.plane, n3.plane, n3.origin), n3;
}
function dt(t2, i, n3, r2) {
  return t2 !== r2 && W(t2, r2), p2(_t, i, n3), S(r2.basis1, t2.basis1, _t), S(r2.basis2, t2.basis2, _t), K2(r2), r2;
}
function ht(t2) {
  return y(t2.plane);
}
...
function yt(t2, i) {
  const n3 = c(c2.get(), i, t2.origin), s3 = j(t2.basis1), r2 = j(t2.basis2), e3 = A(t2.basis1, n3), o3 = A(t2.basis2, n3);
...
function vt(t2, i, n3) {
  ...
  e(n3.origin, o3, a2), e(n3.origin, n3.origin, e3);
  const c3 = x(c2.get(), s3, i.direction[0]), u2 = x(c2.get(), r2, i.direction[1]);
  return x(n3.vector, e(c3, c3, u2), 2), n3;
}
function Pt(t2, i) {
...
//# sourceMappingURL=chunk-IGOFLZNQ.js.map
