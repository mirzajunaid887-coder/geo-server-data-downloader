...
var S2 = n3 = class extends n {
  ...
  clone() {
    const { leftTableKey: e, rightTableKey: r2, leftTableSource: o3, rightTableSource: t2, joinType: c4 } = this, s3 = { leftTableKey: e, rightTableKey: r2, leftTableSource: (o3 == null ? void 0 : o3.clone()) ?? void 0, rightTableSource: (t2 == null ? void 0 : t2.clone()) ?? void 0, joinType: c4 };
    return new n3(s3);
  }
};
...
var a4 = y2 = class extends n {
  ...
  clone() {
    const { workspaceId: e, query: r2, oidFields: o3, spatialReference: t2, geometryType: p4 } = this, s3 = { workspaceId: e, query: r2, oidFields: o3, spatialReference: (t2 == null ? void 0 : t2.clone()) ?? void 0, geometryType: p4 };
    return new y2(s3);
  }
};
...
//# sourceMappingURL=chunk-NWIJE6CU.js.map
