...
function u(t2) {
  ...
  if (!o2) return n;
  for (const r of o2) {
    if (!((_a = r.coverageAreas) == null ? void 0 : _a.length) || !r.attribution) continue;
...
function l(t2, o2, e, c2) {
  ...
  return (u2 == null ? void 0 : u2.filter((t3) => {
    const o3 = !m2.has(t3.index) && R(t3.bbox, l2, f2);
...
//# sourceMappingURL=chunk-NIGVFB2V.js.map
