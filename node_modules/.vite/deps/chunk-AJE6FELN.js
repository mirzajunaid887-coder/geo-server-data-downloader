...
var c3 = class {
  ...
  async getSymbolAsync(t2, e3, r4 = true) {
    var _a;
    const i6 = await this._evaluator, l3 = (e3 == null ? void 0 : e3.fields) ?? _(t2.attributes), n7 = i6.createDictionaryFieldsIndex(l3), m8 = i6.evaluate(t2, (e3 == null ? void 0 : e3.scale) ?? 0, n7, e3 == null ? void 0 : e3.spatialReference);
    if (null == m8) return null;
    const c6 = u2(t2.geometry), y4 = t.parse(m8, i6.itemNames, c6), f4 = "esriGeometryPoint" === c6 && !((_a = t2.geometry) == null ? void 0 : _a.hasZ);
  ...
  async _cimPartsToCIMSymbol(t2, r4, o2, s4, i6, a7, m8) {
    const c6 = r4.map((t3) => this._getSymbolPart(t3, i6));
    let f4 = await Promise.all(c6);
    if (a7 && this.fieldMap && f4.length > 0) {
      const { OverrideHelper: r5 } = await import("./OverrideHelper-4R4MIFKU.js");
      f4 = a(f4);
      for (const e3 of f4) r5.applyDictionaryTextOverrides(e3, t2, this.fieldMap, m8, _2(e3));
    }
    const p3 = y(f4, o2, s4);
    return new m2({ data: p3 });
  }
  async _fetchSymbolPart(e3, r4) {
    const o2 = await this.dictionaryInfo, s4 = (this.url + "/" + o2.cimRefTemplateUrl).replaceAll(/\{itemName\}/gi, e3), { data: i6 } = await f(s4, { responseType: "json", query: { f: "json" }, ...r4 });
    return i6;
  }
...
var c4 = p = class extends m4(a3) {
  ...
  writeVisualVariables(e3, t2, s4, i6) {
    (i6 == null ? void 0 : i6.origin) || super.writeVisualVariables(e3, t2, s4, i6);
  }
  clone() {
...
__decorate([a2({ type: [a6], json: { write: true } })], y2.prototype, "attributes", void 0), __decorate([a2({ type: g, json: { write: true } })], y2.prototype, "backgroundColor", void 0), __decorate([a2({ type: Boolean, json: { write: true } })], y2.prototype, "dotBlendingEnabled", void 0), __decorate([a2({ type: String, json: { write: false } })], y2.prototype, "dotShape", void 0), __decorate([a2({ type: Number, json: { write: true } })], y2.prototype, "dotSize", void 0), __decorate([a2({ type: i2, json: { write: true } })], y2.prototype, "legendOptions", void 0), __decorate([a2({ type: d, json: { default: null, write: true } })], y2.prototype, "outline", void 0), __decorate([a2({ type: Number, json: { write: true } })], y2.prototype, "dotValue", void 0), __decorate([a2({ type: Number, json: { write: true } })], y2.prototype, "referenceScale", void 0), __decorate([a2({ type: Number, json: { write: true } })], y2.prototype, "seed", void 0), __decorate([r({ dotDensity: "dot-density" })], y2.prototype, "type", void 0), y2 = m6 = __decorate([c("esri.renderers.DotDensityRenderer")], y2);
...
function f2(t2) {
  if (null != t2) {
    ...
    if (null != e3 || null != i6 || null != s4) {
      const { blurRadius: e4, maxPixelIntensity: i7, minPixelIntensity: s5, ...r4 } = t2;
      return r4;
    }
  }
  return t2;
}
var w = g2 = class extends a3 {
  constructor(t2) {
...
__decorate([a2({ type: b, json: { write: true, origins: { "web-scene": { write: false, read: false } } } })], w.prototype, "authoringInfo", void 0), __decorate([a2({ type: Number, json: { origins: { "portal-item": { write: true }, "web-map": { write: true } } } })], w.prototype, "blurRadius", null), __decorate([a2({ type: [l2], json: { write: { isRequired: true } } })], w.prototype, "colorStops", void 0), __decorate([a2({ type: String, json: { write: true } })], w.prototype, "field", void 0), __decorate([a2({ type: p2, json: { write: true } })], w.prototype, "legendOptions", void 0), __decorate([a2({ type: Number, json: { write: true } })], w.prototype, "maxDensity", void 0), __decorate([a2({ type: Number, json: { origins: { "portal-item": { write: true }, "web-map": { write: true } } } })], w.prototype, "maxPixelIntensity", null), __decorate([a2({ type: Number, json: { write: true } })], w.prototype, "minDensity", void 0), __decorate([a2({ type: Number, json: { origins: { "portal-item": { write: true }, "web-map": { write: true } } } })], w.prototype, "minPixelIntensity", null), __decorate([a2({ type: Number, cast: o, json: { write: true } })], w.prototype, "radius", null), __decorate([a2({ type: Number, range: { min: 0 }, json: { default: 0, write: true } })], w.prototype, "referenceScale", void 0), __decorate([r({ heatmap: "heatmap" })], w.prototype, "type", void 0), __decorate([a2({ type: String, json: { write: true, origins: { "web-document": { write: false }, "portal-item": { write: false } } } })], w.prototype, "valueExpression", void 0), __decorate([a2({ type: String })], w.prototype, "valueExpressionTitle", void 0), __decorate([a2({ readOnly: true })], w.prototype, "_pixelIntensityToDensity", null), w = g2 = __decorate([c("esri.renderers.HeatmapRenderer")], w);
...
var v2 = { base: u4, key: "type", typeMap: { size: j, opacity: a4 } };
var S = class extends m4(l(a3)) {
  constructor(e3) {
  ...
  get symbols() {
    return [this.getSymbol(), this.backgroundFillSymbol].filter(U);
  }
  async collectRequiredFields(e3, t2) {
    await this.collectVVRequiredFields(e3, t2);
    for (const o2 of this.attributes) o2.valueExpression && await v(e3, t2, null, o2.valueExpression), o2.field && e3.add(o2.field);
...
var m7 = { key: "type", base: a3, typeMap: { heatmap: w, simple: n4, "unique-value": A, "class-breaks": j2, "dot-density": y2, dictionary: c4, "pie-chart": S }, errorContext: "renderer" };
var u7 = { key: "type", base: a3, typeMap: { simple: n4, "unique-value": A, "class-breaks": j2, heatmap: w }, errorContext: "renderer", validate: c5 };
function c5(e3) {
  switch (e3.type) {
    case "simple":
      return f3(e3);
...
function d2(r4) {
  const t2 = r4.uniqueValueInfos, s4 = t2 == null ? void 0 : t2.filter(({ symbol: r5, label: t3 }, s5) => (r5 || n.getLogger("esri.renderers.support.types").error(`Removed invalid unique value info ([${s5}] ${t3}) without a symbol from web scene.`), !!r5));
  return (s4 == null ? void 0 : s4.length) !== (t2 == null ? void 0 : t2.length) && (r4.uniqueValueInfos = s4), r4;
}
function y3(r4) {
  const t2 = r4.classBreakInfos, s4 = t2 == null ? void 0 : t2.filter(({ symbol: r5, label: t3 }, s5) => (r5 || n.getLogger("esri.renderers.support.types").error(`Removed invalid class break info ([${s5}] ${t3}) without a symbol from web scene.`), !!r5));
...
//# sourceMappingURL=chunk-AJE6FELN.js.map
