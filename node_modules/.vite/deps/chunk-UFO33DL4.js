import {
  l as l3
} from "./chunk-O6SCFUZZ.js";
import {
  D as D2,
  H
} from "./chunk-TJLC532S.js";
import {
  c as c5,
  d,
  f as f3,
...
var u5 = class extends n {
  ...
  get flatWebGLFunctionChain() {
    ...
    for (; r11 == null ? void 0 : r11.length; ) {
      ...
      for (let s15 = 0; s15 < r11.length; s15++) {
        const { parameters: e7 } = r11[s15], i23 = e7.rasters || e7.raster && [e7.raster];
        (i23 == null ? void 0 : i23.length) && t4.push(...i23);
      }
      r11 = t4;
    }
    for (let a27 = s14.length - 1; a27 >= 0; a27--) s14[a27].isNoopProcess && s14.splice(a27, 1);
    let i22 = false;
    for (let a27 = 0; a27 < s14.length; a27++) {
      const t4 = s14[a27];
      t4.id = s14.length - a27 - 1;
      const { rasters: e7 } = t4.parameters;
      i22 = i22 || null != e7 && e7.length > 1;
    }
    const n28 = s14.some(({ name: t4 }) => a6.has(t4.toLowerCase())), { rawSourceRasterInfos: o19 } = this;
    return { functions: s14, hasBranches: i22, hasFocalFunction: n28, isSourceSingleBand: 1 === ((_a = o19 == null ? void 0 : o19[0]) == null ? void 0 : _a.bandCount) };
  }
  get neighborhoodSize() {
    let { rows: t3, cols: s14 } = this._getNeighborhoodSize();
    const e6 = this.getImmediateChildFunctions();
    for (const r11 of e6) {
      const e7 = r11.neighborhoodSize;
      t3 = Math.max(t3, e7.rows), s14 = Math.max(s14, e7.cols);
    }
    return { rows: t3, cols: s14 };
  }
  bind(t3, s14 = false, e6 = -1) {
    this.id = e6 + 1;
    const r11 = this._getRasterValues();
    let i22 = true;
    for (let n28 = 0; n28 < r11.length; n28++) {
      const e7 = r11[n28];
      if (null != e7 && this._isRasterFunctionValue(e7)) {
        const r12 = e7.bind(t3, s14, this.id + n28);
        if (!r12.success) return this._bindingResult = r12, r12;
        i22 = i22 && r12.supportsGPU;
      }
    }
    if (!this.rasterInfo || s14) {
      if (this.sourceRasterInfos = this._getSourceRasterInfos(t3), this._bindingResult = this._bindSourceRasters(), i22 && (i22 = this._bindingResult.supportsGPU), this._bindingResult.success && (this._patchRasterInfo(), i22 && this.isRoot)) {
        this.processInputBandIds();
        this.swizzleInputBandIds(this.rawInputBandIds) || (i22 = this.rawInputBandIds.length <= 3);
      }
      return this._bindingResult.supportsGPU = i22, this._bindingResult;
    }
  ...
  process(t3, s14) {
    ...
    return this._processPixels({ ...t3, pixelBlocks: r11 }, s14);
  }
  processInputBandIds() {
  ...
  _getNeighborhoodSize() {
    return { rows: 1, cols: 1 };
  }
  _removeStatsHistColormapVAT(t3) {
    var _a;
    t3.statistics = null, t3.histograms = null, t3.colormap = null, t3.attributeTable = null, (_a = t3.multidimensionalInfo) == null ? void 0 : _a.variables.forEach((t4) => {
  ...
  _getSourceRasterInfos(t3) {
    ...
    const i22 = s14.map((t4) => t4 && "object" == typeof t4 && "bind" in t4 && t4.rasterInfo ? t4.rasterInfo : "string" == typeof t4 && r11.includes(t4) ? e6[r11.indexOf(t4)] : "number" != typeof t4 ? e6[0] : void 0), n28 = i22.find((t4) => t4) ?? e6[0];
    return i22.forEach((t4, s15) => {
      void 0 === t4 && (i22[s15] = n28);
    }), i22;
  }
  _getPrimaryRasterId(t3) {
    return t3 == null ? void 0 : t3.rasterId;
  }
  _getPrimaryRasters(t3, s14 = [], e6 = []) {
    for (let r11 = 0; r11 < t3.sourceRasters.length; r11++) {
      const i22 = t3.sourceRasters[r11];
      if ("number" != typeof i22) if ("bind" in i22) this._getPrimaryRasters(i22, s14, e6);
      else {
        const t4 = i22, r12 = this._getPrimaryRasterId(t4);
  ...
  _readRasterValue(t3, s14, e6) {
    ...
    if ("number" == typeof t3) {
      ...
      const { width: e7, height: i22, pixelType: o19 } = s15, a27 = new Float32Array(e7 * i22);
      a27.fill(t3);
      const u23 = this.sourceRasterInfos[0].bandCount, l23 = new Array(u23).fill(a27);
      return new c3({ width: e7, height: i22, pixelType: o19, pixels: l23 });
    }
    return t3.process(s14, e6);
  }
  _patchRasterInfo() {
    const { rasterInfo: t3 } = this;
    if (!(t3 == null ? void 0 : t3.keyProperties)) return;
    const { bandCount: s14, keyProperties: e6, statistics: r11, histograms: i22 } = t3, n28 = e6.BandProperties;
    n28 && n28.length !== s14 && (t3.keyProperties = { ...e6, BandProperties: void 0 }), r11 && r11.length !== s14 && (t3.statistics = r11.length > s14 ? r11.slice(0, s14) : null), i22 && i22.length !== s14 && (t3.histograms = i22.length > s14 ? i22.slice(0, s14) : null), e6.BAND_COUNT && Number(e6.BAND_COUNT) !== s14 && (t3.keyProperties = { ...e6, BAND_COUNT: "string" == typeof e6.BAND_COUNT ? String(s14) : s14 });
  }
};
__decorate([a2({ json: { write: true } })], u5.prototype, "functionName", void 0), __decorate([a2({ json: { write: true } })], u5.prototype, "functionArguments", void 0), __decorate([a2()], u5.prototype, "rasterArgumentNames", void 0), __decorate([a2({ json: { write: true } }), m((t3) => t3 == null ? void 0 : t3.toLowerCase())], u5.prototype, "outputPixelType", void 0), __decorate([a2({ json: { write: true } })], u5.prototype, "mainPrimaryRasterId", void 0), __decorate([a2()], u5.prototype, "sourceRasters", void 0), __decorate([a2({ type: [m5], json: { write: true } })], u5.prototype, "sourceRasterInfos", void 0), __decorate([a2({ json: { write: true } })], u5.prototype, "rasterInfo", void 0), __decorate([a2({ json: { write: true } })], u5.prototype, "readingBufferSize", void 0), __decorate([a2({ json: { write: true } })], u5.prototype, "id", void 0), __decorate([a2()], u5.prototype, "isNoopProcess", void 0), __decorate([a2()], u5.prototype, "supportsGPU", null), __decorate([a2({ json: { write: true } })], u5.prototype, "rawInputBandIds", void 0), __decorate([a2()], u5.prototype, "rawSourceRasterInfos", void 0), __decorate([a2({ json: { write: true } })], u5.prototype, "isInputBandIdsSwizzled", void 0), __decorate([a2({ json: { write: true } })], u5.prototype, "swizzledBandSelection", void 0), __decorate([a2()], u5.prototype, "isBranch", void 0), __decorate([a2()], u5.prototype, "isRoot", void 0), __decorate([a2({ readOnly: true })], u5.prototype, "flatWebGLFunctionChain", null), __decorate([a2({ readOnly: true })], u5.prototype, "neighborhoodSize", null), __decorate([a2()], u5.prototype, "_bindingResult", void 0), u5 = __decorate([c("esri.layers.raster.functions.BaseRasterFunction")], u5);
var l5 = u5;

// node_modules/@arcgis/core/layers/support/rasterFunctionConstants.js
var D4 = { userDefined: -1, lineDetectionHorizontal: 0, lineDetectionVertical: 1, lineDetectionLeftDiagonal: 2, lineDetectionRightDiagonal: 3, gradientNorth: 4, gradientWest: 5, gradientEast: 6, gradientSouth: 7, gradientNorthEast: 8, gradientNorthWest: 9, smoothArithmeticMean: 10, smoothing3x3: 11, smoothing5x5: 12, sharpening3x3: 13, sharpening5x5: 14, laplacian3x3: 15, laplacian5x5: 16, sobelHorizontal: 17, sobelVertical: 18, sharpen: 19, sharpen2: 20, pointSpread: 21, none: 255 };
...
function f4(t3, e6 = false) {
  ...
  const s14 = r11[0], a27 = new Uint8Array(s14);
  if (1 === r11.length) return a27;
  if (!e6) {
    for (let t4 = 1; t4 < r11.length; t4++) {
      const e7 = r11[t4];
      for (let t5 = 0; t5 < a27.length; t5++) a27[t5] && (a27[t5] = e7[t5] ? 255 : 0);
    }
    return a27;
  }
  for (let l23 = 1; l23 < r11.length; l23++) {
    const t4 = r11[l23];
    for (let e7 = 0; e7 < a27.length; e7++) 0 === a27[e7] && (a27[e7] = t4[e7] ? 255 : 0);
  }
  return a27;
}
function i3(t3, e6, r11) {
  const [o19, s14] = t3, a27 = o19.length, l23 = c3.createEmptyBand(r11, a27);
  for (let n28 = 0; n28 < a27; n28++) e6 && !e6[n28] || (l23[n28] = o19[n28] + s14[n28]);
  return l23;
}
function u6(t3, e6, r11) {
  const [o19] = t3, s14 = o19.length, a27 = c3.createEmptyBand("f32", s14);
  return a27.set(o19), a27;
}
function h2(t3, e6, r11) {
  const [o19] = t3, s14 = o19.length, a27 = c3.createEmptyBand(r11, s14);
  for (let n28 = 0; n28 < s14; n28++) e6 && !e6[n28] || (a27[n28] = o19[n28] * o19[n28]);
  return a27;
}
...
function m8(t3, e6, r11) {
  const [o19] = t3, s14 = o19.length, a27 = c3.createEmptyBand(r11, s14);
  for (let n28 = 0; n28 < s14; n28++) e6 && !e6[n28] || (a27[n28] = Math.sign(o19[n28]) * Math.floor(Math.abs(o19[n28])));
  return a27;
}
...
function E(t3, e6, r11) {
  const [o19, s14] = t3, a27 = o19.length, l23 = c3.createEmptyBand(r11, a27);
  for (let n28 = 0; n28 < a27; n28++) e6 && !e6[n28] || (l23[n28] = Math.floor(o19[n28] / s14[n28]));
  return l23;
}
function M2(t3, e6, r11, s14) {
  const a27 = t3[0], l23 = a27.length, c31 = c3.createEmptyBand(r11, l23);
  if (s14 === p2.atanh) {
    for (let t4 = 0; t4 < l23; t4++) if (e6[t4]) {
      const n28 = a27[t4];
      Math.abs(n28) >= 1 ? e6[t4] = 0 : c31[t4] = Math.atanh(n28);
    }
    return c31;
  }
  const f8 = s14 === p2.asin ? Math.asin : Math.acos;
  for (let n28 = 0; n28 < l23; n28++) if (e6[n28]) {
    const t4 = a27[n28];
    Math.abs(t4) > 1 ? e6[n28] = 0 : c31[n28] = f8(t4);
  }
  return c31;
}
function B3(t3, e6, r11, o19) {
  const [s14] = t3, a27 = s14.length, l23 = c3.createEmptyBand(r11, a27);
  for (let n28 = 0; n28 < a27; n28++) e6 && !e6[n28] || (l23[n28] = o19(s14[n28]));
  return l23;
}
function I(t3, e6, r11, o19) {
  const [s14, a27] = t3, l23 = s14.length, c31 = c3.createEmptyBand(r11, l23);
  for (let n28 = 0; n28 < l23; n28++) e6 && !e6[n28] || (c31[n28] = o19(s14[n28], a27[n28]));
  return c31;
}
...
function b2(t3, e6, r11) {
  const [o19] = t3, s14 = o19.length, a27 = c3.createEmptyBand(r11, s14);
  for (let n28 = 0; n28 < s14; n28++) e6 && !e6[n28] || (a27[n28] = ~o19[n28]);
  return a27;
}
...
function k(t3, e6, r11) {
  const [o19, s14] = t3, a27 = o19.length, l23 = c3.createEmptyBand(r11, a27);
  for (let n28 = 0; n28 < a27; n28++) e6 && !e6[n28] || (l23[n28] = o19[n28] && s14[n28] ? 1 : 0);
  return l23;
}
function q(t3, e6, r11) {
  const [o19] = t3, s14 = o19.length, a27 = c3.createEmptyBand(r11, s14);
  for (let n28 = 0; n28 < s14; n28++) e6 && !e6[n28] || (a27[n28] = o19[n28] ? 0 : 1);
  return a27;
}
...
function U2(t3, e6, r11) {
  const [o19, s14] = t3, a27 = o19.length, l23 = c3.createEmptyBand(r11, a27);
  for (let n28 = 0; n28 < a27; n28++) e6 && !e6[n28] || (l23[n28] = (o19[n28] ? 1 : 0) ^ (s14[n28] ? 1 : 0));
  return l23;
}
...
function F(t3, e6, r11, o19) {
  const [s14] = t3, a27 = s14.length, l23 = c3.createEmptyBand(r11, a27), c31 = o19 === Math.E;
  for (let n28 = 0; n28 < a27; n28++) e6 && !e6[n28] || (l23[n28] = c31 ? Math.exp(s14[n28]) : o19 ** s14[n28]);
  return l23;
}
...
function R(t3, e6, r11, o19) {
  const [s14] = t3, a27 = s14.length, l23 = c3.createEmptyBand(r11, a27);
  for (let n28 = 0; n28 < a27; n28++) e6 && !e6[n28] || (s14[n28] <= 0 ? e6[n28] = 0 : l23[n28] = o19(s14[n28]));
  return l23;
}
...
function K(t3, e6, r11) {
  const [o19] = t3, s14 = o19.length, a27 = c3.createEmptyBand(r11, s14);
  if (!e6) return a27;
  for (let n28 = 0; n28 < s14; n28++) a27[n28] = e6[n28] ? 0 : 1;
  return a27;
}
...
function V(t3, e6, r11) {
  const [o19, s14] = t3, a27 = o19.length, l23 = c3.createEmptyBand(r11, a27);
  for (let n28 = 0; n28 < a27; n28++) e6 && !e6[n28] || (l23[n28] = o19[n28] === s14[n28] ? 0 : 1);
  return l23;
}
function W(t3, e6, r11) {
  const [o19, s14] = t3, a27 = o19.length, l23 = c3.createEmptyBand(r11, a27), c31 = new Uint8Array(a27);
  for (let n28 = 0; n28 < a27; n28++) null != e6 && !e6[n28] || 0 !== o19[n28] || (l23[n28] = s14[n28], c31[n28] = 255);
  return { band: l23, mask: c31 };
}
function Y(t3, e6, r11) {
  const [o19, s14, a27] = t3, l23 = o19.length, c31 = c3.createEmptyBand(r11, l23);
  for (let n28 = 0; n28 < l23; n28++) e6 && !e6[n28] || (c31[n28] = o19[n28] ? s14[n28] : a27[n28]);
  return c31;
}
function Z(t3, e6, r11) {
  ...
  const [s14] = t3, a27 = s14.length, l23 = c3.createEmptyBand(r11, a27);
  for (let n28 = 0; n28 < a27; n28++) if (!e6 || e6[n28]) {
    let e7 = s14[n28];
...
function et(t3, e6, r11) {
  ...
  if (o19 < 2) return t3[0];
  const [s14] = t3, a27 = s14.length, l23 = c3.createEmptyBand(r11, a27);
  for (let n28 = 0; n28 < a27; n28++) if (!e6 || e6[n28]) for (let e7 = 0; e7 < o19; e7++) {
    const r12 = t3[e7];
    l23[n28] += r12[n28];
  }
  return l23;
...
function nt(t3, e6, r11) {
  ...
  for (let n28 = 0; n28 < a27; n28++) if (!e6 || e6[n28]) {
    ...
    let r12 = 0;
    for (let a28 = 0; a28 < o19; a28++) {
      const o20 = t3[a28];
      r12 += o20[n28], e7[a28] = o20[n28];
    }
    r12 /= o19;
    let s15 = 0;
...
function rt(t3, e6, r11) {
  const o19 = t3.length;
  if (o19 < 2) return t3[0];
  const s14 = Math.floor(o19 / 2), [a27] = t3, l23 = a27.length, c31 = c3.createEmptyBand(r11, l23), f8 = new Float32Array(o19), i22 = o19 % 2 == 1;
  for (let n28 = 0; n28 < l23; n28++) if (!e6 || e6[n28]) {
    for (let e7 = 0; e7 < o19; e7++) f8[e7] = t3[e7][n28];
    f8.sort(), c31[n28] = i22 ? f8[s14] : (f8[s14] + f8[s14 - 1]) / 2;
  }
  return c31;
}
function ot(t3, e6, r11) {
  ...
  const a27 = o19.length, l23 = c3.createEmptyBand(r11, a27);
  for (let n28 = 0; n28 < a27; n28++) e6 && !e6[n28] || (l23[n28] = o19[n28] < s14[n28] ? o19[n28] : s14[n28]);
  return l23;
}
function st(t3, e6, r11) {
  const o19 = t3.length;
  if (o19 <= 2) return ot(t3, e6, r11);
  const s14 = t3[0].length, a27 = c3.createEmptyBand(r11, s14), l23 = /* @__PURE__ */ new Map();
  for (let n28 = 0; n28 < s14; n28++) if (!e6 || e6[n28]) {
    ...
    s15.length > 1 && s15.sort((t4, e8) => t4 - e8), a27[n28] = s15[0];
  }
  return a27;
}
...
function lt(t3, e6, r11) {
  const o19 = t3.length;
  if (o19 < 2) return t3[0];
  const [s14] = t3, a27 = s14.length, l23 = c3.createEmptyBand(r11, a27), c31 = /* @__PURE__ */ new Set();
  for (let n28 = 0; n28 < a27; n28++) if (!e6 || e6[n28]) {
    let e7;
    c31.clear();
    for (let r12 = 0; r12 < o19; r12++) e7 = t3[r12][n28], c31.add(e7);
    l23[n28] = c31.size;
  }
  return l23;
}
...
function ht() {
  ct.size || (ct.set(4, Math.sqrt), ct.set(6, Math.acos), ct.set(7, Math.asin), ct.set(8, Math.atan), ct.set(9, Math.atanh), ct.set(10, Math.abs), ct.set(21, Math.cos), ct.set(22, Math.cosh), ct.set(48, Math.floor), ct.set(49, Math.ceil), ct.set(51, Math.sin), ct.set(52, Math.sinh), ct.set(56, Math.tan), ct.set(57, Math.tanh), ct.set(59, Math.acosh), ct.set(60, Math.asinh), ct.set(65, Math.floor), ft.set(5, Math.pow), ft.set(61, Math.atan2), it.set(1, i3), it.set(2, g2), it.set(3, p3), it.set(11, w3), it.set(12, x), it.set(13, b2), it.set(14, A2), it.set(15, P), it.set(16, T), it.set(17, k), it.set(18, q), it.set(19, N), it.set(20, U2), it.set(23, d4), it.set(24, j), it.set(25, C2), it.set(26, z2), it.set(27, O), it.set(28, D5), it.set(29, G), it.set(30, m8), it.set(31, K), it.set(32, u6), it.set(33, H2), it.set(34, J), it.set(35, v), it.set(36, S), it.set(37, X), it.set(44, L), it.set(45, Q), it.set(46, V), it.set(53, h2), it.set(64, y), it.set(65, E), it.set(76, Y), it.set(78, Y), ut.set(38, st), ut.set(39, Z), ut.set(40, tt), ut.set(41, rt), ut.set(42, $), ut.set(43, at), ut.set(47, _), ut.set(54, nt), ut.set(55, et), ut.set(58, lt), ut.set(66, st), ut.set(67, Z), ut.set(68, tt), ut.set(69, rt), ut.set(70, $), ut.set(71, at), ut.set(72, _), ut.set(73, nt), ut.set(74, et), ut.set(75, lt));
}
function gt(l23, c31, i22 = {}) {
  ht();
  let u23 = f4(l23, c31 >= 66 && c31 <= 75);
  const { outputPixelType: h5 = "f32" } = i22, g5 = !ut.has(c31) || i22.processAsMultiband, p19 = g5 ? l23[0].pixels.length : 1, m17 = [];
  for (let f8 = 0; f8 < p19; f8++) {
    const i23 = ut.has(c31) && !g5 ? l23.flatMap((t3) => t3.pixels) : l23.map((t3) => t3.pixels[f8]);
    let p20, d11 = true;
    if (c31 === B2.setNull) {
      const t3 = W(i23, u23, h5);
      p20 = t3.band, u23 = t3.mask, d11 = false;
    } else if (it.has(c31)) {
      p20 = it.get(c31)(i23, u23, "f64");
    } else if (ct.has(c31)) p20 = c31 === p2.asin || c31 === p2.acos || c31 === p2.atanh ? M2(i23, u23, "f64", c31) : B3(i23, u23, "f64", ct.get(c31));
    else if (ft.has(c31)) p20 = I(i23, u23, "f64", ft.get(c31));
    else if (ut.has(c31)) {
      p20 = ut.get(c31)(i23, u23, "f64");
    } else p20 = i23[0], d11 = false;
    if (d11 && c31 !== s3.isNull && !a7.has(c31)) {
      const r11 = c3.createEmptyBand(h5, p20.length);
      u23 || (u23 = new Uint8Array(p20.length).fill(255)), f(p20, u23), c2(p20, u23, h5, r11), p20 = r11;
    }
    m17.push(p20);
  }
  const d10 = l23[0];
  return new c3({ width: d10.width, height: d10.height, pixelType: h5, mask: c31 === s3.isNull ? null : u23, pixels: m17 });
}
...
var p4 = class extends l5 {
  ...
  _processPixels(t3) {
    ...
    return null == (e6 == null ? void 0 : e6[0]) || null == (e6 == null ? void 0 : e6[1]) ? null : pt(e6, this.functionArguments.operation, this.outputPixelType);
  }
  _getWebGLParameters() {
...
var n5 = class extends l5 {
  ...
  _bindSourceRasters() {
    ...
    this.isGCS = ((_a = t3.spatialReference) == null ? void 0 : _a.isGeographic) ?? false, this.outputPixelType = this._getOutputPixelType("f32");
    const s14 = t3.clone();
  ...
  _processPixels(t3) {
    var _a;
    const s14 = (_a = t3.pixelBlocks) == null ? void 0 : _a[0];
    if (null == s14) return null;
    const { extent: e6, primaryPixelSizes: r11 } = t3, o19 = r11 == null ? void 0 : r11[0], n28 = o19 ?? (e6 ? { x: e6.width / s14.width, y: e6.height / s14.height } : { x: 1, y: 1 });
...
function t(t3, r11) {
  ...
  let a27 = "";
  for (let f8 = 0; f8 < l23.length; f8++) {
    const t4 = l23[f8];
    e3.has(t4) ? (a27.length && s14.push(n6(a27, r11)), o19.push(t4), a27 = "") : a27 = a27.concat(t4);
  }
  return a27.length && s14.push(n6(a27, r11)), { ops: o19, nums: s14 };
}
function n6(e6, t3) {
...
function r6(e6, t3, n28, r11) {
  ...
  const a27 = new Float32Array(l23);
  switch (t3) {
    case "+":
      for (let t4 = 0; t4 < l23; t4++) (null == e6 || e6[t4]) && (a27[t4] = o19[t4] + s14[t4]);
      break;
    case "-":
      for (let t4 = 0; t4 < l23; t4++) (null == e6 || e6[t4]) && (a27[t4] = o19[t4] - s14[t4]);
      break;
    case "*":
      ...
      break;
    case "/":
      for (let t4 = 0; t4 < l23; t4++) (null == e6 || e6[t4]) && s14[t4] && (a27[t4] = o19[t4] / s14[t4]);
      break;
    case "(":
    case ")":
...
function s4(e6, n28, s14) {
  let a27, { ops: f8, nums: i22 } = t(s14, n28);
  if (0 === f8.length) {
  ...
  for (; f8.length > 0; ) {
    const { numIndex: t3, opIndex: n29 } = o7(f8);
    if (a27 = r6(e6, f8[n29], i22[t3], i22[t3 + 1]), 1 === f8.length) break;
    f8 = l7(f8, n29), i22.splice(t3, 2, a27);
  }
  return [a27];
}
...
function s5(t3, i22) {
  if (!o3(t3)) return t3;
  const { equation: s14, method: l23 } = i22, c31 = i22.bandIndexes.map((t4) => t4 - 1), { pixels: U3, mask: q2 } = t3;
  let M4;
  switch (l23) {
    case "gndvi":
    case "nbr":
    ...
    case "ndmi":
    case "mndwi":
      M4 = u8(q2, U3[c31[0]], U3[c31[1]]);
      break;
    case "ndwi":
      M4 = u8(q2, U3[c31[1]], U3[c31[0]]);
      break;
    case "sr":
    case "sr-re":
    case "iron-oxide":
    ...
    case "clay-minerals":
      M4 = f5(q2, U3[c31[0]], U3[c31[1]]);
      break;
    case "ci-g":
    case "ci-re":
      M4 = h3(q2, U3[c31[0]], U3[c31[1]]);
      break;
    case "savi":
      M4 = w4(q2, U3[c31[0]], U3[c31[1]], c31[2] + 1);
      break;
    case "tsavi":
      M4 = m9(q2, U3[c31[0]], U3[c31[1]], c31[2] + 1, c31[3] + 1, c31[4] + 1);
      break;
    case "msavi":
      M4 = d5(q2, U3[c31[0]], U3[c31[1]]);
      break;
    case "gemi":
      M4 = g3(q2, U3[c31[0]], U3[c31[1]]);
      break;
    case "pvi":
      M4 = y2(q2, U3[c31[0]], U3[c31[1]], c31[2] + 1, c31[3] + 1);
      break;
    case "gvitm":
      M4 = p5(q2, [U3[c31[0]], U3[c31[1]], U3[c31[2]], U3[c31[3]], U3[c31[4]], U3[c31[5]]]);
      break;
    case "sultan":
      M4 = b3(q2, [U3[c31[0]], U3[c31[1]], U3[c31[2]], U3[c31[3]], U3[c31[4]]]);
      break;
    case "vari":
      M4 = v2(q2, [U3[c31[0]], U3[c31[1]], U3[c31[2]]]);
      break;
    case "mtvi2":
      M4 = k2(q2, [U3[c31[0]], U3[c31[1]], U3[c31[2]]]);
      break;
    case "rtvi-core":
      M4 = A3(q2, [U3[c31[0]], U3[c31[1]], U3[c31[2]]]);
      break;
    case "evi":
      M4 = F2(q2, [U3[c31[0]], U3[c31[1]], U3[c31[2]]]);
      break;
    case "wndwi":
      M4 = x2(q2, [U3[c31[0]], U3[c31[1]], U3[c31[2]]], c31[3] ? c31[3] + 1 : 0.5);
      break;
    case "bai":
      M4 = j2(q2, U3[c31[0]], U3[c31[1]]);
      break;
    case "custom":
      M4 = s4(q2, U3, s14);
      break;
  ...
  let I3;
  q2 ? (I3 = new Uint8Array(t3.width * t3.height), I3.set(q2)) : T3 && (I3 = new Uint8Array(t3.width * t3.height).fill(255)), T3 && (M4 = M4.map((t4) => {
...
function l8(t3, n28, e6, r11) {
  const { mask: o19, pixels: i22, width: s14, height: l23 } = t3, c31 = i22[e6], u23 = i22[n28], f8 = u23.length, h5 = r11 ? new Uint8Array(f8) : new Float32Array(f8), w6 = r11 ? 100 : 1, m17 = r11 ? 100.5 : 0;
  for (let a27 = 0; a27 < f8; a27++) if (null == o19 || o19[a27]) {
    const t4 = c31[a27], n29 = u23[a27], e7 = t4 + n29;
    e7 && (h5[a27] = (t4 - n29) / e7 * w6 + m17);
  }
  const d10 = new c3({ width: s14, height: l23, mask: o19, pixelType: r11 ? "u8" : "f32", pixels: [h5] });
...
function u8(t3, n28, e6) {
  ...
  for (let a27 = 0; a27 < r11; a27++) if (null == t3 || t3[a27]) {
    const t4 = n28[a27], r12 = e6[a27], i22 = t4 + r12;
    i22 && (o19[a27] = (t4 - r12) / i22);
  }
  return [o19];
}
function f5(t3, n28, e6) {
  const r11 = e6.length, o19 = new Float32Array(r11);
  for (let a27 = 0; a27 < r11; a27++) if (null == t3 || t3[a27]) {
    const t4 = n28[a27], r12 = e6[a27];
    r12 && (o19[a27] = t4 / r12);
  }
  return [o19];
}
function h3(t3, n28, e6) {
  const r11 = n28.length, o19 = new Float32Array(r11);
  for (let a27 = 0; a27 < r11; a27++) if (null == t3 || t3[a27]) {
    const t4 = n28[a27], r12 = e6[a27];
    r12 && (o19[a27] = t4 / r12 - 1);
  }
  return [o19];
}
function w4(t3, n28, e6, r11) {
  const o19 = e6.length, a27 = new Float32Array(o19);
  for (let i22 = 0; i22 < o19; i22++) if (null == t3 || t3[i22]) {
    const t4 = e6[i22], o20 = n28[i22], s14 = o20 + t4 + r11;
    s14 && (a27[i22] = (o20 - t4) / s14 * (1 + r11));
  }
  return [a27];
}
function m9(t3, n28, e6, r11, o19, a27) {
  const i22 = e6.length, s14 = new Float32Array(i22), l23 = -o19 * r11 + a27 * (1 + r11 * r11);
  for (let c31 = 0; c31 < i22; c31++) if (null == t3 || t3[c31]) {
    const t4 = e6[c31], a28 = n28[c31], i23 = o19 * a28 + t4 + l23;
    i23 && (s14[c31] = r11 * (a28 - r11 * t4 - o19) / i23);
  }
  return [s14];
}
function d5(t3, n28, e6) {
  const r11 = e6.length, o19 = new Float32Array(r11);
  for (let a27 = 0; a27 < r11; a27++) if (null == t3 || t3[a27]) {
    const t4 = e6[a27], r12 = n28[a27], i22 = 2 * r12 + 1;
    o19[a27] = 0.5 * (i22 - Math.sqrt(i22 * i22 - 8 * (r12 - t4)));
  }
  return [o19];
}
function g3(t3, n28, e6) {
  const r11 = e6.length, o19 = new Float32Array(r11);
  for (let a27 = 0; a27 < r11; a27++) if (null == t3 || t3[a27]) {
    const t4 = e6[a27], r12 = n28[a27];
    if (1 !== t4 && r12 + t4 + 0.5 !== 0) {
      const n29 = (2 * (r12 * r12 - t4 * t4) + 1.5 * r12 + 0.5 * t4) / (r12 + t4 + 0.5);
      o19[a27] = n29 * (1 - 0.25 * n29) - (t4 - 0.125) / (1 - t4);
    }
  }
  return [o19];
}
function y2(t3, n28, e6, r11, o19) {
  const a27 = e6.length, i22 = new Float32Array(a27), s14 = 1 / Math.sqrt(1 + r11 * r11);
  for (let l23 = 0; l23 < a27; l23++) if (null == t3 || t3[l23]) {
    const t4 = e6[l23], a28 = n28[l23];
    i22[l23] = (a28 - r11 * t4 - o19) * s14;
  }
  return [i22];
}
function p5(t3, n28) {
  const [e6, r11, o19, a27, i22, s14] = n28, l23 = e6.length, c31 = new Float32Array(l23);
  for (let u23 = 0; u23 < l23; u23++) (null == t3 || t3[u23]) && (c31[u23] = -0.2848 * e6[u23] - 0.2435 * r11[u23] - 0.5436 * o19[u23] + 0.7243 * a27[u23] + 0.084 * i22[u23] - 0.18 * s14[u23]);
  return [c31];
}
function b3(t3, n28) {
  const [e6, r11, o19, a27, i22] = n28, s14 = e6.length, l23 = new Float32Array(s14), c31 = new Float32Array(s14), u23 = new Float32Array(s14);
  for (let f8 = 0; f8 < s14; f8++) (null == t3 || t3[f8]) && (l23[f8] = i22[f8] ? a27[f8] / i22[f8] * 100 : 0, c31[f8] = e6[f8] ? a27[f8] / e6[f8] * 100 : 0, u23[f8] = o19[f8] ? r11[f8] / o19[f8] * (a27[f8] / o19[f8]) * 100 : 0);
  return [l23, c31, u23];
}
function v2(t3, n28) {
  const [e6, r11, o19] = n28, a27 = e6.length, i22 = new Float32Array(a27);
  for (let s14 = 0; s14 < a27; s14++) if (null == t3 || t3[s14]) for (s14 = 0; s14 < a27; s14++) {
    const t4 = e6[s14], n29 = r11[s14], a28 = n29 + t4 - o19[s14];
    a28 && (i22[s14] = (n29 - t4) / a28);
  }
  return [i22];
}
function k2(t3, n28) {
  const [e6, r11, o19] = n28, a27 = e6.length, i22 = new Float32Array(a27);
  for (let s14 = 0; s14 < a27; s14++) if (null == t3 || t3[s14]) for (s14 = 0; s14 < a27; s14++) {
    const t4 = e6[s14], n29 = r11[s14], a28 = o19[s14], l23 = Math.sqrt((2 * t4 + 1) ** 2 - (6 * t4 - 5 * Math.sqrt(n29)) - 0.5);
    if (l23) {
      const e7 = 1.5 * (1.2 * (t4 - a28) - 2.5 * (n29 - a28));
      i22[s14] = e7 / l23;
    }
  }
  return [i22];
...
function A3(t3, n28) {
  const [e6, r11, o19] = n28, a27 = e6.length, i22 = new Float32Array(a27);
  for (let s14 = 0; s14 < a27; s14++) if (null == t3 || t3[s14]) for (s14 = 0; s14 < a27; s14++) {
    const t4 = e6[s14], n29 = r11[s14], a28 = o19[s14];
    i22[s14] = 100 * (t4 - n29) - 10 * (t4 - a28);
  }
  return [i22];
}
function F2(t3, n28) {
  const [e6, r11, o19] = n28, a27 = e6.length, i22 = new Float32Array(a27);
  for (let s14 = 0; s14 < a27; s14++) if (null == t3 || t3[s14]) for (s14 = 0; s14 < a27; s14++) {
    const t4 = e6[s14], n29 = r11[s14], a28 = t4 + 6 * n29 - 7.5 * o19[s14] + 1;
    a28 && (i22[s14] = 2.5 * (t4 - n29) / a28);
  }
  return [i22];
}
function x2(t3, n28, e6 = 0.5) {
  const [r11, o19, a27] = n28, i22 = o19.length, s14 = new Float32Array(i22);
  for (let l23 = 0; l23 < i22; l23++) if (null == t3 || t3[l23]) for (l23 = 0; l23 < i22; l23++) {
    const t4 = r11[l23], n29 = o19[l23], i23 = a27[l23], c31 = t4 + e6 * n29 + (1 - e6) * i23;
    c31 && (s14[l23] = (t4 - e6 * n29 - (1 - e6) * i23) / c31);
  }
  return [s14];
}
function j2(t3, n28, e6) {
  const r11 = e6.length, o19 = new Float32Array(r11);
  for (let a27 = 0; a27 < r11; a27++) if (null == t3 || t3[a27]) for (a27 = 0; a27 < r11; a27++) {
    const t4 = (0.1 - n28[a27]) ** 2 + (0.06 - e6[a27]) ** 2;
    t4 && (o19[a27] = 1 / t4);
  }
  return [o19];
}
...
var u9 = class extends l5 {
  ...
  _bindSourceRasters() {
    ...
    const t3 = e6.clone();
    t3.pixelType = this.outputPixelType, t3.bandCount = "sultan" === this.functionArguments.method ? 3 : 1, this._removeStatsHistColormapVAT(t3), t3.keyProperties = { ...t3.keyProperties, BandProperties: void 0 }, this.rasterInfo = t3;
    return { success: true, supportsGPU: !["custom", "gvitm", "sultan"].includes(this.functionArguments.method) };
  }
  _processPixels(e6) {
    var _a;
    const t3 = (_a = e6.pixelBlocks) == null ? void 0 : _a[0];
  ...
  _swizzleBandIds(e6) {
    ...
    return i22[2] ?? (i22[2] = i22[1]), this.isInputBandIdsSwizzled = true, this.swizzledBandSelection = i22, false;
  }
};
...
var c13 = class extends l5 {
  ...
  _bindSourceRasters() {
    ...
    if ("outside" === r11) try {
      const { spatialReference: e7 } = t3, r12 = "extent" === s14.type ? D2(s14, e7) : H(s14, e7).extent;
      r12 && l3(t3, r12);
    } catch {
    }
  ...
  _processPixels(t3) {
    var _a;
    return (_a = t3.pixelBlocks) == null ? void 0 : _a[0];
  }
  _getWebGLParameters() {
...
var u11 = i5 = class extends c6 {
  ...
  clone() {
    var _a;
    return new i5({ colormap: a(this.colormap), colormapName: this.colormapName, colorRamp: (_a = this.colorRamp) == null ? void 0 : _a.clone(), colorRampName: this.colorRampName });
  }
};
...
var m13 = class extends l5 {
  ...
  _bindSourceRasters() {
    ...
    if (!(t3 == null ? void 0 : t3.length)) if (s14) this.colorRamp = s14, t3 = B(s14, { interpolateAlpha: true });
    else if (e6) {
      const o20 = d2(e6);
      o20 && (t3 = B(o20), this.colorRamp = p(o20));
    } else r11 && (t3 = c14(r11));
    if (!(t3 == null ? void 0 : t3.length)) return { success: false, supportsGPU: false, error: "colormap-function: missing colormap argument" };
  ...
  _processPixels(o19) {
    var _a;
    let t3 = (_a = o19.pixelBlocks) == null ? void 0 : _a[0];
...
var a11 = class extends l5 {
  ...
  _bindSourceRasters() {
    var _a;
    const t3 = this.sourceRasterInfos[0];
    if (t3.bandCount > 1 || !((_a = t3.colormap) == null ? void 0 : _a.length)) return { success: false, supportsGPU: false, error: "colormap-to-rgb-function: source data must be single band with a colormap" };
    const o19 = t3.clone();
  ...
  _processPixels(t3) {
    var _a;
    let o19 = (_a = t3.pixelBlocks) == null ? void 0 : _a[0];
    if (!o19 || !this.lookup) return o19;
    o19 = o19.clone();
    const e6 = o19.pixels[0], r11 = o19.mask ?? new Uint8Array(e6.length).fill(255), s14 = new Uint8Array(e6.length), n28 = new Uint8Array(e6.length), p19 = new Uint8Array(e6.length), { indexedColormap: a27, offset: u23 } = this.lookup, l23 = a27.length;
    for (let i22 = 0; i22 < e6.length; i22++) if (r11[i22]) {
      let t4 = 4 * (e6[i22] - u23);
      t4 < 0 || t4 > l23 - 4 ? r11[i22] = 0 : (s14[i22] = a27[t4++], n28[i22] = a27[t4++], p19[i22] = a27[t4++]);
    }
...
var i8 = class extends l5 {
  ...
  _bindSourceRasters() {
    ...
    s14.multidimensionalInfo && s14.multidimensionalInfo.variables.forEach((e7) => {
      const s15 = t3.map((t4) => {
        var _a;
        return (_a = t4.multidimensionalInfo) == null ? void 0 : _a.variables.find(({ name: t5 }) => t5 === e7.name);
      }), n29 = s15.map((t4) => {
        var _a;
        return ((_a = t4 == null ? void 0 : t4.statistics) == null ? void 0 : _a.length) ? t4.statistics : null;
      }), r11 = s15.map((t4) => {
        var _a;
        return ((_a = t4 == null ? void 0 : t4.histograms) == null ? void 0 : _a.length) ? t4.histograms : null;
      });
    ...
    const n28 = t3.every((t4) => {
      var _a;
      return (_a = t4.keyProperties.BandProperties) == null ? void 0 : _a.length;
    }) ? t3.flatMap((t4) => t4.keyProperties.BandProperties) : void 0;
    s14.keyProperties = { ...s14.keyProperties, BandProperties: n28 }, this.rasterInfo = s14;
    return { success: true, supportsGPU: s14.bandCount <= 3 };
  }
  _processPixels(t3) {
    const { pixelBlocks: e6 } = t3;
    if (!e6) return null;
    const s14 = e6 == null ? void 0 : e6[0];
...
function i9(e6, n28, s14, i22) {
  const [f8, h5] = e6, p19 = r4(s14) && !r4(f8.pixelType) && !r4(h5.pixelType), u23 = [f8.mask, h5.mask].filter((e7) => e7), m17 = c3.combineBandMasks(u23), g5 = e6.map((e7) => e7.pixels[0]), { width: k4, height: x5 } = f8, b4 = c3.createEmptyBand(s14, k4 * x5);
  switch (n28) {
    case "difference":
    case "relative-difference":
      ...
      break;
    case "categorical":
      l11({ bands: g5, mask: m17, outBand: b4, ...i22 });
      break;
...
function o10(e6) {
  const { bands: [t3, a27], mask: n28, isRelative: s14, isRoundingNeeded: i22, outBand: o19 } = e6, l23 = t3.length;
  for (let c31 = 0; c31 < l23; c31++) if (!n28 || n28[c31]) {
    let e7 = t3[c31] - a27[c31];
    if (s14) {
      const n29 = Math.max(Math.abs(t3[c31]), Math.abs(a27[c31]));
      e7 = 0 === n29 ? 0 : e7 / n29;
    }
    o19[c31] = i22 ? Math.round(e7) : e7;
  }
}
function l11(e6) {
  const { bands: [t3, a27], categoryIndexLookups: [n28, s14], classNames: [i22, o19], mask: l23, keepMethod: c31, outBand: d10 } = e6, r11 = t3.length, f8 = i22.length, h5 = o19.length, p19 = f8 * h5, u23 = p19 + 1, m17 = p19 + 2;
  for (let g5 = 0; g5 < r11; g5++) if (!l23 || l23[g5]) {
    const e7 = t3[g5], l24 = a27[g5], r12 = n28[e7], f9 = s14[l24], k4 = i22[r12], x5 = o19[f9];
    d10[g5] = null == r12 || null == f9 ? p19 : "changed" === c31 && k4 === x5 ? u23 : "unchanged" === c31 && k4 !== x5 ? m17 : r12 * h5 + f9;
  }
}
function c15(e6) {
  const { pixels: [t3, a27], mask: n28, outBand: s14 } = e6, i22 = t3[0].length, o19 = t3.length;
  for (let l23 = 0; l23 < i22; l23++) if (!n28 || n28[l23]) {
    let e7 = 0;
    for (let n29 = 0; n29 < o19; n29++) {
      const s15 = t3[n29][l23] - a27[n29][l23];
      e7 += s15 * s15;
    }
...
function d7(e6) {
  ...
  for (let l23 = 0; l23 < i22; l23++) if (!n28 || n28[l23]) {
    ...
    for (let s15 = 0; s15 < o19; s15++) {
      const o20 = t3[s15][l23], c32 = a27[s15][l23];
      e7 += o20 * c32, n29 += o20 * o20, i23 += c32 * c32;
    }
    const c31 = Math.sqrt(n29 * i23);
    s14[l23] = c31 ? Math.acos(e7 / c31) : 1.5707963267948966;
  }
}
function r7(e6) {
  const { pixels: [t3, a27], mask: n28, outBand: s14 } = e6, i22 = t3[0].length, o19 = t3.length;
  for (let l23 = 0; l23 < i22; l23++) if (!n28 || n28[l23]) {
    let e7 = 0, n29 = 0;
    for (let s15 = 0; s15 < o19; s15++) {
      const i23 = Math.abs(t3[s15][l23] - a27[s15][l23]);
...
var l12 = class extends l5 {
  ...
  _processPixels(e6) {
    ...
    if (null == (t3 == null ? void 0 : t3[0]) || null == (t3 == null ? void 0 : t3[1])) return null;
  ...
  _getWebGLParameters() {
    ...
    let [t3, s14] = u2(e6);
    const a27 = r4(e6);
    return a27 && (t3 -= 1e-4, s14 += 1e-4), { method: this.functionArguments.method, domainRange: [t3, s14], isOutputRounded: a27 };
  }
  _updateAttributeTable(e6, t3, s14) {
    const n28 = this.sourceRasterInfos.map((e7) => e7.attributeTable), r11 = n28.map((e7, s15) => e7.features.map((e8) => e8.attributes[t3[s15]])), a27 = n28.map((e7, t4) => e7.features.map((e8) => e8.attributes[s14[t4]])), o19 = r11.map((e7) => {
      const t4 = [];
      return e7.forEach((e8, s15) => t4[e8] = s15), t4;
    }), { keepMethod: i22 } = this.functionArguments;
    this._categoryConfig = { categoryIndexLookups: o19, classNames: a27, keepMethod: i22 };
    ...
    const m17 = this._getFieldNames(n28, "red"), p19 = this._getFieldNames(n28, "green"), c31 = this._getFieldNames(n28, "blue"), f8 = [], d10 = 2 === m17.length && 2 === p19.length && 2 === c31.length;
    d10 && (f8.push(...n28.map((e7, t4) => e7.features.map((e8) => [e8.attributes[m17[t4]], e8.attributes[p19[t4]], e8.attributes[c31[t4]]]))), l23.fields.push(new m2({ name: "Red", type: "integer" }), new m2({ name: "Green", type: "integer" }), new m2({ name: "Blue", type: "integer" })));
    const g5 = l23.features[0].clone();
    g5.geometry = null;
    const h5 = [], [y3, C3] = r11.map((e7) => e7.length);
    let b4 = 1;
    for (let u23 = 0; u23 < y3; u23++) {
      ...
      for (let t4 = 0; t4 < C3; t4++) {
        ...
        const n29 = g5.clone();
        n29.attributes = { OID: b4++, Value: u23 * C3 + t4, ClassName: e7 === s15 ? e7 : `${e7} -> ${s15}`, Class_From: e7, Class_To: s15 }, d10 && (n29.attributes.Red = f8[0][u23][0] + f8[1][t4][0] >> 1, n29.attributes.Green = f8[0][u23][1] + f8[1][t4][1] >> 1, n29.attributes.Blue = f8[0][u23][2] + f8[1][t4][2] >> 1), h5.push(n29);
      }
    }
    if ("changed" === i22) {
      const e7 = g5.clone();
      e7.attributes = { OID: b4++, Value: y3 * C3 + 1, ClassName: "No Change", Class_From: "Same", Class_To: "Same" }, h5.push(e7);
    } else if ("unchanged" === i22) {
      const e7 = g5.clone();
      e7.attributes = { OID: b4++, Value: y3 * C3 + 2, ClassName: "Changed", Class_From: "Any", Class_To: "Any" }, h5.push(e7);
    }
    l23.features = h5, e6.attributeTable = l23;
  }
  _getFieldNames(e6, t3) {
    return e6.map(({ fields: e7 }) => {
      var _a;
      return (_a = e7.find((e8) => e8.name.toLowerCase() === t3)) == null ? void 0 : _a.name;
    }).filter((e7) => e7);
  }
...
var u14 = class extends l5 {
  ...
  _processPixels(t3) {
    var _a;
    const s14 = (_a = t3.pixelBlocks) == null ? void 0 : _a[0];
    return null == s14 ? null : f2(s14, { lut: s14.pixels.map(() => this.lookup), offset: 0, outputPixelType: "u8" });
  }
  _getWebGLParameters() {
...
function o12(o19, t3, f8, r11, l23) {
  const e6 = Math.floor(r11 / 2);
  for (let c31 = 0; c31 < e6; c31++) for (let r12 = 0; r12 < t3; r12++) o19[c31 * t3 + r12] = o19[(l23 - 1 - c31) * t3 + r12], o19[(f8 - 1 - c31) * t3 + r12] = o19[(f8 - l23 + c31) * t3 + r12];
  const n28 = Math.floor(l23 / 2);
  for (let c31 = 0; c31 < f8; c31++) {
    const f9 = c31 * t3;
    for (let r12 = 0; r12 < n28; r12++) o19[f9 + r12] = o19[f9 + l23 - 1 - r12], o19[f9 + t3 - r12 - 1] = o19[f9 + t3 + r12 - l23];
  }
}
...
function r8(e6, t3, n28, o19, l23, r11, s14) {
  const i22 = new Float32Array(t3 * n28), a27 = r11.length, p19 = s14 ? 0 : o19, h5 = s14 ? o19 : 0, c31 = s14 ? 1 : t3;
  for (let u23 = p19; u23 < n28 - p19; u23++) {
    const n29 = u23 * t3;
    for (let s15 = h5; s15 < t3 - h5; s15++) {
      if (l23 && !l23[n29 + s15]) continue;
      let t4 = 0;
      for (let l24 = 0; l24 < a27; l24++) t4 += e6[n29 + s15 + (l24 - o19) * c31] * r11[l24];
      i22[n29 + s15] = t4;
    }
  }
  return i22;
...
function s8(e6, t3, n28, o19, l23, r11, s14) {
  const i22 = new Float32Array(t3 * n28), a27 = Math.floor(o19 / 2), p19 = Math.floor(l23 / 2);
  for (let h5 = a27; h5 < n28 - a27; h5++) {
    const n29 = h5 * t3;
    for (let h6 = p19; h6 < t3 - p19; h6++) {
      if (r11 && !r11[n29 + h6]) continue;
      let c31 = 0;
      for (let r12 = 0; r12 < o19; r12++) for (let o20 = 0; o20 < l23; o20++) c31 += e6[n29 + h6 + (r12 - a27) * t3 + o20 - p19] * s14[r12 * l23 + o20];
      i22[n29 + h6] = c31;
    }
  }
  return i22;
...
function i11(n28, o19, l23 = true) {
  const { pixels: r11, width: i22, height: a27, pixelType: p19, mask: h5 } = n28, c31 = r11.length, u23 = [], { kernel: f8, rows: g5, cols: m17 } = o19;
  for (let t3 = 0; t3 < c31; t3++) {
    const n29 = s8(r11[t3], i22, a27, g5, m17, h5, f8);
    l23 && o12(n29, i22, a27, g5, m17), u23.push(n29);
  }
  return new c3({ width: i22, height: a27, pixelType: p19, pixels: u23, mask: h5 });
}
function a13(n28, o19, l23, s14 = true) {
  const { pixels: i22, width: a27, height: p19, pixelType: h5, mask: c31 } = n28, u23 = i22.length, f8 = [], g5 = o19.length, m17 = l23.length, x5 = Math.floor(g5 / 2), w6 = Math.floor(m17 / 2);
  for (let t3 = 0; t3 < u23; t3++) {
    let n29 = r8(i22[t3], a27, p19, x5, c31, o19, true);
    n29 = r8(n29, a27, p19, w6, c31, l23, false), s14 && o12(n29, a27, p19, g5, m17), f8.push(n29);
  }
  return new c3({ width: a27, height: p19, pixelType: h5, pixels: f8, mask: c31 });
}
function p9(e6, t3) {
...
o13.set(D4.none, [0, 0, 0, 0, 1, 0, 0, 0, 0]), o13.set(D4.lineDetectionHorizontal, [-1, -1, -1, 2, 2, 2, -1, -1, -1]), o13.set(D4.lineDetectionVertical, [-1, 2, -1, -1, 2, -1, -1, 2, -1]), o13.set(D4.lineDetectionLeftDiagonal, [2, -1, -1, -1, 2, -1, -1, -1, 2]), o13.set(D4.lineDetectionRightDiagonal, [-1, -1, 2, -1, 2, -1, 2, -1, -1]), o13.set(D4.gradientNorth, [-1, -2, -1, 0, 0, 0, 1, 2, 1]), o13.set(D4.gradientWest, [-1, 0, 1, -2, 0, 2, -1, 0, 1]), o13.set(D4.gradientEast, [1, 0, -1, 2, 0, -2, 1, 0, -1]), o13.set(D4.gradientSouth, [1, 2, 1, 0, 0, 0, -1, -2, -1]), o13.set(D4.gradientNorthEast, [0, -1, -2, 1, 0, -1, 2, 1, 0]), o13.set(D4.gradientNorthWest, [-2, -1, 0, -1, 0, 1, 0, 1, 2]), o13.set(D4.smoothArithmeticMean, [0.111111111111, 0.111111111111, 0.111111111111, 0.111111111111, 0.111111111111, 0.111111111111, 0.111111111111, 0.111111111111, 0.111111111111]), o13.set(D4.smoothing3x3, [0.0625, 0.125, 0.0625, 0.125, 0.25, 0.125, 0.0625, 0.125, 0.0625]), o13.set(D4.smoothing5x5, [1, 1, 1, 1, 1, 1, 4, 4, 4, 1, 1, 4, 12, 4, 1, 1, 4, 4, 4, 1, 1, 1, 1, 1, 1]), o13.set(D4.sharpening3x3, [-1, -1, -1, -1, 9, -1, -1, -1, -1]), o13.set(D4.sharpening5x5, [-1, -3, -4, -3, -1, -3, 0, 6, 0, -3, -4, 6, 21, 6, -4, -3, 0, 6, 0, -3, -1, -3, -4, -3, -1]), o13.set(D4.laplacian3x3, [0, -1, 0, -1, 4, -1, 0, -1, 0]), o13.set(D4.laplacian5x5, [0, 0, -1, 0, 0, 0, -1, -2, -1, 0, -1, -2, 17, -2, -1, 0, -1, -2, -1, 0, 0, 0, -1, 0, 0]), o13.set(D4.sobelHorizontal, [-1, -2, -1, 0, 0, 0, 1, 2, 1]), o13.set(D4.sobelVertical, [-1, 0, 1, -2, 0, 2, -1, 0, 1]), o13.set(D4.sharpen, [0, -0.25, 0, -0.25, 2, -0.25, 0, -0.25, 0]), o13.set(D4.sharpen2, [-0.25, -0.25, -0.25, -0.25, 3, -0.25, -0.25, -0.25, -0.25]), o13.set(D4.pointSpread, [-0.627, 0.352, -0.627, 0.352, 2.923, 0.352, -0.627, 0.352, -0.627]);
...
var l14 = p10 = class extends c6 {
  ...
  set convolutionType(o19) {
    ...
    if (!t3 || o19 === D4.userDefined || o19 === D4.none) return;
...
var c18 = class extends l5 {
  ...
  _bindSourceRasters() {
    ...
    if (!Object.values(D4).includes(t3)) return { success: false, supportsGPU: false, error: `convolution-function: the specified kernel type is not supported ${t3}` };
    if (t3 !== D4.none && e6 * o19 !== n28.length) return { success: false, supportsGPU: false, error: "convolution-function: the specified rows and cols do not match the length of the kernel" };
    ...
    const i22 = [D4.none, D4.sharpen, D4.sharpen2, D4.sharpening3x3, D4.sharpening5x5];
  ...
  _processPixels(t3) {
    var _a;
    const e6 = (_a = t3.pixelBlocks) == null ? void 0 : _a[0];
    if (null == e6 || this.functionArguments.convolutionType === D4.none) return e6;
  ...
  _getNeighborhoodSize() {
    const { rows: t3, cols: e6 } = this.functionArguments;
    return { rows: t3, cols: e6 };
  }
};
...
var u15 = class extends l5 {
  ...
  _bindSourceRasters() {
    ...
    this.outputPixelType = this._getOutputPixelType("f32");
    const t3 = this.sourceRasterInfos[0].clone();
    return t3.pixelType = this.outputPixelType, t3.bandCount = 1, this._removeStatsHistColormapVAT(t3), this.rasterInfo = t3, this.isGCS = ((_a = t3.spatialReference) == null ? void 0 : _a.isGeographic) ?? false, { success: true, supportsGPU: true };
  }
  _processPixels(t3) {
    var _a;
    const e6 = (_a = t3.pixelBlocks) == null ? void 0 : _a[0];
    if (null == e6) return null;
    const { zFactor: r11, curvatureType: s14 } = this.functionArguments, { extent: o19, primaryPixelSizes: u23 } = t3, a27 = u23 == null ? void 0 : u23[0], c31 = a27 ?? (o19 ? { x: o19.width / e6.width, y: o19.height / e6.height } : { x: 1, y: 1 }), p19 = this.isGCS && r11 >= 1 ? r11 * n2 : r11;
    return f3(e6, { zFactor: p19, curvatureType: s14, resolution: c31 });
  }
  _getWebGLParameters() {
...
var i13 = a15 = class extends c6 {
  ...
  clone() {
    var _a, _b, _c;
    return new a15({ bandIds: (_a = this.bandIds) == null ? void 0 : _a.slice(), bandNames: (_b = this.bandNames) == null ? void 0 : _b.slice(), bandWavelengths: (_c = this.bandWavelengths) == null ? void 0 : _c.slice(), missingBandAction: this.missingBandAction, method: this.method, wavelengthMatchTolerance: this.wavelengthMatchTolerance });
  }
};
...
var a16 = class extends l5 {
  ...
  _bindSourceRasters() {
    var _a;
    const { functionArguments: t3, sourceRasterInfos: n28 } = this, e6 = n28[0], { method: s14, bandNames: r11, bandWavelengths: i22, bandIds: a27, missingBandAction: o19 } = t3, h5 = (r11 == null ? void 0 : r11.length) && ("name" === s14 || "id" !== s14 && !(a27 == null ? void 0 : a27.length)), c31 = (i22 == null ? void 0 : i22.length) && ("wavelength" === s14 || "id" !== s14 && !(a27 == null ? void 0 : a27.length)), m17 = 1 === o19, g5 = h5 ? l16(e6, r11) : c31 ? d8(e6, i22, this.functionArguments, m17) : u16(e6, a27, m17);
    if (null == g5) {
      return { success: false, supportsGPU: false, error: `extract-band-function: Invalid ${h5 ? "band names" : c31 ? "band wavelengths" : "band ids"} for the imagery data source` };
    }
    ...
    const { statistics: f8, histograms: I3 } = p19;
    null != f8 && f8.length && (p19.statistics = g5.map((t4) => f8[t4] || f8[f8.length - 1])), null != I3 && I3.length && (p19.histograms = g5.map((t4) => I3[t4] || I3[I3.length - 1])), p19.multidimensionalInfo && p19.multidimensionalInfo.variables.forEach((t4) => {
    ...
    let x5 = (_a = p19.keyProperties) == null ? void 0 : _a.BandProperties;
    (x5 == null ? void 0 : x5.length) && (x5 = g5.map((t4) => t4 >= x5.length ? x5[x5.length - 1] : x5[t4]), p19.keyProperties = { ...p19.keyProperties, BandProperties: x5 }), this.rasterInfo = p19;
    return { success: true, supportsGPU: p19.bandCount <= 3 };
  }
  _processPixels(t3) {
    var _a;
    const n28 = (_a = t3.pixelBlocks) == null ? void 0 : _a[0];
  ...
  _swizzleBandIds(t3) {
    ...
    return this.isInputBandIdsSwizzled = true, n28[1] ?? (n28[1] = n28[0]), n28[2] ?? (n28[2] = n28[1]), this.swizzledBandSelection = n28, false;
  }
};
...
function u16(t3, n28, e6) {
  ...
  return !(n28 == null ? void 0 : n28.length) || e6 && n28.some((t4) => t4 < 0 || t4 >= s14) ? null : n28;
}
function d8(t3, n28, { wavelengthMatchTolerance: e6 }, s14) {
  ...
  for (let o19 = 0; o19 < n28.length; o19++) {
    ...
    for (let n29 = 0; n29 < i22.length; n29++) {
      const e7 = i22[n29], s15 = t4 >= e7.minWavelength && t4 <= e7.maxWavelength, a28 = Math.abs(t4 - (e7.minWavelength + e7.maxWavelength) / 2);
      s15 ? a28 < u23 && (r12 = true, l23 = n29, u23 = a28) : !r12 && a28 < u23 && (l23 = n29, u23 = a28);
    }
...
function s9(s14, i22, n28, h5) {
  const { pixels: o19, width: a27, height: l23 } = s14, r11 = o19.length, p19 = n28.startsWith("f"), c31 = !p19, [d10, f8] = u2(n28), m17 = a27 * l23, g5 = c3.createEmptyBand(n28, m17);
  for (let t3 = 0; t3 < l23; t3++) {
    let e6 = t3 * a27;
    for (let t4 = 0; t4 < a27; t4++, e6++) if (!h5 || h5[e6]) {
      let t5 = 0;
      for (let s15 = 0; s15 < r11; s15++) t5 += i22[s15] * o19[s15][e6];
      p19 || (t5 = Math.round(t5), c31 && (t5 = t5 > f8 ? f8 : t5 < d10 ? d10 : t5)), g5[e6] = t5;
    }
  }
  return g5;
}
function i14(t3, i22, n28) {
  const { width: h5, height: o19, mask: a27, bandMasks: l23 } = t3, r11 = (l23 == null ? void 0 : l23.length) ? c3.combineBandMasks(l23) : a27, p19 = s9(t3, i22, n28, r11), c31 = new c3({ width: h5, height: o19, pixels: [p19], pixelType: n28, mask: r11 });
  return c31.updateStatistics(), c31;
}
function n15(t3, i22, n28) {
  const { width: h5, height: o19, mask: a27, bandMasks: l23 } = t3, r11 = (l23 == null ? void 0 : l23.length) ? c3.combineBandMasks(l23) : a27, p19 = [], c31 = t3.pixels.length;
  for (let e6 = 0; e6 < i22.length / c31; e6++) {
    const h6 = s9(t3, i22.slice(e6 * c31, (e6 + 1) * c31), n28, r11);
    p19.push(h6);
  }
  const d10 = new c3({ width: h5, height: o19, pixels: p19, pixelType: n28, mask: r11 });
  return d10.updateStatistics(), d10;
}
...
var i15 = class extends l5 {
  ...
  _bindSourceRasters() {
    ...
    if (!(t3 == null ? void 0 : t3.length)) return { success: false, supportsGPU: false, error: "missing valid conversion parameters." };
    const e6 = this.sourceRasterInfos[0].clone();
...
var c21 = class extends l5 {
  ...
  _bindSourceRasters() {
    ...
    this.outputPixelType = this._getOutputPixelType("u8");
    const e6 = t3.clone();
    return this._removeStatsHistColormapVAT(e6), e6.pixelType = this.outputPixelType, e6.bandCount = 1, e6.statistics = [{ min: 0, max: 255, avg: 60, stddev: 10 }], this.rasterInfo = e6, this.isGCS = ((_a = e6.spatialReference) == null ? void 0 : _a.isGeographic) ?? false, { success: true, supportsGPU: true };
  }
  _processPixels(t3) {
    var _a;
    const e6 = (_a = t3.pixelBlocks) == null ? void 0 : _a[0];
    if (!e6) return null;
    const { extent: s14, primaryPixelSizes: i22 } = t3, r11 = i22 == null ? void 0 : i22[0], o19 = r11 ?? (s14 ? { x: s14.width / e6.width, y: s14.height / e6.height } : { x: 1, y: 1 }), a27 = d(this.functionArguments, o19, this.isGCS), p19 = r5(e6, a27);
    return p19.pixelType = this.outputPixelType, p19;
  }
  _getWebGLParameters() {
    const t3 = d(this.functionArguments, { x: 1, y: 1 }, this.isGCS), e6 = o4(t3), { slopeType: s14, zFactor: r11, pixelSizeFactor: o19, pixelSizePower: u23 } = this.functionArguments, c31 = "scaled" === s14, l23 = r4(this.outputPixelType);
    return { ...e6, zFactor: r11, gcsFactor: this.isGCS ? n2 : 1, pixelSizeFactor: c31 ? o19 : 0, pixelSizePower: c31 ? u23 : 0, isOutputRounded: l23 };
  }
  _getNeighborhoodSize() {
    return { rows: 3, cols: 3 };
  }
...
var m15 = class extends l5 {
  ...
  _getWebGLParameters() {
    var _a;
    const { operation: t3 } = this.functionArguments, s14 = c8[t3], e6 = ((_a = Object.keys(m7).find((s15) => m7[s15] === t3)) == null ? void 0 : _a.toLowerCase()) ?? "undefined", i22 = this.outputPixelType ?? "f32";
    let [r11, u23] = u2(i22);
    const c31 = r4(i22);
    return c31 && (r11 -= 1e-4, u23 += 1e-4), { imageCount: s14, operationName: e6, domainRange: [r11, u23], isOutputRounded: c31 };
  }
  _updateStatistics(t3) {
    var _a, _b;
    const s14 = this.sourceRasterInfos[0], { operation: e6 } = this.functionArguments, n28 = (_a = l6(e6)) == null ? void 0 : _a.domain;
    if (n28) {
      t3.statistics = [];
      for (let s15 = 0; s15 < t3.bandCount; s15++) t3.statistics[s15] = { min: n28[0], max: n28[1], avg: (n28[0] + n28[1]) / 2, stddev: (n28[0] + n28[1]) / 10 };
    } else 45 === e6 && ((_b = s14.statistics) == null ? void 0 : _b.length) && (t3.statistics = s14.statistics.map((t4) => ({ min: -t4.max, max: -t4.min, avg: null != t4.avg ? -t4.avg : void 0, stddev: null != t4.stddev ? -t4.stddev : void 0 })));
  }
  _updatePixelType(t3) {
    ...
    let a27 = "f32";
    if (r11 && u23) a27 = i(r11[0], r11[1]);
    else if (30 === n28) {
      const t4 = s14 == null ? void 0 : s14[0];
      a27 = t4 ? i(t4.min, t4.max) : r4(e6) ? e6 : "s32";
    } else if (45 === n28 && r4(e6)) {
      const t4 = s14 == null ? void 0 : s14.map(({ max: t5 }) => -t5), n29 = s14 == null ? void 0 : s14.map(({ min: t5 }) => -t5), o19 = (t4 == null ? void 0 : t4.length) ? Math.min(...t4) : null, r12 = (n29 == null ? void 0 : n29.length) ? Math.min(...n29) : null;
      a27 = null != o19 && null != r12 ? i(o19, r12) : e6.startsWith("s") ? e6.replace("s", "u") : "u1" === e6 || "u2" === e6 || "u4" === e6 ? "s8" : "u8" === e6 ? "s16" : "s32";
    }
    t3.pixelType = this.outputPixelType = this._getOutputPixelType(a27);
  }
};
...
var a20 = o16 = class extends c6 {
  ...
  clone() {
    var _a, _b;
    return new o16({ includedRanges: ((_a = this.includedRanges) == null ? void 0 : _a.slice()) ?? [], noDataValues: ((_b = this.noDataValues) == null ? void 0 : _b.slice()) ?? [], noDataInterpretation: this.noDataInterpretation });
  }
};
...
var l19 = class extends l5 {
  ...
  _bindSourceRasters() {
    ...
    if (!(s14 == null ? void 0 : s14.length) && !(n28 == null ? void 0 : n28.length)) return { success: false, supportsGPU: false, error: "missing includedRanges or noDataValues argument" };
    let o19 = [];
    for (let i22 = 0; i22 < t3.bandCount; i22++) {
      const t4 = U(e6, s14 == null ? void 0 : s14.slice(2 * i22, 2 * i22 + 2), n28 == null ? void 0 : n28[i22]);
      if (null == t4) {
        o19 = null;
        break;
      }
    ...
    this.lookups = o19;
    const r11 = null != n28 && n28.every((t4) => {
      var _a;
      return (t4 == null ? void 0 : t4.length) === ((_a = n28[0]) == null ? void 0 : _a.length);
    });
  ...
  _getWebGLParameters() {
    ...
    n28.fill(D), ((_a = s14 == null ? void 0 : s14[0]) == null ? void 0 : _a.length) && n28.set(s14[0]);
    const o19 = new Float32Array(6);
    for (let r11 = 0; r11 < o19.length; r11 += 2) o19[r11] = (t3 == null ? void 0 : t3[r11]) ?? -D, o19[r11 + 1] = (t3 == null ? void 0 : t3[r11 + 1]) ?? D;
    return (t3 == null ? void 0 : t3.length) && o19.set(t3), { bandCount: this.sourceRasterInfos[0].bandCount, noDataValues: n28, includedRanges: o19 };
  }
};
...
var a21 = class extends l5 {
  ...
  _bindSourceRasters() {
    ...
    const r11 = e6.clone();
    r11.pixelType = this.outputPixelType, this._removeStatsHistColormapVAT(r11), r11.bandCount = 1, r11.keyProperties = { ...r11.keyProperties, BandProperties: void 0 };
    const [o19, a27, u23, d10] = t3 ? [-1, 1, 0, 0.1] : [0, 200, 100, 10];
    return r11.statistics = [{ min: o19, max: a27, avg: u23, stddev: d10 }], this.rasterInfo = r11, { success: true, supportsGPU: true };
  }
  _processPixels(t3) {
    var _a;
    const s14 = (_a = t3.pixelBlocks) == null ? void 0 : _a[0];
...
var f6 = class extends l5 {
  ...
  _bindSourceRasters() {
    ...
    const { allowUnmatched: n28, replacementValue: a27, outputValues: l23, inputRanges: r11, noDataRanges: p19, isLastInputRangeInclusive: m17 } = this.functionArguments, c31 = "unknown" === this.outputPixelType || null == this.outputPixelType;
    if (this.outputPixelType = this._getOutputPixelType(e6), l23 == null ? void 0 : l23.length) {
      const o19 = s14 == null ? void 0 : s14[0];
      if (n28 && null == a27) {
        let e7 = (o19 == null ? void 0 : o19.min) ?? l23[0], s15 = (o19 == null ? void 0 : o19.max) ?? l23[0];
        e7 = Math.min.apply(null, [...l23, e7]), s15 = Math.max.apply(null, [...l23, s15]), t3.statistics = [{ min: e7, max: s15, avg: (o19 == null ? void 0 : o19.avg) ?? 0, stddev: (o19 == null ? void 0 : o19.stddev) ?? -1 }];
      } else {
        let e7 = l23[0], s15 = e7;
        for (let t4 = 0; t4 < l23.length; t4++) e7 = e7 > l23[t4] ? l23[t4] : e7, s15 = s15 > l23[t4] ? s15 : l23[t4];
        n28 && null != a27 && (e7 = Math.min(e7, a27), s15 = Math.max(s15, a27)), t3.statistics = [{ min: e7, max: s15, avg: (o19 == null ? void 0 : o19.avg) ?? 0, stddev: (o19 == null ? void 0 : o19.stddev) ?? -1 }];
      }
      if (c31) {
        ...
        l23.some((t4) => Math.floor(t4) !== t4) ? this.outputPixelType = "f64" === r12 ? "f64" : "f32" : this.outputPixelType = n28 && null == a27 && i22.indexOf(e6) > i22.indexOf(r12) ? e6 : r12;
      }
    }
  ...
  _processPixels(t3) {
    ...
    if (s14) {
      const t4 = f2(e6, { lut: [s14.lut], offset: s14.offset, outputPixelType: n28 });
      return null != t4 && s14.mask && (t4.mask = c4(e6.pixels[0], e6.mask, s14.mask, s14.offset, "u8")), t4;
    }
    const { inputRanges: u23, outputValues: a27, noDataRanges: o19, allowUnmatched: i22, isLastInputRangeInclusive: m17, replacementValue: c31 } = this.functionArguments;
    return g(e6, { inputRanges: u23, outputValues: a27, noDataRanges: o19, outputPixelType: n28, allowUnmatched: i22, isLastInputRangeInclusive: m17, replacementValue: c31 });
  }
  _getWebGLParameters() {
    const { allowUnmatched: t3, noDataRanges: s14, isLastInputRangeInclusive: n28 } = this.functionArguments, a27 = this.functionArguments.inputRanges ?? [], o19 = this.functionArguments.outputValues ?? [], l23 = m4(a27, o19, n28), r11 = new Float32Array(2 * l2);
    r11.fill(D), (s14 == null ? void 0 : s14.length) && r11.set(s14);
...
__decorate([a2({ json: { write: true, name: "rasterFunction" } })], f6.prototype, "functionName", void 0), __decorate([a2({ type: i16, json: { write: true, name: "rasterFunctionArguments" } })], f6.prototype, "functionArguments", void 0), __decorate([a2()], f6.prototype, "rasterArgumentNames", void 0), __decorate([a2({ json: { write: true } })], f6.prototype, "lookup", void 0), f6 = __decorate([c("esri.layers.raster.functions.RemapFunction")], f6);
var g4 = f6;
...
var h4 = class extends l5 {
  ...
  _bindSourceRasters() {
    ...
    if (!t3 && !(s14 == null ? void 0 : s14.length)) return { success: false, supportsGPU: false, error: "shadedrelief-function: a color ramp argument must be specified" };
    this.outputPixelType = this._getOutputPixelType("u8");
    const o19 = e6.clone();
    this._removeStatsHistColormapVAT(o19), o19.pixelType = this.outputPixelType, o19.bandCount = 3, o19.statistics = [{ min: 0, max: 255, avg: 60, stddev: 10 }, { min: 0, max: 255, avg: 60, stddev: 10 }, { min: 0, max: 255, avg: 60, stddev: 10 }], this.rasterInfo = o19, this.isGCS = ((_a = o19.spatialReference) == null ? void 0 : _a.isGeographic) ?? false, (s14 == null ? void 0 : s14.length) || (s14 = B(t3, { interpolateAlpha: true }));
    const { indexedColormap: r11, offset: n28 } = a3({ colormap: s14 });
    if (!(r11 == null ? void 0 : r11.length)) return { success: false, supportsGPU: false, error: "shadedrelief-function: a valid colorramp is required" };
    const a27 = D3(r11);
    return this.lookup = { indexedColormap: r11, offset: n28, hsvMap: a27 }, { success: true, supportsGPU: a4(r11) };
  }
  _processPixels(e6) {
    var _a, _b, _c;
    const t3 = (_a = e6.pixelBlocks) == null ? void 0 : _a[0];
    if (!t3 || !this.lookup) return null;
    let s14 = (_b = e6.primaryPixelSizes) == null ? void 0 : _b[0];
    if (null == s14) {
      const { extent: o20 } = e6;
      s14 = o20 ? { x: o20.width / t3.width, y: o20.height / t3.height } : { x: 1, y: 1 };
    }
    const o19 = d(this.functionArguments, s14, this.isGCS), r11 = r5(t3, o19), i22 = ((_c = this.sourceRasterInfos[0].statistics) == null ? void 0 : _c[0]) ?? { min: 0, max: 8e3 };
    return c5(r11, t3, this.lookup.hsvMap, i22), r11.pixelType = this.outputPixelType, r11;
  }
  _getWebGLParameters() {
    var _a;
    const e6 = d(this.functionArguments, { x: 1, y: 1 }, this.isGCS), t3 = o4(e6), { slopeType: s14, zFactor: r11, pixelSizeFactor: i22, pixelSizePower: n28 } = this.functionArguments, p19 = "scaled" === s14, { indexedColormap: u23, offset: m17 } = this.lookup, d10 = (_a = this.sourceRasterInfos[0].statistics) == null ? void 0 : _a[0], f8 = r4(this.outputPixelType);
    return { ...t3, indexedColormap: u23, offset: m17, zFactor: r11, gcsFactor: this.isGCS ? n2 : 1, pixelSizeFactor: p19 ? i22 : 0, pixelSizePower: p19 ? n28 : 0, minValue: (d10 == null ? void 0 : d10.min) ?? 0, maxValue: (d10 == null ? void 0 : d10.max) ?? 8e3, isOutputRounded: f8 };
  }
  _getNeighborhoodSize() {
    return { rows: 3, cols: 3 };
  }
};
__decorate([a2({ json: { write: true, name: "rasterFunction" } })], h4.prototype, "functionName", void 0), __decorate([a2({ type: c23, json: { write: true, name: "rasterFunctionArguments" } })], h4.prototype, "functionArguments", void 0), __decorate([a2()], h4.prototype, "rasterArgumentNames", void 0), __decorate([a2({ json: { write: true } })], h4.prototype, "isGCS", void 0), __decorate([a2({ json: { write: true } })], h4.prototype, "lookup", void 0), h4 = __decorate([c("esri.layers.raster.functions.ShadedReliefFunction")], h4);
var x3 = h4;
...
var u19 = class extends l5 {
  ...
  _bindSourceRasters() {
    ...
    this.outputPixelType = this._getOutputPixelType("f32");
    const e6 = this.sourceRasterInfos[0].clone();
    return e6.pixelType = this.outputPixelType, this._removeStatsHistColormapVAT(e6), e6.statistics = "percent-rise" !== this.functionArguments.slopeType ? [{ min: 0, max: 90, avg: 1, stddev: 1 }] : null, e6.bandCount = 1, this.rasterInfo = e6, this.isGCS = ((_a = e6.spatialReference) == null ? void 0 : _a.isGeographic) ?? false, { success: true, supportsGPU: true };
  }
  _processPixels(e6) {
    var _a;
    const t3 = (_a = e6.pixelBlocks) == null ? void 0 : _a[0];
    if (null == t3) return null;
    const { zFactor: s14, slopeType: i22, pixelSizePower: o19, pixelSizeFactor: r11 } = this.functionArguments, { isGCS: p19 } = this, { extent: u23, primaryPixelSizes: a27 } = e6, c31 = a27 == null ? void 0 : a27[0], l23 = c31 ?? (u23 ? { x: u23.width / t3.width, y: u23.height / t3.height } : { x: 1, y: 1 });
    return h(t3, { zFactor: s14, slopeType: i22, pixelSizePower: o19, pixelSizeFactor: r11, isGCS: p19, resolution: l23 });
  }
  _getWebGLParameters() {
    const { zFactor: e6, slopeType: t3, pixelSizeFactor: s14, pixelSizePower: o19 } = this.functionArguments;
    return { zFactor: this.isGCS && e6 >= 1 ? e6 * n2 : e6, slopeType: t3, pixelSizeFactor: s14 ?? 0, pixelSizePower: o19 ?? 0, isOutputRounded: r4(this.outputPixelType) };
  }
  _getNeighborhoodSize() {
    return { rows: 3, cols: 3 };
  }
...
var u20 = class extends l5 {
  ...
  _getWebGLParameters() {
    const t3 = u2(this.outputPixelType), [e6, s14, o19, n28, i22, u23, p19, c31, a27] = this.functionArguments.conversionMatrix;
    return { weights: [e6, n28, p19, s14, i22, c31, o19, u23, a27], clampRange: t3 };
  }
};
...
function s13(t3, e6) {
  ...
  const { statisticsType: a27, kernelRows: c31, kernelCols: f8 } = e6, h5 = "stddev" === a27, u23 = s14 * r11, m17 = new Float64Array(u23), d10 = new Float64Array(u23), y3 = new Uint32Array(u23);
  for (let A4 = 0; A4 < r11; A4++) {
    const t4 = A4 * s14;
    let e7 = 0, o20 = 0, r12 = 0;
    for (let s15 = 0; s15 < f8; s15++) i22 && !i22[t4 + s15] || (e7 += n28[t4 + s15], h5 && (o20 += n28[t4 + s15] ** 2), r12++);
    m17[t4] = e7, d10[t4] = o20, y3[t4] = r12;
    for (let l24 = 1; l24 <= s14 - f8; l24++) {
      const s15 = t4 + l24 - 1, a28 = s15 + f8;
      i22 ? (i22[s15] && (r12--, e7 -= n28[s15], h5 && (o20 -= n28[s15] ** 2)), i22[a28] && (r12++, e7 += n28[a28], h5 && (o20 += n28[a28] ** 2))) : (e7 -= n28[s15], e7 += n28[a28], h5 && (o20 -= n28[s15] ** 2, o20 += n28[a28] ** 2)), m17[t4 + l24] = e7, y3[t4 + l24] = r12, h5 && (d10[t4 + l24] = o20);
    }
  }
  const k4 = new Float64Array(u23), p19 = new Float64Array(u23), w6 = new Uint32Array(u23), M4 = c31 * s14;
  for (let A4 = 0; A4 <= s14 - f8; A4++) {
    let t4 = 0, e7 = 0, o20 = 0;
    for (let n29 = 0; n29 < c31; n29++) {
      const r12 = n29 * s14 + A4;
      t4 += m17[r12], o20 += y3[r12], h5 && (e7 += d10[r12]);
    }
    k4[A4] = t4, p19[A4] = e7, w6[A4] = o20;
    for (let n29 = 1; n29 <= r11 - c31; n29++) {
      const r12 = (n29 - 1) * s14 + A4, i23 = r12 + M4;
      t4 -= m17[r12], t4 += m17[i23], o20 -= y3[r12], o20 += y3[i23], h5 && (e7 -= d10[r12], e7 += d10[i23]), k4[n29 * s14 + A4] = t4, p19[n29 * s14 + A4] = e7, w6[n29 * s14 + A4] = o20;
    }
  }
  const g5 = Math.floor(c31 / 2), b4 = Math.floor(f8 / 2);
  for (let A4 = g5; A4 < r11 - g5; A4++) {
    ...
    for (let e7 = b4; e7 < s14 - b4; e7++) {
      ...
      const a28 = k4[n29] / r12, c32 = h5 ? Math.sqrt((p19[n29] - k4[n29] * a28) / r12) : a28;
      l23[t4 + e7] = c32, i22 && (i22[t4 + e7] = 255);
    }
  }
}
function r10(t3, e6) {
  const { fillNoDataOnly: o19 } = e6, { band: n28, width: s14, height: r11, mask: i22, outBand: l23 } = t3;
  if (o19 && !i22) return void l23.set(n28);
  const { kernelRows: a27, kernelCols: c31, statisticsType: f8 } = e6, h5 = Math.floor(a27 / 2), u23 = Math.floor(c31 / 2), m17 = "min" === f8, d10 = l23.slice(), y3 = new Uint32Array(s14 * r11);
  for (let k4 = h5; k4 < r11 - h5; k4++) {
    const t4 = k4 * s14;
    for (let e7 = u23; e7 < s14 - u23; e7++) {
      let o20 = m17 ? Number.MAX_VALUE : -Number.MAX_VALUE, r12 = 0;
      for (let l24 = 0; l24 < a27; l24++) for (let a28 = 0; a28 < c31; a28++) {
        const c32 = t4 + e7 + (l24 - h5) * s14 + a28 - u23;
        i22 && !i22[c32] || (o20 = m17 ? Math.min(o20, n28[c32]) : Math.max(o20, n28[c32]), r12++);
      }
      i22 ? (d10[t4 + e7] = 0 === r12 ? 0 : o20, y3[t4 + e7] = r12) : l23[t4 + e7] = 0 === r12 ? 0 : o20;
    }
  }
  if (i22) for (let k4 = h5; k4 < r11 - h5; k4++) {
    const t4 = k4 * s14;
...
function i18(t3, e6) {
  const { fillNoDataOnly: o19 } = e6, { band: n28, width: s14, height: r11, mask: i22, outBand: l23 } = t3;
  if (o19 && !i22) return void l23.set(n28);
  const { kernelRows: a27, kernelCols: c31 } = e6, f8 = Math.floor(a27 / 2), h5 = Math.floor(c31 / 2), u23 = l23.slice(), m17 = new Uint32Array(s14 * r11);
  for (let d10 = f8; d10 < r11 - f8; d10++) {
    const t4 = d10 * s14;
    for (let e7 = h5; e7 < s14 - h5; e7++) {
      if (o19 && (i22 == null ? void 0 : i22[t4 + e7])) continue;
      const r12 = [];
      for (let o20 = 0; o20 < a27; o20++) for (let l24 = 0; l24 < c31; l24++) {
        const a28 = t4 + e7 + (o20 - f8) * s14 + l24 - h5;
        i22 && !i22[a28] || r12.push(n28[a28]);
      }
  ...
  if (i22) for (let d10 = f8; d10 < r11 - f8; d10++) {
    const t4 = d10 * s14;
    for (let e7 = h5; e7 < s14 - h5; e7++) if (m17[t4 + e7]) {
      if (o19 && i22[t4 + e7]) continue;
...
function l21(t3, e6) {
  const { fillNoDataOnly: o19 } = e6, { band: n28, width: s14, height: r11, mask: i22, outBand: l23 } = t3;
  if (o19 && !i22) return void l23.set(n28);
  const { kernelRows: a27, kernelCols: c31 } = e6, f8 = Math.floor(a27 / 2), h5 = Math.floor(c31 / 2), u23 = "majority" === e6.statisticsType, m17 = a27 * c31, d10 = l23.slice(), y3 = new Uint32Array(s14 * r11);
  for (let k4 = f8; k4 < r11 - f8; k4++) {
    const t4 = k4 * s14;
    for (let e7 = h5; e7 < s14 - h5; e7++) {
      if (o19 && (i22 == null ? void 0 : i22[t4 + e7])) continue;
      ...
      for (let o20 = 0; o20 < a27; o20++) for (let l24 = 0; l24 < c31; l24++) {
        const a28 = t4 + e7 + (o20 - f8) * s14 + l24 - h5;
        if (i22 && !i22[a28]) continue;
        const c32 = n28[a28];
        r12.set(c32, r12.has(c32) ? r12.get(c32) + 1 : 1);
      }
  ...
  if (i22) for (let k4 = f8; k4 < r11 - f8; k4++) {
    const t4 = k4 * s14;
    for (let e7 = h5; e7 < s14 - h5; e7++) if (y3[t4 + e7]) {
      if (o19 && i22[t4 + e7]) continue;
      l23[t4 + e7] = d10[t4 + e7], i22[t4 + e7] = 255;
    }
  }
...
function a25(t3, n28) {
  const { mask: a27 } = t3, { fillNoDataOnly: c31 } = n28;
  if (c31 && !a27) return t3;
  const { pixels: f8, width: h5, height: u23, bandMasks: m17, pixelType: d10 } = t3, y3 = f8.length, k4 = h5 * u23, p19 = [], { kernelRows: w6, kernelCols: M4, statisticsType: g5, mirrorEdges: b4 } = n28;
  if (c31 && !a27) return t3;
  const A4 = n28.outputPixelType ?? d10, x5 = [];
  for (let j3 = 0; j3 < y3; j3++) {
    const t4 = f8[j3], d11 = c3.createEmptyBand(A4, k4);
    c31 && d11.set(t4);
    const y4 = (m17 == null ? void 0 : m17[j3]) ?? a27, B6 = (y4 == null ? void 0 : y4.slice()) ?? null, N3 = { band: t4, width: h5, height: u23, mask: B6, outBand: d11 };
    switch (g5) {
      case "min":
      case "max":
        r10(N3, n28);
    ...
    b4 && !c31 && o12(d11, h5, u23, w6, M4), p19.push(d11), B6 && x5.push(B6);
  }
  let B5 = x5[0] ?? a27;
  x5.length !== y3 && (x5.length = 0), y3 > 1 && (m17 == null ? void 0 : m17.length) && (B5 = c3.combineBandMasks(m17));
  const N2 = new c3({ pixelType: A4, width: h5, height: u23, pixels: p19, bandMasks: m17 && x5.length ? x5 : null, mask: B5 });
...
__decorate([a2({ json: { write: true, read: { source: ["kernelRows", "rows"], reader: (t3, s14) => Number(t3 ?? (s14 == null ? void 0 : s14.kernelRows) ?? 3) } } })], l22.prototype, "rows", void 0), __decorate([a2({ json: { write: true, read: { source: ["kernelCols", "cols"], reader: (t3, s14) => Number(t3 ?? (s14 == null ? void 0 : s14.kernelCols) ?? 3) } } })], l22.prototype, "cols", void 0), __decorate([a2({ json: { write: true } })], l22.prototype, "fillNoDataOnly", void 0), __decorate([a2({ json: { read: { source: ["statisticsType", "type"], reader: (t3, s14) => n22.fromJSON((s14 == null ? void 0 : s14.statisticsType) ?? (s14 == null ? void 0 : s14.type)) ?? "min" }, write: { target: "type" } } }), r2(n22)], l22.prototype, "statisticsType", void 0), l22 = c25 = __decorate([c("esri.layers.raster.functions.StatisticsFunctionArguments")], l22);
var n23 = l22;

// node_modules/@arcgis/core/layers/raster/functions/StatisticsFunction.js
var c26 = class extends l5 {
  constructor() {
  ...
  _getNeighborhoodSize() {
    const { rows: t3, cols: s14 } = this.functionArguments;
    return { rows: t3, cols: s14 };
  }
};
__decorate([a2({ json: { write: true, name: "rasterFunction" } })], c26.prototype, "functionName", void 0), __decorate([a2({ type: n23, json: { write: true, name: "rasterFunctionArguments" } })], c26.prototype, "functionArguments", void 0), __decorate([a2()], c26.prototype, "rasterArgumentNames", void 0), c26 = __decorate([c("esri.layers.raster.functions.StatisticsFunction")], c26);
var u21 = c26;

// node_modules/@arcgis/core/layers/raster/functions/StatisticsHistogramFunctionArguments.js
var n24;
var c27 = n24 = class extends c6 {
  constructor() {
  ...
  writeStatistics(t3, s14, r11) {
    ...
    const o19 = [];
    t3.forEach((t4) => {
      const s15 = { ...t4, mean: t4.avg, standardDeviation: t4.stddev };
...
__decorate([a2({ json: { write: true } })], c27.prototype, "statistics", void 0), __decorate([o2("statistics")], c27.prototype, "readStatistics", null), __decorate([r3("statistics")], c27.prototype, "writeStatistics", null), __decorate([a2({ json: { write: true } })], c27.prototype, "histograms", void 0), c27 = n24 = __decorate([c("esri.layers.raster.functions.StatisticsHistogramFunctionArguments")], c27);
var m16 = c27;
...
var u22 = n26 = class extends c6 {
  ...
  writeStatistics(t3, e6, o19) {
    (t3 == null ? void 0 : t3.length) && (Array.isArray(t3[0]) || (t3 = t3.map((t4) => [t4.min, t4.max, t4.avg, t4.stddev])), e6[o19] = t3);
  }
  clone() {
...
var c29 = class extends l5 {
  ...
  _bindSourceRasters() {
    ...
    if (!u23 && ["u8", "u16", "s8", "s16"].includes(s14)) {
      ...
      this.lookup = l4({ pixelType: s14, ...u24, gamma: i22 ? r11 : null, rounding: p20 }), this.cutOffs = u24;
    ...
    const { outputMin: m17 = 0, outputMax: c31 = 255 } = this.functionArguments;
    p19.statistics = [];
    for (let o19 = 0; o19 < p19.bandCount; o19++) p19.statistics[o19] = { min: m17, max: c31 };
    this.rasterInfo = p19;
  ...
  _processPixels(t3, s14) {
    ...
    if (o19) return f2(e6, { ...o19, outputPixelType: this.rasterInfo.pixelType });
    const { functionArguments: u23 } = this, i22 = (s14 == null ? void 0 : s14.stretchCutoff) ?? this.cutOffs ?? b(u23.toJSON(), { rasterInfo: this.sourceRasterInfos[0], pixelBlock: e6 }), a27 = u23.useGamma ? u23.gamma : null;
    return z(e6, { ...i22, gamma: a27, outputPixelType: this.outputPixelType });
  }
  _getWebGLParameters() {
    const { outputMin: t3 = 0, outputMax: s14 = 255, gamma: e6, useGamma: u23 } = this.functionArguments, r11 = this.rasterInfo.bandCount >= 2 ? 3 : 1, i22 = u23 && (e6 == null ? void 0 : e6.length) ? w2(r11, e6) : [1, 1, 1], { minCutOff: n28, maxCutOff: a27 } = this.cutOffs ?? { minCutOff: [0, 0, 0], maxCutOff: [255, 255, 255] };
    1 === n28.length && (n28[1] = n28[2] = n28[0], a27[1] = a27[2] = a27[0]);
    const p19 = a27.map((e7, o19) => (s14 - t3) / (a27[o19] - n28[o19])), c31 = r4(this.outputPixelType), f8 = u23 && e6 ? [e6[0], e6[1] ?? e6[0], e6[2] ?? e6[0]] : [1, 1, 1], l23 = u23 ? [i22[0], i22[1] ?? i22[0], i22[2] ?? i22[0]] : [1, 1, 1];
    return { bandCount: r11, minOutput: t3, maxOutput: s14, minCutOff: n28, maxCutOff: a27, factor: p19, useGamma: u23, gamma: f8, gammaCorrection: l23, stretchType: this.functionArguments.stretchType, isOutputRounded: c31, type: "stretch" };
  }
};
__decorate([a2({ json: { write: true, name: "rasterFunction" } })], c29.prototype, "functionName", void 0), __decorate([a2({ type: c28, json: { write: true, name: "rasterFunctionArguments" } })], c29.prototype, "functionArguments", void 0), __decorate([a2()], c29.prototype, "rasterArgumentNames", void 0), __decorate([a2({ json: { write: true } })], c29.prototype, "lookup", void 0), __decorate([a2({ json: { write: true } })], c29.prototype, "cutOffs", void 0), c29 = __decorate([c("esri.layers.raster.functions.StretchFunction")], c29);
var f7 = c29;

// node_modules/@arcgis/core/layers/raster/functions/TableFunctionArguments.js
var a26;
var c30 = a26 = class extends c6 {
  constructor() {
    super(...arguments), this.attributeTableAsRecordSet = null;
  }
  clone() {
    return new a26({ attributeTableAsRecordSet: a(this.attributeTableAsRecordSet) });
  }
};
__decorate([a2({ json: { write: true } })], c30.prototype, "attributeTableAsRecordSet", void 0), c30 = a26 = __decorate([c("esri.layers.raster.functions.TableFunctionArguments")], c30);
var i20 = c30;
...
var i21 = class extends l5 {
  ...
  _bindSourceRasters() {
    ...
    const s14 = t3.clone();
    return s14.pixelType = this.outputPixelType, s14.bandCount = 1, "thematic" !== s14.dataType && (s14.keyProperties = s14.keyProperties ? { ...s14.keyProperties, DataType: "thematic" } : { DataType: "thematic" }), this.rasterInfo = s14, { success: true, supportsGPU: true };
  }
  _processPixels(t3) {
    var _a;
    return (_a = t3.pixelBlocks) == null ? void 0 : _a[0];
...
function k3(t3) {
  ...
  return "Local" !== e6 || ((_a = n28.rasters) == null ? void 0 : _a.length) || (n28.rasters = ["$$"]), { ...t3, rasterFunctionArguments: n28 };
}
function x4(t3, r11) {
  var _a, _b;
  const { rasterFunction: n28, rasterFunctionArguments: o19 } = t3, s14 = (_a = t3.outputPixelType) == null ? void 0 : _a.toLowerCase();
  if (null == n28 || !w5.has(n28)) throw new r("raster-function-helper", `unsupported raster function: ${n28}`);
  const a27 = w5.get(n28), i22 = ("function" == typeof a27.ctor ? a27.ctor : a27.ctor.default).fromJSON({ ...t3, outputPixelType: s14 }), { rasterArgumentNames: c31 } = i22, u23 = [], m17 = V2(o19, c31), l23 = "rasters" === c31[0] || c31.length > 1, p19 = [];
  for (let e6 = 0; e6 < m17.length; e6++) {
    const t4 = m17[e6];
    let n29;
    null == t4 || "string" == typeof t4 && t4.startsWith("$") ? u23.push(r11 == null ? void 0 : r11.raster) : "string" == typeof t4 ? r11[t4] && u23.push(r11[t4]) : "number" != typeof t4 && "rasterFunction" in t4 && (n29 = x4(t4, r11), l23 || (i22.functionArguments[c31[e6]] = n29), u23.push(n29)), l23 && p19.push(n29 ?? t4);
  }
  if (l23 && ("rasters" === c31[0] ? i22.functionArguments.rasters = p19 : c31.forEach((t4, e6) => {
    i22.functionArguments[t4] = p19[e6];
  })), r11) {
    i22.sourceRasters = u23;
    const t4 = (_b = r11.raster) == null ? void 0 : _b.url;
...
function M3(t3, r11) {
  ...
  switch (n28.type) {
    ...
    case "MultiPartColorRamp":
      ...
      break;
    case "ArgumentArray":
      if (((_a = n28.elements) == null ? void 0 : _a.length) && "RasterStatistics" !== n28.elements[0].type) {
        const t4 = [];
        for (let o20 = 0; o20 < n28.elements.length; o20++) {
          const s14 = n28.elements[o20], { type: a27 } = s14;
          if (a27) if ("RasterFunctionTemplate" === a27) {
            const { renderingRule: e6 } = H3(s14, r11);
            t4.push(e6), null != s14._object_id && r11.set(s14._object_id, e6);
          } else {
            if ("RasterFunctionVariable" !== a27) throw new r("raster-function-helper", "unsupported raster function json.");
            {
              const e6 = M3(s14, r11);
              t4.push(e6), null != s14._object_id && r11.set(s14._object_id, e6);
            }
...
function L2(t3, e6) {
  ...
  const { renderingRule: r11, templates: n28 } = e6, { function: o19, arguments: s14, _object_id: a27 } = t3;
  if (!o19 || !s14) return;
  null != a27 && n28.set(a27, r11), r11.rasterFunction = o19.type.replace("Function", ""), r11.outputPixelType = o19.pixelType;
  const i22 = {};
  r11.rasterFunctionArguments = i22;
  for (const c31 in s14) {
    if ("type" === c31 || "object_id" === c31 || "_object_ref_id" === c31) continue;
    const t4 = s14[c31];
    t4 && "object" == typeof t4 && "type" in t4 && ("RasterFunctionTemplate" === t4.type || "RasterFunctionVariable" === t4.type) ? ("RasterFunctionVariable" === t4.type ? i22[c31] = M3(t4, n28) : (r11.rasterFunctionArguments[c31] = {}, L2(t4, { renderingRule: r11.rasterFunctionArguments[c31], templates: n28 })), null != t4._object_id && n28.set(t4._object_id, i22[c31])) : i22[c31] = t4;
  }
...
function O2(t3) {
  ...
  if ("object" != typeof r11 || !(r11 == null ? void 0 : r11.rasterFunctionArguments) || !n28.size) return;
  ...
  for (const s14 in o19) {
    ...
    t4 && "object" == typeof t4 && (t4.rasterFunctionArguments && O2({ renderingRule: t4, templates: n28 }), Array.isArray(t4) && t4.forEach((o20, s15) => {
      if (o20 && "object" == typeof o20) if (null != o20._object_ref_id) {
        ...
        const a27 = n28.get(r12);
        a27 && "object" == typeof a27 ? Object.assign(o20, a27) : t4[s15] = a27;
...
function G2(t3) {
  var _a;
  ((_a = t3.Statistics) == null ? void 0 : _a.length) && "object" == typeof t3.Statistics && (t3.Statistics = t3.Statistics.map((t4) => [t4.min, t4.max, t4.mean, t4.standardDeviation])), null != t3.NumberOfStandardDeviation && (t3.NumberOfStandardDeviations = t3.NumberOfStandardDeviation, delete t3.NumberOfStandardDeviation);
}
function P2(t3) {
  var _a, _b;
  "randomcolorramp" === ((_b = (_a = t3.ColorRamp) == null ? void 0 : _a.type) == null ? void 0 : _b.toLowerCase()) && (delete t3.ColorRamp, t3.ColormapName = "Random"), 0 === t3.ColorSchemeType && delete t3.ColorRamp;
}
function I2(t3) {
