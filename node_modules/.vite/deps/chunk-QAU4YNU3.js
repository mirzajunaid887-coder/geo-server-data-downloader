...
function f(a3, f3) {
  ...
  S.uniforms.add(new r("intrinsicWidth", (e5) => e5.width));
  const { hasScreenSizePerspective: y, spherical: O } = f3;
  y ? (a3.include(s, f3), t2(S), d(S, f3), S.uniforms.add(new t3("inverseViewMatrix", (a4, t4) => h(z, i(z, t4.camera.viewMatrix, a4.origin)))), S.code.add(t`
...
return size;
    ...
    `)), f3.hasVVOpacity ? (m2.add("opacityFeatureAttribute", "float"), S.constants.add("vvOpacityNumber", "int", 8), S.uniforms.add(new r2("vvOpacityValues", u2, (e5) => e5.vvOpacity.values), new r2("vvOpacityOpacities", u2, (e5) => e5.vvOpacity.opacityValues), new r("vvOpacityFallback", (e5) => e5.vvOpacity.fallback, { supportsNaN: true })), S.code.add(t`
...
function i4(i5, n3) {
  ...
  `), 2 === n3.space && (d4.constants.add("maxSegmentLengthFraction", "float", 0.45), d4.uniforms.add(new r3("perRenderPixelRatio", (e5) => e5.camera.perRenderPixelRatio)), d4.code.add(t`
...
//# sourceMappingURL=chunk-QAU4YNU3.js.map
