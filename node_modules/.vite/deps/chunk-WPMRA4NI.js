...
function n2(t) {
  ...
  return r3.accumulateAttributeNames && (r3.accumulateAttributeNames = (_a5 = e2.accumulateAttributeNames) == null ? void 0 : _a5.join()), r3.attributeParameterValues && (r3.attributeParameterValues = JSON.stringify(e2.attributeParameterValues)), r3.barriers && (r3.barriers = JSON.stringify(e2.barriers)), r3.locateSettings && (r3.locateSettings = JSON.stringify(e2.locateSettings)), r3.outSR && (r3.outSR = (_b = e2.outSR) == null ? void 0 : _b.wkid), r3.overrides && (r3.overrides = JSON.stringify(e2.overrides)), r3.polygonBarriers && (r3.polygonBarriers = JSON.stringify(e2.polygonBarriers)), r3.polylineBarriers && (r3.polylineBarriers = JSON.stringify(e2.polylineBarriers)), r3.restrictionAttributeNames && (r3.restrictionAttributeNames = (_c = e2.restrictionAttributeNames) == null ? void 0 : _c.join()), r3.stops && (r3.stops = JSON.stringify(e2.stops)), r3.travelMode && (r3.travelMode = JSON.stringify(e2.travelMode)), r3;
}
...
//# sourceMappingURL=chunk-WPMRA4NI.js.map
