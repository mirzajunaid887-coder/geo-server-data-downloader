...
var g = c2 = class extends n {
  ...
  writeGeometryType(e, t, r2, o4) {
    ...
    if (s2) {
      for (const n2 of s2) if (null != (n2 == null ? void 0 : n2.geometry)) return void h.write(n2.geometry.type, t, r2, o4);
    }
  }
  ...
  toJSON(e) {
    ...
    if (t.features && Array.isArray(e) && e.length > 0) for (let r2 = 0; r2 < t.features.length; r2++) {
      ...
      if (o4.geometry) {
        ...
        o4.geometry = (t2 == null ? void 0 : t2.toJSON()) || o4.geometry;
      }
    }
    return t;
  }
  quantize(e) {
    ...
    for (let p = 0, m2 = l.length; p < m2; p++) (a3 == null ? void 0 : a3(l[p].geometry)) || (l.splice(p, 1), p--, m2--);
  ...
  readFeaturesWithClass(e, t, r2) {
    ...
    for (let n2 = 0; n2 < e.length; n2++) {
      const t2 = e[n2], i = r2.fromJSON(t2), l = (_a = t2.geometry) == null ? void 0 : _a.spatialReference;
      ...
      if (a3 && null != p) for (const e2 in p) {
        const t3 = p[e2], r3 = a3[e2], s3 = r3 == null ? void 0 : r3.spatialReference;
...
//# sourceMappingURL=chunk-IHTFASY4.js.map
