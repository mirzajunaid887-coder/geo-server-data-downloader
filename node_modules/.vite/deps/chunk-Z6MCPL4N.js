...
var r2 = class {
  ...
  add(r7, e11) {
    if (u3(r7)) {
      ...
      for (const e12 of r7) o4(e12) && t7.push(e12);
    } else if (o4(r7)) {
  ...
  remove(r7) {
    ...
    return this.has(r7) ? (s4(this._getGroup(r7)), this._groups.delete(e5(r7)), this) : this;
  }
  removeAll() {
  ...
  _getOrCreateGroup(t7) {
    ...
    const r7 = [];
    return this._groups.set(e5(t7), r7), r7;
  }
  _getGroup(t7) {
    return this._groups.get(e5(t7));
  }
};
function e5(t7) {
  return t7 || "_default_";
...
function s4(t7) {
  for (const e11 of t7) e11 instanceof r2 ? e11.removeAll() : e11.remove();
}
function o4(t7) {
  return null != t7 && (!!t7.remove || t7 instanceof r2);
}
...
var s5 = class extends s3 {
  constructor(t7) {
    super(new i2(t7)), this._observer && e7.register(this, new WeakRef(this._observer), this);
  }
  destroy() {
    var _a, _b2;
...
var e7 = new FinalizationRegistry((t7) => {
  var _a;
...
var t4 = class {
  constructor(t7 = 50, o8 = 50) {
    this._pool = new e2(() => [], void 0, r5, o8, t7);
  }
  acquire() {
...
function n3(n6, t7) {
  for (const r7 of n6.values()) if (t7(r7)) return true;
  return false;
}
function t5(n6, t7) {
  if (t7) for (const r7 of t7) null != r7 && n6.add(r7);
}
function r6(n6, t7) {
  if (!t7) return n6;
  for (const r7 of t7) n6.delete(r7);
  return n6;
}
function o6(n6, t7) {
  null != t7 && n6.add(t7);
...
function u5(n6, r7) {
  ...
  return t5(o8, n6), t5(o8, r7), o8;
}
function e8(n6, t7) {
  const r7 = /* @__PURE__ */ new Set();
  for (const o8 of t7) n6.has(o8) && r7.add(o8);
  return r7;
}
function f2(n6, t7) {
  if (!n6 || !t7) return false;
  if (n6 === t7) return true;
  for (const r7 of n6) if (!t7.has(r7)) return false;
  return true;
}
function i3(n6, t7) {
  if (null == n6 && null == t7) return true;
  if (null == n6 || null == t7 || n6.size !== t7.size) return false;
  for (const r7 of n6) if (!t7.has(r7)) return false;
  return true;
}
function c(n6, t7) {
  const r7 = new Set(n6);
  for (const o8 of t7) r7.delete(o8);
  return r7;
}
function l4(n6, t7) {
  return c(u5(n6, t7), e8(n6, t7));
}
...
var l5 = [];
function o7(l6, o8) {
  let e11 = new s5(a3), i5 = null, s7 = false;
  function a3() {
    if (!e11 || s7) return;
...
function i4(l6, o8) {
  ...
  const s7 = !!(o8 == null ? void 0 : o8.sync);
  let a3 = new s5(() => {
...
function b(e11, r7, l6) {
  let o8 = l(e11, r7, l6, (e12, r8, l7) => {
    let i5, n6, s7 = e9(() => u2(e12, r8), (t7, s8) => {
      var _a;
      ((_a = e12.__accessor__) == null ? void 0 : _a.lifecycle) === I.DESTROYED || i5 && i5.uid !== n6 ? o8.remove() : (i5 || (i5 = h2.acquireUntracked(t7, l7, s8, e12, r8), n6 = i5.uid), _(i5));
    });
    return e(() => {
...
var m4 = class {
  ...
  getDependsInfo(t7, e11, i5) {
    ...
    if (!f4(r7)) return "";
    const n6 = new s3(), a3 = f(n6, () => {
      var _a;
      return (_a = r7.metadata.get) == null ? void 0 : _a.call(t7);
    });
...
`;
  ...
  notifyChange(t7) {
    var _a;
    (_a = this.propertiesByName.get(t7)) == null ? void 0 : _a.notifyChange();
  }
  invalidate(t7) {
    var _a;
    (_a = this.propertiesByName.get(t7)) == null ? void 0 : _a.invalidate();
  }
  commit(t7) {
    var _a;
    (_a = this.propertiesByName.get(t7)) == null ? void 0 : _a.commit();
  }
  _internalSet(t7, e11) {
...
function m5(e11) {
  ...
  switch (typeof e11) {
    case "object":
      return ((_a = e11.constructor) == null ? void 0 : _a.__accessorMetadata__) || e11 instanceof Date ? { type: e11.constructor, value: e11 } : e11;
    case "boolean":
...
var _b = class _b {
  ...
  constructor(...e11) {
    ...
    Object.defineProperty(this, "__accessor__", { enumerable: false, value: t7 }), e11.length > 0 && (t7.ctorArgs = ((_a = this.normalizeCtorArgs) == null ? void 0 : _a.apply(this, e11)) ?? e11[0]), (_b2 = t6()) == null ? void 0 : _b2.onInstanceConstruct(this);
  }
  postscript() {
  ...
  destroy() {
    var _a;
    this.destroyed || (q(this), this.__accessor__.destroy(), (_a = t6()) == null ? void 0 : _a.onInstanceDestroy(this));
  }
  [Symbol.dispose]() {
    this.destroy();
  }
  ...
  addHandles(e11, r7) {
    ...
    (this[v2] ?? (this[v2] = new r2())).add(e11, r7);
  }
  removeHandles(e11) {
    var _a;
    (_a = this[v2]) == null ? void 0 : _a.remove(e11);
  }
  removeAllHandles() {
    var _a;
  ...
  removeHandlesReference(e11) {
    var _a;
    (_a = this[v2]) == null ? void 0 : _a.removeReference(e11);
  }
  hasHandles(e11) {
    var _a;
    return true === ((_a = this[v2]) == null ? void 0 : _a.has(e11));
  }
  _override(e11, t7) {
...
//# sourceMappingURL=chunk-Z6MCPL4N.js.map
